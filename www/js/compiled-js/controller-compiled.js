...
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.forgotPasswordFormValidator.whenValidate();case 1:case'end':return _context52.stop();}}},_callee52,this);}));function resetPasswordButtonClicked(){return _ref52.apply(this,arguments);}return resetPasswordButtonClicked;}(),/**
         ...
         * @returns {Promise<void>}
         */thirdPartyLoginButtonClicked:function(){var _ref53=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee56(){var toast;return regeneratorRuntime.wrap(function _callee56$(_context56){while(1){switch(_context56.prev=_context56.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context56.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to sign in';toast.dataBind();toast.show();return _context56.abrupt('return');case 10:// hide the tooltips on the login form
$('#login-page #login-form').get(0).ej2_instances.forEach(function(tooltipArrayElem){// hide the tooltip
tooltipArrayElem.close();});// hide the tooltips on the signup form
$('#login-page #signup-form').get(0).ej2_instances.forEach(function(tooltipArrayElem){// hide the tooltip
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3500;toast.content='Error signing user. Try again ';toast.dataBind();toast.show();resolve();// resolve the promise
case 11:case'end':return _context53.stop();}}},_callee53,this);}));return function(_x21,_x22){return _ref55.apply(this,arguments);};}()));case 1:case'end':return _context54.stop();}}},_callee54,this);}));function signInFailure(){return _ref54.apply(this,arguments);}return signInFailure;}(),signInSuccessWithAuthResult:function(){var _ref56=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee55(authResult){return regeneratorRuntime.wrap(function _callee55$(_context55){while(1){switch(_context55.prev=_context55.next){case 0:// triggers when forebase is successfully logged in
console.log("I GOT YOU",authResult);// hide the 'third-party-login-modal'
_context55.next=3;return $('#third-party-login-modal').get(0).hide();case 3:return _context55.abrupt('return',false);case 4:case'end':return _context55.stop();}}},_callee55,this);}));function signInSuccessWithAuthResult(_x23){return _ref56.apply(this,arguments);}return signInSuccessWithAuthResult;}()}});// disable firebase ui auto-signin
utopiasoftware[utopiasoftware_app_namespace].model.firebaseUI.disableAutoSignIn();case 16:case'end':return _context56.stop();}}},_callee56,this);}));function thirdPartyLoginButtonClicked(){return _ref53.apply(this,arguments);}return thirdPartyLoginButtonClicked;}(),/**
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=3000;toast.content='User signin completed';toast.dataBind();toast.show();case 15:case'end':return _context57.stop();}}},_callee57,this);}));return function(_x24){return _ref58.apply(this,arguments);};}()).catch(function(){var _ref59=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee58(err){var toast;return regeneratorRuntime.wrap(function _callee58$(_context58){while(1){switch(_context58.prev=_context58.next){case 0:// an error occurred
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Invalid user email or password. User signin failed ';toast.dataBind();toast.show();case 12:case'end':return _context58.stop();}}},_callee58,this);}));return function(_x25){return _ref59.apply(this,arguments);};}());return _context59.abrupt('return',promisesArrayPromise);case 21:case'end':return _context59.stop();}}},_callee59,this);}));function loginFormValidated(){return _ref57.apply(this,arguments);}return loginFormValidated;}(),/**
...
case 13:case'end':return _context61.stop();}}},_callee61,this);}));return function(_x27){return _ref62.apply(this,arguments);};}());}));return _context62.abrupt('return',Promise.all(promisesArray));case 16:case'end':return _context62.stop();}}},_callee62,this);}));function signupFormValidated(){return _ref60.apply(this,arguments);}return signupFormValidated;}(),/**
...
$('#products-page .page__content .infinite-load-container').remove();case 5:case'end':return _context65.stop();}}},_callee65,this);}));function pageHide(_x28){return _ref65.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
reject(err);// reject the parent promise with the error
});}));}return _context68.abrupt('return',Promise.all(productPromisesArray));case 5:case'end':return _context68.stop();}}},_callee68,this);}));function loadProducts(_x33){return _ref68.apply(this,arguments);}return loadProducts;}(),/**
...
}});return _context69.abrupt('return',displayCompletedPromise);case 2:case'end':return _context69.stop();}}},_callee69,this);}));function displayPageContent(_x36){return _ref69.apply(this,arguments);}return displayPageContent;}(),/**
         * method scrolls the page to the top
         * @returns {Promise<void>}
...
window.plugins.socialsharing.shareWithOptions(shareOptions,function(){},function(){});},0);case 4:case'end':return _context76.stop();}}},_callee76,this);}));function shareButtonClicked(){return _ref76.apply(this,arguments);}return shareButtonClicked;}(),/**
         ...
         * @returns {Promise<void>}
         */rateButtonClicked:function(){var _ref77=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee79(){var userDetails,toast,_toast,ordersArray,_toast2;return regeneratorRuntime.wrap(function _callee79$(_context79){while(1){switch(_context79.prev=_context79.next){case 0:userDetails=null;// holds the user details
// display page preloader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast2=$('.timed-page-toast').get(0).ej2_instances[0];_toast2.cssClass='error-ej2-toast';_toast2.timeOut=3500;_toast2.content='Sorry, you need to have purchased this product before it can be rated';_toast2.dataBind();_toast2.show();return _context79.abrupt('return');case 51:_context79.prev=51;// hide page preloader
...
_toast3=$('.timed-page-toast').get(0).ej2_instances[0];_toast3.cssClass='success-ej2-toast';_toast3.timeOut=3500;_toast3.content='Thank you. Your product review has been received';_toast3.dataBind();_toast3.show();_context78.next=37;break;case 23:_context78.prev=23;_context78.t0=_context78['catch'](0);_context78.next=27;return $('#loader-modal').get(0).hide();case 27:_context78.next=29;return $('#rate-product-modal').get(0).show();case 29:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show error
_toast4=$('.timed-page-toast').get(0).ej2_instances[0];_toast4.cssClass='error-ej2-toast';_toast4.timeOut=3500;_toast4.content='Error. Your product review could not be sent. Please retry';_toast4.dataBind();_toast4.show();case 37:_context78.prev=37;return _context78.finish(37);case 39:_context78.next=41;return $('#rate-product-modal').get(0).hide();case 41:case'end':return _context78.stop();}}},_callee78,this,[[0,23,37,39]]);}));// display "Rate Product" modal
...
$('#product-details-page .product-details-weight').html(''+(!productDetails.weight||productDetails.weight==""?"(Not Available)":''+productDetails.weight));case 19:case'end':return _context85.stop();}}},_callee85,this);}));function displayProductDetails(_x42){return _ref83.apply(this,arguments);}return displayProductDetails;}(),/**
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast5=$('.timed-page-toast').get(0).ej2_instances[0];_toast5.cssClass='error-ej2-toast';_toast5.timeOut=3500;_toast5.content='Error adding product to your cart. Try again';_toast5.dataBind();_toast5.show();case 66:_context88.prev=66;// enable the "Add To Cart" button
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast6=$('.timed-page-toast').get(0).ej2_instances[0];_toast6.cssClass='error-ej2-toast';_toast6.timeOut=3500;_toast6.content='Error adding customised product to your cart. Try again';_toast6.dataBind();_toast6.show();case 53:_context95.prev=53;// check if this is a save of an "edited" previously customised product
if(utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationCartKey){// since a current customisation cart key exist, this is an update
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee100(){var selectedProduct,_toast7,_toast8;return regeneratorRuntime.wrap(function _callee100$(_context100){while(1){switch(_context100.prev=_context100.next){case 0:_context100.prev=0;// find the product to be updated within the app localCart
...
_toast8=$('.timed-page-toast').get(0).ej2_instances[0];_toast8.cssClass='error-ej2-toast';_toast8.timeOut=3500;_toast8.content='Product quantity not updated. Try again';_toast8.dataBind();_toast8.show();case 28:_context100.prev=28;// hide page preloader
...
$('#view-cart-page #view-cart-total-price').html('&#x20a6;'+kendo.toString(utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.calculateCartTotalPrice(localCart),"n2"));case 33:_context101.prev=33;return _context101.finish(33);case 35:case'end':return _context101.stop();}}},_callee101,this,[[1,,33,35],[2,11]]);}));function displayUserCart(_x47){return _ref102.apply(this,arguments);}return displayUserCart;}(),/**
...
$('#view-cart-page-delete-cart-item-action-sheet #view-cart-page-delete-cart-item-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee104(){var localCart,productIndex,$cartDisplayedItem,toast,_toast9;return regeneratorRuntime.wrap(function _callee104$(_context104){while(1){switch(_context104.prev=_context104.next){case 0:localCart=[];// holds the local cart array
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast9=$('.timed-page-toast').get(0).ej2_instances[0];_toast9.cssClass='error-ej2-toast';_toast9.timeOut=3500;_toast9.content='Error deleting product from your cart. Try again';_toast9.dataBind();_toast9.show();case 42:_context104.prev=42;// hide page preloader
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast10=$('.timed-page-toast').get(0).ej2_instances[0];_toast10.cssClass='default-ej2-toast';_toast10.timeOut=3000;_toast10.content='Your cart is empty. Go order some products!';_toast10.dataBind();_toast10.show();return _context107.abrupt('return');case 38:if(!(userDetails.billing.address_1=="")){_context107.next=49;break;}// no billing address has been provided
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast11=$('.timed-page-toast').get(0).ej2_instances[0];_toast11.cssClass='error-ej2-toast';_toast11.timeOut=3500;_toast11.content='Please update your billing address to checkout your cart';_toast11.dataBind();_toast11.show();$('#app-main-navigator').get(0).pushPage('billing-info-page.html');return _context107.abrupt('return');case 49:if(!(navigator.connection.type===Connection.NONE)){_context107.next=59;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast12=$('.timed-page-toast').get(0).ej2_instances[0];_toast12.cssClass='error-ej2-toast';_toast12.timeOut=3000;_toast12.content='Connect to the Internet to checkout your cart';_toast12.dataBind();_toast12.show();return _context107.abrupt('return');case 59:// show the app loader modal
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast13=$('.timed-page-toast').get(0).ej2_instances[0];_toast13.cssClass='error-ej2-toast';_toast13.timeOut=3000;_toast13.content='Checkout failed. '+(_context107.t2.message||"");_toast13.dataBind();_toast13.show();case 86:_context107.prev=86;// hide the app loader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast14=$('.timed-page-toast').get(0).ej2_instances[0];_toast14.cssClass='success-ej2-toast';_toast14.timeOut=3000;_toast14.content='User profile updated';_toast14.dataBind();_toast14.show();_context112.next=63;break;case 52:_context112.prev=52;_context112.t0=_context112['catch'](17);_context112.t0=JSON.parse(_context112.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast15=$('.timed-page-toast').get(0).ej2_instances[0];_toast15.cssClass='error-ej2-toast';_toast15.timeOut=3000;_toast15.content='User profile update failed. '+(_context112.t0.message||"");_toast15.dataBind();_toast15.show();case 63:_context112.prev=63;// enable the "Update" button
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast16=$('.timed-page-toast').get(0).ej2_instances[0];_toast16.cssClass='success-ej2-toast';_toast16.timeOut=3000;_toast16.content='User password changed';_toast16.dataBind();_toast16.show();_context118.next=64;break;case 53:_context118.prev=53;_context118.t1=_context118['catch'](17);_context118.t1=JSON.parse(_context118.t1.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast17=$('.timed-page-toast').get(0).ej2_instances[0];_toast17.cssClass='error-ej2-toast';_toast17.timeOut=3000;_toast17.content='User password change failed. '+(_context118.t1.message||"");_toast17.dataBind();_toast17.show();case 64:_context118.prev=64;// enable the "Update" button
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast18=$('.timed-page-toast').get(0).ej2_instances[0];_toast18.cssClass='success-ej2-toast';_toast18.timeOut=3000;_toast18.content='User billing address updated';_toast18.dataBind();_toast18.show();_context124.next=64;break;case 53:_context124.prev=53;_context124.t0=_context124['catch'](17);_context124.t0=JSON.parse(_context124.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast19=$('.timed-page-toast').get(0).ej2_instances[0];_toast19.cssClass='error-ej2-toast';_toast19.timeOut=3000;_toast19.content='User billing address update failed. '+(_context124.t0.message||"");_toast19.dataBind();_toast19.show();case 64:_context124.prev=64;// enable the "Update" button
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast20=$('.timed-page-toast').get(0).ej2_instances[0];_toast20.cssClass='success-ej2-toast';_toast20.timeOut=3000;_toast20.content='Shipping information updated';_toast20.dataBind();_toast20.show();_context134.next=65;break;case 54:_context134.prev=54;_context134.t0=_context134['catch'](17);_context134.t0=JSON.parse(_context134.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast21=$('.timed-page-toast').get(0).ej2_instances[0];_toast21.cssClass='error-ej2-toast';_toast21.timeOut=3000;_toast21.content='Shipping information update failed. '+(_context134.t0.message||"");_toast21.dataBind();_toast21.show();case 65:_context134.prev=65;// enable the "Update" button
...
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast22=$('.timed-page-toast').get(0).ej2_instances[0];_toast22.cssClass='error-ej2-toast';_toast22.timeOut=3000;_toast22.content='Coupon not applied. Invalid coupon code';_toast22.dataBind();_toast22.show();case 42:case'end':return _context147.stop();}}},_callee147,this,[[10,31]]);}));function applyCouponButtonClicked(){return _ref150.apply(this,arguments);}return applyCouponButtonClicked;}(),/**
...
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast23=$('.timed-page-toast').get(0).ej2_instances[0];_toast23.cssClass='error-ej2-toast';_toast23.timeOut=3000;_toast23.content='Shipping note could not added. Please retry';_toast23.dataBind();_toast23.show();case 35:case'end':return _context148.stop();}}},_callee148,this,[[10,24]]);}));function addNoteButtonClicked(){return _ref151.apply(this,arguments);}return addNoteButtonClicked;}(),/**
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast24=$('.timed-page-toast').get(0).ej2_instances[0];_toast24.cssClass='error-ej2-toast';_toast24.timeOut=3500;_toast24.content='Error making payment for this order. Try again';_toast24.dataBind();_toast24.show();case 68:_context151.prev=68;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast25=$('.timed-page-toast').get(0).ej2_instances[0];_toast25.cssClass='error-ej2-toast';_toast25.timeOut=3500;_toast25.content='Error placing this order. Try again';_toast25.dataBind();_toast25.show();case 112:_context151.prev=112;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast26=$('.timed-page-toast').get(0).ej2_instances[0];_toast26.cssClass='error-ej2-toast';_toast26.timeOut=3000;_toast26.content='Shipping method not updated, retry. '+(_context152.t0.message||"");_toast26.dataBind();_toast26.show();// hide the page loader modal
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast27=$('.timed-page-toast').get(0).ej2_instances[0];_toast27.cssClass='error-ej2-toast';_toast27.timeOut=3000;_toast27.content='Payment method not updated, retry. '+(_context153.t0.message||"");_toast27.dataBind();_toast27.show();// hide the page loader modal
...
return _context155.abrupt('return');case 37:case'end':return _context155.stop();}}},_callee155,this,[[2,14]]);}));return function(_x52,_x53){return _ref159.apply(this,arguments);};}()));case 2:case'end':return _context156.stop();}}},_callee156,this);}));function validateOrderCheckout(){return _ref158.apply(this,arguments);}return validateOrderCheckout;}(),/**
...
case 46:_context157.prev=46;return _context157.finish(46);case 48:case'end':return _context157.stop();}}},_callee157,this,[[0,,46,48],[14,18,22,30],[23,,25,29]]);}));return function(_x55,_x56){return _ref161.apply(this,arguments);};}()));case 1:case'end':return _context158.stop();}}},_callee158,this);}));function createRemoteCartFromOrder(){return _ref160.apply(this,arguments);}return createRemoteCartFromOrder;}()},/**
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast28=$('.timed-page-toast').get(0).ej2_instances[0];_toast28.cssClass='error-ej2-toast';_toast28.timeOut=3000;_toast28.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast28.dataBind();_toast28.show();case 28:case'end':return _context159.stop();}}},_callee159,this,[[1,15]]);})),0);}}).appendTo('#track-order-page-input');}catch(err){}case 5:case'end':return _context160.stop();}}},_callee160,this);}));return function loadPageOnAppReady(){return _ref162.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
...
searchAutoComplete.dataBind();// bind new value to the component
searchAutoComplete.change();// trigger the change method
}case 1:case'end':return _context162.stop();}}},_callee162,this);}));function enterButtonClicked(_x57){return _ref165.apply(this,arguments);}return enterButtonClicked;}(),/**
...
promisesArray.push(Promise.reject("no internet connection"));}return _context163.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context163.stop();}}},_callee163,this);}));function loadOrders(_x60){return _ref166.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
...
}});return _context164.abrupt('return',displayCompletedPromise);case 2:case'end':return _context164.stop();}}},_callee164,this);}));function displayPageContent(_x61){return _ref167.apply(this,arguments);}return displayPageContent;}(),/**
...
$('#track-order-page .modal').css("display","none");return _context165.finish(18);case 21:case'end':return _context165.stop();}}},_callee165,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context166.stop();}}},_callee166,this);}));function checkoutButtonClicked(_x62){return _ref168.apply(this,arguments);}return checkoutButtonClicked;}(),/**
...
$('#track-order-page .modal').css("display","none");return _context167.finish(18);case 21:case'end':return _context167.stop();}}},_callee167,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context168.stop();}}},_callee168,this);}));function detailsButtonClicked(_x63){return _ref170.apply(this,arguments);}return detailsButtonClicked;}(),/**
...
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee170(){var selectedOrder,userDetails,searchResultsArray,_toast29,_toast30;return regeneratorRuntime.wrap(function _callee170$(_context170){while(1){switch(_context170.prev=_context170.next){case 0:// display the page loader
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast29=$('.timed-page-toast').get(0).ej2_instances[0];_toast29.cssClass='default-ej2-toast';_toast29.timeOut=2000;_toast29.content='Order #'+selectedOrder.id+' has been cancelled';_toast29.dataBind();_toast29.show();_context170.next=36;break;case 26:_context170.prev=26;_context170.t0=_context170['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast30=$('.timed-page-toast').get(0).ej2_instances[0];_toast30.cssClass='error-ej2-toast';_toast30.timeOut=3500;_toast30.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast30.dataBind();_toast30.show();case 36:_context170.prev=36;// display the page loader
...
_context171.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context171.stop();}}},_callee171,this);}));function cancelButtonClicked(_x64){return _ref172.apply(this,arguments);}return cancelButtonClicked;}(),/**
...
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee172(){var selectedOrder,newOrder,_toast31;return regeneratorRuntime.wrap(function _callee172$(_context172){while(1){switch(_context172.prev=_context172.next){case 0:// get the selected order to be checked out
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast31=$('.timed-page-toast').get(0).ej2_instances[0];_toast31.cssClass='error-ej2-toast';_toast31.timeOut=3000;_toast31.content='Placing new order failed. Please retry';_toast31.dataBind();_toast31.show();case 34:_context172.prev=34;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context172.finish(34);case 37:case'end':return _context172.stop();}}},_callee172,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context173.stop();}}},_callee173,this);}));function reorderButtonClicked(_x65){return _ref175.apply(this,arguments);}return reorderButtonClicked;}()},/**
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref179=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee176(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast33;return regeneratorRuntime.wrap(function _callee176$(_context176){while(1){switch(_context176.prev=_context176.next){case 0:// disable pull-to-refresh widget till loading is done
...
promisesArray.push(Promise.reject("no internet connection"));}return _context177.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context177.stop();}}},_callee177,this);}));function loadOrders(_x69){return _ref180.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
...
}});return _context178.abrupt('return',displayCompletedPromise);case 2:case'end':return _context178.stop();}}},_callee178,this);}));function displayPageContent(_x70){return _ref181.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
$('#completed-orders-page .modal').css("display","none");return _context179.finish(18);case 21:case'end':return _context179.stop();}}},_callee179,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context180.stop();}}},_callee180,this);}));function checkoutButtonClicked(_x71){return _ref182.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
$('#completed-orders-page .modal').css("display","none");return _context181.finish(18);case 21:case'end':return _context181.stop();}}},_callee181,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context182.stop();}}},_callee182,this);}));function detailsButtonClicked(_x72){return _ref184.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
...
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee184(){var selectedOrder,userDetails,searchResultsArray,_toast34,_toast35;return regeneratorRuntime.wrap(function _callee184$(_context184){while(1){switch(_context184.prev=_context184.next){case 0:// display the page loader
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast34=$('.timed-page-toast').get(0).ej2_instances[0];_toast34.cssClass='default-ej2-toast';_toast34.timeOut=2000;_toast34.content='Order #'+selectedOrder.id+' has been cancelled';_toast34.dataBind();_toast34.show();_context184.next=36;break;case 26:_context184.prev=26;_context184.t0=_context184['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast35=$('.timed-page-toast').get(0).ej2_instances[0];_toast35.cssClass='error-ej2-toast';_toast35.timeOut=3500;_toast35.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast35.dataBind();_toast35.show();case 36:_context184.prev=36;// display the page loader
...
_context185.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context185.stop();}}},_callee185,this);}));function cancelButtonClicked(_x73){return _ref186.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee186(){var selectedOrder,newOrder,_toast36;return regeneratorRuntime.wrap(function _callee186$(_context186){while(1){switch(_context186.prev=_context186.next){case 0:// get the selected order to be checked out
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast36=$('.timed-page-toast').get(0).ej2_instances[0];_toast36.cssClass='error-ej2-toast';_toast36.timeOut=3000;_toast36.content='Placing new order failed. Please retry';_toast36.dataBind();_toast36.show();case 34:_context186.prev=34;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context186.finish(34);case 37:case'end':return _context186.stop();}}},_callee186,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context187.stop();}}},_callee187,this);}));function reorderButtonClicked(_x74){return _ref189.apply(this,arguments);}return reorderButtonClicked;}()},/**
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref193=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee190(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast38;return regeneratorRuntime.wrap(function _callee190$(_context190){while(1){switch(_context190.prev=_context190.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#pending-orders-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast38=$('.timed-page-toast').get(0).ej2_instances[0];_toast38.cssClass='error-ej2-toast';_toast38.timeOut=3000;_toast38.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast38.dataBind();_toast38.show();case 27:_context190.prev=27;// enable pull-to-refresh widget till loading is done
...
promisesArray.push(Promise.reject("no internet connection"));}return _context191.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context191.stop();}}},_callee191,this);}));function loadOrders(_x78){return _ref194.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
...
}});return _context192.abrupt('return',displayCompletedPromise);case 2:case'end':return _context192.stop();}}},_callee192,this);}));function displayPageContent(_x79){return _ref195.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
$('#pending-orders-page .modal').css("display","none");return _context193.finish(18);case 21:case'end':return _context193.stop();}}},_callee193,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context194.stop();}}},_callee194,this);}));function checkoutButtonClicked(_x80){return _ref196.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
$('#pending-orders-page .modal').css("display","none");return _context195.finish(18);case 21:case'end':return _context195.stop();}}},_callee195,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context196.stop();}}},_callee196,this);}));function detailsButtonClicked(_x81){return _ref198.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
...
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee198(){var selectedOrder,userDetails,searchResultsArray,_toast39,_toast40;return regeneratorRuntime.wrap(function _callee198$(_context198){while(1){switch(_context198.prev=_context198.next){case 0:// display the page loader
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast39=$('.timed-page-toast').get(0).ej2_instances[0];_toast39.cssClass='default-ej2-toast';_toast39.timeOut=2000;_toast39.content='Order #'+selectedOrder.id+' has been cancelled';_toast39.dataBind();_toast39.show();_context198.next=36;break;case 26:_context198.prev=26;_context198.t0=_context198['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast40=$('.timed-page-toast').get(0).ej2_instances[0];_toast40.cssClass='error-ej2-toast';_toast40.timeOut=3500;_toast40.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast40.dataBind();_toast40.show();case 36:_context198.prev=36;// display the page loader
...
_context199.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context199.stop();}}},_callee199,this);}));function cancelButtonClicked(_x82){return _ref200.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee200(){var selectedOrder,newOrder,_toast41;return regeneratorRuntime.wrap(function _callee200$(_context200){while(1){switch(_context200.prev=_context200.next){case 0:// get the selected order to be checked out
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast41=$('.timed-page-toast').get(0).ej2_instances[0];_toast41.cssClass='error-ej2-toast';_toast41.timeOut=3000;_toast41.content='Placing new order failed. Please retry';_toast41.dataBind();_toast41.show();case 34:_context200.prev=34;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context200.finish(34);case 37:case'end':return _context200.stop();}}},_callee200,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context201.stop();}}},_callee201,this);}));function reorderButtonClicked(_x83){return _ref203.apply(this,arguments);}return reorderButtonClicked;}()},/**
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee206(){var selectedOrder,newOrder,_toast42;return regeneratorRuntime.wrap(function _callee206$(_context206){while(1){switch(_context206.prev=_context206.next){case 0:// get the selected order to be checked out
