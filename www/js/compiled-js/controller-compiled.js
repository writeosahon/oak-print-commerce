...
processData:false,data:JSON.stringify({password:authResult.user.uid})}));case 16:resultArray[0]=_context55.sent;resultArray[0].password=authResult.user.uid;// save the created user details data to ENCRYPTED app database as cached data
