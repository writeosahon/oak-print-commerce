...
_context55.next=22;return $('#loader-modal').get(0).hide();case 22:_context55.next=24;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 24:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast=$('.timed-page-toast').get(0).ej2_instances[0];_toast.cssClass='success-ej2-toast';_toast.timeOut=3000;_toast.content='User signin completed';_toast.dataBind();_toast.show();_context55.next=46;break;case 34:_context55.prev=34;_context55.t0=_context55['catch'](3);_context55.next=38;return $('#loader-modal').get(0).hide();case 38:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast2=$('.timed-page-toast').get(0).ej2_instances[0];_toast2.cssClass='error-ej2-toast';_toast2.timeOut=3500;_toast2.content='User does not have an account. User signin failed ';_toast2.dataBind();_toast2.show();case 46:if(!(loginMode==="sign up")){_context55.next=86;break;}_context55.prev=47;// display modal to user that signin is being completed
...
_context55.next=57;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:userDetails},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 57:// subscribe push notification for this user's device
window.plugins.OneSignal.setSubscription(true);// set the tag used to identify users for push notification sending
window.plugins.OneSignal.sendTags({appMail:userDetails.email});// hide loader
_context55.next=61;return $('#loader-modal').get(0).hide();case 61:_context55.next=63;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 63:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast3=$('.timed-page-toast').get(0).ej2_instances[0];_toast3.cssClass='success-ej2-toast';_toast3.timeOut=3000;_toast3.content='User signup completed';_toast3.dataBind();_toast3.show();_context55.next=86;break;case 73:_context55.prev=73;_context55.t1=_context55['catch'](47);_context55.t1=JSON.parse(_context55.t1.responseText);// hide loader
_context55.next=78;return $('#loader-modal').get(0).hide();case 78:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast4=$('.timed-page-toast').get(0).ej2_instances[0];_toast4.cssClass='error-ej2-toast';_toast4.timeOut=3000;_toast4.content='Error. '+(_context55.t1.message||"User signup failed");_toast4.dataBind();_toast4.show();case 86:return _context55.abrupt('return',false);case 87:case'end':return _context55.stop();}}},_callee55,this,[[3,34],[47,73]]);}));function signInSuccessWithAuthResult(_x24){return _ref56.apply(this,arguments);}return signInSuccessWithAuthResult;}()}});// disable firebase ui auto-signin
...
_context57.next=7;return $('#loader-modal').get(0).hide();case 7:_context57.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 9:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=3000;toast.content='User signin completed';toast.dataBind();toast.show();case 17:case'end':return _context57.stop();}}},_callee57,this);}));return function(_x25){return _ref58.apply(this,arguments);};}()).catch(function(){var _ref59=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee58(err){var toast;return regeneratorRuntime.wrap(function _callee58$(_context58){while(1){switch(_context58.prev=_context58.next){case 0:// an error occurred
...
window.plugins.OneSignal.setSubscription(true);// set the tag used to identify users for push notification sending
window.plugins.OneSignal.sendTags({appMail:userDetails.email});// hide loader
_context60.next=7;return $('#loader-modal').get(0).hide();case 7:_context60.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 9:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
