...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");toast.dataBind();toast.show();case 29:case'end':return _context154.stop();}}},_callee154,this,[[1,16]]);})),0);}}).appendTo('#track-order-page-input');}catch(err){}case 5:case'end':return _context155.stop();}}},_callee155,this);}));return function loadPageOnAppReady(){return _ref157.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
