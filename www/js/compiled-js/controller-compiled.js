...
processData:false,data:JSON.stringify(newOrder)}));case 10:newOrder=_context165.sent;_context165.next=13;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 13:userDetails=_context165.sent.userDetails;_context165.next=16;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 16:_context165.next=28;break;case 18:_context165.prev=18;_context165.t0=_context165['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast31=$('.timed-page-toast').get(0).ej2_instances[0];_toast31.cssClass='error-ej2-toast';_toast31.timeOut=3000;_toast31.content='Placing new order failed. Please retry';_toast31.dataBind();_toast31.show();case 28:_context165.prev=28;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context165.finish(28);case 31:case'end':return _context165.stop();}}},_callee165,this,[[3,18,28,31]]);})),0);case 13:case'end':return _context166.stop();}}},_callee166,this);}));function reorderButtonClicked(_x61){return _ref168.apply(this,arguments);}return reorderButtonClicked;}()},/**
