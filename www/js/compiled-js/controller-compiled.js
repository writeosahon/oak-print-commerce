...
$('#completed-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context160.prev=6;// hide the previously displayed orders info
...
_context160.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context160.sent.userDetails;_context160.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 14:searchResultsArray=_context160.sent;_context160.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context161.stop();}}},_callee161,this);}));function pageHide(){return _ref164.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
promisesArray.push(Promise.reject("no internet connection"));}return _context163.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context163.stop();}}},_callee163,this);}));function loadOrders(_x62){return _ref166.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
...
}});return _context164.abrupt('return',displayCompletedPromise);case 2:case'end':return _context164.stop();}}},_callee164,this);}));function displayPageContent(_x63){return _ref167.apply(this,arguments);}return displayPageContent;}()},/**
...
$('#pending-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context165.prev=6;// hide the previously displayed orders info
...
$('#pending-orders-page .modal').css("display","none");}_context165.next=33;break;case 20:_context165.prev=20;_context165.t0=_context165['catch'](6);// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#pending-orders-page .row').css("display","none");// show the page loader
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context166.stop();}}},_callee166,this);}));function pageHide(){return _ref169.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// reset the view-model properties
...
$('#pending-orders-page .modal').css("display","table");// load the user profile details from the app database
_context167.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context167.sent.userDetails;_context167.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 9:searchResultsArray=_context167.sent;_context167.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#pending-orders-page .row').css("display","none");// hide the page loader
$('#pending-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
$('#pending-orders-page .page-preloader').css("display","none");// show the orders info
$('#pending-orders-page .row').css("display","block");// hide the page loader
$('#pending-orders-page .modal').css("display","none");}_context167.next=27;break;case 15:_context167.prev=15;_context167.t0=_context167['catch'](2);// hide the page preloader
...
promisesArray.push(Promise.reject("no internet connection"));}return _context168.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context168.stop();}}},_callee168,this);}));function loadOrders(_x67){return _ref171.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
...
}});return _context169.abrupt('return',displayCompletedPromise);case 2:case'end':return _context169.stop();}}},_callee169,this);}));function displayPageContent(_x68){return _ref172.apply(this,arguments);}return displayPageContent;}()}};
