...
return _context2.finish(44);case 50:case'end':return _context2.stop();}}},_callee2,this,[[14,42,44,50],[18,24],[31,37]]);})));// end of ons.ready()
},/**
...
_context55.next=18;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 18:_context55.next=20;return $('#loader-modal').get(0).hide();case 20:_context55.next=22;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 22:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast=$('.timed-page-toast').get(0).ej2_instances[0];_toast.cssClass='success-ej2-toast';_toast.timeOut=3000;_toast.content='User signin completed';_toast.dataBind();_toast.show();_context55.next=44;break;case 32:_context55.prev=32;_context55.t0=_context55['catch'](3);_context55.next=36;return $('#loader-modal').get(0).hide();case 36:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast2=$('.timed-page-toast').get(0).ej2_instances[0];_toast2.cssClass='error-ej2-toast';_toast2.timeOut=3500;_toast2.content='User does not have an account. User signin failed ';_toast2.dataBind();_toast2.show();case 44:if(!(loginMode==="sign up")){_context55.next=82;break;}_context55.prev=45;// display modal to user that signin is being completed
$('#loader-modal-message').html("Completing Signup...");_context55.next=49;return $('#loader-modal').get(0).show();case 49:_context55.next=51;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/customers",type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({email:authResult.user.email,username:authResult.user.email,password:authResult.user.uid})}));case 51:userDetails=_context55.sent;userDetails.password=authResult.user.uid;// save the created user details data to ENCRYPTED app database as cached data
_context55.next=55;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:userDetails},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 55:_context55.next=57;return $('#loader-modal').get(0).hide();case 57:_context55.next=59;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 59:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast3=$('.timed-page-toast').get(0).ej2_instances[0];_toast3.cssClass='success-ej2-toast';_toast3.timeOut=3000;_toast3.content='User signup completed';_toast3.dataBind();_toast3.show();_context55.next=82;break;case 69:_context55.prev=69;_context55.t1=_context55['catch'](45);_context55.t1=JSON.parse(_context55.t1.responseText);// hide loader
_context55.next=74;return $('#loader-modal').get(0).hide();case 74:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast4=$('.timed-page-toast').get(0).ej2_instances[0];_toast4.cssClass='error-ej2-toast';_toast4.timeOut=3000;_toast4.content='Error. '+(_context55.t1.message||"User signup failed");_toast4.dataBind();_toast4.show();case 82:return _context55.abrupt('return',false);case 83:case'end':return _context55.stop();}}},_callee55,this,[[3,32],[45,69]]);}));function signInSuccessWithAuthResult(_x24){return _ref56.apply(this,arguments);}return signInSuccessWithAuthResult;}()}});// disable firebase ui auto-signin
