...
utopiasoftware[utopiasoftware_app_namespace].controller = {
    ...
    searchPageViewModel: {
        ...
        findMoreClicked: function () {
            var _ref25 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee26() {
                                        ...
                                        while (1) {
                                            switch (_context25.prev = _context25.next) {
                                                ...
                                                case 10:
                                                    ...
                                                    console.log("PRODUCTS PAGE", _context25.t0);
                                                    // hide all previously displayed ej2 toast
                                                    $('.page-toast').get(0).ej2_instances[0].hide('All');
                                                    // display toast to show that an error
                                                    toast = $('.page-toast').get(0).ej2_instances[0];
    ...
    productsPageViewModel: {
         ...
         */
        pageHide: function () {
            var _ref36 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee36(event) {
                    ...
                    while (1) {
                        switch (_context37.prev = _context37.next) {
                            ...
                            case 10:
                                ...
                                // an error occurred
                                console.log("PROJECT REFRESH ERROR", _context37.t0);
                                // display toast to show that error
                                toast = $('.page-toast').get(0).ej2_instances[0];
         ...
         */
        loadProducts: function () {
            var _ref39 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee39(queryParam) {
                    ...
                    while (1) {
                        switch (_context39.prev = _context39.next) {
                            case 0:
                                ...
                                return _context39.abrupt('return', Promise.all(productPromisesArray));
         ...
         */
        displayPageContent: function () {
            var _ref40 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee40(productsArray) {
                var appendContent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
                var overwriteContent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
                    ...
                    while (1) {
                        switch (_context40.prev = _context40.next) {
                            case 0:
                                ...
                                return _context40.abrupt('return', displayCompletedPromise);
            ...
            function displayPageContent(_x22) {
