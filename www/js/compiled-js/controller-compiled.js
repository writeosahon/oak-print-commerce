...
_context107.prev=17;_context107.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context107.sent.userDetails;console.log("USER DETAILS BEFORE PROFILE UPDATE",userDetails);// temporary hold the user id and password
...
$('#profile-page .modal').css("display","none");return _context107.finish(63);case 70:return _context107.abrupt('return',promisesArrayPromise);case 71:case'end':return _context107.stop();}}},_callee107,this,[[17,52,63,70]]);}));function profileFormValidated(){return _ref110.apply(this,arguments);}return profileFormValidated;}(),/**
         ...
         * @returns {Promise<void>}
         */displayProfileContent:function(){var _ref111=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee108(){var userDetails;return regeneratorRuntime.wrap(function _callee108$(_context108){while(1){switch(_context108.prev=_context108.next){case 0:_context108.prev=0;_context108.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context108.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user profile data in the profile form
$('#profile-page #profile-form #profile-email').val(userDetails.email);$('#profile-page #profile-form #profile-first-name').val(userDetails.first_name||"");$('#profile-page #profile-form #profile-last-name').val(userDetails.last_name||"");$('#profile-page #profile-form #profile-phone-number').val(userDetails.billing&&userDetails.billing.phone?userDetails.billing.phone:"");case 9:_context108.prev=9;// hide page preloader
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context113.prev=17;_context113.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context113.sent.userDetails;console.log("USER DETAILS BEFORE PASSWORD CHANGE",userDetails);// check if the current password input matches that in the current user password
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context119.prev=17;_context119.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context119.sent.userDetails;console.log("USER DETAILS BEFORE BILLING INFO UPDATE",userDetails);// temporary hold the user id and password
...
$('#billing-info-page .modal').css("display","none");return _context119.finish(64);case 71:return _context119.abrupt('return',promisesArrayPromise);case 72:case'end':return _context119.stop();}}},_callee119,this,[[17,53,64,71]]);}));function billingInfoFormValidated(){return _ref122.apply(this,arguments);}return billingInfoFormValidated;}(),/**
         ...
         * @returns {Promise<void>}
         */displayContent:function(){var _ref123=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee123(){var userDetails,countryDropDownList,statesDropDownList;return regeneratorRuntime.wrap(function _callee123$(_context123){while(1){switch(_context123.prev=_context123.next){case 0:_context123.prev=0;_context123.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context123.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user billing info data in the billing info form
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context129.prev=17;_context129.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context129.sent.userDetails;console.log("USER DETAILS BEFORE SHIPPING INFO UPDATE",userDetails);// temporary hold the user id and password
...
$('#shipping-info-page .modal').css("display","none");return _context129.finish(65);case 72:return _context129.abrupt('return',promisesArrayPromise);case 73:case'end':return _context129.stop();}}},_callee129,this,[[17,54,65,72]]);}));function shippingInfoFormValidated(){return _ref132.apply(this,arguments);}return shippingInfoFormValidated;}(),/**
         ...
         * @returns {Promise<void>}
         */displayContent:function(){var _ref133=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee133(){var userDetails,countryDropDownList,statesDropDownList;return regeneratorRuntime.wrap(function _callee133$(_context133){while(1){switch(_context133.prev=_context133.next){case 0:_context133.prev=0;_context133.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context133.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user shipping info data in the shipping info form
...
_context150.prev=2;_context150.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 5:userDetails=_context150.sent.userDetails;if(!(!userDetails.first_name||userDetails.first_name=="")){_context150.next=8;break;}throw"validation error";case 8:// user validation was successful
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context162.prev=3;_context162.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context162.next=18;break;case 8:_context162.prev=8;_context162.t0=_context162['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
...
$('#track-order-page .modal').css("display","none");return _context162.finish(18);case 21:case'end':return _context162.stop();}}},_callee162,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context163.stop();}}},_callee163,this);}));function detailsButtonClicked(_x60){return _ref165.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref167=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee166(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee166$(_context166){while(1){switch(_context166.prev=_context166.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context166.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context166.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee164(){return regeneratorRuntime.wrap(function _callee164$(_context164){while(1){switch(_context164.prev=_context164.next){case 0:_context164.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context164.stop();}}},_callee164,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee165(){var selectedOrder,userDetails,searchResultsArray,_toast29,_toast30;return regeneratorRuntime.wrap(function _callee165$(_context165){while(1){switch(_context165.prev=_context165.next){case 0:// display the page loader
$('#track-order-page .modal').css("display","table");_context165.prev=1;_context165.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
_context165.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+selectedOrder.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context165.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context165.sent.userDetails;_context165.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"search":$('#track-order-page #track-order-page-input').get(0).ej2_instances[0].value||""});case 13:searchResultsArray=_context165.sent;_context165.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast29=$('.timed-page-toast').get(0).ej2_instances[0];_toast29.cssClass='default-ej2-toast';_toast29.timeOut=2000;_toast29.content='Order #'+selectedOrder.id+' has been cancelled';_toast29.dataBind();_toast29.show();_context165.next=36;break;case 26:_context165.prev=26;_context165.t0=_context165['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast30=$('.timed-page-toast').get(0).ej2_instances[0];_toast30.cssClass='error-ej2-toast';_toast30.timeOut=3500;_toast30.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast30.dataBind();_toast30.show();case 36:_context165.prev=36;// display the page loader
$('#track-order-page .modal').css("display","none");return _context165.finish(36);case 39:case'end':return _context165.stop();}}},_callee165,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context166.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context166.stop();}}},_callee166,this);}));function cancelButtonClicked(_x61){return _ref167.apply(this,arguments);}return cancelButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref170=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee168(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee168$(_context168){while(1){switch(_context168.prev=_context168.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context168.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context168.abrupt('return');case 11:// show the page loader
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee167(){var selectedOrder,newOrder,_toast31;return regeneratorRuntime.wrap(function _callee167$(_context167){while(1){switch(_context167.prev=_context167.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context167.prev=3;// create a new order object
...
_context167.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context167.sent;_context167.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context167.next=34;break;case 23:_context167.prev=23;_context167.t0=_context167['catch'](3);console.log(_context167.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast31=$('.timed-page-toast').get(0).ej2_instances[0];_toast31.cssClass='error-ej2-toast';_toast31.timeOut=3000;_toast31.content='Placing new order failed. Please retry';_toast31.dataBind();_toast31.show();case 34:_context167.prev=34;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context167.finish(34);case 37:case'end':return _context167.stop();}}},_callee167,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context168.stop();}}},_callee168,this);}));function reorderButtonClicked(_x62){return _ref170.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */completedOrdersPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref172=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee169(){var userDetails,searchResultsArray,toast,_toast32;return regeneratorRuntime.wrap(function _callee169$(_context169){while(1){switch(_context169.prev=_context169.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context169.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context169.abrupt('return');case 3:// listen for the back button event
...
$('#completed-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context169.prev=6;// hide the previously displayed orders info
...
_context169.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context169.sent.userDetails;_context169.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 14:searchResultsArray=_context169.sent;_context169.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref173=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee170(){return regeneratorRuntime.wrap(function _callee170$(_context170){while(1){switch(_context170.prev=_context170.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context170.stop();}}},_callee170,this);}));function pageHide(){return _ref173.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref174=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee171(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast33;return regeneratorRuntime.wrap(function _callee171$(_context171){while(1){switch(_context171.prev=_context171.next){case 0:// disable pull-to-refresh widget till loading is done
$('#completed-orders-page #completed-orders-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context171.prev=2;// show the page loader
$('#completed-orders-page .modal').css("display","table");// load the user profile details from the app database
_context171.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context171.sent.userDetails;_context171.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 9:searchResultsArray=_context171.sent;_context171.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#completed-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#completed-orders-page .row').css("display","none");// hide the page loader
$('#completed-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
$('#completed-orders-page .page-preloader').css("display","none");// show the orders info
$('#completed-orders-page .row').css("display","block");// hide the page loader
$('#completed-orders-page .modal').css("display","none");}_context171.next=27;break;case 15:_context171.prev=15;_context171.t0=_context171['catch'](2);// hide the page preloader
$('#completed-orders-page .page-preloader').css("display","none");// show the page loader
$('#completed-orders-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast33=$('.timed-page-toast').get(0).ej2_instances[0];_toast33.cssClass='error-ej2-toast';_toast33.timeOut=3000;_toast33.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast33.dataBind();_toast33.show();case 27:_context171.prev=27;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context171.finish(27);case 32:case'end':return _context171.stop();}}},_callee171,this,[[2,15,27,32]]);}));function pagePullHookAction(){return _ref174.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to load orders to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
         ...
         *
         * @returns {Promise<void>}
         */loadOrders:function(){var _ref175=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee172(queryParam){var pageToAccess=arguments.length>1&&arguments[1]!==undefined?arguments[1]:queryParam.page||1;var pageSize=arguments.length>2&&arguments[2]!==undefined?arguments[2]:queryParam.per_page||20;var promisesArray;return regeneratorRuntime.wrap(function _callee172$(_context172){while(1){switch(_context172.prev=_context172.next){case 0:queryParam.page=pageToAccess;queryParam.per_page=pageSize;promisesArray=[];// holds the array for the promises used to load the orders
// check if there is internet connection or not
if(navigator.connection.type!==Connection.NONE){// there is internet connection
// load the requested products list from the server
promisesArray.push(new Promise(function(resolve,reject){Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"get",//contentType: "application/x-www-form-urlencoded",
...
promisesArray.push(Promise.reject("no internet connection"));}return _context172.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context172.stop();}}},_callee172,this);}));function loadOrders(_x66){return _ref175.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref176=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee173(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee173$(_context173){while(1){switch(_context173.prev=_context173.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
// check if the ordersArray is empty or not
if(ordersArray.length<=0){// there are no new content to display
resolve(ordersArray.length);// resolve promise with the length of the orders array
}else{// there are some orders to display
...
$('#completed-orders-page #completed-orders-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context173.abrupt('return',displayCompletedPromise);case 2:case'end':return _context173.stop();}}},_callee173,this);}));function displayPageContent(_x67){return _ref176.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref177=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee175(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee175$(_context175){while(1){switch(_context175.prev=_context175.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee174(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee174$(_context174){while(1){switch(_context174.prev=_context174.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context174.prev=3;_context174.next=6;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 6:_context174.next=18;break;case 8:_context174.prev=8;_context174.t0=_context174['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context174.prev=18;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context174.finish(18);case 21:case'end':return _context174.stop();}}},_callee174,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context175.stop();}}},_callee175,this);}));function checkoutButtonClicked(_x68){return _ref177.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref179=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee178(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee178$(_context178){while(1){switch(_context178.prev=_context178.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context178.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context178.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee176(){return regeneratorRuntime.wrap(function _callee176$(_context176){while(1){switch(_context176.prev=_context176.next){case 0:_context176.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context176.stop();}}},_callee176,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee177(){var selectedOrder,userDetails,searchResultsArray,_toast34,_toast35;return regeneratorRuntime.wrap(function _callee177$(_context177){while(1){switch(_context177.prev=_context177.next){case 0:// display the page loader
$('#completed-orders-page .modal').css("display","table");_context177.prev=1;_context177.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
selectedOrder.status="cancelled";// update the selectedOrder status remotely
_context177.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+selectedOrder.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context177.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context177.sent.userDetails;_context177.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 13:searchResultsArray=_context177.sent;_context177.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast34=$('.timed-page-toast').get(0).ej2_instances[0];_toast34.cssClass='default-ej2-toast';_toast34.timeOut=2000;_toast34.content='Order #'+selectedOrder.id+' has been cancelled';_toast34.dataBind();_toast34.show();_context177.next=36;break;case 26:_context177.prev=26;_context177.t0=_context177['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast35=$('.timed-page-toast').get(0).ej2_instances[0];_toast35.cssClass='error-ej2-toast';_toast35.timeOut=3500;_toast35.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast35.dataBind();_toast35.show();case 36:_context177.prev=36;// display the page loader
$('#completed-orders-page .modal').css("display","none");return _context177.finish(36);case 39:case'end':return _context177.stop();}}},_callee177,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context178.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context178.stop();}}},_callee178,this);}));function cancelButtonClicked(_x69){return _ref179.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref182=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee180(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee180$(_context180){while(1){switch(_context180.prev=_context180.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context180.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context180.abrupt('return');case 11:// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee179(){var selectedOrder,newOrder,_toast36;return regeneratorRuntime.wrap(function _callee179$(_context179){while(1){switch(_context179.prev=_context179.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context179.prev=3;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context179.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context179.sent;_context179.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context179.next=34;break;case 23:_context179.prev=23;_context179.t0=_context179['catch'](3);console.log(_context179.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast36=$('.timed-page-toast').get(0).ej2_instances[0];_toast36.cssClass='error-ej2-toast';_toast36.timeOut=3000;_toast36.content='Placing new order failed. Please retry';_toast36.dataBind();_toast36.show();case 34:_context179.prev=34;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context179.finish(34);case 37:case'end':return _context179.stop();}}},_callee179,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context180.stop();}}},_callee180,this);}));function reorderButtonClicked(_x70){return _ref182.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */pendingOrdersPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref184=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee181(){var userDetails,searchResultsArray,toast,_toast37;return regeneratorRuntime.wrap(function _callee181$(_context181){while(1){switch(_context181.prev=_context181.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context181.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context181.abrupt('return');case 3:// listen for the back button event
...
$('#pending-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context181.prev=6;// hide the previously displayed orders info
...
_context181.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context181.sent.userDetails;_context181.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 14:searchResultsArray=_context181.sent;_context181.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref185=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee182(){return regeneratorRuntime.wrap(function _callee182$(_context182){while(1){switch(_context182.prev=_context182.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context182.stop();}}},_callee182,this);}));function pageHide(){return _ref185.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// reset the view-model properties
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref186=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee183(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast38;return regeneratorRuntime.wrap(function _callee183$(_context183){while(1){switch(_context183.prev=_context183.next){case 0:// disable pull-to-refresh widget till loading is done
$('#pending-orders-page #pending-orders-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context183.prev=2;// show the page loader
$('#pending-orders-page .modal').css("display","table");// load the user profile details from the app database
_context183.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context183.sent.userDetails;_context183.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 9:searchResultsArray=_context183.sent;_context183.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#pending-orders-page .row').css("display","none");// hide the page loader
$('#pending-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
$('#pending-orders-page .page-preloader').css("display","none");// show the orders info
$('#pending-orders-page .row').css("display","block");// hide the page loader
$('#pending-orders-page .modal').css("display","none");}_context183.next=27;break;case 15:_context183.prev=15;_context183.t0=_context183['catch'](2);// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// show the page loader
$('#pending-orders-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast38=$('.timed-page-toast').get(0).ej2_instances[0];_toast38.cssClass='error-ej2-toast';_toast38.timeOut=3000;_toast38.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast38.dataBind();_toast38.show();case 27:_context183.prev=27;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context183.finish(27);case 32:case'end':return _context183.stop();}}},_callee183,this,[[2,15,27,32]]);}));function pagePullHookAction(){return _ref186.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to load orders to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
         ...
         *
         * @returns {Promise<void>}
         */loadOrders:function(){var _ref187=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee184(queryParam){var pageToAccess=arguments.length>1&&arguments[1]!==undefined?arguments[1]:queryParam.page||1;var pageSize=arguments.length>2&&arguments[2]!==undefined?arguments[2]:queryParam.per_page||20;var promisesArray;return regeneratorRuntime.wrap(function _callee184$(_context184){while(1){switch(_context184.prev=_context184.next){case 0:queryParam.page=pageToAccess;queryParam.per_page=pageSize;promisesArray=[];// holds the array for the promises used to load the orders
// check if there is internet connection or not
if(navigator.connection.type!==Connection.NONE){// there is internet connection
// load the requested products list from the server
promisesArray.push(new Promise(function(resolve,reject){Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"get",//contentType: "application/x-www-form-urlencoded",
...
promisesArray.push(Promise.reject("no internet connection"));}return _context184.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context184.stop();}}},_callee184,this);}));function loadOrders(_x74){return _ref187.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref188=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee185(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee185$(_context185){while(1){switch(_context185.prev=_context185.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
// check if the ordersArray is empty or not
if(ordersArray.length<=0){// there are no new content to display
resolve(ordersArray.length);// resolve promise with the length of the orders array
}else{// there are some orders to display
...
$('#pending-orders-page #pending-orders-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context185.abrupt('return',displayCompletedPromise);case 2:case'end':return _context185.stop();}}},_callee185,this);}));function displayPageContent(_x75){return _ref188.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref189=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee187(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee187$(_context187){while(1){switch(_context187.prev=_context187.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee186(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee186$(_context186){while(1){switch(_context186.prev=_context186.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context186.prev=3;_context186.next=6;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 6:_context186.next=18;break;case 8:_context186.prev=8;_context186.t0=_context186['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context186.prev=18;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context186.finish(18);case 21:case'end':return _context186.stop();}}},_callee186,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context187.stop();}}},_callee187,this);}));function checkoutButtonClicked(_x76){return _ref189.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref191=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee190(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee190$(_context190){while(1){switch(_context190.prev=_context190.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context190.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context190.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee188(){return regeneratorRuntime.wrap(function _callee188$(_context188){while(1){switch(_context188.prev=_context188.next){case 0:_context188.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context188.stop();}}},_callee188,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee189(){var selectedOrder,userDetails,searchResultsArray,_toast39,_toast40;return regeneratorRuntime.wrap(function _callee189$(_context189){while(1){switch(_context189.prev=_context189.next){case 0:// display the page loader
$('#pending-orders-page .modal').css("display","table");_context189.prev=1;_context189.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context189.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context189.sent.userDetails;_context189.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 13:searchResultsArray=_context189.sent;_context189.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast39=$('.timed-page-toast').get(0).ej2_instances[0];_toast39.cssClass='default-ej2-toast';_toast39.timeOut=2000;_toast39.content='Order #'+selectedOrder.id+' has been cancelled';_toast39.dataBind();_toast39.show();_context189.next=36;break;case 26:_context189.prev=26;_context189.t0=_context189['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast40=$('.timed-page-toast').get(0).ej2_instances[0];_toast40.cssClass='error-ej2-toast';_toast40.timeOut=3500;_toast40.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast40.dataBind();_toast40.show();case 36:_context189.prev=36;// display the page loader
$('#pending-orders-page .modal').css("display","none");return _context189.finish(36);case 39:case'end':return _context189.stop();}}},_callee189,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context190.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context190.stop();}}},_callee190,this);}));function cancelButtonClicked(_x77){return _ref191.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref194=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee192(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee192$(_context192){while(1){switch(_context192.prev=_context192.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context192.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context192.abrupt('return');case 11:// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee191(){var selectedOrder,newOrder,_toast41;return regeneratorRuntime.wrap(function _callee191$(_context191){while(1){switch(_context191.prev=_context191.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context191.prev=3;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context191.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context191.sent;_context191.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context191.next=34;break;case 23:_context191.prev=23;_context191.t0=_context191['catch'](3);console.log(_context191.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast41=$('.timed-page-toast').get(0).ej2_instances[0];_toast41.cssClass='error-ej2-toast';_toast41.timeOut=3000;_toast41.content='Placing new order failed. Please retry';_toast41.dataBind();_toast41.show();case 34:_context191.prev=34;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context191.finish(34);case 37:case'end':return _context191.stop();}}},_callee191,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context192.stop();}}},_callee192,this);}));function reorderButtonClicked(_x78){return _ref194.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */orderDetailsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref196=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee193(){var promisesArray,orderId,toast;return regeneratorRuntime.wrap(function _callee193$(_context193){while(1){switch(_context193.prev=_context193.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context193.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context193.abrupt('return');case 3:// listen for the back button event
...
utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails=$('#app-main-navigator').get(0).topPage.data.orderData;_context193.prev=7;// create the "Reorder" button
new ej.splitbuttons.ProgressButton({cssClass:'e-hide-spinner',duration:10*60*60*1000// set spinner/progress duration for 10 hr
...
_context193.next=14;return Promise.all(promisesArray);case 14:promisesArray=_context193.sent;// get the order notes belonging to the specified order object
...
_context193.next=18;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 18:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context193.next=30;break;case 21:_context193.prev=21;_context193.t0=_context193['catch'](7);console.log("ORDER DETAILS ERROR",_context193.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 30:_context193.prev=30;// hide page preloader
$('#order-details-page .page-preloader').css("display","none");// hide page modal loader
$('#order-details-page .modal').css("display","none");return _context193.finish(30);case 34:case'end':return _context193.stop();}}},_callee193,this,[[7,21,30,34]]);}));return function loadPageOnAppReady(){return _ref196.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function(){var _ref197=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee194(){return regeneratorRuntime.wrap(function _callee194$(_context194){while(1){switch(_context194.prev=_context194.next){case 0:window.SoftInputMode.set('adjustPan');// adjust device input mode
// update cart count
$('#order-details-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);case 2:case'end':return _context194.stop();}}},_callee194,this);}));function pageShow(){return _ref197.apply(this,arguments);}return pageShow;}(),/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref198=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee195(){return regeneratorRuntime.wrap(function _callee195$(_context195){while(1){switch(_context195.prev=_context195.next){case 0:case'end':return _context195.stop();}}},_callee195,this);}));function pageHide(){return _ref198.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref199=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee196(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var promisesArray,orderId,toast;return regeneratorRuntime.wrap(function _callee196$(_context196){while(1){switch(_context196.prev=_context196.next){case 0:// disable pull-to-refresh widget till loading is done
$('#order-details-page #order-details-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context196.prev=2;// load the order notes attached to the loaded order details
promisesArray=[];// holds all created promises
orderId=utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails.id;// get the id for the specified order object
promisesArray.push(Promise.resolve($.ajax(// load the order notes for the specified order object
{url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+orderId+'/notes'),type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{"type":"any"}})));// wait for all promises to resolve
_context196.next=8;return Promise.all(promisesArray);case 8:promisesArray=_context196.sent;// get the order notes belonging to the specified order object
utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderNotesArray=promisesArray[0];// display the order details
_context196.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 12:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context196.next=26;break;case 15:_context196.prev=15;_context196.t0=_context196['catch'](2);// hide the page preloader
$('#order-details-page .page-preloader').css("display","none");// show the page loader
$('#order-details-page .modal').css("display","none");console.log("ORDER DETAILS ERROR",_context196.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 26:_context196.prev=26;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context196.finish(26);case 31:case'end':return _context196.stop();}}},_callee196,this,[[2,15,26,31]]);}));function pagePullHookAction(){return _ref199.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is triggered when the user clicks the "Reorder" button
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref200=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee199(){var toast,userDetails,payStackResponse,transactionCompletedUrl,searchParams,completedTransactionReference,localOrderObject,_toast42,_localOrderObject2,_toast43;return regeneratorRuntime.wrap(function _callee199$(_context199){while(1){switch(_context199.prev=_context199.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context199.next=14;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make payment';toast.dataBind();toast.show();// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();return _context199.abrupt('return');case 14:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="paystack")){_context199.next=74;break;}// user selected the paystack (Pay With Card)
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);// inform the user that payment gateway is being prepared
$('#loader-modal-message').html("Preparing Payment Channel...");$('#loader-modal').get(0).show();// show loader
_context199.prev=18;_context199.next=21;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 21:userDetails=_context199.sent.userDetails;_context199.next=24;return Promise.resolve($.ajax({url:'https://api.paystack.co/transaction/initialize',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Bearer "+Base64.decode(utopiasoftware[utopiasoftware_app_namespace].paystackAccessor));},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({email:userDetails.email,amount:""+kendo.parseFloat(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.total)*100,callback_url:"https://shopoakexclusive.com/"})}));case 24:payStackResponse=_context199.sent;if(!(payStackResponse.status===true)){_context199.next=52;break;}_context199.next=28;return new Promise(function(resolve,reject){// create/open inapp browser
var transactionInAppBrowser=cordova.InAppBrowser.open(window.encodeURI(payStackResponse.data.authorization_url),'_blank','location=yes,clearcache=yes,clearsessioncache=yes,closebuttoncolor=#ffffff,hardwareback=no,hidenavigationbuttons=yes,hideurlbar=yes,zoom=no,toolbarcolor=#3f51b5');// add event listeners for the transaction inapp browswer
transactionInAppBrowser.addEventListener("loadstart",function(loadStartEvent){// check which url is being loaded
if(loadStartEvent.url.startsWith("https://shopoakexclusive.com/")){// transaction was completed
// set a flag to indicate that the transaction was completed
...
resolve(transactionInAppBrowser._utopiasoftware_transaction_completed_url);}else{// transaction was not completed
reject();// reject parent promise
}});});case 28:transactionCompletedUrl=_context199.sent;// get the search parameters object from the transaction completed url
searchParams=new URLSearchParams(transactionCompletedUrl.split("?")[1]);// get the 'reference' search parameter value
completedTransactionReference=searchParams.get("reference");// inform the user that their order is being placed
$('#loader-modal-message').html("Completing Order Placement...");// get a local/deep-clone copy of the page's checkout order object
localOrderObject=JSON.parse(JSON.stringify(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder));// update the order status (by setting the order paid flag) and transaction reference
localOrderObject.transaction_id=completedTransactionReference;localOrderObject.set_paid=true;// update the coupons for the local order object to be sent to the server
localOrderObject.coupon_lines=localOrderObject.coupon_lines.map(function(couponElem){return{code:couponElem.code};});// update the checkout order data on the remote server
_context199.next=38;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 38:localOrderObject=_context199.sent;_context199.prev=39;_context199.next=42;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 42:_context199.next=46;break;case 44:_context199.prev=44;_context199.t0=_context199['catch'](39);case 46:// update the checkout-order-placement-modal with the checkout order number
$('#checkout-order-placement-modal .order-number').html(localOrderObject.number);// add the click handler for the 'checkout-order-placement-modal-ok-button'
$('#checkout-order-placement-modal #checkout-order-placement-modal-ok-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee197(){return regeneratorRuntime.wrap(function _callee197$(_context197){while(1){switch(_context197.prev=_context197.next){case 0:_context197.next=2;return $('ons-splitter').get(0).content.load("app-main-template");case 2:_context197.next=4;return $('#checkout-order-placement-modal').get(0).hide();case 4:case'end':return _context197.stop();}}},_callee197,this);}));// show the 'checkout-order-placement-modal'
_context199.next=50;return $('#checkout-order-placement-modal').get(0).show();case 50:_context199.next=53;break;case 52:throw"error";case 53:_context199.next=66;break;case 55:_context199.prev=55;_context199.t1=_context199['catch'](18);console.log("PAYMENT ERROR",_context199.t1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast42=$('.timed-page-toast').get(0).ej2_instances[0];_toast42.cssClass='error-ej2-toast';_toast42.timeOut=3500;_toast42.content='Error making payment for this order. Try again';_toast42.dataBind();_toast42.show();case 66:_context199.prev=66;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
$('#loader-modal').get(0).hide();return _context199.finish(66);case 73:return _context199.abrupt('return');case 74:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="cod")){_context199.next=118;break;}// user selected the cod (Cash on Delivery)
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);// inform the user that their order is being placed
$('#loader-modal-message').html("Completing Order Placement...");_context199.next=79;return $('#loader-modal').get(0).show();case 79:_context199.prev=79;// get a local/deep-clone copy of the page's checkout order object
...
_context199.next=85;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+_localOrderObject2.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(_localOrderObject2)}));case 85:_localOrderObject2=_context199.sent;_context199.prev=86;_context199.next=89;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 89:_context199.next=93;break;case 91:_context199.prev=91;_context199.t2=_context199['catch'](86);case 93:// update the checkout-order-placement-modal with the checkout order number
...
$('#checkout-order-placement-modal #checkout-order-placement-modal-ok-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee198(){return regeneratorRuntime.wrap(function _callee198$(_context198){while(1){switch(_context198.prev=_context198.next){case 0:_context198.next=2;return $('ons-splitter').get(0).content.load("app-main-template");case 2:_context198.next=4;return $('#checkout-order-placement-modal').get(0).hide();case 4:case'end':return _context198.stop();}}},_callee198,this);}));// show the 'checkout-order-placement-modal'
_context199.next=97;return $('#checkout-order-placement-modal').get(0).show();case 97:_context199.next=110;break;case 99:_context199.prev=99;_context199.t3=_context199['catch'](79);console.log("PAYMENT ERROR",_context199.t3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast43=$('.timed-page-toast').get(0).ej2_instances[0];_toast43.cssClass='error-ej2-toast';_toast43.timeOut=3500;_toast43.content='Error placing this order. Try again';_toast43.dataBind();_toast43.show();case 110:_context199.prev=110;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
$('#loader-modal').get(0).hide();return _context199.finish(110);case 117:return _context199.abrupt('return');case 118:case'end':return _context199.stop();}}},_callee199,this,[[18,55,66,73],[39,44],[79,99,110,117],[86,91]]);}));function reorderButtonClicked(){return _ref200.apply(this,arguments);}return reorderButtonClicked;}(),/**
         * method is used to load the order details data into the page
         * @returns {Promise<void>}
         */displayContent:function(){var _ref203=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee200(){var orderData,_displayContent,index,orderNote,_index;return regeneratorRuntime.wrap(function _callee200$(_context200){while(1){switch(_context200.prev=_context200.next){case 0:try{// get the order object set on this page
...
_displayContent+='<div class="col-xs-12" style="text-align: left; padding-right: 5px;\n                            padding-top: 10px; padding-bottom: 10px">'+orderData.shipping.postcode+'</div>';}_displayContent+='<div class="col-xs-12" style="text-align: left; padding-right: 5px;\n                            padding-top: 10px; padding-bottom: 10px">'+orderData.shipping.country+'</div>';$('#order-details-page #order-details-list .order-details-shipping-details').html(_displayContent);}finally{}case 1:case'end':return _context200.stop();}}},_callee200,this);}));function displayContent(){return _ref203.apply(this,arguments);}return displayContent;}()}};
