...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee165(){var selectedOrder,pagesStackArray,indexOfCheckoutPage,toast;return regeneratorRuntime.wrap(function _callee165$(_context165){while(1){switch(_context165.prev=_context165.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context165.prev=3;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context165.next=9;break;}_context165.next=9;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 9:_context165.next=11;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 11:_context165.next=23;break;case 13:_context165.prev=13;_context165.t0=_context165['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 23:_context165.prev=23;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context165.finish(23);case 26:case'end':return _context165.stop();}}},_callee165,this,[[3,13,23,26]]);})),0);case 3:case'end':return _context166.stop();}}},_callee166,this);}));function checkoutButtonClicked(_x63){return _ref168.apply(this,arguments);}return checkoutButtonClicked;}(),/**
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee179(){var selectedOrder,pagesStackArray,indexOfCheckoutPage,toast;return regeneratorRuntime.wrap(function _callee179$(_context179){while(1){switch(_context179.prev=_context179.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context179.prev=3;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context179.next=9;break;}_context179.next=9;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 9:_context179.next=11;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 11:_context179.next=23;break;case 13:_context179.prev=13;_context179.t0=_context179['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 23:_context179.prev=23;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context179.finish(23);case 26:case'end':return _context179.stop();}}},_callee179,this,[[3,13,23,26]]);})),0);case 3:case'end':return _context180.stop();}}},_callee180,this);}));function checkoutButtonClicked(_x72){return _ref182.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee193(){var selectedOrder,pagesStackArray,indexOfCheckoutPage,toast;return regeneratorRuntime.wrap(function _callee193$(_context193){while(1){switch(_context193.prev=_context193.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context193.prev=3;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context193.next=9;break;}_context193.next=9;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 9:_context193.next=11;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 11:_context193.next=23;break;case 13:_context193.prev=13;_context193.t0=_context193['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 23:_context193.prev=23;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context193.finish(23);case 26:case'end':return _context193.stop();}}},_callee193,this,[[3,13,23,26]]);})),0);case 3:case'end':return _context194.stop();}}},_callee194,this);}));function checkoutButtonClicked(_x81){return _ref196.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
