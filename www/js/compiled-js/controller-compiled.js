...
cordova.plugins.email.open({to:["info@oakexclusive.com","shop@oakexclusive.com"],subject:"[provide an appropriate subject]",body:"[Enter your inquiries]"});case 1:case'end':return _context46.stop();}}},_callee46,this);}));function contactUsListItemClicked(){return _ref46.apply(this,arguments);}return contactUsListItemClicked;}()},/**
     ...
     */loginPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref47=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee47(){return regeneratorRuntime.wrap(function _callee47$(_context47){while(1){switch(_context47.prev=_context47.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context47.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context47.abrupt('return');case 3:// listen for the back button event
...
new ej.buttons.Button({isToggle:true,cssClass:'e-flat e-small e-round',iconCss:"zmdi zmdi-eye",iconPosition:"Left"}).appendTo($('#signup-password-view-button',$thisPage).get(0));}catch(err){}case 20:case'end':return _context47.stop();}}},_callee47,this);}));return function loadPageOnAppReady(){return _ref47.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
window.addEventListener('keyboardDidShow',utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.keyboardShownAdjustView);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref48=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee48(){return regeneratorRuntime.wrap(function _callee48$(_context48){while(1){switch(_context48.prev=_context48.next){case 0:// remove listener for when the device keyboard is shown
...
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.loginFormValidator.destroy();utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.signupFormValidator.destroy();utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.forgotPasswordFormValidator.destroy();},/**
         * method is triggered when the device back button is clicked OR a similar action is triggered
         */backButtonClicked:function(){var _ref49=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee49(){return regeneratorRuntime.wrap(function _callee49$(_context49){while(1){switch(_context49.prev=_context49.next){case 0:return _context49.abrupt('return',$('#app-main-navigator').get(0).popPage());case 1:case'end':return _context49.stop();}}},_callee49,this);}));function backButtonClicked(){return _ref49.apply(this,arguments);}return backButtonClicked;}(),/**
...
$("#login-page ons-carousel-item.third .login-page-form-container").scrollTop(Math.floor($(document.activeElement).closest("ons-input").position().top-30));break;}},/**
         ...
         *
         * @returns {Promise<void>}
         */signinButtonClicked:function(){var _ref50=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee50(){return regeneratorRuntime.wrap(function _callee50$(_context50){while(1){switch(_context50.prev=_context50.next){case 0:// run the validation method for the sign-in form
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.loginFormValidator.whenValidate();case 1:case'end':return _context50.stop();}}},_callee50,this);}));function signinButtonClicked(){return _ref50.apply(this,arguments);}return signinButtonClicked;}(),/**
         * method is triggered when the "Sign Up" button is clicked
         *
         * @returns {Promise<void>}
         */signupButtonClicked:function(){var _ref51=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee51(){return regeneratorRuntime.wrap(function _callee51$(_context51){while(1){switch(_context51.prev=_context51.next){case 0:// run the validation method for the sign-in form
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.signupFormValidator.whenValidate();case 1:case'end':return _context51.stop();}}},_callee51,this);}));function signupButtonClicked(){return _ref51.apply(this,arguments);}return signupButtonClicked;}(),/**
         * method is triggered when the "Forgot Password" button is clicked
         *
         * @returns {Promise<void>}
         */forgotPasswordButtonClicked:function(){var _ref52=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee52(){return regeneratorRuntime.wrap(function _callee52$(_context52){while(1){switch(_context52.prev=_context52.next){case 0:// open inapp browser for user to reset password
cordova.InAppBrowser.open(window.encodeURI('https://shopoakexclusive.com/my-account/lost-password/'),'_blank','location=yes,clearcache=yes,clearsessioncache=yes,closebuttoncolor=#ffffff,hardwareback=no,hidenavigationbuttons=yes,hideurlbar=yes,zoom=no,toolbarcolor=#3f51b5');case 1:case'end':return _context52.stop();}}},_callee52,this);}));function forgotPasswordButtonClicked(){return _ref52.apply(this,arguments);}return forgotPasswordButtonClicked;}(),/**
         * method is triggered when the "Reset Password" button is clicked
         *
         * @returns {Promise<void>}
         */resetPasswordButtonClicked:function(){var _ref53=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee53(){return regeneratorRuntime.wrap(function _callee53$(_context53){while(1){switch(_context53.prev=_context53.next){case 0:// run the validation method for the sign-in form
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.forgotPasswordFormValidator.whenValidate();case 1:case'end':return _context53.stop();}}},_callee53,this);}));function resetPasswordButtonClicked(){return _ref53.apply(this,arguments);}return resetPasswordButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */thirdPartyLoginButtonClicked:function(){var _ref54=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee57(){var loginMode=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'sign in';var toast;return regeneratorRuntime.wrap(function _callee57$(_context57){while(1){switch(_context57.prev=_context57.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context57.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to '+loginMode;toast.dataBind();toast.show();return _context57.abrupt('return');case 10:// hide the tooltips on the login form
$('#login-page #login-form').get(0).ej2_instances.forEach(function(tooltipArrayElem){// hide the tooltip
tooltipArrayElem.close();});// hide the tooltips on the signup form
$('#login-page #signup-form').get(0).ej2_instances.forEach(function(tooltipArrayElem){// hide the tooltip
...
$('#third-party-login-modal #third-party-login-loader').css("display","none");},signInFailure:function(){var _ref55=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee55(){return regeneratorRuntime.wrap(function _callee55$(_context55){while(1){switch(_context55.prev=_context55.next){case 0:return _context55.abrupt('return',new Promise(function(){var _ref56=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee54(resolve,reject){var toast;return regeneratorRuntime.wrap(function _callee54$(_context54){while(1){switch(_context54.prev=_context54.next){case 0:_context54.next=2;return $('#third-party-login-modal').get(0).hide();case 2:// inform the user of the error
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
...
case 11:case'end':return _context54.stop();}}},_callee54,this);}));return function(_x22,_x23){return _ref56.apply(this,arguments);};}()));case 1:case'end':return _context55.stop();}}},_callee55,this);}));function signInFailure(){return _ref55.apply(this,arguments);}return signInFailure;}(),signInSuccessWithAuthResult:function(){var _ref57=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee56(authResult){var resultArray,_toast,_toast2,userDetails,_toast3,_toast4;return regeneratorRuntime.wrap(function _callee56$(_context56){while(1){switch(_context56.prev=_context56.next){case 0:_context56.next=2;return $('#third-party-login-modal').get(0).hide();case 2:if(!(loginMode==="sign in")){_context56.next=46;break;}_context56.prev=3;// display modal to user that signin is being completed
$('#loader-modal-message').html("Completing Signin...");_context56.next=7;return $('#loader-modal').get(0).show();case 7:_context56.next=9;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/customers",type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{email:authResult.user.email}}));case 9:resultArray=_context56.sent;if(!(resultArray.length==0)){_context56.next=12;break;}throw"error";case 12:_context56.next=14;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/customers/'+resultArray[0].id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({password:authResult.user.uid})}));case 14:resultArray[0]=_context56.sent;resultArray[0].password=authResult.user.uid;// save the created user details data to ENCRYPTED app database as cached data
_context56.next=18;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 18:// subscribe push notification for this user's device
...
_context56.next=22;return $('#loader-modal').get(0).hide();case 22:_context56.next=24;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 24:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast=$('.timed-page-toast').get(0).ej2_instances[0];_toast.cssClass='success-ej2-toast';_toast.timeOut=3000;_toast.content='User signin completed';_toast.dataBind();_toast.show();_context56.next=46;break;case 34:_context56.prev=34;_context56.t0=_context56['catch'](3);_context56.next=38;return $('#loader-modal').get(0).hide();case 38:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast2=$('.timed-page-toast').get(0).ej2_instances[0];_toast2.cssClass='error-ej2-toast';_toast2.timeOut=3500;_toast2.content='User does not have an account. User signin failed ';_toast2.dataBind();_toast2.show();case 46:if(!(loginMode==="sign up")){_context56.next=86;break;}_context56.prev=47;// display modal to user that signin is being completed
$('#loader-modal-message').html("Completing Signup...");_context56.next=51;return $('#loader-modal').get(0).show();case 51:_context56.next=53;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/customers",type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({email:authResult.user.email,username:authResult.user.email,password:authResult.user.uid})}));case 53:userDetails=_context56.sent;userDetails.password=authResult.user.uid;// save the created user details data to ENCRYPTED app database as cached data
_context56.next=57;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:userDetails},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 57:// subscribe push notification for this user's device
window.plugins.OneSignal.setSubscription(true);// set the tag used to identify users for push notification sending
window.plugins.OneSignal.sendTags({appMail:userDetails.email});// hide loader
_context56.next=61;return $('#loader-modal').get(0).hide();case 61:_context56.next=63;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 63:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast3=$('.timed-page-toast').get(0).ej2_instances[0];_toast3.cssClass='success-ej2-toast';_toast3.timeOut=3000;_toast3.content='User signup completed';_toast3.dataBind();_toast3.show();_context56.next=86;break;case 73:_context56.prev=73;_context56.t1=_context56['catch'](47);_context56.t1=JSON.parse(_context56.t1.responseText);// hide loader
_context56.next=78;return $('#loader-modal').get(0).hide();case 78:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast4=$('.timed-page-toast').get(0).ej2_instances[0];_toast4.cssClass='error-ej2-toast';_toast4.timeOut=3000;_toast4.content='Error. '+(_context56.t1.message||"User signup failed");_toast4.dataBind();_toast4.show();case 86:return _context56.abrupt('return',false);case 87:case'end':return _context56.stop();}}},_callee56,this,[[3,34],[47,73]]);}));function signInSuccessWithAuthResult(_x24){return _ref57.apply(this,arguments);}return signInSuccessWithAuthResult;}()}});// disable firebase ui auto-signin
utopiasoftware[utopiasoftware_app_namespace].model.firebaseUI.disableAutoSignIn();case 18:case'end':return _context57.stop();}}},_callee57,this);}));function thirdPartyLoginButtonClicked(){return _ref54.apply(this,arguments);}return thirdPartyLoginButtonClicked;}(),/**
         * method is triggered when the login form is successfully validated
         *
         * @returns {Promise<void>}
         */loginFormValidated:function(){var _ref58=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee60(){var toast,promisesArray,userEmail,userPassword,promisesArrayPromise;return regeneratorRuntime.wrap(function _callee60$(_context60){while(1){switch(_context60.prev=_context60.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context60.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to sign in';toast.dataBind();toast.show();return _context60.abrupt('return');case 10:// display modal to user that signin is being completed
$('#loader-modal-message').html("Completing Signin...");_context60.next=13;return $('#loader-modal').get(0).show();case 13:// show loader
...
promisesArrayPromise.then(function(){var _ref59=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee58(resultsArray){var toast;return regeneratorRuntime.wrap(function _callee58$(_context58){while(1){switch(_context58.prev=_context58.next){case 0:// add the user's password to the user details retrieved from the server
resultsArray[1][0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context58.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[1][0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:// subscribe push notification for this user's device
window.plugins.OneSignal.setSubscription(true);// set the tag used to identify users for push notification sending
window.plugins.OneSignal.sendTags({appMail:resultsArray[1][0].email});// hide loader
_context58.next=7;return $('#loader-modal').get(0).hide();case 7:_context58.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 9:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=3000;toast.content='User signin completed';toast.dataBind();toast.show();case 17:case'end':return _context58.stop();}}},_callee58,this);}));return function(_x25){return _ref59.apply(this,arguments);};}()).catch(function(){var _ref60=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee59(err){var toast;return regeneratorRuntime.wrap(function _callee59$(_context59){while(1){switch(_context59.prev=_context59.next){case 0:// an error occurred
err=JSON.parse(err.responseText);// hide loader
_context59.next=3;return $('#loader-modal').get(0).hide();case 3:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Invalid user email or password. User signin failed ';toast.dataBind();toast.show();case 11:case'end':return _context59.stop();}}},_callee59,this);}));return function(_x26){return _ref60.apply(this,arguments);};}());return _context60.abrupt('return',promisesArrayPromise);case 21:case'end':return _context60.stop();}}},_callee60,this);}));function loginFormValidated(){return _ref58.apply(this,arguments);}return loginFormValidated;}(),/**
         * method is triggered when the sign up form is successfully validated
         *
         * @returns {Promise<void>}
         */signupFormValidated:function(){var _ref61=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee63(){var toast,promisesArray;return regeneratorRuntime.wrap(function _callee63$(_context63){while(1){switch(_context63.prev=_context63.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context63.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to sign up';toast.dataBind();toast.show();return _context63.abrupt('return');case 10:// display modal to user that signup is being completed
$('#loader-modal-message').html("Completing Signup...");_context63.next=13;return $('#loader-modal').get(0).show();case 13:// show loader
...
_context61.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:userDetails},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:// subscribe push notification for this user's device
window.plugins.OneSignal.setSubscription(true);// set the tag used to identify users for push notification sending
window.plugins.OneSignal.sendTags({appMail:userDetails.email});// hide loader
_context61.next=7;return $('#loader-modal').get(0).hide();case 7:_context61.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 9:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
...
case 18:case'end':return _context61.stop();}}},_callee61,this);}));return function(_x27){return _ref62.apply(this,arguments);};}()).catch(function(){var _ref63=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee62(err){var toast;return regeneratorRuntime.wrap(function _callee62$(_context62){while(1){switch(_context62.prev=_context62.next){case 0:// an error occurred
err=JSON.parse(err.responseText);// hide loader
_context62.next=3;return $('#loader-modal').get(0).hide();case 3:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
...
case 12:case'end':return _context62.stop();}}},_callee62,this);}));return function(_x28){return _ref63.apply(this,arguments);};}());}));return _context63.abrupt('return',Promise.all(promisesArray));case 16:case'end':return _context63.stop();}}},_callee63,this);}));function signupFormValidated(){return _ref61.apply(this,arguments);}return signupFormValidated;}(),/**
         * method is triggered when the forgot password form is successfully validated
         *
         * @returns {Promise<void>}
         */forgotPasswordFormValidated:function(){var _ref64=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee64(){return regeneratorRuntime.wrap(function _callee64$(_context64){while(1){switch(_context64.prev=_context64.next){case 0:case'end':return _context64.stop();}}},_callee64,this);}));function forgotPasswordFormValidated(){return _ref64.apply(this,arguments);}return forgotPasswordFormValidated;}()},/**
...
utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.productItemClicked(window.parseInt($(event.currentTarget).attr('data-product')),window.parseInt($(event.currentTarget).attr('data-page')));});try{}catch(err){}case 12:case'end':return _context65.stop();}}},_callee65,this);}));return function loadPageOnAppReady(){return _ref65.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref66=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee66(event){return regeneratorRuntime.wrap(function _callee66$(_context66){while(1){switch(_context66.prev=_context66.next){case 0:// flag that page infinite scroll should NOT be allowed
...
$('#products-page .page__content .infinite-load-container').remove();case 5:case'end':return _context66.stop();}}},_callee66,this);}));function pageHide(_x29){return _ref66.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref67=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee67(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productArray,toast;return regeneratorRuntime.wrap(function _callee67$(_context67){while(1){switch(_context67.prev=_context67.next){case 0:// disable pull-to-refresh widget till loading is done
$('#products-page #products-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context67.prev=2;_context67.next=5;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.loadProducts(utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentQueryParam,1);case 5:productArray=_context67.sent;_context67.next=8;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.displayPageContent(productArray[0]);case 8:_context67.next=17;break;case 10:_context67.prev=10;_context67.t0=_context67['catch'](2);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 17:_context67.prev=17;// hide the page preloader
...
doneCallBack();return _context67.finish(17);case 22:case'end':return _context67.stop();}}},_callee67,this,[[2,10,17,22]]);}));function pagePullHookAction(){return _ref67.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is triggered when the pull-hook on the page is active
         *
         * @param doneCallBack
         * @returns {Promise<void>}
         */pageInfiniteScroll:function(){var _ref68=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee68(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productArray,toast;return regeneratorRuntime.wrap(function _callee68$(_context68){while(1){switch(_context68.prev=_context68.next){case 0:if(!($('#products-page').get(0)._allowInfinitePageScroll===false)){_context68.next=3;break;}// page infinite scroll is NOT allowed
doneCallBack();return _context68.abrupt('return');case 3:// append an infinite load indicator to the bottom of the page
...
_context68.prev=6;_context68.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.loadProducts(utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentQueryParam,utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentPage+1);case 9:productArray=_context68.sent;_context68.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.displayPageContent(productArray[0],true,false);case 12:_context68.next=21;break;case 14:_context68.prev=14;_context68.t0=_context68['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 21:_context68.prev=21;// check if any new products were retrieved
...
doneCallBack();return _context68.finish(21);case 25:case'end':return _context68.stop();}}},_callee68,this,[[6,14,21,25]]);}));function pageInfiniteScroll(){return _ref68.apply(this,arguments);}return pageInfiniteScroll;}(),/**
         * method is used to load products to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
...
reject(err);// reject the parent promise with the error
});}));}return _context69.abrupt('return',Promise.all(productPromisesArray));case 5:case'end':return _context69.stop();}}},_callee69,this);}));function loadProducts(_x34){return _ref69.apply(this,arguments);}return loadProducts;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref70=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee70(productsArray){var appendContent=arguments.length>1&&arguments[1]!==undefined?arguments[1]:true;var overwriteContent=arguments.length>2&&arguments[2]!==undefined?arguments[2]:true;var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee70$(_context70){while(1){switch(_context70.prev=_context70.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var productsContent="";// holds the contents for the products
// check if the productsArray is empty or not
if(productsArray.length<=0){// there are no new content to display
...
$('#products-page').get(0)._allowInfinitePageScroll=true;resolve(productsArray.length);// resolve the promise with length of the productsArray
}});return _context70.abrupt('return',displayCompletedPromise);case 2:case'end':return _context70.stop();}}},_callee70,this);}));function displayPageContent(_x37){return _ref70.apply(this,arguments);}return displayPageContent;}(),/**
         * method scrolls the page to the top
         * @returns {Promise<void>}
         */scrollPageToTop:function(){var _ref71=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee71(){return regeneratorRuntime.wrap(function _callee71$(_context71){while(1){switch(_context71.prev=_context71.next){case 0:window.setTimeout(function(){$('#products-page .page__content').animate({scrollTop:0},400);},0);case 1:case'end':return _context71.stop();}}},_callee71,this);}));function scrollPageToTop(){return _ref71.apply(this,arguments);}return scrollPageToTop;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */productItemClicked:function(){var _ref72=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee73(productIndex,productPage){return regeneratorRuntime.wrap(function _callee73$(_context73){while(1){switch(_context73.prev=_context73.next){case 0:// handle the function task in a different event queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee72(){var productItemsArray;return regeneratorRuntime.wrap(function _callee72$(_context72){while(1){switch(_context72.prev=_context72.next){case 0:_context72.prev=0;_context72.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData((""+productPage).padStart(7,"0")+"products",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 3:productItemsArray=_context72.sent.products;// display the products details page using the selected product
$('#app-main-navigator').get(0).pushPage("product-details-page.html",{animation:"lift",data:{product:productItemsArray[productIndex]}});_context72.next=9;break;case 7:_context72.prev=7;_context72.t0=_context72['catch'](0);case 9:case'end':return _context72.stop();}}},_callee72,this,[[0,7]]);})),0);case 1:case'end':return _context73.stop();}}},_callee73,this);}));function productItemClicked(_x38,_x39){return _ref72.apply(this,arguments);}return productItemClicked;}()},/**
     ...
     */productDetailsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref74=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee75(){var productDetailsArray,toast;return regeneratorRuntime.wrap(function _callee75$(_context75){while(1){switch(_context75.prev=_context75.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context75.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context75.abrupt('return');case 3:// listen for the back button event
...
$('#product-details-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context75.prev=6;// create the "Pick Quantity" button
...
$('#rate-product-modal #rate-product-rater-widget').rateYo({starWidth:"20px",normalFill:"#808080",ratedFill:"#F39C12",numStars:5,precision:0,rating:0,fullStar:true,spacing:"10px",onChange:function(){var _ref75=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee74(ratingValue,ratingWidgetInstance){return regeneratorRuntime.wrap(function _callee74$(_context74){while(1){switch(_context74.prev=_context74.next){case 0:// enable the the comment input and "Rate" button
$('#rate-product-modal #rate-product-comment').removeAttr("disabled");$('#rate-product-modal #rate-product-rate-button').removeAttr("disabled");case 2:case'end':return _context74.stop();}}},_callee74,this);}));function onChange(_x40,_x41){return _ref75.apply(this,arguments);}return onChange;}()});// load product variations asynchronously without waiting for the response
...
_context75.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProduct();case 16:productDetailsArray=_context75.sent;_context75.next=19;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.displayProductDetails(productDetailsArray[0]);case 19:// enable the "Add To Cart" button
$('#product-details-page #product-details-add-to-cart').removeAttr("disabled");_context75.next=30;break;case 22:_context75.prev=22;_context75.t0=_context75['catch'](6);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 30:_context75.prev=30;// hide the preloader
$('#product-details-page .page-preloader').css("display","none");return _context75.finish(30);case 33:case'end':return _context75.stop();}}},_callee75,this,[[6,22,30,33]]);}));return function loadPageOnAppReady(){return _ref74.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
$('#product-details-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);window.SoftInputMode.set('adjustResize');},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref76=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee76(){return regeneratorRuntime.wrap(function _callee76$(_context76){while(1){switch(_context76.prev=_context76.next){case 0:case'end':return _context76.stop();}}},_callee76,this);}));function pageHide(){return _ref76.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();break;}}else{// there is only 1 page in the stack
         ...
         * @returns {Promise<void>}
         */shareButtonClicked:function(){var _ref77=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee77(){var shareOptions;return regeneratorRuntime.wrap(function _callee77$(_context77){while(1){switch(_context77.prev=_context77.next){case 0:shareOptions={};// holds the options for sharing
...
window.plugins.socialsharing.shareWithOptions(shareOptions,function(){},function(){});},0);case 4:case'end':return _context77.stop();}}},_callee77,this);}));function shareButtonClicked(){return _ref77.apply(this,arguments);}return shareButtonClicked;}(),/**
         * method is triggered when the "Rate" button is clicked
         * @returns {Promise<void>}
         */rateButtonClicked:function(){var _ref78=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee80(){var userDetails,toast,_toast5,ordersArray,_toast6;return regeneratorRuntime.wrap(function _callee80$(_context80){while(1){switch(_context80.prev=_context80.next){case 0:userDetails=null;// holds the user details
// display page preloader
$('#product-details-page .page-preloader').css("display","block");// check if a user has signed in
_context80.prev=2;_context80.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 5:userDetails=_context80.sent.userDetails;_context80.next=20;break;case 8:_context80.prev=8;_context80.t0=_context80['catch'](2);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#product-details-page .page-preloader').css("display","none");return _context80.abrupt('return');case 20:if(!(navigator.connection.type===Connection.NONE)){_context80.next=31;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#product-details-page .page-preloader').css("display","none");return _context80.abrupt('return');case 31:_context80.prev=31;// display the page loader modal
$('#product-details-page .modal').css("display","table");// check if the current user has ever purchased this product before
_context80.next=35;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{status:"completed",customer:userDetails.id,product:utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.currentProductDetails.id}}));case 35:ordersArray=_context80.sent;if(!(ordersArray.length===0)){_context80.next=38;break;}throw"error";case 38:_context80.next=51;break;case 40:_context80.prev=40;_context80.t1=_context80['catch'](31);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast6=$('.timed-page-toast').get(0).ej2_instances[0];_toast6.cssClass='error-ej2-toast';_toast6.timeOut=3500;_toast6.content='Sorry, you need to have purchased this product before it can be rated';_toast6.dataBind();_toast6.show();return _context80.abrupt('return');case 51:_context80.prev=51;// hide page preloader
$('#product-details-page .page-preloader').css("display","none");// hide page loader
$('#product-details-page .modal').css("display","none");return _context80.finish(51);case 55:// set the handlers for the buttons on the "Rate Product" modal
$('#rate-product-modal #rate-product-cancel-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee78(){return regeneratorRuntime.wrap(function _callee78$(_context78){while(1){switch(_context78.prev=_context78.next){case 0:_context78.next=2;return $('#rate-product-modal').get(0).hide();case 2:case'end':return _context78.stop();}}},_callee78,this);}));$('#rate-product-modal #rate-product-rate-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee79(){var _toast7,_toast8;return regeneratorRuntime.wrap(function _callee79$(_context79){while(1){switch(_context79.prev=_context79.next){case 0:_context79.prev=0;_context79.next=3;return $('#rate-product-modal').get(0).hide();case 3:// inform user that review is being sent
$('#loader-modal-message').html("Sending User Review...");_context79.next=6;return $('#loader-modal').get(0).show();case 6:_context79.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/products/reviews',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
...
_context79.next=13;return $('#loader-modal').get(0).hide();case 13:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show success
_toast7=$('.timed-page-toast').get(0).ej2_instances[0];_toast7.cssClass='success-ej2-toast';_toast7.timeOut=3500;_toast7.content='Thank you. Your product review has been received';_toast7.dataBind();_toast7.show();_context79.next=37;break;case 23:_context79.prev=23;_context79.t0=_context79['catch'](0);_context79.next=27;return $('#loader-modal').get(0).hide();case 27:_context79.next=29;return $('#rate-product-modal').get(0).show();case 29:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show error
_toast8=$('.timed-page-toast').get(0).ej2_instances[0];_toast8.cssClass='error-ej2-toast';_toast8.timeOut=3500;_toast8.content='Error. Your product review could not be sent. Please retry';_toast8.dataBind();_toast8.show();case 37:_context79.prev=37;return _context79.finish(37);case 39:_context79.next=41;return $('#rate-product-modal').get(0).hide();case 41:case'end':return _context79.stop();}}},_callee79,this,[[0,23,37,39]]);}));// display "Rate Product" modal
_context80.next=59;return $('#rate-product-modal').get(0).show();case 59:case'end':return _context80.stop();}}},_callee80,this,[[2,8],[31,40,51,55]]);}));function rateButtonClicked(){return _ref78.apply(this,arguments);}return rateButtonClicked;}(),/**
         * method is triggered when the pull-hook on the page is active
         *
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref81=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee81(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productDetailsArray,toast;return regeneratorRuntime.wrap(function _callee81$(_context81){while(1){switch(_context81.prev=_context81.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].dataBind();$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].stop();_context81.prev=6;// load product variations asynchronously without waiting for the response
utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProductVariations();// load product details
_context81.next=10;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProduct();case 10:productDetailsArray=_context81.sent;_context81.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.displayProductDetails(productDetailsArray[0]);case 13:_context81.next=22;break;case 15:_context81.prev=15;_context81.t0=_context81['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 22:_context81.prev=22;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context81.finish(22);case 27:case'end':return _context81.stop();}}},_callee81,this,[[6,15,22,27]]);}));function pagePullHookAction(){return _ref81.apply(this,arguments);}return pagePullHookAction;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProduct:function(){var _ref82=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee82(){var productPromisesArray,toast,aProduct;return regeneratorRuntime.wrap(function _callee82$(_context82){while(1){switch(_context82.prev=_context82.next){case 0:productPromisesArray=[];// holds the array for the promises used to load the product
...
reject(err);// reject the parent promise with the error
});}));}return _context82.abrupt('return',Promise.all(productPromisesArray));case 4:case'end':return _context82.stop();}}},_callee82,this);}));function loadProduct(){return _ref82.apply(this,arguments);}return loadProduct;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProductVariations:function(){var _ref83=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee83(){var productPromisesArray,productId;return regeneratorRuntime.wrap(function _callee83$(_context83){while(1){switch(_context83.prev=_context83.next){case 0:productPromisesArray=[];// holds the array for the promises used to load the product
...
reject(err);// reject the parent promise with the error
});}));return _context83.abrupt('return',Promise.all(productPromisesArray));case 5:case'end':return _context83.stop();}}},_callee83,this);}));function loadProductVariations(){return _ref83.apply(this,arguments);}return loadProductVariations;}(),/**
         * method is used to display the product details on the page
         *
         * @param productDetails {Object} the product object to be displayed
         *
         * @returns {Promise<void>}
         */displayProductDetails:function(){var _ref84=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee86(productDetails){var variationContent,index;return regeneratorRuntime.wrap(function _callee86$(_context86){while(1){switch(_context86.prev=_context86.next){case 0:// update the product details image
...
new ej.dropdowns.DropDownList({cssClass:"product-details-variation-class",placeholder:productDetails.attributes[index].name,floatLabelType:'Always',change:function(){var _ref85=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee85(){return regeneratorRuntime.wrap(function _callee85$(_context85){while(1){switch(_context85.prev=_context85.next){case 0:return _context85.abrupt('return',new Promise(function(resolve2,reject2){// handle the change in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee84(){var concatenatedVarationValue,variationIndexPosition,productVariation;return regeneratorRuntime.wrap(function _callee84$(_context84){while(1){switch(_context84.prev=_context84.next){case 0:concatenatedVarationValue="";// holds the concatenated variation values
...
resolve2();case 6:case'end':return _context84.stop();}}},_callee84,this);})),0);}));case 1:case'end':return _context85.stop();}}},_callee85,this);}));function change(){return _ref85.apply(this,arguments);}return change;}()}).appendTo(element);});// collapse the variations content
...
$('#product-details-page .product-details-weight').html(''+(!productDetails.weight||productDetails.weight==""?"(Not Available)":''+productDetails.weight));case 19:case'end':return _context86.stop();}}},_callee86,this);}));function displayProductDetails(_x43){return _ref84.apply(this,arguments);}return displayProductDetails;}(),/**
         * method is triggered when the customise button is clicked
         *
         * @returns {Promise<void>}
         */customiseButtonClicked:function(){var _ref87=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee88(){var toast;return regeneratorRuntime.wrap(function _callee88$(_context88){while(1){switch(_context88.prev=_context88.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context88.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to customise product';toast.dataBind();toast.show();return _context88.abrupt('return');case 10:// perform the method task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee87(){var productUrl,variationIndex,productVariation;return regeneratorRuntime.wrap(function _callee87$(_context87){while(1){switch(_context87.prev=_context87.next){case 0:productUrl="";// holds the url for the product being customised
...
_context87.next=4;return $('#app-main-navigator').get(0).pushPage("customise-product-page.html");case 4:_context87.next=6;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(productUrl);case 6:case'end':return _context87.stop();}}},_callee87,this);})),0);case 11:case'end':return _context88.stop();}}},_callee88,this);}));function customiseButtonClicked(){return _ref87.apply(this,arguments);}return customiseButtonClicked;}(),/**
         * method is triggered when the "Add To Cart" button is clicked
         *
         * @returns {Promise<void>}
         */addToCartButtonClicked:function(){var _ref89=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee90(){return regeneratorRuntime.wrap(function _callee90$(_context90){while(1){switch(_context90.prev=_context90.next){case 0:// disable the "Add To Cart" button
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee89(){var localCart,utopiasoftwareCartObject,variationIndex,productVariation,searchParams,_iteratorNormalCompletion,_didIteratorError,_iteratorError,_iterator,_step,_ref91,_ref92,key,value,toast,_toast9;return regeneratorRuntime.wrap(function _callee89$(_context89){while(1){switch(_context89.prev=_context89.next){case 0:localCart=[];// holds the local cart collection
utopiasoftwareCartObject={cartData:{}};// holds the object whose properties make up the cart item
// get the cached user cart
_context89.prev=2;_context89.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 5:localCart=_context89.sent.cart;_context89.next=10;break;case 8:_context89.prev=8;_context89.t0=_context89['catch'](2);case 10:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.currentProductVariationIndex!==-1)){_context89.next=36;break;}// a product variation was selected
...
utopiasoftwareCartObject.cartData.variation={};_iteratorNormalCompletion=true;_didIteratorError=false;_iteratorError=undefined;_context89.prev=19;for(_iterator=searchParams[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){_ref91=_step.value;_ref92=_slicedToArray(_ref91,2);key=_ref92[0];value=_ref92[1];utopiasoftwareCartObject.cartData.variation[key]=value;}// store the product variation object as additional data just for the mobile app
_context89.next=27;break;case 23:_context89.prev=23;_context89.t1=_context89['catch'](19);_didIteratorError=true;_iteratorError=_context89.t1;case 27:_context89.prev=27;_context89.prev=28;if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}case 30:_context89.prev=30;if(!_didIteratorError){_context89.next=33;break;}throw _iteratorError;case 33:return _context89.finish(30);case 34:return _context89.finish(27);case 35:utopiasoftwareCartObject.productVariation=productVariation;case 36:// set the other properties of the cart data
...
utopiasoftwareCartObject.uid=Random.uuid4(utopiasoftware[utopiasoftware_app_namespace].randomisationEngine);_context89.prev=40;// add the created 'utopiasoftwareCartObject' to the user cart collection
localCart.push(utopiasoftwareCartObject);// save the updated cached user cart
_context89.next=44;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 44:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=2000;toast.content='Product has been added to your cart';toast.dataBind();toast.show();_context89.next=64;break;case 54:_context89.prev=54;_context89.t2=_context89['catch'](40);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast9=$('.timed-page-toast').get(0).ej2_instances[0];_toast9.cssClass='error-ej2-toast';_toast9.timeOut=3500;_toast9.content='Error adding product to your cart. Try again';_toast9.dataBind();_toast9.show();case 64:_context89.prev=64;// enable the "Add To Cart" button
$('#product-details-page #product-details-add-to-cart').removeAttr("disabled");// hide the spinner from the 'Add To Cart'
$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].dataBind();$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].stop();return _context89.finish(64);case 70:case'end':return _context89.stop();}}},_callee89,this,[[2,8],[19,23,27,35],[28,,30,34],[40,54,64,70]]);})),0);case 5:case'end':return _context90.stop();}}},_callee90,this);}));function addToCartButtonClicked(){return _ref89.apply(this,arguments);}return addToCartButtonClicked;}()},/**
     ...
     */customiseProductPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref93=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee91(){return regeneratorRuntime.wrap(function _callee91$(_context91){while(1){switch(_context91.prev=_context91.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context91.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context91.abrupt('return');case 3:// listen for the back button event
...
new ej.splitbuttons.ProgressButton({cssClass:'e-hide-spinner',duration:10*60*60*1000// set spinner/progress duration for 10 hr
}).appendTo('#customise-product-add-to-cart');}catch(err){}finally{}case 8:case'end':return _context91.stop();}}},_callee91,this);}));return function loadPageOnAppReady(){return _ref93.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref94=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee92(){return regeneratorRuntime.wrap(function _callee92$(_context92){while(1){switch(_context92.prev=_context92.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context92.stop();}}},_callee92,this);}));function pageHide(){return _ref94.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         *
         * @returns {Promise<void>}
         */receiveMessageListener:function(){var _ref95=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee93(receiveEvent){var cartData;return regeneratorRuntime.wrap(function _callee93$(_context93){while(1){switch(_context93.prev=_context93.next){case 0:if(!(receiveEvent.origin!=="https://shopoakexclusive.com")){_context93.next=2;break;}return _context93.abrupt('return');case 2:if(!(receiveEvent.data==="page ready")){_context93.next=8;break;}// parent site is ready to work together
...
$('#customise-product-page .page-preloader').css("display","none");return _context93.abrupt('return');case 8:// the page sent cart data
...
$('.page-toast').get(0).ej2_instances[0].hide('All');_context94.prev=8;_context94.next=11;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationUrl,utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationCartKey);case 11:_context94.next=20;break;case 13:_context94.prev=13;_context94.t0=_context94['catch'](8);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 20:_context94.prev=20;window.setTimeout(function(){// wait for 2 sec before declaring loading done
...
doneCallBack();},2000);return _context94.finish(20);case 23:case'end':return _context94.stop();}}},_callee94,this,[[8,13,20,23]]);}));function pagePullHookAction(){return _ref96.apply(this,arguments);}return pagePullHookAction;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProductCustomisation:function(){var _ref97=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee95(){var customisationUrl=arguments.length>0&&arguments[0]!==undefined?arguments[0]:utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationUrl;var remoteCartItemKey=arguments[1];var toast;return regeneratorRuntime.wrap(function _callee95$(_context95){while(1){switch(_context95.prev=_context95.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context95.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to customise product and Pull Down to refresh';toast.dataBind();toast.show();return _context95.abrupt('return');case 10:// display the page preloader
...
utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.customisationPageLoadCount=0;utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.cartsQueue=[];return _context95.abrupt('return',true);case 17:case'end':return _context95.stop();}}},_callee95,this);}));function loadProductCustomisation(){return _ref97.apply(this,arguments);}return loadProductCustomisation;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */saveCustomisedProductToCart:function(){var _ref98=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee96(){var previousCartObject,updatedCartObject,property,customisedProduct,localCart,utopiasoftwareCartObject,customisedIndex,toast,_toast10;return regeneratorRuntime.wrap(function _callee96$(_context96){while(1){switch(_context96.prev=_context96.next){case 0:// get the previous remote cart object and the new/updated remote cart object
...
_context96.t0=regeneratorRuntime.keys(updatedCartObject);case 3:if((_context96.t1=_context96.t0()).done){_context96.next=58;break;}property=_context96.t1.value;if(previousCartObject[property]){_context96.next=56;break;}// property does not exist in the previousCartObject, so this property belongs to the latest customised product
// get the latest customised product
customisedProduct=updatedCartObject[property];localCart=[];// holds the local cart collection
utopiasoftwareCartObject={cartData:{}};// holds the object whose properties make up the cart item
// get the cached user cart
_context96.prev=9;_context96.next=12;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 12:localCart=_context96.sent.cart;// check if this is a save of an "edited" previously customised product
...
}_context96.next=18;break;case 16:_context96.prev=16;_context96.t2=_context96['catch'](9);case 18:// set the other properties of the cart data
...
utopiasoftwareCartObject.uid=Random.uuid4(utopiasoftware[utopiasoftware_app_namespace].randomisationEngine);_context96.prev=27;// add the created 'utopiasoftwareCartObject' to the user cart collection
localCart.push(utopiasoftwareCartObject);// save the updated cached user cart
_context96.next=31;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 31:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=2000;toast.content='Customised product has been added to your cart';toast.dataBind();toast.show();_context96.next=51;break;case 41:_context96.prev=41;_context96.t3=_context96['catch'](27);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast10=$('.timed-page-toast').get(0).ej2_instances[0];_toast10.cssClass='error-ej2-toast';_toast10.timeOut=3500;_toast10.content='Error adding customised product to your cart. Try again';_toast10.dataBind();_toast10.show();case 51:_context96.prev=51;// check if this is a save of an "edited" previously customised product
if(utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationCartKey){// since a current customisation cart key exist, this is an update
...
$('#customise-product-page #customise-product-page-iframe-container .modal').css("display","none");return _context96.finish(51);case 55:return _context96.abrupt('break',58);case 56:_context96.next=3;break;case 58:case'end':return _context96.stop();}}},_callee96,this,[[9,16],[27,41,51,55]]);}));function saveCustomisedProductToCart(){return _ref98.apply(this,arguments);}return saveCustomisedProductToCart;}(),/**
         * method is triggered when the user clicks the "Add To Cart" button
         *
         * @returns {Promise<void>}
         */addToCartButtonClicked:function(){var _ref99=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee97(){var toast;return regeneratorRuntime.wrap(function _callee97$(_context97){while(1){switch(_context97.prev=_context97.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context97.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to add customised product to cart';toast.dataBind();toast.show();return _context97.abrupt('return');case 10:// show the spinner on the 'Add To Cart' button to indicate process is ongoing
...
$('#customise-product-page #customise-product-page-iframe').get(0).contentWindow.utopiasoftware_addUsage();case 15:case'end':return _context97.stop();}}},_callee97,this);}));function addToCartButtonClicked(){return _ref99.apply(this,arguments);}return addToCartButtonClicked;}()},/**
     * this is the view-model/controller for the View Cart page
     */viewCartPageViewModel:{/**
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref100=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee98(){var toast;return regeneratorRuntime.wrap(function _callee98$(_context98){while(1){switch(_context98.prev=_context98.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context98.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context98.abrupt('return');case 3:// listen for the back button event
...
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred. Pull down to refresh';toast.dataBind();toast.show();}case 7:case'end':return _context98.stop();}}},_callee98,this);}));return function loadPageOnAppReady(){return _ref100.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
$('#view-cart-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);window.SoftInputMode.set('adjustResize');},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref101=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee99(){return regeneratorRuntime.wrap(function _callee99$(_context99){while(1){switch(_context99.prev=_context99.next){case 0:case'end':return _context99.stop();}}},_callee99,this);}));function pageHide(){return _ref101.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref102=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee100(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var toast;return regeneratorRuntime.wrap(function _callee100$(_context100){while(1){switch(_context100.prev=_context100.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].dataBind();$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].stop();_context100.prev=6;_context100.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart();case 9:_context100.next=18;break;case 11:_context100.prev=11;_context100.t0=_context100['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 18:_context100.prev=18;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context100.finish(18);case 24:case'end':return _context100.stop();}}},_callee100,this,[[6,11,18,24]]);}));function pagePullHookAction(){return _ref102.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to display the user cart on the View Cart page.
         * @param localCart {Array}
         *
         * @returns Promise
         */displayUserCart:function(){var _ref103=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee102(localCart){var displayContent,toast,index;return regeneratorRuntime.wrap(function _callee102$(_context102){while(1){switch(_context102.prev=_context102.next){case 0:displayContent="";// holds the cart content to be displayed
_context102.prev=1;_context102.prev=2;_context102.t0=localCart;if(_context102.t0){_context102.next=8;break;}_context102.next=7;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 7:_context102.t0=_context102.sent.cart;case 8:localCart=_context102.t0;_context102.next=14;break;case 11:_context102.prev=11;_context102.t1=_context102['catch'](2);// if error occurred during local cart retrieval
localCart=[];// set localCart to empty array
case 14:if(!(localCart.length===0)){_context102.next=24;break;}// localCart is empty
// display message to inform user that cart is empty
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Your cart is empty. Go order some products!';toast.dataBind();toast.show();return _context102.abrupt('return');case 24:// destroy all the "Edit" buttons on the View Cart page
$("#view-cart-page .view-cart-edit-button").each(function(index,element){// destroy the "Edit" button
element.ej2_instances[0].destroy();});// destroy all the "Remove" buttons required for the View Cart page
$("#view-cart-page .view-cart-remove-button").each(function(index,element){// destroy the "Remove" button
element.ej2_instances[0].destroy();});// destroy all the "Quantity" input required for the View Cart page
...
$("#view-cart-page .view-cart-quantity-input").each(function(index,element){var _ref105;new ej.inputs.NumericTextBox((_ref105={value:element.value,cssClass:'view-cart-quantity-input-class',currency:null,decimals:0,floatLabelType:'Auto',format:'n',showSpinButton:true,min:1,max:10,placeholder:' ',step:1,strictMode:true,width:'60%'},_defineProperty(_ref105,'value',1),_defineProperty(_ref105,'change',function change(){// track changes in the quantity numeric input for every product
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee101(){var selectedProduct,_toast11,_toast12;return regeneratorRuntime.wrap(function _callee101$(_context101){while(1){switch(_context101.prev=_context101.next){case 0:_context101.prev=0;// find the product to be updated within the app localCart
...
_context101.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 5:_context101.next=7;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart(localCart);case 7:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast11=$('.timed-page-toast').get(0).ej2_instances[0];_toast11.cssClass='success-ej2-toast';_toast11.timeOut=2000;_toast11.content='Product quantity updated';_toast11.dataBind();_toast11.show();_context101.next=27;break;case 17:_context101.prev=17;_context101.t0=_context101['catch'](0);// hide all previously displayed ej2 toast
...
_toast12=$('.timed-page-toast').get(0).ej2_instances[0];_toast12.cssClass='error-ej2-toast';_toast12.timeOut=3500;_toast12.content='Product quantity not updated. Try again';_toast12.dataBind();_toast12.show();case 27:_context101.prev=27;// hide page preloader
$('#view-cart-page .page-preloader').css("display","none");return _context101.finish(27);case 30:case'end':return _context101.stop();}}},_callee101,this,[[0,17,27,30]]);})),0);}),_ref105)).appendTo(element);});// update the total price of items displayed
$('#view-cart-page #view-cart-total-price').html('&#x20a6;'+kendo.toString(utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.calculateCartTotalPrice(localCart),"n2"));case 33:_context102.prev=33;return _context102.finish(33);case 35:case'end':return _context102.stop();}}},_callee102,this,[[1,,33,35],[2,11]]);}));function displayUserCart(_x48){return _ref103.apply(this,arguments);}return displayUserCart;}(),/**
         * method is a utility/helper function used to view/load and display the user's cart
         *
         * @returns {Promise<void>}
         */viewCartPage:function(){var _ref106=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee103(){var toast;return regeneratorRuntime.wrap(function _callee103$(_context103){while(1){switch(_context103.prev=_context103.next){case 0:_context103.prev=0;_context103.next=3;return $('#app-main-navigator').get(0).bringPageTop("view-cart-page.html");case 3:_context103.next=5;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart();case 5:// enable the checkout button
$('#view-cart-page #view-cart-checkout').removeAttr("disabled");_context103.next=16;break;case 8:_context103.prev=8;_context103.t0=_context103['catch'](0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred. Pull down to refresh';toast.dataBind();toast.show();case 16:_context103.prev=16;// hide the preloader
$('#view-cart-page .page-preloader').css("display","none");return _context103.finish(16);case 19:case'end':return _context103.stop();}}},_callee103,this,[[0,8,16,19]]);}));function viewCartPage(){return _ref106.apply(this,arguments);}return viewCartPage;}(),/**
...
return accumulator+currentElement.cartData.quantity*kendo.parseFloat(currentElement.product.price);}},0);},/**
         ...
         *
         * @returns {Promise<void>}
         */deleteCartItemButtonClicked:function(){var _ref107=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee106(){var productUId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:"";return regeneratorRuntime.wrap(function _callee106$(_context106){while(1){switch(_context106.prev=_context106.next){case 0:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
...
$('#view-cart-page-delete-cart-item-action-sheet #view-cart-page-delete-cart-item-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee104(){return regeneratorRuntime.wrap(function _callee104$(_context104){while(1){switch(_context104.prev=_context104.next){case 0:_context104.next=2;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').hide();case 2:case'end':return _context104.stop();}}},_callee104,this);}));// function for "Accept/Yes" button
$('#view-cart-page-delete-cart-item-action-sheet #view-cart-page-delete-cart-item-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee105(){var localCart,productIndex,$cartDisplayedItem,toast,_toast13;return regeneratorRuntime.wrap(function _callee105$(_context105){while(1){switch(_context105.prev=_context105.next){case 0:localCart=[];// holds the local cart array
_context105.prev=1;// display page preloader
$('#view-cart-page .page-preloader').css("display","block");// hide the action sheet
_context105.next=5;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').hide();case 5:_context105.prev=5;_context105.next=8;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 8:localCart=_context105.sent.cart;_context105.next=13;break;case 11:_context105.prev=11;_context105.t0=_context105['catch'](5);case 13:// get the product to be deleted from the cart
...
_context105.next=17;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 17:// hide from display, the cart item belonging to the deleted product
$cartDisplayedItem=$('#view-cart-page .col-xs-12[data-utopiasoftware-product-uid="'+productUId+'"]');_context105.next=20;return kendo.fx($cartDisplayedItem).expand("vertical").duration(250).reverse();case 20:// update the total price of items displayed
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=2000;toast.content='Product has been deleted from your cart';toast.dataBind();toast.show();_context105.next=41;break;case 31:_context105.prev=31;_context105.t1=_context105['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast13=$('.timed-page-toast').get(0).ej2_instances[0];_toast13.cssClass='error-ej2-toast';_toast13.timeOut=3500;_toast13.content='Error deleting product from your cart. Try again';_toast13.dataBind();_toast13.show();case 41:_context105.prev=41;// hide page preloader
$('#view-cart-page .page-preloader').css("display","none");return _context105.finish(41);case 44:case'end':return _context105.stop();}}},_callee105,this,[[1,31,41,44],[5,11]]);}));// display the delete confirmation dialog
_context106.next=4;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').show();case 4:case'end':return _context106.stop();}}},_callee106,this);}));function deleteCartItemButtonClicked(){return _ref107.apply(this,arguments);}return deleteCartItemButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */editCartItemButtonClicked:function(){var _ref110=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee107(productUrl,cartItemKey){return regeneratorRuntime.wrap(function _callee107$(_context107){while(1){switch(_context107.prev=_context107.next){case 0:_context107.next=2;return $('#app-main-navigator').get(0).bringPageTop("customise-product-page.html");case 2:_context107.next=4;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(productUrl,cartItemKey);case 4:case'end':return _context107.stop();}}},_callee107,this);}));function editCartItemButtonClicked(_x51,_x52){return _ref110.apply(this,arguments);}return editCartItemButtonClicked;}(),/**
         * method is triggerd when the "Check Out" button is clicked
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref111=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee108(){var userDetails,toast,localCart,_toast14,_toast15,_toast16,orderData,userCart,index,key,pagesStackArray,indexOfCheckoutPage,_toast17;return regeneratorRuntime.wrap(function _callee108$(_context108){while(1){switch(_context108.prev=_context108.next){case 0:userDetails=null;// holds the user details
// check if a user has signed in
_context108.prev=1;_context108.next=4;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 4:userDetails=_context108.sent.userDetails;_context108.next=19;break;case 7:_context108.prev=7;_context108.t0=_context108['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#app-main-navigator').get(0).pushPage('login-page.html');return _context108.abrupt('return');case 19:_context108.prev=19;_context108.next=22;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 22:localCart=_context108.sent.cart;if(!(localCart.length===0)){_context108.next=25;break;}throw"error";case 25:_context108.next=38;break;case 27:_context108.prev=27;_context108.t1=_context108['catch'](19);// display message to inform user that cart is empty
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast14=$('.timed-page-toast').get(0).ej2_instances[0];_toast14.cssClass='default-ej2-toast';_toast14.timeOut=3000;_toast14.content='Your cart is empty. Go order some products!';_toast14.dataBind();_toast14.show();return _context108.abrupt('return');case 38:if(!(userDetails.billing.address_1=="")){_context108.next=49;break;}// no billing address has been provided
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast15=$('.timed-page-toast').get(0).ej2_instances[0];_toast15.cssClass='error-ej2-toast';_toast15.timeOut=3500;_toast15.content='Please update your billing address to checkout your cart';_toast15.dataBind();_toast15.show();$('#app-main-navigator').get(0).pushPage('billing-info-page.html');return _context108.abrupt('return');case 49:if(!(navigator.connection.type===Connection.NONE)){_context108.next=59;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast16=$('.timed-page-toast').get(0).ej2_instances[0];_toast16.cssClass='error-ej2-toast';_toast16.timeOut=3000;_toast16.content='Connect to the Internet to checkout your cart';_toast16.dataBind();_toast16.show();return _context108.abrupt('return');case 59:// show the app loader modal
$('#loader-modal-message').html("Preparing Checkout...");$('#loader-modal').get(0).show();// show loader
// create the user's order object
orderData={status:"pending",currency:"NGN",customer_id:userDetails.id,billing:userDetails.billing,shipping:userDetails.shipping,line_items:[]};_context108.prev=62;_context108.next=65;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 65:userCart=_context108.sent.cart;// loop through the user cart item to create the order items
...
_context108.next=69;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(orderData)}));case 69:orderData=_context108.sent;// check if the checkout page has previously been displayed in the app-main navigator
...
if(!(indexOfCheckoutPage>-1)){_context108.next=75;break;}_context108.next=75;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 75:_context108.next=77;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:orderData}});case 77:_context108.next=90;break;case 79:_context108.prev=79;_context108.t2=_context108['catch'](62);_context108.t2=JSON.parse(_context108.t2.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast17=$('.timed-page-toast').get(0).ej2_instances[0];_toast17.cssClass='error-ej2-toast';_toast17.timeOut=3000;_toast17.content='Checkout failed. '+(_context108.t2.message||"");_toast17.dataBind();_toast17.show();case 90:_context108.prev=90;// hide the app loader
$('#loader-modal').get(0).hide();// hide loader
return _context108.finish(90);case 93:case'end':return _context108.stop();}}},_callee108,this,[[1,7],[19,27],[62,79,90,93]]);}));function checkoutButtonClicked(){return _ref111.apply(this,arguments);}return checkoutButtonClicked;}()},/**
...
$('#profile-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener);_context109.prev=9;// create the tooltip objects for the profile form
...
_context109.next=15;return utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.displayProfileContent();case 15:_context109.next=19;break;case 17:_context109.prev=17;_context109.t0=_context109['catch'](9);case 19:_context109.prev=19;return _context109.finish(19);case 21:case'end':return _context109.stop();}}},_callee109,this,[[9,17,19,21]]);}));return function loadPageOnAppReady(){return _ref112.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref113=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee110(){return regeneratorRuntime.wrap(function _callee110$(_context110){while(1){switch(_context110.prev=_context110.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context110.stop();}}},_callee110,this);}));function pageHide(){return _ref113.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.profileFormValidator.whenValidate();case 1:case'end':return _context112.stop();}}},_callee112,this);}));function updateButtonClicked(){return _ref115.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the profile form is successfully validated
         *
         * @returns {Promise<void>}
         */profileFormValidated:function(){var _ref116=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee113(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast18,_toast19;return regeneratorRuntime.wrap(function _callee113$(_context113){while(1){switch(_context113.prev=_context113.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context113.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update your profile';toast.dataBind();toast.show();return _context113.abrupt('return');case 10:// disable the "Update" button
...
_context113.prev=17;_context113.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context113.sent.userDetails;// temporary hold the user id and password
...
_context113.next=37;return promisesArrayPromise;case 37:resultsArray=_context113.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context113.next=41;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 41:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast18=$('.timed-page-toast').get(0).ej2_instances[0];_toast18.cssClass='success-ej2-toast';_toast18.timeOut=3000;_toast18.content='User profile updated';_toast18.dataBind();_toast18.show();_context113.next=62;break;case 51:_context113.prev=51;_context113.t0=_context113['catch'](17);_context113.t0=JSON.parse(_context113.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast19=$('.timed-page-toast').get(0).ej2_instances[0];_toast19.cssClass='error-ej2-toast';_toast19.timeOut=3000;_toast19.content='User profile update failed. '+(_context113.t0.message||"");_toast19.dataBind();_toast19.show();case 62:_context113.prev=62;// enable the "Update" button
...
$('#profile-page .modal').css("display","none");return _context113.finish(62);case 69:return _context113.abrupt('return',promisesArrayPromise);case 70:case'end':return _context113.stop();}}},_callee113,this,[[17,51,62,69]]);}));function profileFormValidated(){return _ref116.apply(this,arguments);}return profileFormValidated;}(),/**
         * method is used to load the current user profile data into the profile form
         * @returns {Promise<void>}
         */displayProfileContent:function(){var _ref117=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee114(){var userDetails;return regeneratorRuntime.wrap(function _callee114$(_context114){while(1){switch(_context114.prev=_context114.next){case 0:_context114.prev=0;_context114.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context114.sent.userDetails;// display the user profile data in the profile form
$('#profile-page #profile-form #profile-email').val(userDetails.email);$('#profile-page #profile-form #profile-first-name').val(userDetails.first_name||"");$('#profile-page #profile-form #profile-last-name').val(userDetails.last_name||"");$('#profile-page #profile-form #profile-phone-number').val(userDetails.billing&&userDetails.billing.phone?userDetails.billing.phone:"");case 8:_context114.prev=8;// hide page preloader
...
$('#profile-page #profile-update').removeAttr("disabled");return _context114.finish(8);case 13:case'end':return _context114.stop();}}},_callee114,this,[[0,,8,13]]);}));function displayProfileContent(){return _ref117.apply(this,arguments);}return displayProfileContent;}()},/**
...
$('#change-password-page #change-password-update').removeAttr("disabled");}case 10:case'end':return _context115.stop();}}},_callee115,this);}));return function loadPageOnAppReady(){return _ref118.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref119=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee116(){return regeneratorRuntime.wrap(function _callee116$(_context116){while(1){switch(_context116.prev=_context116.next){case 0:// hide the tooltips on the changePassword form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context116.stop();}}},_callee116,this);}));function pageHide(){return _ref119.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$("#change-password-page #change-password-form ons-input").each(function(index,element){document.getElementById('change-password-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context117.stop();}}},_callee117,this);}));function scrollAndResizeEventListener(){return _ref120.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref121=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee118(){return regeneratorRuntime.wrap(function _callee118$(_context118){while(1){switch(_context118.prev=_context118.next){case 0:// run the validation method for the profile form
utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.changePasswordFormValidator.whenValidate();case 1:case'end':return _context118.stop();}}},_callee118,this);}));function updateButtonClicked(){return _ref121.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the changePassword form is successfully validated
         *
         * @returns {Promise<void>}
         */changePasswordFormValidated:function(){var _ref122=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee119(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,resultsArray,_toast20,_toast21;return regeneratorRuntime.wrap(function _callee119$(_context119){while(1){switch(_context119.prev=_context119.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context119.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change password';toast.dataBind();toast.show();return _context119.abrupt('return');case 10:// disable the "Update" button
...
processData:false}));case 24:_context119.next=29;break;case 26:_context119.prev=26;_context119.t0=_context119['catch'](21);throw{responseText:JSON.stringify({message:"current password is incorrect."})};case 29:// temporary hold the user id
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context119.next=37;return promisesArrayPromise;case 37:resultsArray=_context119.sent;// add the user's new password to the user details retrieved from the server
...
_context119.next=41;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 41:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast20=$('.timed-page-toast').get(0).ej2_instances[0];_toast20.cssClass='success-ej2-toast';_toast20.timeOut=3000;_toast20.content='User password changed';_toast20.dataBind();_toast20.show();_context119.next=62;break;case 51:_context119.prev=51;_context119.t1=_context119['catch'](17);_context119.t1=JSON.parse(_context119.t1.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast21=$('.timed-page-toast').get(0).ej2_instances[0];_toast21.cssClass='error-ej2-toast';_toast21.timeOut=3000;_toast21.content='User password change failed. '+(_context119.t1.message||"");_toast21.dataBind();_toast21.show();case 62:_context119.prev=62;// enable the "Update" button
...
$('#change-password-page .modal').css("display","none");return _context119.finish(62);case 69:return _context119.abrupt('return',promisesArrayPromise);case 70:case'end':return _context119.stop();}}},_callee119,this,[[17,51,62,69],[21,26]]);}));function changePasswordFormValidated(){return _ref122.apply(this,arguments);}return changePasswordFormValidated;}()},/**
     ...
     */billingInfoPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref123=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee121(){var countryDataArray;return regeneratorRuntime.wrap(function _callee121$(_context121){while(1){switch(_context121.prev=_context121.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context121.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context121.abrupt('return');case 3:// listen for the back button event
...
$('#billing-info-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener);_context121.prev=11;// create the "Cancel" button
new ej.buttons.Button({//iconCss: "zmdi zmdi-shopping-cart-add utopiasoftware-icon-zoom-one-point-two",
//iconPosition: "Left"
...
_context121.next=17;return Promise.resolve($.ajax({url:'country-list.json',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 17:countryDataArray=_context121.sent;// create the tooltip objects for the billing info form
...
new ej.dropdowns.DropDownList({cssClass:"billing-info-dropdownlist",dataSource:countryDataArray.find(function(countryElement){return countryElement.code==="NG";}).states,fields:{value:'code',text:'name'},placeholder:"State",floatLabelType:'Auto',itemTemplate:'<span>${name}</span>',valueTemplate:'<span>${name}</span>',select:function(){var _ref124=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee120(){return regeneratorRuntime.wrap(function _callee120$(_context120){while(1){switch(_context120.prev=_context120.next){case 0:// listen for when dropdown list value is changed by selection
...
/*utopiasoftware[utopiasoftware_app_namespace].controller.
                                    billingInfoPageViewModel.updateButtonClicked()*/},0);case 1:case'end':return _context120.stop();}}},_callee120,this);}));function select(){return _ref124.apply(this,arguments);}return select;}()}).appendTo('#billing-info-state');// display the billing info on the billing info form
_context121.next=23;return utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.displayContent();case 23:_context121.next=27;break;case 25:_context121.prev=25;_context121.t0=_context121['catch'](11);case 27:_context121.prev=27;return _context121.finish(27);case 29:case'end':return _context121.stop();}}},_callee121,this,[[11,25,27,29]]);}));return function loadPageOnAppReady(){return _ref123.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref125=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee122(){return regeneratorRuntime.wrap(function _callee122$(_context122){while(1){switch(_context122.prev=_context122.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context122.stop();}}},_callee122,this);}));function pageHide(){return _ref125.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// destroy the tooltips on the profile form
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref126=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee123(){return regeneratorRuntime.wrap(function _callee123$(_context123){while(1){switch(_context123.prev=_context123.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the profile form
$('#billing-info-form textarea, #billing-info-form ons-input, #billing-info-form #billing-info-country, #billing-info-form #billing-info-state').each(function(index,element){document.getElementById('billing-info-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context123.stop();}}},_callee123,this);}));function scrollAndResizeEventListener(){return _ref126.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref127=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee124(){return regeneratorRuntime.wrap(function _callee124$(_context124){while(1){switch(_context124.prev=_context124.next){case 0:// run the validation method for the billing-info form
utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.billingInfoFormValidator.whenValidate();case 1:case'end':return _context124.stop();}}},_callee124,this);}));function updateButtonClicked(){return _ref127.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the billing-info form is successfully validated
         *
         * @returns {Promise<void>}
         */billingInfoFormValidated:function(){var _ref128=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee125(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast22,_toast23;return regeneratorRuntime.wrap(function _callee125$(_context125){while(1){switch(_context125.prev=_context125.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context125.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update your billing address';toast.dataBind();toast.show();return _context125.abrupt('return');case 10:// disable the "Update" button
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context125.prev=17;_context125.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context125.sent.userDetails;// temporary hold the user id and password
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context125.next=38;return promisesArrayPromise;case 38:resultsArray=_context125.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context125.next=42;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 42:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast22=$('.timed-page-toast').get(0).ej2_instances[0];_toast22.cssClass='success-ej2-toast';_toast22.timeOut=3000;_toast22.content='User billing address updated';_toast22.dataBind();_toast22.show();_context125.next=63;break;case 52:_context125.prev=52;_context125.t0=_context125['catch'](17);_context125.t0=JSON.parse(_context125.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast23=$('.timed-page-toast').get(0).ej2_instances[0];_toast23.cssClass='error-ej2-toast';_toast23.timeOut=3000;_toast23.content='User billing address update failed. '+(_context125.t0.message||"");_toast23.dataBind();_toast23.show();case 63:_context125.prev=63;// enable the "Update" button
...
$('#billing-info-page .modal').css("display","none");return _context125.finish(63);case 70:return _context125.abrupt('return',promisesArrayPromise);case 71:case'end':return _context125.stop();}}},_callee125,this,[[17,52,63,70]]);}));function billingInfoFormValidated(){return _ref128.apply(this,arguments);}return billingInfoFormValidated;}(),/**
         * method is used to load the current billing info data into the billing info form
         * @returns {Promise<void>}
         */displayContent:function(){var _ref129=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee129(){var userDetails,countryDropDownList,statesDropDownList;return regeneratorRuntime.wrap(function _callee129$(_context129){while(1){switch(_context129.prev=_context129.next){case 0:_context129.prev=0;_context129.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context129.sent.userDetails;// display the user billing info data in the billing info form
...
statesDropDownList.dataBind();}case 19:_context129.prev=19;// hide page preloader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee128(){return regeneratorRuntime.wrap(function _callee128$(_context128){while(1){switch(_context128.prev=_context128.next){case 0:// reinstate the country dropdownlist "select" listener
countryDropDownList.addEventListener("select",_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee127(){var countryDropDownList;return regeneratorRuntime.wrap(function _callee127$(_context127){while(1){switch(_context127.prev=_context127.next){case 0:// listen for when dropdown list value is changed by selection
countryDropDownList=this;// holds this dropdown list
// execute the task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee126(){var countryStatesArray,stateDropDownList;return regeneratorRuntime.wrap(function _callee126$(_context126){while(1){switch(_context126.prev=_context126.next){case 0:// get the country object and its states that represents the country value selected
...
stateDropDownList.dataBind();case 6:case'end':return _context126.stop();}}},_callee126,this);})),0);case 2:case'end':return _context127.stop();}}},_callee127,this);})));case 1:case'end':return _context128.stop();}}},_callee128,this);})),0);return _context129.finish(19);case 25:case'end':return _context129.stop();}}},_callee129,this,[[0,,19,25]]);}));function displayContent(){return _ref129.apply(this,arguments);}return displayContent;}()},/**
     ...
     */shippingInfoPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref133=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee131(){var countryDataArray;return regeneratorRuntime.wrap(function _callee131$(_context131){while(1){switch(_context131.prev=_context131.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context131.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context131.abrupt('return');case 3:// listen for the back button event
...
$('#shipping-info-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener);_context131.prev=11;// create the "Cancel" button
new ej.buttons.Button({//iconCss: "zmdi zmdi-shopping-cart-add utopiasoftware-icon-zoom-one-point-two",
//iconPosition: "Left"
...
// load the country data from the local list with the app
_context131.next=17;return Promise.resolve($.ajax({url:'country-list.json',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 17:countryDataArray=_context131.sent;// create the tooltip objects for the shipping info form
...
new ej.dropdowns.DropDownList({cssClass:"shipping-info-dropdownlist",dataSource:countryDataArray.find(function(countryElement){return countryElement.code==="NG";}).states,fields:{value:'code',text:'name'},placeholder:"State",floatLabelType:'Auto',itemTemplate:'<span>${name}</span>',valueTemplate:'<span>${name}</span>',select:function(){var _ref134=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee130(){return regeneratorRuntime.wrap(function _callee130$(_context130){while(1){switch(_context130.prev=_context130.next){case 0:// listen for when dropdown list value is changed by selection
// handle method task in a different event block
...
$('#shipping-info-page #shipping-info-form').get(0).ej2_instances[$('#shipping-info-state').get(0)._utopiasoftware_validator_index].close();},0);case 1:case'end':return _context130.stop();}}},_callee130,this);}));function select(){return _ref134.apply(this,arguments);}return select;}()}).appendTo('#shipping-info-state');// display the shipping info on the shipping info form
_context131.next=23;return utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.displayContent();case 23:_context131.next=27;break;case 25:_context131.prev=25;_context131.t0=_context131['catch'](11);case 27:_context131.prev=27;return _context131.finish(27);case 29:case'end':return _context131.stop();}}},_callee131,this,[[11,25,27,29]]);}));return function loadPageOnAppReady(){return _ref133.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref135=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee132(){return regeneratorRuntime.wrap(function _callee132$(_context132){while(1){switch(_context132.prev=_context132.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context132.stop();}}},_callee132,this);}));function pageHide(){return _ref135.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref136=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee133(){return regeneratorRuntime.wrap(function _callee133$(_context133){while(1){switch(_context133.prev=_context133.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the shipping form
$('#shipping-info-form textarea, #shipping-info-form ons-input, #shipping-info-form #shipping-info-country, #shipping-info-form #shipping-info-state').each(function(index,element){document.getElementById('shipping-info-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context133.stop();}}},_callee133,this);}));function scrollAndResizeEventListener(){return _ref136.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref137=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee134(){return regeneratorRuntime.wrap(function _callee134$(_context134){while(1){switch(_context134.prev=_context134.next){case 0:// run the validation method for the shipping-info form
utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.shippingInfoFormValidator.whenValidate();case 1:case'end':return _context134.stop();}}},_callee134,this);}));function updateButtonClicked(){return _ref137.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the shipping-info form is successfully validated
         *
         * @returns {Promise<void>}
         */shippingInfoFormValidated:function(){var _ref138=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee135(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast24,_toast25;return regeneratorRuntime.wrap(function _callee135$(_context135){while(1){switch(_context135.prev=_context135.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context135.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update shipping information';toast.dataBind();toast.show();return _context135.abrupt('return');case 10:// disable the "Update" button
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context135.prev=17;_context135.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context135.sent.userDetails;// temporary hold the user id and password
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context135.next=39;return promisesArrayPromise;case 39:resultsArray=_context135.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context135.next=43;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 43:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast24=$('.timed-page-toast').get(0).ej2_instances[0];_toast24.cssClass='success-ej2-toast';_toast24.timeOut=3000;_toast24.content='Shipping information updated';_toast24.dataBind();_toast24.show();_context135.next=64;break;case 53:_context135.prev=53;_context135.t0=_context135['catch'](17);_context135.t0=JSON.parse(_context135.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast25=$('.timed-page-toast').get(0).ej2_instances[0];_toast25.cssClass='error-ej2-toast';_toast25.timeOut=3000;_toast25.content='Shipping information update failed. '+(_context135.t0.message||"");_toast25.dataBind();_toast25.show();case 64:_context135.prev=64;// enable the "Update" button
...
$('#shipping-info-page .modal').css("display","none");return _context135.finish(64);case 71:return _context135.abrupt('return',promisesArrayPromise);case 72:case'end':return _context135.stop();}}},_callee135,this,[[17,53,64,71]]);}));function shippingInfoFormValidated(){return _ref138.apply(this,arguments);}return shippingInfoFormValidated;}(),/**
         * method is used to load the current shipping info data into the shipping info form
         * @returns {Promise<void>}
         */displayContent:function(){var _ref139=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee139(){var userDetails,countryDropDownList,statesDropDownList;return regeneratorRuntime.wrap(function _callee139$(_context139){while(1){switch(_context139.prev=_context139.next){case 0:_context139.prev=0;_context139.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context139.sent.userDetails;// display the user shipping info data in the shipping info form
...
statesDropDownList.dataBind();}else{// the state dropdown has no value and the country selected is not nigeria
statesDropDownList.enabled=false;// disable the state dropdownlist
statesDropDownList.dataBind();}case 21:_context139.prev=21;// hide page preloader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee138(){return regeneratorRuntime.wrap(function _callee138$(_context138){while(1){switch(_context138.prev=_context138.next){case 0:// reinstate the country dropdownlist "select" listener
countryDropDownList.addEventListener("select",_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee137(){var countryDropDownList;return regeneratorRuntime.wrap(function _callee137$(_context137){while(1){switch(_context137.prev=_context137.next){case 0:// listen for when dropdown list value is changed by selection
countryDropDownList=this;// holds this dropdown list
// execute the task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee136(){var countryStatesArray,stateDropDownList;return regeneratorRuntime.wrap(function _callee136$(_context136){while(1){switch(_context136.prev=_context136.next){case 0:// get the country object and its states that represents the country value selected
countryStatesArray=countryDropDownList.getDataByValue(countryDropDownList.value).states;// get the state dropdownlist
...
stateDropDownList.dataBind();case 6:case'end':return _context136.stop();}}},_callee136,this);})),0);case 2:case'end':return _context137.stop();}}},_callee137,this);})));case 1:case'end':return _context138.stop();}}},_callee138,this);})),0);return _context139.finish(21);case 27:case'end':return _context139.stop();}}},_callee139,this,[[0,,21,27]]);}));function displayContent(){return _ref139.apply(this,arguments);}return displayContent;}()},/**
     ...
     */checkoutPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref143=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee140(){var promisesArray,toast;return regeneratorRuntime.wrap(function _callee140$(_context140){while(1){switch(_context140.prev=_context140.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context140.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context140.abrupt('return');case 3:// listen for the back button event
...
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder=$('#app-main-navigator').get(0).topPage.data.orderData;_context140.prev=6;// create the accorodion ej2 component used on the "Checkout" page
...
_context140.next=20;return Promise.all(promisesArray);case 20:promisesArray=_context140.sent;// filter only pay method that are enabled
...
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.countryArray=promisesArray[2];_context140.next=40;break;case 28:_context140.prev=28;_context140.t0=_context140['catch'](6);_context140.next=32;return $('#app-main-navigator').get(0).popPage();case 32:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3500;if(_context140.t0==="fatal error"){// if error is flagged as a fatal error
toast.content='A serious error occurred. Please resign into your account';}else{toast.content='Error preparing checkout. Please retry';}toast.dataBind();toast.show();case 40:_context140.prev=40;// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");return _context140.finish(40);case 44:case'end':return _context140.stop();}}},_callee140,this,[[6,28,40,44]]);}));return function loadPageOnAppReady(){return _ref143.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function(){var _ref144=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee141(){var paymentMethodDropDown,toast;return regeneratorRuntime.wrap(function _callee141$(_context141){while(1){switch(_context141.prev=_context141.next){case 0:if(!($('#checkout-page #checkout-payment-method-type').length==0)){_context141.next=2;break;}return _context141.abrupt('return');case 2:// get payment method dropdownlist component
...
if(!(paymentMethodDropDown.dataSource.length==0)){_context141.next=6;break;}// datasource for the payment method dropdownlist has not been set
// re-execute this method again after some time
window.setTimeout(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow,500);return _context141.abrupt('return');case 6:window.SoftInputMode.set('adjustResize');// adjust device input mode
...
$('#checkout-page .modal').css("display","table");_context141.prev=10;_context141.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.displayContent();case 13:_context141.next=28;break;case 15:_context141.prev=15;_context141.t0=_context141['catch'](10);// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Checkout error. Please retry';toast.dataBind();toast.show();return _context141.abrupt('return');case 28:_context141.prev=28;_context141.next=31;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.validateOrderCheckout();case 31:_context141.next=35;break;case 33:_context141.prev=33;_context141.t1=_context141['catch'](28);case 35:_context141.prev=35;// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");return _context141.finish(35);case 39:case'end':return _context141.stop();}}},_callee141,this,[[10,15],[28,33,35,39]]);}));function pageShow(){return _ref144.apply(this,arguments);}return pageShow;}(),/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref145=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee142(){return regeneratorRuntime.wrap(function _callee142$(_context142){while(1){switch(_context142.prev=_context142.next){case 0://add listener for when the window is resized by virtue of the device keyboard being shown
...
tooltipArrayElem.close();});case 2:case'end':return _context142.stop();}}},_callee142,this);}));function pageHide(){return _ref145.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
if(!(indexOfPage>-1)){_context144.next=5;break;}_context144.next=5;return $('#app-main-navigator').get(0).removePage(indexOfPage);case 5:// display the profile page
$('#app-main-navigator').get(0).pushPage('profile-page.html');case 6:case'end':return _context144.stop();}}},_callee144,this);}));function editPersonalDetailsButtonClicked(){return _ref147.apply(this,arguments);}return editPersonalDetailsButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the billing details is clicked
         *
         * @returns {Promise<void>}
         */editBillingDetailsButtonClicked:function(){var _ref148=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee145(){var pagesStackArray,indexOfPage;return regeneratorRuntime.wrap(function _callee145$(_context145){while(1){switch(_context145.prev=_context145.next){case 0:// set the update billing details flag to true
...
if(!(indexOfPage>-1)){_context145.next=6;break;}_context145.next=6;return $('#app-main-navigator').get(0).removePage(indexOfPage);case 6:// display the billing details page
$('#app-main-navigator').get(0).pushPage('billing-info-page.html');case 7:case'end':return _context145.stop();}}},_callee145,this);}));function editBillingDetailsButtonClicked(){return _ref148.apply(this,arguments);}return editBillingDetailsButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the shipping details is clicked
         *
         * @returns {Promise<void>}
         */editShippingDetailsButtonClicked:function(){var _ref149=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee146(){var pagesStackArray,indexOfPage;return regeneratorRuntime.wrap(function _callee146$(_context146){while(1){switch(_context146.prev=_context146.next){case 0:// set the update shipping details flag to true
...
if(!(indexOfPage>-1)){_context146.next=6;break;}_context146.next=6;return $('#app-main-navigator').get(0).removePage(indexOfPage);case 6:// display the shipping details page
$('#app-main-navigator').get(0).pushPage('shipping-info-page.html');case 7:case'end':return _context146.stop();}}},_callee146,this);}));function editShippingDetailsButtonClicked(){return _ref149.apply(this,arguments);}return editShippingDetailsButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the shipping method is clicked
         *
         * @returns {Promise<void>}
         */editShippingMethodButtonClicked:function(){var _ref150=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee147(){return regeneratorRuntime.wrap(function _callee147$(_context147){while(1){switch(_context147.prev=_context147.next){case 0:// handle the task in a separate event block
window.setTimeout(function(){// enable the shipping method dropdownlist
var shippingMethodDropdownList=$('#checkout-page #checkout-shipping-method-type').get(0).ej2_instances[0];shippingMethodDropdownList.enabled=true;shippingMethodDropdownList.dataBind();},0);case 1:case'end':return _context147.stop();}}},_callee147,this);}));function editShippingMethodButtonClicked(){return _ref150.apply(this,arguments);}return editShippingMethodButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the payment method is clicked
         *
         * @returns {Promise<void>}
         */editPaymentMethodButtonClicked:function(){var _ref151=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee148(){return regeneratorRuntime.wrap(function _callee148$(_context148){while(1){switch(_context148.prev=_context148.next){case 0:// handle the task in a separate event block
window.setTimeout(function(){// enable the payment method dropdownlist
var paymentMethodDropdownList=$('#checkout-page #checkout-payment-method-type').get(0).ej2_instances[0];paymentMethodDropdownList.enabled=true;paymentMethodDropdownList.dataBind();},0);case 1:case'end':return _context148.stop();}}},_callee148,this);}));function editPaymentMethodButtonClicked(){return _ref151.apply(this,arguments);}return editPaymentMethodButtonClicked;}(),/**
         * method is triggerd when  the "Apply" coupon button is clicked
         *
         * @returns {Promise<void>}
         */applyCouponButtonClicked:function(){var _ref152=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee149(){var toast,couponsArray,localOrderObject,_toast26;return regeneratorRuntime.wrap(function _callee149$(_context149){while(1){switch(_context149.prev=_context149.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context149.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to apply coupon';toast.dataBind();toast.show();return _context149.abrupt('return');case 10:_context149.prev=10;// show the page loader modal
$('#checkout-page .modal').css("display","table");// check if user has entered any  coupon code
if(!($('#checkout-page #checkout-payment-voucher-code').val().trim()==="")){_context149.next=14;break;}throw"error - no coupon code provided";case 14:_context149.next=16;return Promise.resolve($.ajax(// load the list of shipping zones
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{code:$('#checkout-page #checkout-payment-voucher-code').val().trim()}}));case 16:couponsArray=_context149.sent;if(!(couponsArray.length==0)){_context149.next=19;break;}throw"error - no coupon found";case 19:// get a local/deep-clone copy of the page's checkout order object
...
_context149.next=24;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 24:localOrderObject=_context149.sent;// update the page checkout order with the updated order from the server
...
_context149.next=29;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 29:_context149.next=42;break;case 31:_context149.prev=31;_context149.t0=_context149['catch'](10);// hide the page loader modal
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast26=$('.timed-page-toast').get(0).ej2_instances[0];_toast26.cssClass='error-ej2-toast';_toast26.timeOut=3000;_toast26.content='Coupon not applied. Invalid coupon code';_toast26.dataBind();_toast26.show();case 42:case'end':return _context149.stop();}}},_callee149,this,[[10,31]]);}));function applyCouponButtonClicked(){return _ref152.apply(this,arguments);}return applyCouponButtonClicked;}(),/**
         * method is triggerd when  the "Add" note button is clicked
         *
         * @returns {Promise<void>}
         */addNoteButtonClicked:function(){var _ref153=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee150(){var toast,localOrderObject,_toast27;return regeneratorRuntime.wrap(function _callee150$(_context150){while(1){switch(_context150.prev=_context150.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context150.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to add shipping notes to the order';toast.dataBind();toast.show();return _context150.abrupt('return');case 10:_context150.prev=10;// show page loader
...
_context150.next=17;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 17:localOrderObject=_context150.sent;// update the page checkout order with the updated order from the server
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder=localOrderObject;// clear the coupon code entered into the coupon/voucher input
...
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();return _context153.abrupt('return');case 14:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="paystack")){_context153.next=75;break;}// user selected the paystack (Pay With Card)
...
_context153.prev=18;_context153.next=21;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 21:userDetails=_context153.sent.userDetails;_context153.next=24;return Promise.resolve($.ajax({url:'https://api.paystack.co/transaction/initialize',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Bearer "+Base64.decode(utopiasoftware[utopiasoftware_app_namespace].paystackAccessor));},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({email:userDetails.email,amount:""+kendo.parseFloat(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.total)*100,callback_url:"https://shopoakexclusive.com/"})}));case 24:payStackResponse=_context153.sent;if(!(payStackResponse.status===true)){_context153.next=54;break;}_context153.next=28;return new Promise(function(resolve,reject){// create/open inapp browser
...
}});});case 28:transactionCompletedUrl=_context153.sent;// get the search parameters object from the transaction completed url
...
if(!(!completedTransactionReference||completedTransactionReference==="")){_context153.next=33;break;}throw"error";case 33:// inform the user that their order is being placed
...
localOrderObject.coupon_lines=localOrderObject.coupon_lines.map(function(couponElem){return{code:couponElem.code};});// update the checkout order data on the remote server
_context153.next=40;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 40:localOrderObject=_context153.sent;_context153.prev=41;_context153.next=44;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 44:_context153.next=48;break;case 46:_context153.prev=46;_context153.t0=_context153['catch'](41);case 48:// update the checkout-order-placement-modal with the checkout order number
...
$('#checkout-order-placement-modal #checkout-order-placement-modal-ok-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee151(){return regeneratorRuntime.wrap(function _callee151$(_context151){while(1){switch(_context151.prev=_context151.next){case 0:_context151.next=2;return $('ons-splitter').get(0).content.load("app-main-template");case 2:_context151.next=4;return $('#checkout-order-placement-modal').get(0).hide();case 4:case'end':return _context151.stop();}}},_callee151,this);}));// show the 'checkout-order-placement-modal'
_context153.next=52;return $('#checkout-order-placement-modal').get(0).show();case 52:_context153.next=55;break;case 54:throw"error";case 55:_context153.next=67;break;case 57:_context153.prev=57;_context153.t1=_context153['catch'](18);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast28=$('.timed-page-toast').get(0).ej2_instances[0];_toast28.cssClass='error-ej2-toast';_toast28.timeOut=3500;_toast28.content='Error making payment for this order. Try again';_toast28.dataBind();_toast28.show();case 67:_context153.prev=67;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
...
$('#loader-modal').get(0).hide();return _context153.finish(67);case 74:return _context153.abrupt('return');case 75:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="cod")){_context153.next=118;break;}// user selected the cod (Cash on Delivery)
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);// inform the user that their order is being placed
$('#loader-modal-message').html("Completing Order Placement...");_context153.next=80;return $('#loader-modal').get(0).show();case 80:_context153.prev=80;// get a local/deep-clone copy of the page's checkout order object
...
processData:false,data:JSON.stringify(_localOrderObject)}));case 86:_localOrderObject=_context153.sent;_context153.prev=87;_context153.next=90;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 90:_context153.next=94;break;case 92:_context153.prev=92;_context153.t2=_context153['catch'](87);case 94:// update the checkout-order-placement-modal with the checkout order number
...
_context153.next=98;return $('#checkout-order-placement-modal').get(0).show();case 98:_context153.next=110;break;case 100:_context153.prev=100;_context153.t3=_context153['catch'](80);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast29=$('.timed-page-toast').get(0).ej2_instances[0];_toast29.cssClass='error-ej2-toast';_toast29.timeOut=3500;_toast29.content='Error placing this order. Try again';_toast29.dataBind();_toast29.show();case 110:_context153.prev=110;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
$('#loader-modal').get(0).hide();return _context153.finish(110);case 117:return _context153.abrupt('return');case 118:case'end':return _context153.stop();}}},_callee153,this,[[18,57,67,74],[41,46],[80,100,110,117],[87,92]]);}));function makePaymentButtonClicked(){return _ref154.apply(this,arguments);}return makePaymentButtonClicked;}(),/**
         * method is used to load the current checkout/order data into the page
         * @returns {Promise<void>}
         */displayContent:function(){var _ref157=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee156(){var userDetails,orderData,shippingCountryCode,shippingZoneId,shippingCountry,shippingZone,shippingMethodsArray,shippingMethodDropDown,paymentMethodDropDown,couponsMultiSelectDropDown,couponsArray,orderItemsDisplayContent,index;return regeneratorRuntime.wrap(function _callee156$(_context156){while(1){switch(_context156.prev=_context156.next){case 0:_context156.prev=0;_context156.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context156.sent.userDetails;// check if the checkout order billing data should be updated with the current user's billing
...
_context156.next=22;return Promise.resolve($.ajax(// load the list of shipping zones
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 22:shippingMethodsArray=_context156.sent;// filter the shipping methods for only the methods that are enabled
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee154(){var toast,localOrderObject,remoteCartTotals,_toast30;return regeneratorRuntime.wrap(function _callee154$(_context154){while(1){switch(_context154.prev=_context154.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context154.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change shipping method';toast.dataBind();toast.show();return _context154.abrupt('return');case 10:// display the page loader modal
$('#checkout-page .modal').css("display","table");// get a local/deep-clone copy of the page's checkout order object
...
_context154.prev=15;_context154.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/oakscripts/setshipping.php',type:"post",//contentType: "application/json",
...
_context154.next=26;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 26:localOrderObject=_context154.sent;// update the page checkout order with the updated order from the server
...
_context154.next=32;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 32:_context154.next=46;break;case 34:_context154.prev=34;_context154.t0=_context154['catch'](15);_context154.t0=JSON.parse(_context154.t0.responseText.trim());// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast30=$('.timed-page-toast').get(0).ej2_instances[0];_toast30.cssClass='error-ej2-toast';_toast30.timeOut=3000;_toast30.content='Shipping method not updated, retry. '+(_context154.t0.message||"");_toast30.dataBind();_toast30.show();// hide the page loader modal
$('#checkout-page .modal').css("display","none");case 46:case'end':return _context154.stop();}}},_callee154,this,[[15,34]]);})),0);});// remove the "select" event listener for the shipping method dropdownlist
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change payment method';toast.dataBind();toast.show();return _context155.abrupt('return');case 10:// display the page loader modal
$('#checkout-page .modal').css("display","table");// get a local/deep-clone copy of the page's checkout order object
...
localOrderObject.coupon_lines=localOrderObject.coupon_lines.map(function(couponElem){return{code:couponElem.code};});// update the checkout order data on the remote server
_context155.prev=15;_context155.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 18:localOrderObject=_context155.sent;// update the page checkout order with the updated order from the server
...
_context155.next=24;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 24:_context155.next=38;break;case 26:_context155.prev=26;_context155.t0=_context155['catch'](15);_context155.t0=JSON.parse(_context155.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast31=$('.timed-page-toast').get(0).ej2_instances[0];_toast31.cssClass='error-ej2-toast';_toast31.timeOut=3000;_toast31.content='Payment method not updated, retry. '+(_context155.t0.message||"");_toast31.dataBind();_toast31.show();// hide the page loader modal
$('#checkout-page .modal').css("display","none");case 38:case'end':return _context155.stop();}}},_callee155,this,[[15,26]]);})),0);});// set the order coupons
...
$('#checkout-page .checkout-page-discount').css("display","none");}case 49:_context156.prev=49;return _context156.finish(49);case 51:case'end':return _context156.stop();}}},_callee156,this,[[0,,49,51]]);}));function displayContent(){return _ref157.apply(this,arguments);}return displayContent;}(),/**
...
_context157.prev=2;_context157.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 5:userDetails=_context157.sent.userDetails;if(!(!userDetails.first_name||userDetails.first_name=="")){_context157.next=8;break;}throw"validation error";case 8:// user validation was successful
...
tooltipIndex=$('#checkout-page .checkout-personal-details-accordion-item .utopiasoftware-checkout-failure').get(0)._utopiasoftware_validator_index;$('#checkout-page').get(0).ej2_instances[tooltipIndex].close();_context157.next=24;break;case 14:_context157.prev=14;_context157.t0=_context157['catch'](2);// user details could not be loaded, so user validation failed
...
if(!(validationSuccessful===true)){_context157.next=34;break;}// validation was successful
// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");resolve();// resolve validation promise
return _context157.abrupt('return');case 34:// validation failed
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);reject();// reject validation promise
return _context157.abrupt('return');case 37:case'end':return _context157.stop();}}},_callee157,this,[[2,14]]);}));return function(_x53,_x54){return _ref161.apply(this,arguments);};}()));case 2:case'end':return _context158.stop();}}},_callee158,this);}));function validateOrderCheckout(){return _ref160.apply(this,arguments);}return validateOrderCheckout;}(),/**
...
index=0;case 8:if(!(index<orderData.line_items.length)){_context159.next=40;break;}cartItemData={};// use the line item meta data to create part of cartItemData
_iteratorNormalCompletion2=true;_didIteratorError2=false;_iteratorError2=undefined;_context159.prev=13;for(_iterator2=orderData.line_items[index].meta_data[Symbol.iterator]();!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){metaDataElem=_step2.value;if(metaDataElem.key==="_fpd_data"){// check the "key" property of the metaData object
...
_context159.next=21;break;case 17:_context159.prev=17;_context159.t0=_context159['catch'](13);_didIteratorError2=true;_iteratorError2=_context159.t0;case 21:_context159.prev=21;_context159.prev=22;if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}case 24:_context159.prev=24;if(!_didIteratorError2){_context159.next=27;break;}throw _iteratorError2;case 27:return _context159.finish(24);case 28:return _context159.finish(21);case 29:cartItemData.product_id=orderData.line_items[index].product_id;cartItemData.variation_id=orderData.line_items[index].variation_id;cartItemData.quantity=orderData.line_items[index].quantity;// add the created cartItemData to remote user cart
_context159.t1=addToCartPromises;_context159.next=35;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v2/cart/add',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));},crossDomain:true,xhrFields:{withCredentials:true},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(cartItemData)}));case 35:_context159.t2=_context159.sent;_context159.t1.push.call(_context159.t1,_context159.t2);case 37:index++;_context159.next=8;break;case 40:_context159.next=42;return Promise.all(addToCartPromises);case 42:resolve();// resolve the parent promise
case 43:_context159.prev=43;return _context159.finish(43);case 45:case'end':return _context159.stop();}}},_callee159,this,[[0,,43,45],[13,17,21,29],[22,,24,28]]);}));return function(_x56,_x57){return _ref163.apply(this,arguments);};}()));case 1:case'end':return _context160.stop();}}},_callee160,this);}));function createRemoteCartFromOrder(){return _ref162.apply(this,arguments);}return createRemoteCartFromOrder;}()},/**
     ...
     */trackOrderPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref164=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee162(){var searchAutoComplete;return regeneratorRuntime.wrap(function _callee162$(_context162){while(1){switch(_context162.prev=_context162.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context162.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context162.abrupt('return');case 3:// listen for the back button event
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee161(){var searchResultsArray,userDetails,toast,_toast32;return regeneratorRuntime.wrap(function _callee161$(_context161){while(1){switch(_context161.prev=_context161.next){case 0:searchResultsArray=[];_context161.prev=1;// hide the previously displayed orders info
...
_context161.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context161.sent.userDetails;_context161.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"search":searchValue});case 9:searchResultsArray=_context161.sent;_context161.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
...
$('#track-order-page .modal').css("display","none");}_context161.next=28;break;case 15:_context161.prev=15;_context161.t0=_context161['catch'](1);// hide the previously displayed orders info
$('#track-order-page .row').css("display","none");// show the page loader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast32=$('.timed-page-toast').get(0).ej2_instances[0];_toast32.cssClass='error-ej2-toast';_toast32.timeOut=3000;_toast32.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast32.dataBind();_toast32.show();case 28:case'end':return _context161.stop();}}},_callee161,this,[[1,15]]);})),0);}}).appendTo('#track-order-page-input');}catch(err){}case 5:case'end':return _context162.stop();}}},_callee162,this);}));return function loadPageOnAppReady(){return _ref164.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref166=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee163(){return regeneratorRuntime.wrap(function _callee163$(_context163){while(1){switch(_context163.prev=_context163.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context163.stop();}}},_callee163,this);}));function pageHide(){return _ref166.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// destroy the search input autocomplete component
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param keyEvent
         * @returns {Promise<void>}
         */enterButtonClicked:function(){var _ref167=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee164(keyEvent){var searchAutoComplete;return regeneratorRuntime.wrap(function _callee164$(_context164){while(1){switch(_context164.prev=_context164.next){case 0:// check which key was pressed
if(keyEvent.which===kendo.keys.ENTER)// if the enter key was pressed
{// prevent the default action from occurring
keyEvent.preventDefault();keyEvent.stopImmediatePropagation();keyEvent.stopPropagation();// hide the device keyboard
Keyboard.hide();// get the search autocomplete component
...
searchAutoComplete.dataBind();// bind new value to the component
searchAutoComplete.change();// trigger the change method
}case 1:case'end':return _context164.stop();}}},_callee164,this);}));function enterButtonClicked(_x58){return _ref167.apply(this,arguments);}return enterButtonClicked;}(),/**
...
promisesArray.push(Promise.reject("no internet connection"));}return _context165.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context165.stop();}}},_callee165,this);}));function loadOrders(_x61){return _ref168.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref169=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee166(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee166$(_context166){while(1){switch(_context166.prev=_context166.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
...
$('#track-order-page #track-order-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context166.abrupt('return',displayCompletedPromise);case 2:case'end':return _context166.stop();}}},_callee166,this);}));function displayPageContent(_x62){return _ref169.apply(this,arguments);}return displayPageContent;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref170=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee168(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee168$(_context168){while(1){switch(_context168.prev=_context168.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee167(){var selectedOrder,pagesStackArray,indexOfCheckoutPage,toast;return regeneratorRuntime.wrap(function _callee167$(_context167){while(1){switch(_context167.prev=_context167.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context167.prev=1;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context167.next=7;break;}_context167.next=7;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 7:_context167.next=9;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 9:_context167.next=21;break;case 11:_context167.prev=11;_context167.t0=_context167['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 21:_context167.prev=21;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context167.finish(21);case 24:case'end':return _context167.stop();}}},_callee167,this,[[1,11,21,24]]);})),0);case 3:case'end':return _context168.stop();}}},_callee168,this);}));function checkoutButtonClicked(_x63){return _ref170.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */detailsButtonClicked:function(){var _ref172=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee170(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee170$(_context170){while(1){switch(_context170.prev=_context170.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee169(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee169$(_context169){while(1){switch(_context169.prev=_context169.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context169.prev=1;_context169.next=4;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 4:_context169.next=16;break;case 6:_context169.prev=6;_context169.t0=_context169['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 16:_context169.prev=16;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context169.finish(16);case 19:case'end':return _context169.stop();}}},_callee169,this,[[1,6,16,19]]);})),0);case 3:case'end':return _context170.stop();}}},_callee170,this);}));function detailsButtonClicked(_x64){return _ref172.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref174=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee173(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee173$(_context173){while(1){switch(_context173.prev=_context173.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context173.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context173.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee171(){return regeneratorRuntime.wrap(function _callee171$(_context171){while(1){switch(_context171.prev=_context171.next){case 0:_context171.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context171.stop();}}},_callee171,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee172(){var selectedOrder,userDetails,searchResultsArray,_toast33,_toast34;return regeneratorRuntime.wrap(function _callee172$(_context172){while(1){switch(_context172.prev=_context172.next){case 0:// display the page loader
$('#track-order-page .modal').css("display","table");_context172.prev=1;_context172.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
_context172.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+selectedOrder.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context172.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context172.sent.userDetails;_context172.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"search":$('#track-order-page #track-order-page-input').get(0).ej2_instances[0].value||""});case 13:searchResultsArray=_context172.sent;_context172.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast33=$('.timed-page-toast').get(0).ej2_instances[0];_toast33.cssClass='default-ej2-toast';_toast33.timeOut=2000;_toast33.content='Order #'+selectedOrder.id+' has been cancelled';_toast33.dataBind();_toast33.show();_context172.next=36;break;case 26:_context172.prev=26;_context172.t0=_context172['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast34=$('.timed-page-toast').get(0).ej2_instances[0];_toast34.cssClass='error-ej2-toast';_toast34.timeOut=3500;_toast34.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast34.dataBind();_toast34.show();case 36:_context172.prev=36;// display the page loader
$('#track-order-page .modal').css("display","none");return _context172.finish(36);case 39:case'end':return _context172.stop();}}},_callee172,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context173.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context173.stop();}}},_callee173,this);}));function cancelButtonClicked(_x65){return _ref174.apply(this,arguments);}return cancelButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref177=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee175(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee175$(_context175){while(1){switch(_context175.prev=_context175.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context175.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context175.abrupt('return');case 11:// show the page loader
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee174(){var selectedOrder,newOrder,_toast35;return regeneratorRuntime.wrap(function _callee174$(_context174){while(1){switch(_context174.prev=_context174.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context174.prev=1;// create a new order object
...
_context174.next=16;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 16:newOrder=_context174.sent;_context174.next=19;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 19:_context174.next=31;break;case 21:_context174.prev=21;_context174.t0=_context174['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast35=$('.timed-page-toast').get(0).ej2_instances[0];_toast35.cssClass='error-ej2-toast';_toast35.timeOut=3000;_toast35.content='Placing new order failed. Please retry';_toast35.dataBind();_toast35.show();case 31:_context174.prev=31;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context174.finish(31);case 34:case'end':return _context174.stop();}}},_callee174,this,[[1,21,31,34]]);})),0);case 13:case'end':return _context175.stop();}}},_callee175,this);}));function reorderButtonClicked(_x66){return _ref177.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */completedOrdersPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref179=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee176(){var userDetails,searchResultsArray,toast,_toast36;return regeneratorRuntime.wrap(function _callee176$(_context176){while(1){switch(_context176.prev=_context176.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context176.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context176.abrupt('return');case 3:// listen for the back button event
...
$('#completed-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context176.prev=6;// hide the previously displayed orders info
...
_context176.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context176.sent.userDetails;_context176.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 14:searchResultsArray=_context176.sent;_context176.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref180=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee177(){return regeneratorRuntime.wrap(function _callee177$(_context177){while(1){switch(_context177.prev=_context177.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context177.stop();}}},_callee177,this);}));function pageHide(){return _ref180.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref181=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee178(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast37;return regeneratorRuntime.wrap(function _callee178$(_context178){while(1){switch(_context178.prev=_context178.next){case 0:// disable pull-to-refresh widget till loading is done
$('#completed-orders-page #completed-orders-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context178.prev=2;// show the page loader
$('#completed-orders-page .modal').css("display","table");// load the user profile details from the app database
_context178.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context178.sent.userDetails;_context178.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 9:searchResultsArray=_context178.sent;_context178.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#completed-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#completed-orders-page .row').css("display","none");// hide the page loader
$('#completed-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
doneCallBack();return _context178.finish(27);case 32:case'end':return _context178.stop();}}},_callee178,this,[[2,15,27,32]]);}));function pagePullHookAction(){return _ref181.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to load orders to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
         ...
         *
         * @returns {Promise<void>}
         */loadOrders:function(){var _ref182=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee179(queryParam){var pageToAccess=arguments.length>1&&arguments[1]!==undefined?arguments[1]:queryParam.page||1;var pageSize=arguments.length>2&&arguments[2]!==undefined?arguments[2]:queryParam.per_page||20;var promisesArray;return regeneratorRuntime.wrap(function _callee179$(_context179){while(1){switch(_context179.prev=_context179.next){case 0:queryParam.page=pageToAccess;queryParam.per_page=pageSize;promisesArray=[];// holds the array for the promises used to load the orders
// check if there is internet connection or not
if(navigator.connection.type!==Connection.NONE){// there is internet connection
// load the requested products list from the server
promisesArray.push(new Promise(function(resolve,reject){Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"get",//contentType: "application/x-www-form-urlencoded",
...
promisesArray.push(Promise.reject("no internet connection"));}return _context179.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context179.stop();}}},_callee179,this);}));function loadOrders(_x70){return _ref182.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref183=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee180(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee180$(_context180){while(1){switch(_context180.prev=_context180.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
// check if the ordersArray is empty or not
if(ordersArray.length<=0){// there are no new content to display
resolve(ordersArray.length);// resolve promise with the length of the orders array
}else{// there are some orders to display
...
$('#completed-orders-page #completed-orders-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context180.abrupt('return',displayCompletedPromise);case 2:case'end':return _context180.stop();}}},_callee180,this);}));function displayPageContent(_x71){return _ref183.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref184=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee182(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee182$(_context182){while(1){switch(_context182.prev=_context182.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee181(){var selectedOrder,pagesStackArray,indexOfCheckoutPage,toast;return regeneratorRuntime.wrap(function _callee181$(_context181){while(1){switch(_context181.prev=_context181.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context181.prev=1;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context181.next=7;break;}_context181.next=7;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 7:_context181.next=9;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 9:_context181.next=21;break;case 11:_context181.prev=11;_context181.t0=_context181['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 21:_context181.prev=21;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context181.finish(21);case 24:case'end':return _context181.stop();}}},_callee181,this,[[1,11,21,24]]);})),0);case 3:case'end':return _context182.stop();}}},_callee182,this);}));function checkoutButtonClicked(_x72){return _ref184.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */detailsButtonClicked:function(){var _ref186=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee184(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee184$(_context184){while(1){switch(_context184.prev=_context184.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee183(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee183$(_context183){while(1){switch(_context183.prev=_context183.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context183.prev=1;_context183.next=4;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 4:_context183.next=16;break;case 6:_context183.prev=6;_context183.t0=_context183['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 16:_context183.prev=16;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context183.finish(16);case 19:case'end':return _context183.stop();}}},_callee183,this,[[1,6,16,19]]);})),0);case 3:case'end':return _context184.stop();}}},_callee184,this);}));function detailsButtonClicked(_x73){return _ref186.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref188=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee187(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee187$(_context187){while(1){switch(_context187.prev=_context187.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context187.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context187.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee185(){return regeneratorRuntime.wrap(function _callee185$(_context185){while(1){switch(_context185.prev=_context185.next){case 0:_context185.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context185.stop();}}},_callee185,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee186(){var selectedOrder,userDetails,searchResultsArray,_toast38,_toast39;return regeneratorRuntime.wrap(function _callee186$(_context186){while(1){switch(_context186.prev=_context186.next){case 0:// display the page loader
$('#completed-orders-page .modal').css("display","table");_context186.prev=1;_context186.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
selectedOrder.status="cancelled";// update the selectedOrder status remotely
_context186.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+selectedOrder.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context186.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context186.sent.userDetails;_context186.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 13:searchResultsArray=_context186.sent;_context186.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast38=$('.timed-page-toast').get(0).ej2_instances[0];_toast38.cssClass='default-ej2-toast';_toast38.timeOut=2000;_toast38.content='Order #'+selectedOrder.id+' has been cancelled';_toast38.dataBind();_toast38.show();_context186.next=36;break;case 26:_context186.prev=26;_context186.t0=_context186['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast39=$('.timed-page-toast').get(0).ej2_instances[0];_toast39.cssClass='error-ej2-toast';_toast39.timeOut=3500;_toast39.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast39.dataBind();_toast39.show();case 36:_context186.prev=36;// display the page loader
$('#completed-orders-page .modal').css("display","none");return _context186.finish(36);case 39:case'end':return _context186.stop();}}},_callee186,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context187.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context187.stop();}}},_callee187,this);}));function cancelButtonClicked(_x74){return _ref188.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref191=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee189(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee189$(_context189){while(1){switch(_context189.prev=_context189.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context189.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context189.abrupt('return');case 11:// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee188(){var selectedOrder,newOrder,_toast40;return regeneratorRuntime.wrap(function _callee188$(_context188){while(1){switch(_context188.prev=_context188.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context188.prev=1;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context188.next=16;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 16:newOrder=_context188.sent;_context188.next=19;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 19:_context188.next=31;break;case 21:_context188.prev=21;_context188.t0=_context188['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast40=$('.timed-page-toast').get(0).ej2_instances[0];_toast40.cssClass='error-ej2-toast';_toast40.timeOut=3000;_toast40.content='Placing new order failed. Please retry';_toast40.dataBind();_toast40.show();case 31:_context188.prev=31;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context188.finish(31);case 34:case'end':return _context188.stop();}}},_callee188,this,[[1,21,31,34]]);})),0);case 13:case'end':return _context189.stop();}}},_callee189,this);}));function reorderButtonClicked(_x75){return _ref191.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */pendingOrdersPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref193=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee190(){var userDetails,searchResultsArray,toast,_toast41;return regeneratorRuntime.wrap(function _callee190$(_context190){while(1){switch(_context190.prev=_context190.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context190.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context190.abrupt('return');case 3:// listen for the back button event
...
$('#pending-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context190.prev=6;// hide the previously displayed orders info
...
_context190.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context190.sent.userDetails;_context190.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 14:searchResultsArray=_context190.sent;_context190.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref194=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee191(){return regeneratorRuntime.wrap(function _callee191$(_context191){while(1){switch(_context191.prev=_context191.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context191.stop();}}},_callee191,this);}));function pageHide(){return _ref194.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// reset the view-model properties
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref195=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee192(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast42;return regeneratorRuntime.wrap(function _callee192$(_context192){while(1){switch(_context192.prev=_context192.next){case 0:// disable pull-to-refresh widget till loading is done
$('#pending-orders-page #pending-orders-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context192.prev=2;// show the page loader
$('#pending-orders-page .modal').css("display","table");// load the user profile details from the app database
_context192.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context192.sent.userDetails;_context192.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 9:searchResultsArray=_context192.sent;_context192.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#pending-orders-page .row').css("display","none");// hide the page loader
$('#pending-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
doneCallBack();return _context192.finish(27);case 32:case'end':return _context192.stop();}}},_callee192,this,[[2,15,27,32]]);}));function pagePullHookAction(){return _ref195.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to load orders to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
         ...
         *
         * @returns {Promise<void>}
         */loadOrders:function(){var _ref196=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee193(queryParam){var pageToAccess=arguments.length>1&&arguments[1]!==undefined?arguments[1]:queryParam.page||1;var pageSize=arguments.length>2&&arguments[2]!==undefined?arguments[2]:queryParam.per_page||20;var promisesArray;return regeneratorRuntime.wrap(function _callee193$(_context193){while(1){switch(_context193.prev=_context193.next){case 0:queryParam.page=pageToAccess;queryParam.per_page=pageSize;promisesArray=[];// holds the array for the promises used to load the orders
// check if there is internet connection or not
if(navigator.connection.type!==Connection.NONE){// there is internet connection
// load the requested products list from the server
promisesArray.push(new Promise(function(resolve,reject){Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"get",//contentType: "application/x-www-form-urlencoded",
...
promisesArray.push(Promise.reject("no internet connection"));}return _context193.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context193.stop();}}},_callee193,this);}));function loadOrders(_x79){return _ref196.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref197=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee194(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee194$(_context194){while(1){switch(_context194.prev=_context194.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
// check if the ordersArray is empty or not
if(ordersArray.length<=0){// there are no new content to display
resolve(ordersArray.length);// resolve promise with the length of the orders array
}else{// there are some orders to display
...
$('#pending-orders-page #pending-orders-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context194.abrupt('return',displayCompletedPromise);case 2:case'end':return _context194.stop();}}},_callee194,this);}));function displayPageContent(_x80){return _ref197.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref198=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee196(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee196$(_context196){while(1){switch(_context196.prev=_context196.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee195(){var selectedOrder,pagesStackArray,indexOfCheckoutPage,toast;return regeneratorRuntime.wrap(function _callee195$(_context195){while(1){switch(_context195.prev=_context195.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context195.prev=1;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context195.next=7;break;}_context195.next=7;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 7:_context195.next=9;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 9:_context195.next=21;break;case 11:_context195.prev=11;_context195.t0=_context195['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 21:_context195.prev=21;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context195.finish(21);case 24:case'end':return _context195.stop();}}},_callee195,this,[[1,11,21,24]]);})),0);case 3:case'end':return _context196.stop();}}},_callee196,this);}));function checkoutButtonClicked(_x81){return _ref198.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */detailsButtonClicked:function(){var _ref200=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee198(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee198$(_context198){while(1){switch(_context198.prev=_context198.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee197(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee197$(_context197){while(1){switch(_context197.prev=_context197.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context197.prev=1;_context197.next=4;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 4:_context197.next=16;break;case 6:_context197.prev=6;_context197.t0=_context197['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 16:_context197.prev=16;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context197.finish(16);case 19:case'end':return _context197.stop();}}},_callee197,this,[[1,6,16,19]]);})),0);case 3:case'end':return _context198.stop();}}},_callee198,this);}));function detailsButtonClicked(_x82){return _ref200.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref202=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee201(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee201$(_context201){while(1){switch(_context201.prev=_context201.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context201.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context201.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee199(){return regeneratorRuntime.wrap(function _callee199$(_context199){while(1){switch(_context199.prev=_context199.next){case 0:_context199.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context199.stop();}}},_callee199,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee200(){var selectedOrder,userDetails,searchResultsArray,_toast43,_toast44;return regeneratorRuntime.wrap(function _callee200$(_context200){while(1){switch(_context200.prev=_context200.next){case 0:// display the page loader
$('#pending-orders-page .modal').css("display","table");_context200.prev=1;_context200.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
selectedOrder.status="cancelled";// update the selectedOrder status remotely
_context200.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+selectedOrder.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context200.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context200.sent.userDetails;_context200.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 13:searchResultsArray=_context200.sent;_context200.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast43=$('.timed-page-toast').get(0).ej2_instances[0];_toast43.cssClass='default-ej2-toast';_toast43.timeOut=2000;_toast43.content='Order #'+selectedOrder.id+' has been cancelled';_toast43.dataBind();_toast43.show();_context200.next=36;break;case 26:_context200.prev=26;_context200.t0=_context200['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast44=$('.timed-page-toast').get(0).ej2_instances[0];_toast44.cssClass='error-ej2-toast';_toast44.timeOut=3500;_toast44.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast44.dataBind();_toast44.show();case 36:_context200.prev=36;// display the page loader
$('#pending-orders-page .modal').css("display","none");return _context200.finish(36);case 39:case'end':return _context200.stop();}}},_callee200,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context201.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context201.stop();}}},_callee201,this);}));function cancelButtonClicked(_x83){return _ref202.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref205=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee203(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee203$(_context203){while(1){switch(_context203.prev=_context203.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context203.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context203.abrupt('return');case 11:// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee202(){var selectedOrder,newOrder,_toast45;return regeneratorRuntime.wrap(function _callee202$(_context202){while(1){switch(_context202.prev=_context202.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];_context202.prev=1;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context202.next=16;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 16:newOrder=_context202.sent;_context202.next=19;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 19:_context202.next=31;break;case 21:_context202.prev=21;_context202.t0=_context202['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast45=$('.timed-page-toast').get(0).ej2_instances[0];_toast45.cssClass='error-ej2-toast';_toast45.timeOut=3000;_toast45.content='Placing new order failed. Please retry';_toast45.dataBind();_toast45.show();case 31:_context202.prev=31;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context202.finish(31);case 34:case'end':return _context202.stop();}}},_callee202,this,[[1,21,31,34]]);})),0);case 13:case'end':return _context203.stop();}}},_callee203,this);}));function reorderButtonClicked(_x84){return _ref205.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */orderDetailsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref207=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee204(){var promisesArray,orderId,toast;return regeneratorRuntime.wrap(function _callee204$(_context204){while(1){switch(_context204.prev=_context204.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context204.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context204.abrupt('return');case 3:// listen for the back button event
...
utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails=$('#app-main-navigator').get(0).topPage.data.orderData;_context204.prev=7;// create the "Reorder" button
new ej.splitbuttons.ProgressButton({cssClass:'e-hide-spinner',duration:10*60*60*1000// set spinner/progress duration for 10 hr
...
_context204.next=14;return Promise.all(promisesArray);case 14:promisesArray=_context204.sent;// get the order notes belonging to the specified order object
...
_context204.next=18;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 18:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context204.next=29;break;case 21:_context204.prev=21;_context204.t0=_context204['catch'](7);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 29:_context204.prev=29;// hide page preloader
$('#order-details-page .page-preloader').css("display","none");// hide page modal loader
$('#order-details-page .modal').css("display","none");return _context204.finish(29);case 33:case'end':return _context204.stop();}}},_callee204,this,[[7,21,29,33]]);}));return function loadPageOnAppReady(){return _ref207.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function(){var _ref208=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee205(){return regeneratorRuntime.wrap(function _callee205$(_context205){while(1){switch(_context205.prev=_context205.next){case 0:window.SoftInputMode.set('adjustPan');// adjust device input mode
// update cart count
$('#order-details-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);case 2:case'end':return _context205.stop();}}},_callee205,this);}));function pageShow(){return _ref208.apply(this,arguments);}return pageShow;}(),/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref209=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee206(){return regeneratorRuntime.wrap(function _callee206$(_context206){while(1){switch(_context206.prev=_context206.next){case 0:case'end':return _context206.stop();}}},_callee206,this);}));function pageHide(){return _ref209.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{"type":"any"}})));// wait for all promises to resolve
_context207.next=8;return Promise.all(promisesArray);case 8:promisesArray=_context207.sent;// get the order notes belonging to the specified order object
utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderNotesArray=promisesArray[0];// display the order details
_context207.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 12:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context207.next=25;break;case 15:_context207.prev=15;_context207.t0=_context207['catch'](2);// hide the page preloader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 25:_context207.prev=25;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context207.finish(25);case 30:case'end':return _context207.stop();}}},_callee207,this,[[2,15,25,30]]);}));function pagePullHookAction(){return _ref210.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is triggered when the user clicks the "Reorder" button
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref211=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee209(){var toast;return regeneratorRuntime.wrap(function _callee209$(_context209){while(1){switch(_context209.prev=_context209.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context209.next=14;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].dataBind();$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].stop();return _context209.abrupt('return');case 14:// show the page loader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee208(){var selectedOrder,newOrder,_toast46;return regeneratorRuntime.wrap(function _callee208$(_context208){while(1){switch(_context208.prev=_context208.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails;_context208.prev=1;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context208.next=16;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 16:newOrder=_context208.sent;// hide the page loader
...
_context208.next=24;return $('#app-main-navigator').get(0).replacePage("checkout-page.html",{data:{orderData:newOrder}});case 24:_context208.next=41;break;case 26:_context208.prev=26;_context208.t0=_context208['catch'](1);// hide the page loader
$('#order-details-page .modal').css("display","none");// disable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled",true);// add the spinner from the 'Reorder'
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast46=$('.timed-page-toast').get(0).ej2_instances[0];_toast46.cssClass='error-ej2-toast';_toast46.timeOut=3000;_toast46.content='Placing new order failed. Please retry';_toast46.dataBind();_toast46.show();case 41:_context208.prev=41;return _context208.finish(41);case 43:case'end':return _context208.stop();}}},_callee208,this,[[1,26,41,43]]);})),0);case 20:case'end':return _context209.stop();}}},_callee209,this);}));function reorderButtonClicked(){return _ref211.apply(this,arguments);}return reorderButtonClicked;}(),/**
         * method is used to load the order details data into the page
         * @returns {Promise<void>}
         */displayContent:function(){var _ref213=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee210(){var orderData,_displayContent,index,orderNote,_index;return regeneratorRuntime.wrap(function _callee210$(_context210){while(1){switch(_context210.prev=_context210.next){case 0:try{// get the order object set on this page
