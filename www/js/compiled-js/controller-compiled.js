...
jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(thirdPartyUserDetails.pseudoAdditionalUserInfo.providerId+thirdPartyUserDetails.pseudoUser.uid+"@shopoakexclusive.com"+':'+thirdPartyUserDetails.pseudoUser.uid));}},crossDomain:true,xhrFields:{withCredentials:true},dataType:"text",timeout:240000,// wait for 4 minutes before timeout of request
