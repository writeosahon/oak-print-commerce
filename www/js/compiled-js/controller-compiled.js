...
_context191.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 16:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context191.next=27;break;case 19:_context191.prev=19;_context191.t0=_context191['catch'](5);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 27:_context191.prev=27;// hide page preloader
$('#order-details-page .page-preloader').css("display","none");// hide page modal loader
$('#order-details-page .modal').css("display","none");return _context191.finish(27);case 31:case'end':return _context191.stop();}}},_callee191,this,[[5,19,27,31]]);}));return function loadPageOnAppReady(){return _ref194.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
$('#loader-modal').get(0).hide();return _context196.finish(110);case 117:return _context196.abrupt('return');case 118:case'end':return _context196.stop();}}},_callee196,this,[[18,55,66,73],[39,44],[79,99,110,117],[86,91]]);}));function reorderButtonClicked(){return _ref197.apply(this,arguments);}return reorderButtonClicked;}(),/**
         ...
         * @returns {Promise<void>}
         */displayContent:function(){var _ref200=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee197(){var orderData,_displayContent,index,orderNote,_index;return regeneratorRuntime.wrap(function _callee197$(_context197){while(1){switch(_context197.prev=_context197.next){case 0:try{// get the order object set on this page
...
_displayContent+='<div class="col-xs-12" style="text-align: left; padding-right: 5px;\n                            padding-top: 10px; padding-bottom: 10px">'+orderData.shipping.postcode+'</div>';}_displayContent+='<div class="col-xs-12" style="text-align: left; padding-right: 5px;\n                            padding-top: 10px; padding-bottom: 10px">'+orderData.shipping.country+'</div>';$('#order-details-page #order-details-list .order-details-shipping-details').html(_displayContent);}finally{}case 1:case'end':return _context197.stop();}}},_callee197,this);}));function displayContent(){return _ref200.apply(this,arguments);}return displayContent;}()}};
