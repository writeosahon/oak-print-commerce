...
_context157.next=26;break;case 22:_context157.prev=22;_context157.t0=_context157['catch'](18);_didIteratorError2=true;_iteratorError2=_context157.t0;case 26:_context157.prev=26;_context157.prev=27;if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}case 29:_context157.prev=29;if(!_didIteratorError2){_context157.next=32;break;}throw _iteratorError2;case 32:return _context157.finish(29);case 33:return _context157.finish(26);case 34:cartItemData.product_id=orderData.line_items[index].product_id;cartItemData.variation_id=orderData.line_items[index].variation_id;cartItemData.quantity=orderData.line_items[index].quantity;console.log("7");// add the created cartItemData to remote user cart
_context157.t1=addToCartPromises;_context157.next=41;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v2/cart/add',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){if(userDetails.password){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));}else{// use the pseudo (3rd party) user account details
jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(thirdPartyUserDetails.pseudoUser.providerId+thirdPartyUserDetails.pseudoUser.uid+"@shopoakexclusive.com"+':'+thirdPartyUserDetails.pseudoUser.uid));}},crossDomain:true,xhrFields:{withCredentials:true},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(cartItemData)}));case 41:_context157.t2=_context157.sent;_context157.t1.push.call(_context157.t1,_context157.t2);console.log("8");case 44:index++;_context157.next=12;break;case 47:_context157.next=49;return Promise.all(addToCartPromises);case 49:resolve();// resolve the parent promise
case 50:_context157.prev=50;return _context157.finish(50);case 52:case'end':return _context157.stop();}}},_callee157,this,[[0,,50,52],[18,22,26,34],[27,,29,33]]);}));return function(_x56,_x57){return _ref161.apply(this,arguments);};}()));case 1:case'end':return _context158.stop();}}},_callee158,this);}));function createRemoteCartFromOrder(){return _ref160.apply(this,arguments);}return createRemoteCartFromOrder;}()},/**
