...
processData:false,data:JSON.stringify(newOrder)}));case 16:newOrder=_context197.sent;// hide the page loader
...
_context197.next=24;return $('#app-main-navigator').get(0).replacePage("checkout-page.html",{data:{orderData:newOrder}});case 24:_context197.next=42;break;case 26:_context197.prev=26;_context197.t0=_context197['catch'](1);console.log(_context197.t0,"REORDER ERROR");// hide the page loader
$('#order-details-page .modal').css("display","none");// disable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled",true);// add the spinner from the 'Reorder'
