...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{email:authResult.user.email}}));case 10:resultArray=_context55.sent;if(!(resultArray.length==0)){_context55.next=13;break;}throw"error";case 13:// generate the user's name random password
randomlyGeneratedPassword=Random.uuid4(utopiasoftware[utopiasoftware_app_namespace].randomisationEngine);// reset the user's password using randomly generated uuid
_context55.next=16;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/customers/'+resultArray[0].id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({password:randomlyGeneratedPassword})}));case 16:resultArray[0]=_context55.sent;resultArray[0].password=randomlyGeneratedPassword;// save the created user details data to ENCRYPTED app database as cached data
_context55.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:_context55.next=22;return $('#loader-modal').get(0).hide();case 22:_context55.next=24;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 24:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast=$('.timed-page-toast').get(0).ej2_instances[0];_toast.cssClass='success-ej2-toast';_toast.timeOut=3000;_toast.content='User signin completed';_toast.dataBind();_toast.show();_context55.next=47;break;case 34:_context55.prev=34;_context55.t0=_context55['catch'](4);console.log("SIGN IN ERROR",_context55.t0);// hide loader
_context55.next=39;return $('#loader-modal').get(0).hide();case 39:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast2=$('.timed-page-toast').get(0).ej2_instances[0];_toast2.cssClass='error-ej2-toast';_toast2.timeOut=3500;_toast2.content='User does not have an account. User signin failed ';_toast2.dataBind();_toast2.show();case 47:if(loginMode==="sign up"){}return _context55.abrupt('return',false);case 49:case'end':return _context55.stop();}}},_callee55,this,[[4,34]]);}));function signInSuccessWithAuthResult(_x24){return _ref56.apply(this,arguments);}return signInSuccessWithAuthResult;}()}});// disable firebase ui auto-signin
