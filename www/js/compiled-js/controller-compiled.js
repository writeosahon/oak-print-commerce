...
toast.content='A serious error occurred. Please resign into your account';}else{toast.content='Error preparing checkout. Please retry';}toast.dataBind();toast.show();case 41:_context139.prev=41;// hide page preloader
...
_context152.next=52;return $('#checkout-order-placement-modal').get(0).show();case 52:_context152.next=55;break;case 54:throw"error";case 55:_context152.next=68;break;case 57:_context152.prev=57;_context152.t1=_context152['catch'](18);console.log("PAYMENT ERROR",_context152.t1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast28=$('.timed-page-toast').get(0).ej2_instances[0];_toast28.cssClass='error-ej2-toast';_toast28.timeOut=3500;_toast28.content='Error making payment for this order. Try again';_toast28.dataBind();_toast28.show();case 68:_context152.prev=68;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
...
$('#loader-modal').get(0).hide();return _context152.finish(68);case 75:return _context152.abrupt('return');case 76:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="cod")){_context152.next=120;break;}// user selected the cod (Cash on Delivery)
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);// inform the user that their order is being placed
$('#loader-modal-message').html("Completing Order Placement...");_context152.next=81;return $('#loader-modal').get(0).show();case 81:_context152.prev=81;// get a local/deep-clone copy of the page's checkout order object
...
_context152.next=87;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+_localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(_localOrderObject)}));case 87:_localOrderObject=_context152.sent;_context152.prev=88;_context152.next=91;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 91:_context152.next=95;break;case 93:_context152.prev=93;_context152.t2=_context152['catch'](88);case 95:// update the checkout-order-placement-modal with the checkout order number
...
_context152.next=99;return $('#checkout-order-placement-modal').get(0).show();case 99:_context152.next=112;break;case 101:_context152.prev=101;_context152.t3=_context152['catch'](81);console.log("PAYMENT ERROR",_context152.t3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast29=$('.timed-page-toast').get(0).ej2_instances[0];_toast29.cssClass='error-ej2-toast';_toast29.timeOut=3500;_toast29.content='Error placing this order. Try again';_toast29.dataBind();_toast29.show();case 112:_context152.prev=112;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
$('#loader-modal').get(0).hide();return _context152.finish(112);case 119:return _context152.abrupt('return');case 120:case'end':return _context152.stop();}}},_callee152,this,[[18,57,68,75],[41,46],[81,101,112,119],[88,93]]);}));function makePaymentButtonClicked(){return _ref153.apply(this,arguments);}return makePaymentButtonClicked;}(),/**
...
_context155.next=23;return Promise.resolve($.ajax(// load the list of shipping zones
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 23:shippingMethodsArray=_context155.sent;// filter the shipping methods for only the methods that are enabled
...
_context153.next=32;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 32:_context153.next=47;break;case 34:_context153.prev=34;_context153.t0=_context153['catch'](15);console.log("CHECKOUT SHIPPING METHOD UPDATE ERROR",_context153.t0);_context153.t0=JSON.parse(_context153.t0.responseText.trim());// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
...
$('#checkout-page .modal').css("display","none");case 47:case'end':return _context153.stop();}}},_callee153,this,[[15,34]]);})),0);});// remove the "select" event listener for the shipping method dropdownlist
...
_context154.next=24;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 24:_context154.next=39;break;case 26:_context154.prev=26;_context154.t0=_context154['catch'](15);console.log("CHECKOUT PAYMENT METHOD UPDATE ERROR",_context154.t0);_context154.t0=JSON.parse(_context154.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
...
$('#checkout-page .modal').css("display","none");case 39:case'end':return _context154.stop();}}},_callee154,this,[[15,26]]);})),0);});// set the order coupons
...
$('#checkout-page .checkout-page-discount').css("display","none");}case 50:_context155.prev=50;return _context155.finish(50);case 52:case'end':return _context155.stop();}}},_callee155,this,[[0,,50,52]]);}));function displayContent(){return _ref156.apply(this,arguments);}return displayContent;}(),/**
...
index=0;case 8:if(!(index<orderData.line_items.length)){_context158.next=43;break;}console.log("1");cartItemData={};// use the line item meta data to create part of cartItemData
...
_context158.next=22;break;case 18:_context158.prev=18;_context158.t0=_context158['catch'](14);_didIteratorError2=true;_iteratorError2=_context158.t0;case 22:_context158.prev=22;_context158.prev=23;if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}case 25:_context158.prev=25;if(!_didIteratorError2){_context158.next=28;break;}throw _iteratorError2;case 28:return _context158.finish(25);case 29:return _context158.finish(22);case 30:cartItemData.product_id=orderData.line_items[index].product_id;cartItemData.variation_id=orderData.line_items[index].variation_id;cartItemData.quantity=orderData.line_items[index].quantity;console.log("7");// add the created cartItemData to remote user cart
_context158.t1=addToCartPromises;_context158.next=37;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v2/cart/add',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));},crossDomain:true,xhrFields:{withCredentials:true},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(cartItemData)}));case 37:_context158.t2=_context158.sent;_context158.t1.push.call(_context158.t1,_context158.t2);console.log("8");case 40:index++;_context158.next=8;break;case 43:_context158.next=45;return Promise.all(addToCartPromises);case 45:resolve();// resolve the parent promise
case 46:_context158.prev=46;return _context158.finish(46);case 48:case'end':return _context158.stop();}}},_callee158,this,[[0,,46,48],[14,18,22,30],[23,,25,29]]);}));return function(_x56,_x57){return _ref162.apply(this,arguments);};}()));case 1:case'end':return _context159.stop();}}},_callee159,this);}));function createRemoteCartFromOrder(){return _ref161.apply(this,arguments);}return createRemoteCartFromOrder;}()},/**
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context166.prev=3;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context166.next=9;break;}_context166.next=9;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 9:_context166.next=11;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 11:_context166.next=23;break;case 13:_context166.prev=13;_context166.t0=_context166['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 23:_context166.prev=23;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context166.finish(23);case 26:case'end':return _context166.stop();}}},_callee166,this,[[3,13,23,26]]);})),0);case 3:case'end':return _context167.stop();}}},_callee167,this);}));function checkoutButtonClicked(_x63){return _ref169.apply(this,arguments);}return checkoutButtonClicked;}(),/**
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context168.prev=3;_context168.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context168.next=18;break;case 8:_context168.prev=8;_context168.t0=_context168['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context168.prev=18;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context168.finish(18);case 21:case'end':return _context168.stop();}}},_callee168,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context169.stop();}}},_callee169,this);}));function detailsButtonClicked(_x64){return _ref171.apply(this,arguments);}return detailsButtonClicked;}(),/**
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context173.prev=3;// create a new order object
...
_context173.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context173.sent;_context173.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context173.next=34;break;case 23:_context173.prev=23;_context173.t0=_context173['catch'](3);console.log(_context173.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast35=$('.timed-page-toast').get(0).ej2_instances[0];_toast35.cssClass='error-ej2-toast';_toast35.timeOut=3000;_toast35.content='Placing new order failed. Please retry';_toast35.dataBind();_toast35.show();case 34:_context173.prev=34;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context173.finish(34);case 37:case'end':return _context173.stop();}}},_callee173,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context174.stop();}}},_callee174,this);}));function reorderButtonClicked(_x66){return _ref176.apply(this,arguments);}return reorderButtonClicked;}()},/**
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context180.prev=3;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context180.next=9;break;}_context180.next=9;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 9:_context180.next=11;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 11:_context180.next=23;break;case 13:_context180.prev=13;_context180.t0=_context180['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 23:_context180.prev=23;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context180.finish(23);case 26:case'end':return _context180.stop();}}},_callee180,this,[[3,13,23,26]]);})),0);case 3:case'end':return _context181.stop();}}},_callee181,this);}));function checkoutButtonClicked(_x72){return _ref183.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context182.prev=3;_context182.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context182.next=18;break;case 8:_context182.prev=8;_context182.t0=_context182['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context182.prev=18;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context182.finish(18);case 21:case'end':return _context182.stop();}}},_callee182,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context183.stop();}}},_callee183,this);}));function detailsButtonClicked(_x73){return _ref185.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context187.prev=3;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context187.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context187.sent;_context187.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context187.next=34;break;case 23:_context187.prev=23;_context187.t0=_context187['catch'](3);console.log(_context187.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast40=$('.timed-page-toast').get(0).ej2_instances[0];_toast40.cssClass='error-ej2-toast';_toast40.timeOut=3000;_toast40.content='Placing new order failed. Please retry';_toast40.dataBind();_toast40.show();case 34:_context187.prev=34;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context187.finish(34);case 37:case'end':return _context187.stop();}}},_callee187,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context188.stop();}}},_callee188,this);}));function reorderButtonClicked(_x75){return _ref190.apply(this,arguments);}return reorderButtonClicked;}()},/**
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context194.prev=3;// check if the checkout page has previously been displayed in the app-main navigator
pagesStackArray=$('#app-main-navigator').get(0).pages;// holds the array of pages in the app-main navigator
indexOfCheckoutPage=pagesStackArray.findIndex(function(page,pageIndex){// test if the page is the checkout page
return $(pagesStackArray[pageIndex]).get(0).id==="checkout-page";});// check if the checkout page was found in the app-main navigator stack
if(!(indexOfCheckoutPage>-1)){_context194.next=9;break;}_context194.next=9;return $('#app-main-navigator').get(0).removePage(indexOfCheckoutPage);case 9:_context194.next=11;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 11:_context194.next=23;break;case 13:_context194.prev=13;_context194.t0=_context194['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 23:_context194.prev=23;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context194.finish(23);case 26:case'end':return _context194.stop();}}},_callee194,this,[[3,13,23,26]]);})),0);case 3:case'end':return _context195.stop();}}},_callee195,this);}));function checkoutButtonClicked(_x81){return _ref197.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context196.prev=3;_context196.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context196.next=18;break;case 8:_context196.prev=8;_context196.t0=_context196['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context196.prev=18;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context196.finish(18);case 21:case'end':return _context196.stop();}}},_callee196,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context197.stop();}}},_callee197,this);}));function detailsButtonClicked(_x82){return _ref199.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context201.prev=3;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context201.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context201.sent;_context201.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context201.next=34;break;case 23:_context201.prev=23;_context201.t0=_context201['catch'](3);console.log(_context201.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast45=$('.timed-page-toast').get(0).ej2_instances[0];_toast45.cssClass='error-ej2-toast';_toast45.timeOut=3000;_toast45.content='Placing new order failed. Please retry';_toast45.dataBind();_toast45.show();case 34:_context201.prev=34;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context201.finish(34);case 37:case'end':return _context201.stop();}}},_callee201,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context202.stop();}}},_callee202,this);}));function reorderButtonClicked(_x84){return _ref204.apply(this,arguments);}return reorderButtonClicked;}()},/**
...
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context203.next=30;break;case 21:_context203.prev=21;_context203.t0=_context203['catch'](7);console.log("ORDER DETAILS ERROR",_context203.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 30:_context203.prev=30;// hide page preloader
$('#order-details-page .page-preloader').css("display","none");// hide page modal loader
$('#order-details-page .modal').css("display","none");return _context203.finish(30);case 34:case'end':return _context203.stop();}}},_callee203,this,[[7,21,30,34]]);}));return function loadPageOnAppReady(){return _ref206.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context206.next=26;break;case 15:_context206.prev=15;_context206.t0=_context206['catch'](2);// hide the page preloader
$('#order-details-page .page-preloader').css("display","none");// show the page loader
$('#order-details-page .modal').css("display","none");console.log("ORDER DETAILS ERROR",_context206.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 26:_context206.prev=26;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context206.finish(26);case 31:case'end':return _context206.stop();}}},_callee206,this,[[2,15,26,31]]);}));function pagePullHookAction(){return _ref209.apply(this,arguments);}return pagePullHookAction;}(),/**
...
_context207.next=24;return $('#app-main-navigator').get(0).replacePage("checkout-page.html",{data:{orderData:newOrder}});case 24:_context207.next=42;break;case 26:_context207.prev=26;_context207.t0=_context207['catch'](1);console.log(_context207.t0,"REORDER ERROR");// hide the page loader
$('#order-details-page .modal').css("display","none");// disable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled",true);// add the spinner from the 'Reorder'
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast46=$('.timed-page-toast').get(0).ej2_instances[0];_toast46.cssClass='error-ej2-toast';_toast46.timeOut=3000;_toast46.content='Placing new order failed. Please retry';_toast46.dataBind();_toast46.show();case 42:_context207.prev=42;return _context207.finish(42);case 44:case'end':return _context207.stop();}}},_callee207,this,[[1,26,42,44]]);})),0);case 20:case'end':return _context208.stop();}}},_callee208,this);}));function reorderButtonClicked(){return _ref210.apply(this,arguments);}return reorderButtonClicked;}(),/**
