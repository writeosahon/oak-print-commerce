...
_context164.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context164.stop();}}},_callee164,this);}));function cancelButtonClicked(_x60){return _ref165.apply(this,arguments);}return cancelButtonClicked;}()},/**
     ...
     */completedOrdersPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref168=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee165(){var userDetails,searchResultsArray,toast,_toast31;return regeneratorRuntime.wrap(function _callee165$(_context165){while(1){switch(_context165.prev=_context165.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context165.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context165.abrupt('return');case 3:// listen for the back button event
...
$('#completed-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context165.prev=6;// hide the previously displayed orders info
...
_context165.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context165.sent.userDetails;_context165.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 14:searchResultsArray=_context165.sent;_context165.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
...
$('#completed-orders-page .modal').css("display","none");}_context165.next=33;break;case 20:_context165.prev=20;_context165.t0=_context165['catch'](6);// hide the page preloader
$('#completed-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#completed-orders-page .row').css("display","none");// show the page loader
$('#completed-orders-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast31=$('.timed-page-toast').get(0).ej2_instances[0];_toast31.cssClass='error-ej2-toast';_toast31.timeOut=3000;_toast31.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast31.dataBind();_toast31.show();case 33:case'end':return _context165.stop();}}},_callee165,this,[[6,20]]);}));return function loadPageOnAppReady(){return _ref168.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref169=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee166(){return regeneratorRuntime.wrap(function _callee166$(_context166){while(1){switch(_context166.prev=_context166.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context166.stop();}}},_callee166,this);}));function pageHide(){return _ref169.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref170=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee167(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast32;return regeneratorRuntime.wrap(function _callee167$(_context167){while(1){switch(_context167.prev=_context167.next){case 0:// disable pull-to-refresh widget till loading is done
$('#completed-orders-page #completed-orders-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context167.prev=2;// show the page loader
$('#completed-orders-page .modal').css("display","table");// load the user profile details from the app database
_context167.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context167.sent.userDetails;_context167.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 9:searchResultsArray=_context167.sent;_context167.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#completed-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#completed-orders-page .row').css("display","none");// hide the page loader
$('#completed-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
doneCallBack();return _context167.finish(27);case 32:case'end':return _context167.stop();}}},_callee167,this,[[2,15,27,32]]);}));function pagePullHookAction(){return _ref170.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to load orders to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
         ...
         *
         * @returns {Promise<void>}
         */loadOrders:function(){var _ref171=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee168(queryParam){var pageToAccess=arguments.length>1&&arguments[1]!==undefined?arguments[1]:queryParam.page||1;var pageSize=arguments.length>2&&arguments[2]!==undefined?arguments[2]:queryParam.per_page||20;var promisesArray;return regeneratorRuntime.wrap(function _callee168$(_context168){while(1){switch(_context168.prev=_context168.next){case 0:queryParam.page=pageToAccess;queryParam.per_page=pageSize;promisesArray=[];// holds the array for the promises used to load the orders
// check if there is internet connection or not
if(navigator.connection.type!==Connection.NONE){// there is internet connection
// load the requested products list from the server
promisesArray.push(new Promise(function(resolve,reject){Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"get",//contentType: "application/x-www-form-urlencoded",
...
promisesArray.push(Promise.reject("no internet connection"));}return _context168.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context168.stop();}}},_callee168,this);}));function loadOrders(_x64){return _ref171.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref172=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee169(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee169$(_context169){while(1){switch(_context169.prev=_context169.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
// check if the ordersArray is empty or not
if(ordersArray.length<=0){// there are no new content to display
resolve(ordersArray.length);// resolve promise with the length of the orders array
}else{// there are some orders to display
...
}});return _context169.abrupt('return',displayCompletedPromise);case 2:case'end':return _context169.stop();}}},_callee169,this);}));function displayPageContent(_x65){return _ref172.apply(this,arguments);}return displayPageContent;}()},/**
...
$('#pending-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context170.prev=6;// hide the previously displayed orders info
...
_context170.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context170.sent.userDetails;_context170.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 14:searchResultsArray=_context170.sent;_context170.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context171.stop();}}},_callee171,this);}));function pageHide(){return _ref174.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// reset the view-model properties
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref175=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee172(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast34;return regeneratorRuntime.wrap(function _callee172$(_context172){while(1){switch(_context172.prev=_context172.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#pending-orders-page .modal').css("display","table");// load the user profile details from the app database
_context172.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context172.sent.userDetails;_context172.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 9:searchResultsArray=_context172.sent;_context172.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#pending-orders-page .row').css("display","none");// hide the page loader
$('#pending-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
promisesArray.push(Promise.reject("no internet connection"));}return _context173.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context173.stop();}}},_callee173,this);}));function loadOrders(_x69){return _ref176.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
...
}});return _context174.abrupt('return',displayCompletedPromise);case 2:case'end':return _context174.stop();}}},_callee174,this);}));function displayPageContent(_x70){return _ref177.apply(this,arguments);}return displayPageContent;}()}};
