...
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context165.sent;_context165.next=21;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 21:userDetails=_context165.sent.userDetails;_context165.next=24;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 24:_context165.next=37;break;case 26:_context165.prev=26;_context165.t0=_context165['catch'](3);console.log(_context165.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast31=$('.timed-page-toast').get(0).ej2_instances[0];_toast31.cssClass='error-ej2-toast';_toast31.timeOut=3000;_toast31.content='Placing new order failed. Please retry';_toast31.dataBind();_toast31.show();case 37:_context165.prev=37;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context165.finish(37);case 40:case'end':return _context165.stop();}}},_callee165,this,[[3,26,37,40]]);})),0);case 13:case'end':return _context166.stop();}}},_callee166,this);}));function reorderButtonClicked(_x61){return _ref168.apply(this,arguments);}return reorderButtonClicked;}()},/**
