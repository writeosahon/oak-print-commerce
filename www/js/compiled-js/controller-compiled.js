...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{email:authResult.user.email}}));case 10:resultArray=_context55.sent;if(!(resultArray.length==0)){_context55.next=13;break;}throw"error";case 13:_context55.prev=13;_context55.next=16;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/customers",type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({email:authResult.additionalUserInfo.providerId+authResult.user.uid+'@shopoakexclusive.com',username:authResult.additionalUserInfo.providerId+authResult.user.uid+'@shopoakexclusive.com',password:authResult.user.uid})}));case 16:_context55.next=20;break;case 18:_context55.prev=18;_context55.t0=_context55['catch'](13);case 20:_context55.next=22;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 22:_context55.next=24;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"pseudo-user-details",docType:"PSEUDO_USER_DETAILS",pseudoUser:authResult.user,pseudoAdditionalUserInfo:authResult.additionalUserInfo,pseudoCredential:authResult.credential,pseudoOperationType:authResult.operationType},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 24:_context55.next=26;return $('#loader-modal').get(0).hide();case 26:_context55.next=28;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 28:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast=$('.timed-page-toast').get(0).ej2_instances[0];_toast.cssClass='success-ej2-toast';_toast.timeOut=3000;_toast.content='User signin completed';_toast.dataBind();_toast.show();_context55.next=51;break;case 38:_context55.prev=38;_context55.t1=_context55['catch'](4);console.log("SIGN IN ERROR",_context55.t1);// hide loader
_context55.next=43;return $('#loader-modal').get(0).hide();case 43:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast2=$('.timed-page-toast').get(0).ej2_instances[0];_toast2.cssClass='error-ej2-toast';_toast2.timeOut=3500;_toast2.content='User does not have an account. User signin failed ';_toast2.dataBind();_toast2.show();case 51:if(loginMode==="sign up"){}return _context55.abrupt('return',false);case 53:case'end':return _context55.stop();}}},_callee55,this,[[4,38],[13,18]]);}));function signInSuccessWithAuthResult(_x24){return _ref56.apply(this,arguments);}return signInSuccessWithAuthResult;}()}});// disable firebase ui auto-signin
...
window.plugins.socialsharing.shareWithOptions(shareOptions,function(){},function(){});},0);case 4:case'end':return _context76.stop();}}},_callee76,this);}));function shareButtonClicked(){return _ref76.apply(this,arguments);}return shareButtonClicked;}(),/**
         ...
         * @returns {Promise<void>}
         */rateButtonClicked:function(){var _ref77=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee79(){var userDetails,toast,_toast3,ordersArray,_toast4;return regeneratorRuntime.wrap(function _callee79$(_context79){while(1){switch(_context79.prev=_context79.next){case 0:userDetails=null;// holds the user details
// display page preloader
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast3=$('.timed-page-toast').get(0).ej2_instances[0];_toast3.cssClass='error-ej2-toast';_toast3.timeOut=3000;_toast3.content='Connect to the Internet to rate this product';_toast3.dataBind();_toast3.show();// hide page preloader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast4=$('.timed-page-toast').get(0).ej2_instances[0];_toast4.cssClass='error-ej2-toast';_toast4.timeOut=3500;_toast4.content='Sorry, you need to have purchased this product before it can be rated';_toast4.dataBind();_toast4.show();return _context79.abrupt('return');case 51:_context79.prev=51;// hide page preloader
...
_toast5=$('.timed-page-toast').get(0).ej2_instances[0];_toast5.cssClass='success-ej2-toast';_toast5.timeOut=3500;_toast5.content='Thank you. Your product review has been received';_toast5.dataBind();_toast5.show();_context78.next=37;break;case 23:_context78.prev=23;_context78.t0=_context78['catch'](0);_context78.next=27;return $('#loader-modal').get(0).hide();case 27:_context78.next=29;return $('#rate-product-modal').get(0).show();case 29:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show error
_toast6=$('.timed-page-toast').get(0).ej2_instances[0];_toast6.cssClass='error-ej2-toast';_toast6.timeOut=3500;_toast6.content='Error. Your product review could not be sent. Please retry';_toast6.dataBind();_toast6.show();case 37:_context78.prev=37;return _context78.finish(37);case 39:_context78.next=41;return $('#rate-product-modal').get(0).hide();case 41:case'end':return _context78.stop();}}},_callee78,this,[[0,23,37,39]]);}));// display "Rate Product" modal
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast7=$('.timed-page-toast').get(0).ej2_instances[0];_toast7.cssClass='error-ej2-toast';_toast7.timeOut=3500;_toast7.content='Error adding product to your cart. Try again';_toast7.dataBind();_toast7.show();case 66:_context88.prev=66;// enable the "Add To Cart" button
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast8=$('.timed-page-toast').get(0).ej2_instances[0];_toast8.cssClass='error-ej2-toast';_toast8.timeOut=3500;_toast8.content='Error adding customised product to your cart. Try again';_toast8.dataBind();_toast8.show();case 53:_context95.prev=53;// check if this is a save of an "edited" previously customised product
if(utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationCartKey){// since a current customisation cart key exist, this is an update
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee100(){var selectedProduct,_toast9,_toast10;return regeneratorRuntime.wrap(function _callee100$(_context100){while(1){switch(_context100.prev=_context100.next){case 0:_context100.prev=0;// find the product to be updated within the app localCart
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast9=$('.timed-page-toast').get(0).ej2_instances[0];_toast9.cssClass='success-ej2-toast';_toast9.timeOut=2000;_toast9.content='Product quantity updated';_toast9.dataBind();_toast9.show();_context100.next=28;break;case 17:_context100.prev=17;_context100.t0=_context100['catch'](0);console.log("UPDATE PRODUCT QUANTITY",_context100.t0);// hide all previously displayed ej2 toast
...
_toast10=$('.timed-page-toast').get(0).ej2_instances[0];_toast10.cssClass='error-ej2-toast';_toast10.timeOut=3500;_toast10.content='Product quantity not updated. Try again';_toast10.dataBind();_toast10.show();case 28:_context100.prev=28;// hide page preloader
...
$('#view-cart-page-delete-cart-item-action-sheet #view-cart-page-delete-cart-item-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee104(){var localCart,productIndex,$cartDisplayedItem,toast,_toast11;return regeneratorRuntime.wrap(function _callee104$(_context104){while(1){switch(_context104.prev=_context104.next){case 0:localCart=[];// holds the local cart array
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast11=$('.timed-page-toast').get(0).ej2_instances[0];_toast11.cssClass='error-ej2-toast';_toast11.timeOut=3500;_toast11.content='Error deleting product from your cart. Try again';_toast11.dataBind();_toast11.show();case 42:_context104.prev=42;// hide page preloader
...
_context105.next=4;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').show();case 4:case'end':return _context105.stop();}}},_callee105,this);}));function deleteCartItemButtonClicked(){return _ref106.apply(this,arguments);}return deleteCartItemButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref110=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee107(){var userDetails,toast,localCart,_toast12,_toast13,_toast14,orderData,userCart,index,key,_toast15;return regeneratorRuntime.wrap(function _callee107$(_context107){while(1){switch(_context107.prev=_context107.next){case 0:userDetails=null;// holds the user details
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast12=$('.timed-page-toast').get(0).ej2_instances[0];_toast12.cssClass='default-ej2-toast';_toast12.timeOut=3000;_toast12.content='Your cart is empty. Go order some products!';_toast12.dataBind();_toast12.show();return _context107.abrupt('return');case 38:if(!(userDetails.billing.address_1=="")){_context107.next=49;break;}// no billing address has been provided
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast13=$('.timed-page-toast').get(0).ej2_instances[0];_toast13.cssClass='error-ej2-toast';_toast13.timeOut=3500;_toast13.content='Please update your billing address to checkout your cart';_toast13.dataBind();_toast13.show();$('#app-main-navigator').get(0).pushPage('billing-info-page.html');return _context107.abrupt('return');case 49:if(!(navigator.connection.type===Connection.NONE)){_context107.next=59;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast14=$('.timed-page-toast').get(0).ej2_instances[0];_toast14.cssClass='error-ej2-toast';_toast14.timeOut=3000;_toast14.content='Connect to the Internet to checkout your cart';_toast14.dataBind();_toast14.show();return _context107.abrupt('return');case 59:// show the app loader modal
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast15=$('.timed-page-toast').get(0).ej2_instances[0];_toast15.cssClass='error-ej2-toast';_toast15.timeOut=3000;_toast15.content='Checkout failed. '+(_context107.t2.message||"");_toast15.dataBind();_toast15.show();case 86:_context107.prev=86;// hide the app loader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast16=$('.timed-page-toast').get(0).ej2_instances[0];_toast16.cssClass='success-ej2-toast';_toast16.timeOut=3000;_toast16.content='User profile updated';_toast16.dataBind();_toast16.show();_context112.next=63;break;case 52:_context112.prev=52;_context112.t0=_context112['catch'](17);_context112.t0=JSON.parse(_context112.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast17=$('.timed-page-toast').get(0).ej2_instances[0];_toast17.cssClass='error-ej2-toast';_toast17.timeOut=3000;_toast17.content='User profile update failed. '+(_context112.t0.message||"");_toast17.dataBind();_toast17.show();case 63:_context112.prev=63;// enable the "Update" button
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast18=$('.timed-page-toast').get(0).ej2_instances[0];_toast18.cssClass='success-ej2-toast';_toast18.timeOut=3000;_toast18.content='User password changed';_toast18.dataBind();_toast18.show();_context118.next=64;break;case 53:_context118.prev=53;_context118.t1=_context118['catch'](17);_context118.t1=JSON.parse(_context118.t1.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast19=$('.timed-page-toast').get(0).ej2_instances[0];_toast19.cssClass='error-ej2-toast';_toast19.timeOut=3000;_toast19.content='User password change failed. '+(_context118.t1.message||"");_toast19.dataBind();_toast19.show();case 64:_context118.prev=64;// enable the "Update" button
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast20=$('.timed-page-toast').get(0).ej2_instances[0];_toast20.cssClass='success-ej2-toast';_toast20.timeOut=3000;_toast20.content='User billing address updated';_toast20.dataBind();_toast20.show();_context124.next=64;break;case 53:_context124.prev=53;_context124.t0=_context124['catch'](17);_context124.t0=JSON.parse(_context124.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast21=$('.timed-page-toast').get(0).ej2_instances[0];_toast21.cssClass='error-ej2-toast';_toast21.timeOut=3000;_toast21.content='User billing address update failed. '+(_context124.t0.message||"");_toast21.dataBind();_toast21.show();case 64:_context124.prev=64;// enable the "Update" button
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast22=$('.timed-page-toast').get(0).ej2_instances[0];_toast22.cssClass='success-ej2-toast';_toast22.timeOut=3000;_toast22.content='Shipping information updated';_toast22.dataBind();_toast22.show();_context134.next=65;break;case 54:_context134.prev=54;_context134.t0=_context134['catch'](17);_context134.t0=JSON.parse(_context134.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast23=$('.timed-page-toast').get(0).ej2_instances[0];_toast23.cssClass='error-ej2-toast';_toast23.timeOut=3000;_toast23.content='Shipping information update failed. '+(_context134.t0.message||"");_toast23.dataBind();_toast23.show();case 65:_context134.prev=65;// enable the "Update" button
...
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast24=$('.timed-page-toast').get(0).ej2_instances[0];_toast24.cssClass='error-ej2-toast';_toast24.timeOut=3000;_toast24.content='Coupon not applied. Invalid coupon code';_toast24.dataBind();_toast24.show();case 42:case'end':return _context147.stop();}}},_callee147,this,[[10,31]]);}));function applyCouponButtonClicked(){return _ref150.apply(this,arguments);}return applyCouponButtonClicked;}(),/**
         * method is triggerd when  the "Add" note button is clicked
         *
         * @returns {Promise<void>}
         */addNoteButtonClicked:function(){var _ref151=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee148(){var toast,localOrderObject,_toast25;return regeneratorRuntime.wrap(function _callee148$(_context148){while(1){switch(_context148.prev=_context148.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context148.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast26=$('.timed-page-toast').get(0).ej2_instances[0];_toast26.cssClass='error-ej2-toast';_toast26.timeOut=3500;_toast26.content='Error making payment for this order. Try again';_toast26.dataBind();_toast26.show();case 68:_context151.prev=68;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast27=$('.timed-page-toast').get(0).ej2_instances[0];_toast27.cssClass='error-ej2-toast';_toast27.timeOut=3500;_toast27.content='Error placing this order. Try again';_toast27.dataBind();_toast27.show();case 112:_context151.prev=112;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
$('#loader-modal').get(0).hide();return _context151.finish(112);case 119:return _context151.abrupt('return');case 120:case'end':return _context151.stop();}}},_callee151,this,[[18,57,68,75],[41,46],[81,101,112,119],[88,93]]);}));function makePaymentButtonClicked(){return _ref152.apply(this,arguments);}return makePaymentButtonClicked;}(),/**
         ...
         * @returns {Promise<void>}
         */displayContent:function(){var _ref155=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee154(){var userDetails,thirdPartyUserDetails,orderData,shippingCountryCode,shippingZoneId,shippingCountry,shippingZone,shippingMethodsArray,shippingMethodDropDown,paymentMethodDropDown,couponsMultiSelectDropDown,couponsArray,orderItemsDisplayContent,index;return regeneratorRuntime.wrap(function _callee154$(_context154){while(1){switch(_context154.prev=_context154.next){case 0:_context154.prev=0;_context154.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context154.sent.userDetails;if(userDetails.password){_context154.next=8;break;}_context154.next=7;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("pseudo-user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 7:thirdPartyUserDetails=_context154.sent;case 8:// check if the checkout order billing data should be updated with the current user's billing
...
_context154.next=27;return Promise.resolve($.ajax(// load the list of shipping zones
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 27:shippingMethodsArray=_context154.sent;// filter the shipping methods for only the methods that are enabled
...
beforeSend:function beforeSend(jqxhr){if(userDetails.password){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));}else{// use the pseudo (3rd party) user account details
jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(thirdPartyUserDetails.pseudoAdditionalUserInfo.providerId+thirdPartyUserDetails.pseudoUser.uid+"@shopoakexclusive.com"+':'+thirdPartyUserDetails.pseudoUser.uid));}},/*crossDomain: true,
                                    xhrFields: {
                                        withCredentials: true
                                    },*/dataType:"text",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,// send the shipping method data represented by selected shipping method value
data:{id:shippingMethodDropDown.getDataByValue(shippingMethodDropDown.value).instance_id,method_id:shippingMethodDropDown.getDataByValue(shippingMethodDropDown.value).method_id}}));case 18:_context152.next=20;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v2/cart/calculate',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){if(userDetails.password){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));}else{// use the pseudo (3rd party) user account details
jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(thirdPartyUserDetails.pseudoAdditionalUserInfo.providerId+thirdPartyUserDetails.pseudoUser.uid+"@shopoakexclusive.com"+':'+thirdPartyUserDetails.pseudoUser.uid));}},/*crossDomain: true,
                                    xhrFields: {
                                        withCredentials: true
                                    },*/dataType:"text",timeout:240000,// wait for 4 minutes before timeout of request
...
jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(thirdPartyUserDetails.pseudoAdditionalUserInfo.providerId+thirdPartyUserDetails.pseudoUser.uid+"@shopoakexclusive.com"+':'+thirdPartyUserDetails.pseudoUser.uid));}},/*crossDomain: true,
                                    xhrFields: {
                                        withCredentials: true
                                    },*/dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast28=$('.timed-page-toast').get(0).ej2_instances[0];_toast28.cssClass='error-ej2-toast';_toast28.timeOut=3000;_toast28.content='Shipping method not updated, retry. '+(_context152.t0.message||"");_toast28.dataBind();_toast28.show();// hide the page loader modal
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast29=$('.timed-page-toast').get(0).ej2_instances[0];_toast29.cssClass='error-ej2-toast';_toast29.timeOut=3000;_toast29.content='Payment method not updated, retry. '+(_context153.t0.message||"");_toast29.dataBind();_toast29.show();// hide the page loader modal
...
$('#checkout-page .checkout-page-discount').css("display","none");}case 54:_context154.prev=54;return _context154.finish(54);case 56:case'end':return _context154.stop();}}},_callee154,this,[[0,,54,56]]);}));function displayContent(){return _ref155.apply(this,arguments);}return displayContent;}(),/**
...
if($('#user-signout-iframe-container #user-signout-iframe').get(0).contentWindow&&$('#user-signout-iframe-container #user-signout-iframe').get(0).contentWindow.utopiasoftware_removeUsage){// call the method to remotely sign out
$('#user-signout-iframe-container #user-signout-iframe').get(0).contentWindow.utopiasoftware_removeUsage();}return _context158.abrupt('return',new Promise(function(){var _ref161=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee157(resolve,reject){var userDetails,thirdPartyUserDetails,addToCartPromises,index,cartItemData,_iteratorNormalCompletion2,_didIteratorError2,_iteratorError2,_iterator2,_step2,metaDataElem;return regeneratorRuntime.wrap(function _callee157$(_context157){while(1){switch(_context157.prev=_context157.next){case 0:_context157.prev=0;_context157.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context157.sent.userDetails;if(userDetails.password){_context157.next=9;break;}_context157.next=7;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("pseudo-user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 7:thirdPartyUserDetails=_context157.sent;console.log("PSEUDO USER",thirdPartyUserDetails);case 9:_context157.next=11;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v2/cart/clear',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){if(userDetails.password){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));}else{// use the pseudo (3rd party) user account details
jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(thirdPartyUserDetails.pseudoAdditionalUserInfo.providerId+thirdPartyUserDetails.pseudoUser.uid+"@shopoakexclusive.com"+':'+thirdPartyUserDetails.pseudoUser.uid));}},/*crossDomain: true,
                            xhrFields: {
                                withCredentials: true
                            },*/dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 11:// create a loop to add all the line items in the order data to the remote cache
addToCartPromises=[];// holds all the promises used to add all items to the remote cart
index=0;case 13:if(!(index<orderData.line_items.length)){_context157.next=48;break;}console.log("1");cartItemData={};// use the line item meta data to create part of cartItemData
_iteratorNormalCompletion2=true;_didIteratorError2=false;_iteratorError2=undefined;_context157.prev=19;for(_iterator2=orderData.line_items[index].meta_data[Symbol.iterator]();!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){metaDataElem=_step2.value;console.log("2");if(metaDataElem.key==="_fpd_data"){// check the "key" property of the metaData object
...
_context157.next=27;break;case 23:_context157.prev=23;_context157.t0=_context157['catch'](19);_didIteratorError2=true;_iteratorError2=_context157.t0;case 27:_context157.prev=27;_context157.prev=28;if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}case 30:_context157.prev=30;if(!_didIteratorError2){_context157.next=33;break;}throw _iteratorError2;case 33:return _context157.finish(30);case 34:return _context157.finish(27);case 35:cartItemData.product_id=orderData.line_items[index].product_id;cartItemData.variation_id=orderData.line_items[index].variation_id;cartItemData.quantity=orderData.line_items[index].quantity;console.log("7");// add the created cartItemData to remote user cart
_context157.t1=addToCartPromises;_context157.next=42;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v2/cart/add',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){if(userDetails.password){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));}else{// use the pseudo (3rd party) user account details
jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(thirdPartyUserDetails.pseudoAdditionalUserInfo.providerId+thirdPartyUserDetails.pseudoUser.uid+"@shopoakexclusive.com"+':'+thirdPartyUserDetails.pseudoUser.uid));}},/*crossDomain: true,
                                xhrFields: {
                                    withCredentials: true
                                },*/dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(cartItemData)}));case 42:_context157.t2=_context157.sent;_context157.t1.push.call(_context157.t1,_context157.t2);console.log("8");case 45:index++;_context157.next=13;break;case 48:_context157.next=50;return Promise.all(addToCartPromises);case 50:resolve();// resolve the parent promise
case 51:_context157.prev=51;return _context157.finish(51);case 53:case'end':return _context157.stop();}}},_callee157,this,[[0,,51,53],[19,23,27,35],[28,,30,34]]);}));return function(_x56,_x57){return _ref161.apply(this,arguments);};}()));case 2:case'end':return _context158.stop();}}},_callee158,this);}));function createRemoteCartFromOrder(){return _ref160.apply(this,arguments);}return createRemoteCartFromOrder;}()},/**
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast30=$('.timed-page-toast').get(0).ej2_instances[0];_toast30.cssClass='error-ej2-toast';_toast30.timeOut=3000;_toast30.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast30.dataBind();_toast30.show();case 28:case'end':return _context159.stop();}}},_callee159,this,[[1,15]]);})),0);}}).appendTo('#track-order-page-input');}catch(err){}case 5:case'end':return _context160.stop();}}},_callee160,this);}));return function loadPageOnAppReady(){return _ref162.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
...
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee170(){var selectedOrder,userDetails,searchResultsArray,_toast31,_toast32;return regeneratorRuntime.wrap(function _callee170$(_context170){while(1){switch(_context170.prev=_context170.next){case 0:// display the page loader
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast31=$('.timed-page-toast').get(0).ej2_instances[0];_toast31.cssClass='default-ej2-toast';_toast31.timeOut=2000;_toast31.content='Order #'+selectedOrder.id+' has been cancelled';_toast31.dataBind();_toast31.show();_context170.next=36;break;case 26:_context170.prev=26;_context170.t0=_context170['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast32=$('.timed-page-toast').get(0).ej2_instances[0];_toast32.cssClass='error-ej2-toast';_toast32.timeOut=3500;_toast32.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast32.dataBind();_toast32.show();case 36:_context170.prev=36;// display the page loader
...
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee172(){var selectedOrder,newOrder,_toast33;return regeneratorRuntime.wrap(function _callee172$(_context172){while(1){switch(_context172.prev=_context172.next){case 0:// get the selected order to be checked out
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast33=$('.timed-page-toast').get(0).ej2_instances[0];_toast33.cssClass='error-ej2-toast';_toast33.timeOut=3000;_toast33.content='Placing new order failed. Please retry';_toast33.dataBind();_toast33.show();case 34:_context172.prev=34;// hide the page loader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref179=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee176(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast35;return regeneratorRuntime.wrap(function _callee176$(_context176){while(1){switch(_context176.prev=_context176.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee184(){var selectedOrder,userDetails,searchResultsArray,_toast36,_toast37;return regeneratorRuntime.wrap(function _callee184$(_context184){while(1){switch(_context184.prev=_context184.next){case 0:// display the page loader
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast36=$('.timed-page-toast').get(0).ej2_instances[0];_toast36.cssClass='default-ej2-toast';_toast36.timeOut=2000;_toast36.content='Order #'+selectedOrder.id+' has been cancelled';_toast36.dataBind();_toast36.show();_context184.next=36;break;case 26:_context184.prev=26;_context184.t0=_context184['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast37=$('.timed-page-toast').get(0).ej2_instances[0];_toast37.cssClass='error-ej2-toast';_toast37.timeOut=3500;_toast37.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast37.dataBind();_toast37.show();case 36:_context184.prev=36;// display the page loader
...
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee186(){var selectedOrder,newOrder,_toast38;return regeneratorRuntime.wrap(function _callee186$(_context186){while(1){switch(_context186.prev=_context186.next){case 0:// get the selected order to be checked out
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast38=$('.timed-page-toast').get(0).ej2_instances[0];_toast38.cssClass='error-ej2-toast';_toast38.timeOut=3000;_toast38.content='Placing new order failed. Please retry';_toast38.dataBind();_toast38.show();case 34:_context186.prev=34;// hide the page loader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast39=$('.timed-page-toast').get(0).ej2_instances[0];_toast39.cssClass='error-ej2-toast';_toast39.timeOut=3000;_toast39.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast39.dataBind();_toast39.show();case 33:case'end':return _context188.stop();}}},_callee188,this,[[6,20]]);}));return function loadPageOnAppReady(){return _ref191.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref193=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee190(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast40;return regeneratorRuntime.wrap(function _callee190$(_context190){while(1){switch(_context190.prev=_context190.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#pending-orders-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast40=$('.timed-page-toast').get(0).ej2_instances[0];_toast40.cssClass='error-ej2-toast';_toast40.timeOut=3000;_toast40.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast40.dataBind();_toast40.show();case 27:_context190.prev=27;// enable pull-to-refresh widget till loading is done
...
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee198(){var selectedOrder,userDetails,searchResultsArray,_toast41,_toast42;return regeneratorRuntime.wrap(function _callee198$(_context198){while(1){switch(_context198.prev=_context198.next){case 0:// display the page loader
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast41=$('.timed-page-toast').get(0).ej2_instances[0];_toast41.cssClass='default-ej2-toast';_toast41.timeOut=2000;_toast41.content='Order #'+selectedOrder.id+' has been cancelled';_toast41.dataBind();_toast41.show();_context198.next=36;break;case 26:_context198.prev=26;_context198.t0=_context198['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast42=$('.timed-page-toast').get(0).ej2_instances[0];_toast42.cssClass='error-ej2-toast';_toast42.timeOut=3500;_toast42.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast42.dataBind();_toast42.show();case 36:_context198.prev=36;// display the page loader
...
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee200(){var selectedOrder,newOrder,_toast43;return regeneratorRuntime.wrap(function _callee200$(_context200){while(1){switch(_context200.prev=_context200.next){case 0:// get the selected order to be checked out
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast43=$('.timed-page-toast').get(0).ej2_instances[0];_toast43.cssClass='error-ej2-toast';_toast43.timeOut=3000;_toast43.content='Placing new order failed. Please retry';_toast43.dataBind();_toast43.show();case 34:_context200.prev=34;// hide the page loader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee206(){var selectedOrder,newOrder,_toast44;return regeneratorRuntime.wrap(function _callee206$(_context206){while(1){switch(_context206.prev=_context206.next){case 0:// get the selected order to be checked out
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast44=$('.timed-page-toast').get(0).ej2_instances[0];_toast44.cssClass='error-ej2-toast';_toast44.timeOut=3000;_toast44.content='Placing new order failed. Please retry';_toast44.dataBind();_toast44.show();case 42:_context206.prev=42;return _context206.finish(42);case 44:case'end':return _context206.stop();}}},_callee206,this,[[1,26,42,44]]);})),0);case 20:case'end':return _context207.stop();}}},_callee207,this);}));function reorderButtonClicked(){return _ref209.apply(this,arguments);}return reorderButtonClicked;}(),/**
