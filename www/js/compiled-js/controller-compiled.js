...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee154(){var searchResultsArray,userDetails,toast;return regeneratorRuntime.wrap(function _callee154$(_context154){while(1){switch(_context154.prev=_context154.next){case 0:searchResultsArray=[];_context154.prev=1;_context154.next=4;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 4:userDetails=_context154.sent.userDetails;_context154.next=7;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"search":searchValue});case 7:searchResultsArray=_context154.sent;_context154.next=10;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.displayPageContent(searchResultsArray[0]);case 10:_context154.next=23;break;case 12:_context154.prev=12;_context154.t0=_context154['catch'](1);// remove the focus from the search autocomplete component
$('#track-order-page #track-order-page-input').get(0).ej2_instances[0].focusOut();// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");toast.dataBind();toast.show();case 23:case'end':return _context154.stop();}}},_callee154,this,[[1,12]]);})),0);}}).appendTo('#track-order-page-input');}catch(err){}case 5:case'end':return _context155.stop();}}},_callee155,this);}));return function loadPageOnAppReady(){return _ref157.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
...
$('#track-order-page #track-order-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
         ...
         *
         * @returns {Promise<void>}
         */searchAutocompletePopOverItemClicked:function(){var _ref163=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee161(productIndex){var selectedProduct;return regeneratorRuntime.wrap(function _callee161$(_context161){while(1){switch(_context161.prev=_context161.next){case 0:// get the product the user clicked on from the search autocomplete popover
selectedProduct=utopiasoftware[utopiasoftware_app_namespace].controller.searchPageViewModel.currentSearchResultsArray[productIndex];window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee160(){return regeneratorRuntime.wrap(function _callee160$(_context160){while(1){switch(_context160.prev=_context160.next){case 0:_context160.prev=0;_context160.next=3;return $('#app-main-navigator').get(0).pushPage("product-details-page.html",{animation:"lift",data:{product:selectedProduct}});case 3:_context160.next=5;return utopiasoftware[utopiasoftware_app_namespace].controller.searchPageViewModel.saveRecentSearchItem(selectedProduct);case 5:// update the value of the search autocomplete input to that which the user clicked on from the popover
$('#search-page #search-page-input').val(selectedProduct.name);_context160.next=10;break;case 8:_context160.prev=8;_context160.t0=_context160['catch'](0);case 10:case'end':return _context160.stop();}}},_callee160,this,[[0,8]]);})),0);case 2:case'end':return _context161.stop();}}},_callee161,this);}));function searchAutocompletePopOverItemClicked(_x59){return _ref163.apply(this,arguments);}return searchAutocompletePopOverItemClicked;}(),/**
         * method is triggered when the "Find More" option is
         * tapped within the search input popover
         *
         * @returns {Promise<void>}
         */findMoreClicked:function(){var _ref165=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee163(){return regeneratorRuntime.wrap(function _callee163$(_context163){while(1){switch(_context163.prev=_context163.next){case 0:// load the products page in a separate event queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee162(){var productArray,toast;return regeneratorRuntime.wrap(function _callee162$(_context162){while(1){switch(_context162.prev=_context162.next){case 0:_context162.prev=0;_context162.next=3;return $('#app-main-tabbar').get(0).setActiveTab(4,{animation:'none'});case 3:_context162.next=5;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.loadProducts({"order":"desc","orderby":"date","status":"publish","type":"variable","stock_status":"instock","page":1,"per_page":20,"search":$('#search-page #search-page-input').get(0).ej2_instances[0].value.trim()});case 5:productArray=_context162.sent;_context162.next=8;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.displayPageContent(productArray[0]);case 8:_context162.next=18;break;case 10:_context162.prev=10;_context162.t0=_context162['catch'](0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 18:_context162.prev=18;// hide the preloader for the products page
$('#products-page .page-preloader').css("display","none");return _context162.finish(18);case 21:case'end':return _context162.stop();}}},_callee162,this,[[0,10,18,21]]);})),0);case 1:case'end':return _context163.stop();}}},_callee163,this);}));function findMoreClicked(){return _ref165.apply(this,arguments);}return findMoreClicked;}()}};
