...
return _context.finish(46);case 52:case'end':return _context.stop();}}},_callee,this,[[14,43,46,52],[19,25],[32,38]]);})));// end of ons.ready()
},/**
...
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.forgotPasswordFormValidator.whenValidate();case 1:case'end':return _context51.stop();}}},_callee51,this);}));function resetPasswordButtonClicked(){return _ref51.apply(this,arguments);}return resetPasswordButtonClicked;}(),/**
         ...
         * @returns {Promise<void>}
         */thirdPartyLoginButtonClicked:function(){var _ref52=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee53(){var toast;return regeneratorRuntime.wrap(function _callee53$(_context53){while(1){switch(_context53.prev=_context53.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context53.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to sign in';toast.dataBind();toast.show();return _context53.abrupt('return');case 10:// hide the tooltips on the login form
$('#login-page #login-form').get(0).ej2_instances.forEach(function(tooltipArrayElem){// hide the tooltip
tooltipArrayElem.close();});// hide the tooltips on the signup form
$('#login-page #signup-form').get(0).ej2_instances.forEach(function(tooltipArrayElem){// hide the tooltip
tooltipArrayElem.close();});// open the 'third-party-login-modal'
...
$('#third-party-login-modal #third-party-login-loader').css("display","none");},signInSuccessWithAuthResult:function(){var _ref53=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee52(authResult){return regeneratorRuntime.wrap(function _callee52$(_context52){while(1){switch(_context52.prev=_context52.next){case 0:// triggers when forebase is successfully logged in
console.log("I GOT YOU",authResult);// hide the 'third-party-login-modal'
_context52.next=3;return $('#third-party-login-modal').get(0).hide();case 3:return _context52.abrupt('return',false);case 4:case'end':return _context52.stop();}}},_callee52,this);}));function signInSuccessWithAuthResult(_x21){return _ref53.apply(this,arguments);}return signInSuccessWithAuthResult;}()}});// disable firebase ui auto-signin
utopiasoftware[utopiasoftware_app_namespace].model.firebaseUI.disableAutoSignIn();case 16:case'end':return _context53.stop();}}},_callee53,this);}));function thirdPartyLoginButtonClicked(){return _ref52.apply(this,arguments);}return thirdPartyLoginButtonClicked;}(),/**
         * method is triggered when the login form is successfully validated
         *
         * @returns {Promise<void>}
         */loginFormValidated:function(){var _ref54=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee56(){var toast,promisesArray,userEmail,userPassword,promisesArrayPromise;return regeneratorRuntime.wrap(function _callee56$(_context56){while(1){switch(_context56.prev=_context56.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context56.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to sign in';toast.dataBind();toast.show();return _context56.abrupt('return');case 10:// display modal to user that signin is being completed
$('#loader-modal-message').html("Completing Signin...");_context56.next=13;return $('#loader-modal').get(0).show();case 13:// show loader
...
promisesArrayPromise.then(function(){var _ref55=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee54(resultsArray){var toast;return regeneratorRuntime.wrap(function _callee54$(_context54){while(1){switch(_context54.prev=_context54.next){case 0:// add the user's password to the user details retrieved from the server
resultsArray[1][0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context54.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[1][0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:_context54.next=5;return $('#loader-modal').get(0).hide();case 5:_context54.next=7;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 7:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=3000;toast.content='User signin completed';toast.dataBind();toast.show();case 15:case'end':return _context54.stop();}}},_callee54,this);}));return function(_x22){return _ref55.apply(this,arguments);};}()).catch(function(){var _ref56=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee55(err){var toast;return regeneratorRuntime.wrap(function _callee55$(_context55){while(1){switch(_context55.prev=_context55.next){case 0:// an error occurred
console.log("SIGN IN ERROR",err);err=JSON.parse(err.responseText);// hide loader
_context55.next=4;return $('#loader-modal').get(0).hide();case 4:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Invalid user email or password. User signin failed ';toast.dataBind();toast.show();case 12:case'end':return _context55.stop();}}},_callee55,this);}));return function(_x23){return _ref56.apply(this,arguments);};}());return _context56.abrupt('return',promisesArrayPromise);case 21:case'end':return _context56.stop();}}},_callee56,this);}));function loginFormValidated(){return _ref54.apply(this,arguments);}return loginFormValidated;}(),/**
         * method is triggered when the sign up form is successfully validated
         *
         * @returns {Promise<void>}
         */signupFormValidated:function(){var _ref57=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee59(){var toast,promisesArray;return regeneratorRuntime.wrap(function _callee59$(_context59){while(1){switch(_context59.prev=_context59.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context59.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to sign up';toast.dataBind();toast.show();return _context59.abrupt('return');case 10:// display modal to user that signup is being completed
$('#loader-modal-message').html("Completing Signup...");_context59.next=13;return $('#loader-modal').get(0).show();case 13:// show loader
...
case 13:case'end':return _context58.stop();}}},_callee58,this);}));return function(_x25){return _ref59.apply(this,arguments);};}());}));return _context59.abrupt('return',Promise.all(promisesArray));case 16:case'end':return _context59.stop();}}},_callee59,this);}));function signupFormValidated(){return _ref57.apply(this,arguments);}return signupFormValidated;}(),/**
         * method is triggered when the forgot password form is successfully validated
         *
         * @returns {Promise<void>}
         */forgotPasswordFormValidated:function(){var _ref60=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee60(){return regeneratorRuntime.wrap(function _callee60$(_context60){while(1){switch(_context60.prev=_context60.next){case 0:case'end':return _context60.stop();}}},_callee60,this);}));function forgotPasswordFormValidated(){return _ref60.apply(this,arguments);}return forgotPasswordFormValidated;}()},/**
     ...
     */productsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref61=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee61(){return regeneratorRuntime.wrap(function _callee61$(_context61){while(1){switch(_context61.prev=_context61.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context61.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context61.abrupt('return');case 3:// listen for the back button event
...
utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.productItemClicked(window.parseInt($(event.currentTarget).attr('data-product')),window.parseInt($(event.currentTarget).attr('data-page')));});try{}catch(err){}case 12:case'end':return _context61.stop();}}},_callee61,this);}));return function loadPageOnAppReady(){return _ref61.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref62=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee62(event){return regeneratorRuntime.wrap(function _callee62$(_context62){while(1){switch(_context62.prev=_context62.next){case 0:// flag that page infinite scroll should NOT be allowed
...
$('#products-page .page__content .infinite-load-container').remove();case 5:case'end':return _context62.stop();}}},_callee62,this);}));function pageHide(_x26){return _ref62.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref63=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee63(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productArray,toast;return regeneratorRuntime.wrap(function _callee63$(_context63){while(1){switch(_context63.prev=_context63.next){case 0:// disable pull-to-refresh widget till loading is done
$('#products-page #products-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context63.prev=2;_context63.next=5;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.loadProducts(utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentQueryParam,1);case 5:productArray=_context63.sent;_context63.next=8;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.displayPageContent(productArray[0]);case 8:_context63.next=17;break;case 10:_context63.prev=10;_context63.t0=_context63['catch'](2);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 17:_context63.prev=17;// hide the page preloader
...
doneCallBack();return _context63.finish(17);case 22:case'end':return _context63.stop();}}},_callee63,this,[[2,10,17,22]]);}));function pagePullHookAction(){return _ref63.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is triggered when the pull-hook on the page is active
         *
         * @param doneCallBack
         * @returns {Promise<void>}
         */pageInfiniteScroll:function(){var _ref64=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee64(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productArray,toast;return regeneratorRuntime.wrap(function _callee64$(_context64){while(1){switch(_context64.prev=_context64.next){case 0:if(!($('#products-page').get(0)._allowInfinitePageScroll===false)){_context64.next=3;break;}// page infinite scroll is NOT allowed
doneCallBack();return _context64.abrupt('return');case 3:// append an infinite load indicator to the bottom of the page
...
_context64.prev=6;_context64.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.loadProducts(utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentQueryParam,utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentPage+1);case 9:productArray=_context64.sent;_context64.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.displayPageContent(productArray[0],true,false);case 12:_context64.next=21;break;case 14:_context64.prev=14;_context64.t0=_context64['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 21:_context64.prev=21;// check if any new products were retrieved
...
doneCallBack();return _context64.finish(21);case 25:case'end':return _context64.stop();}}},_callee64,this,[[6,14,21,25]]);}));function pageInfiniteScroll(){return _ref64.apply(this,arguments);}return pageInfiniteScroll;}(),/**
         * method is used to load products to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
...
reject(err);// reject the parent promise with the error
});}));}return _context65.abrupt('return',Promise.all(productPromisesArray));case 5:case'end':return _context65.stop();}}},_callee65,this);}));function loadProducts(_x31){return _ref65.apply(this,arguments);}return loadProducts;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref66=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee66(productsArray){var appendContent=arguments.length>1&&arguments[1]!==undefined?arguments[1]:true;var overwriteContent=arguments.length>2&&arguments[2]!==undefined?arguments[2]:true;var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee66$(_context66){while(1){switch(_context66.prev=_context66.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var productsContent="";// holds the contents for the products
// check if the productsArray is empty or not
if(productsArray.length<=0){// there are no new content to display
...
$('#products-page').get(0)._allowInfinitePageScroll=true;resolve(productsArray.length);// resolve the promise with length of the productsArray
}});return _context66.abrupt('return',displayCompletedPromise);case 2:case'end':return _context66.stop();}}},_callee66,this);}));function displayPageContent(_x34){return _ref66.apply(this,arguments);}return displayPageContent;}(),/**
         * method scrolls the page to the top
         * @returns {Promise<void>}
         */scrollPageToTop:function(){var _ref67=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee67(){return regeneratorRuntime.wrap(function _callee67$(_context67){while(1){switch(_context67.prev=_context67.next){case 0:window.setTimeout(function(){$('#products-page .page__content').animate({scrollTop:0},400);},0);case 1:case'end':return _context67.stop();}}},_callee67,this);}));function scrollPageToTop(){return _ref67.apply(this,arguments);}return scrollPageToTop;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */productItemClicked:function(){var _ref68=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee69(productIndex,productPage){return regeneratorRuntime.wrap(function _callee69$(_context69){while(1){switch(_context69.prev=_context69.next){case 0:// handle the function task in a different event queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee68(){var productItemsArray;return regeneratorRuntime.wrap(function _callee68$(_context68){while(1){switch(_context68.prev=_context68.next){case 0:_context68.prev=0;_context68.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData((""+productPage).padStart(7,"0")+"products",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 3:productItemsArray=_context68.sent.products;// display the products details page using the selected product
$('#app-main-navigator').get(0).pushPage("product-details-page.html",{animation:"lift",data:{product:productItemsArray[productIndex]}});_context68.next=9;break;case 7:_context68.prev=7;_context68.t0=_context68['catch'](0);case 9:case'end':return _context68.stop();}}},_callee68,this,[[0,7]]);})),0);case 1:case'end':return _context69.stop();}}},_callee69,this);}));function productItemClicked(_x35,_x36){return _ref68.apply(this,arguments);}return productItemClicked;}()},/**
     ...
     */productDetailsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref70=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee71(){var productDetailsArray,toast;return regeneratorRuntime.wrap(function _callee71$(_context71){while(1){switch(_context71.prev=_context71.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context71.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context71.abrupt('return');case 3:// listen for the back button event
...
$('#product-details-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context71.prev=6;// create the "Pick Quantity" button
...
_context71.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProduct();case 16:productDetailsArray=_context71.sent;_context71.next=19;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.displayProductDetails(productDetailsArray[0]);case 19:// enable the "Add To Cart" button
$('#product-details-page #product-details-add-to-cart').removeAttr("disabled");_context71.next=30;break;case 22:_context71.prev=22;_context71.t0=_context71['catch'](6);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 30:_context71.prev=30;// hide the preloader
$('#product-details-page .page-preloader').css("display","none");return _context71.finish(30);case 33:case'end':return _context71.stop();}}},_callee71,this,[[6,22,30,33]]);}));return function loadPageOnAppReady(){return _ref70.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
$('#product-details-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);window.SoftInputMode.set('adjustResize');},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref72=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee72(){return regeneratorRuntime.wrap(function _callee72$(_context72){while(1){switch(_context72.prev=_context72.next){case 0:case'end':return _context72.stop();}}},_callee72,this);}));function pageHide(){return _ref72.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();break;}}else{// there is only 1 page in the stack
         ...
         * @returns {Promise<void>}
         */shareButtonClicked:function(){var _ref73=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee73(){var shareOptions;return regeneratorRuntime.wrap(function _callee73$(_context73){while(1){switch(_context73.prev=_context73.next){case 0:shareOptions={};// holds the options for sharing
...
window.plugins.socialsharing.shareWithOptions(shareOptions,function(){},function(){});},0);case 4:case'end':return _context73.stop();}}},_callee73,this);}));function shareButtonClicked(){return _ref73.apply(this,arguments);}return shareButtonClicked;}(),/**
         * method is triggered when the "Rate" button is clicked
         * @returns {Promise<void>}
         */rateButtonClicked:function(){var _ref74=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee76(){var userDetails,toast,_toast,ordersArray,_toast2;return regeneratorRuntime.wrap(function _callee76$(_context76){while(1){switch(_context76.prev=_context76.next){case 0:userDetails=null;// holds the user details
// display page preloader
$('#product-details-page .page-preloader').css("display","block");// check if a user has signed in
_context76.prev=2;_context76.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 5:userDetails=_context76.sent.userDetails;_context76.next=20;break;case 8:_context76.prev=8;_context76.t0=_context76['catch'](2);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#product-details-page .page-preloader').css("display","none");return _context76.abrupt('return');case 20:if(!(navigator.connection.type===Connection.NONE)){_context76.next=31;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#product-details-page .page-preloader').css("display","none");return _context76.abrupt('return');case 31:_context76.prev=31;// display the page loader modal
$('#product-details-page .modal').css("display","table");// check if the current user has ever purchased this product before
_context76.next=35;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{status:"completed",customer:userDetails.id,product:utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.currentProductDetails.id}}));case 35:ordersArray=_context76.sent;if(!(ordersArray.length===0)){_context76.next=38;break;}throw"error";case 38:_context76.next=51;break;case 40:_context76.prev=40;_context76.t1=_context76['catch'](31);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast2=$('.timed-page-toast').get(0).ej2_instances[0];_toast2.cssClass='error-ej2-toast';_toast2.timeOut=3500;_toast2.content='Sorry, you need to have purchased this product before it can be rated';_toast2.dataBind();_toast2.show();return _context76.abrupt('return');case 51:_context76.prev=51;// hide page preloader
$('#product-details-page .page-preloader').css("display","none");// hide page loader
$('#product-details-page .modal').css("display","none");return _context76.finish(51);case 55:// set the handlers for the buttons on the "Rate Product" modal
$('#rate-product-modal #rate-product-cancel-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee74(){return regeneratorRuntime.wrap(function _callee74$(_context74){while(1){switch(_context74.prev=_context74.next){case 0:_context74.next=2;return $('#rate-product-modal').get(0).hide();case 2:case'end':return _context74.stop();}}},_callee74,this);}));$('#rate-product-modal #rate-product-rate-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee75(){var _toast3,_toast4;return regeneratorRuntime.wrap(function _callee75$(_context75){while(1){switch(_context75.prev=_context75.next){case 0:_context75.prev=0;_context75.next=3;return $('#rate-product-modal').get(0).hide();case 3:// inform user that review is being sent
$('#loader-modal-message').html("Sending User Review...");_context75.next=6;return $('#loader-modal').get(0).show();case 6:_context75.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/products/reviews',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
...
_context75.next=13;return $('#loader-modal').get(0).hide();case 13:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show success
_toast3=$('.timed-page-toast').get(0).ej2_instances[0];_toast3.cssClass='success-ej2-toast';_toast3.timeOut=3500;_toast3.content='Thank you. Your product review has been received';_toast3.dataBind();_toast3.show();_context75.next=37;break;case 23:_context75.prev=23;_context75.t0=_context75['catch'](0);_context75.next=27;return $('#loader-modal').get(0).hide();case 27:_context75.next=29;return $('#rate-product-modal').get(0).show();case 29:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show error
_toast4=$('.timed-page-toast').get(0).ej2_instances[0];_toast4.cssClass='error-ej2-toast';_toast4.timeOut=3500;_toast4.content='Error. Your product review could not be sent. Please retry';_toast4.dataBind();_toast4.show();case 37:_context75.prev=37;return _context75.finish(37);case 39:_context75.next=41;return $('#rate-product-modal').get(0).hide();case 41:case'end':return _context75.stop();}}},_callee75,this,[[0,23,37,39]]);}));// display "Rate Product" modal
_context76.next=59;return $('#rate-product-modal').get(0).show();case 59:case'end':return _context76.stop();}}},_callee76,this,[[2,8],[31,40,51,55]]);}));function rateButtonClicked(){return _ref74.apply(this,arguments);}return rateButtonClicked;}(),/**
         * method is triggered when the pull-hook on the page is active
         *
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref77=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee77(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productDetailsArray,toast;return regeneratorRuntime.wrap(function _callee77$(_context77){while(1){switch(_context77.prev=_context77.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].dataBind();$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].stop();_context77.prev=6;// load product variations asynchronously without waiting for the response
utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProductVariations();// load product details
_context77.next=10;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProduct();case 10:productDetailsArray=_context77.sent;_context77.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.displayProductDetails(productDetailsArray[0]);case 13:_context77.next=22;break;case 15:_context77.prev=15;_context77.t0=_context77['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 22:_context77.prev=22;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context77.finish(22);case 27:case'end':return _context77.stop();}}},_callee77,this,[[6,15,22,27]]);}));function pagePullHookAction(){return _ref77.apply(this,arguments);}return pagePullHookAction;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProduct:function(){var _ref78=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee78(){var productPromisesArray,toast,aProduct;return regeneratorRuntime.wrap(function _callee78$(_context78){while(1){switch(_context78.prev=_context78.next){case 0:productPromisesArray=[];// holds the array for the promises used to load the product
...
reject(err);// reject the parent promise with the error
});}));}return _context78.abrupt('return',Promise.all(productPromisesArray));case 4:case'end':return _context78.stop();}}},_callee78,this);}));function loadProduct(){return _ref78.apply(this,arguments);}return loadProduct;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProductVariations:function(){var _ref79=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee79(){var productPromisesArray,productId;return regeneratorRuntime.wrap(function _callee79$(_context79){while(1){switch(_context79.prev=_context79.next){case 0:productPromisesArray=[];// holds the array for the promises used to load the product
...
reject(err);// reject the parent promise with the error
});}));return _context79.abrupt('return',Promise.all(productPromisesArray));case 5:case'end':return _context79.stop();}}},_callee79,this);}));function loadProductVariations(){return _ref79.apply(this,arguments);}return loadProductVariations;}(),/**
         * method is used to display the product details on the page
         *
         * @param productDetails {Object} the product object to be displayed
         *
         * @returns {Promise<void>}
         */displayProductDetails:function(){var _ref80=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee82(productDetails){var variationContent,index;return regeneratorRuntime.wrap(function _callee82$(_context82){while(1){switch(_context82.prev=_context82.next){case 0:// update the product details image
...
new ej.dropdowns.DropDownList({cssClass:"product-details-variation-class",placeholder:productDetails.attributes[index].name,floatLabelType:'Always',change:function(){var _ref81=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee81(){return regeneratorRuntime.wrap(function _callee81$(_context81){while(1){switch(_context81.prev=_context81.next){case 0:return _context81.abrupt('return',new Promise(function(resolve2,reject2){// handle the change in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee80(){var concatenatedVarationValue,variationIndexPosition,productVariation;return regeneratorRuntime.wrap(function _callee80$(_context80){while(1){switch(_context80.prev=_context80.next){case 0:concatenatedVarationValue="";// holds the concatenated variation values
...
resolve2();case 6:case'end':return _context80.stop();}}},_callee80,this);})),0);}));case 1:case'end':return _context81.stop();}}},_callee81,this);}));function change(){return _ref81.apply(this,arguments);}return change;}()}).appendTo(element);});// collapse the variations content
...
$('#product-details-page .product-details-weight').html(''+(!productDetails.weight||productDetails.weight==""?"(Not Available)":''+productDetails.weight));case 19:case'end':return _context82.stop();}}},_callee82,this);}));function displayProductDetails(_x40){return _ref80.apply(this,arguments);}return displayProductDetails;}(),/**
         * method is triggered when the customise button is clicked
         *
         * @returns {Promise<void>}
         */customiseButtonClicked:function(){var _ref83=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee84(){var toast;return regeneratorRuntime.wrap(function _callee84$(_context84){while(1){switch(_context84.prev=_context84.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context84.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to customise product';toast.dataBind();toast.show();return _context84.abrupt('return');case 10:// perform the method task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee83(){var productUrl,variationIndex,productVariation;return regeneratorRuntime.wrap(function _callee83$(_context83){while(1){switch(_context83.prev=_context83.next){case 0:productUrl="";// holds the url for the product being customised
...
_context83.next=4;return $('#app-main-navigator').get(0).pushPage("customise-product-page.html");case 4:_context83.next=6;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(productUrl);case 6:case'end':return _context83.stop();}}},_callee83,this);})),0);case 11:case'end':return _context84.stop();}}},_callee84,this);}));function customiseButtonClicked(){return _ref83.apply(this,arguments);}return customiseButtonClicked;}(),/**
         * method is triggered when the "Add To Cart" button is clicked
         *
         * @returns {Promise<void>}
         */addToCartButtonClicked:function(){var _ref85=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee86(){return regeneratorRuntime.wrap(function _callee86$(_context86){while(1){switch(_context86.prev=_context86.next){case 0:// disable the "Add To Cart" button
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee85(){var localCart,utopiasoftwareCartObject,variationIndex,productVariation,searchParams,_iteratorNormalCompletion,_didIteratorError,_iteratorError,_iterator,_step,_ref87,_ref88,key,value,toast,_toast5;return regeneratorRuntime.wrap(function _callee85$(_context85){while(1){switch(_context85.prev=_context85.next){case 0:localCart=[];// holds the local cart collection
utopiasoftwareCartObject={cartData:{}};// holds the object whose properties make up the cart item
// get the cached user cart
_context85.prev=2;_context85.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 5:localCart=_context85.sent.cart;_context85.next=10;break;case 8:_context85.prev=8;_context85.t0=_context85['catch'](2);case 10:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.currentProductVariationIndex!==-1)){_context85.next=36;break;}// a product variation was selected
...
utopiasoftwareCartObject.cartData.variation={};_iteratorNormalCompletion=true;_didIteratorError=false;_iteratorError=undefined;_context85.prev=19;for(_iterator=searchParams[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){_ref87=_step.value;_ref88=_slicedToArray(_ref87,2);key=_ref88[0];value=_ref88[1];utopiasoftwareCartObject.cartData.variation[key]=value;}// store the product variation object as additional data just for the mobile app
_context85.next=27;break;case 23:_context85.prev=23;_context85.t1=_context85['catch'](19);_didIteratorError=true;_iteratorError=_context85.t1;case 27:_context85.prev=27;_context85.prev=28;if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}case 30:_context85.prev=30;if(!_didIteratorError){_context85.next=33;break;}throw _iteratorError;case 33:return _context85.finish(30);case 34:return _context85.finish(27);case 35:utopiasoftwareCartObject.productVariation=productVariation;case 36:// set the other properties of the cart data
...
utopiasoftwareCartObject.uid=Random.uuid4(utopiasoftware[utopiasoftware_app_namespace].randomisationEngine);_context85.prev=40;// add the created 'utopiasoftwareCartObject' to the user cart collection
localCart.push(utopiasoftwareCartObject);// save the updated cached user cart
_context85.next=44;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 44:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=2000;toast.content='Product has been added to your cart';toast.dataBind();toast.show();console.log("USER CART OBJECT",utopiasoftwareCartObject);_context85.next=66;break;case 55:_context85.prev=55;_context85.t2=_context85['catch'](40);console.log("PRODUCT DETAILS ERROR",_context85.t2);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast5=$('.timed-page-toast').get(0).ej2_instances[0];_toast5.cssClass='error-ej2-toast';_toast5.timeOut=3500;_toast5.content='Error adding product to your cart. Try again';_toast5.dataBind();_toast5.show();case 66:_context85.prev=66;// enable the "Add To Cart" button
$('#product-details-page #product-details-add-to-cart').removeAttr("disabled");// hide the spinner from the 'Add To Cart'
$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].dataBind();$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].stop();return _context85.finish(66);case 72:case'end':return _context85.stop();}}},_callee85,this,[[2,8],[19,23,27,35],[28,,30,34],[40,55,66,72]]);})),0);case 5:case'end':return _context86.stop();}}},_callee86,this);}));function addToCartButtonClicked(){return _ref85.apply(this,arguments);}return addToCartButtonClicked;}()},/**
     ...
     */customiseProductPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref89=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee87(){return regeneratorRuntime.wrap(function _callee87$(_context87){while(1){switch(_context87.prev=_context87.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context87.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context87.abrupt('return');case 3:// listen for the back button event
...
new ej.splitbuttons.ProgressButton({cssClass:'e-hide-spinner',duration:10*60*60*1000// set spinner/progress duration for 10 hr
}).appendTo('#customise-product-add-to-cart');}catch(err){console.log("CUSTOMISATION ERROR",err);}finally{}case 8:case'end':return _context87.stop();}}},_callee87,this);}));return function loadPageOnAppReady(){return _ref89.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref90=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee88(){return regeneratorRuntime.wrap(function _callee88$(_context88){while(1){switch(_context88.prev=_context88.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context88.stop();}}},_callee88,this);}));function pageHide(){return _ref90.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         *
         * @returns {Promise<void>}
         */receiveMessageListener:function(){var _ref91=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee89(receiveEvent){var cartData;return regeneratorRuntime.wrap(function _callee89$(_context89){while(1){switch(_context89.prev=_context89.next){case 0:if(!(receiveEvent.origin!=="https://shopoakexclusive.com")){_context89.next=2;break;}return _context89.abrupt('return');case 2:if(!(receiveEvent.data==="page ready")){_context89.next=8;break;}// parent site is ready to work together
...
$('#customise-product-page .page-preloader').css("display","none");return _context89.abrupt('return');case 8:// the page sent cart data
...
$('.page-toast').get(0).ej2_instances[0].hide('All');_context90.prev=8;_context90.next=11;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationUrl,utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationCartKey);case 11:_context90.next=20;break;case 13:_context90.prev=13;_context90.t0=_context90['catch'](8);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 20:_context90.prev=20;window.setTimeout(function(){// wait for 2 sec before declaring loading done
...
doneCallBack();},2000);return _context90.finish(20);case 23:case'end':return _context90.stop();}}},_callee90,this,[[8,13,20,23]]);}));function pagePullHookAction(){return _ref92.apply(this,arguments);}return pagePullHookAction;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProductCustomisation:function(){var _ref93=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee91(){var customisationUrl=arguments.length>0&&arguments[0]!==undefined?arguments[0]:utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationUrl;var remoteCartItemKey=arguments[1];var toast;return regeneratorRuntime.wrap(function _callee91$(_context91){while(1){switch(_context91.prev=_context91.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context91.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to customise product and Pull Down to refresh';toast.dataBind();toast.show();return _context91.abrupt('return');case 10:// check if the 'remoteCartItemKey' has been provided
...
utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.customisationPageLoadCount=0;utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.cartsQueue=[];return _context91.abrupt('return',true);case 16:case'end':return _context91.stop();}}},_callee91,this);}));function loadProductCustomisation(){return _ref93.apply(this,arguments);}return loadProductCustomisation;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */saveCustomisedProductToCart:function(){var _ref94=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee92(){var previousCartObject,updatedCartObject,property,customisedProduct,localCart,utopiasoftwareCartObject,customisedIndex,toast,_toast6;return regeneratorRuntime.wrap(function _callee92$(_context92){while(1){switch(_context92.prev=_context92.next){case 0:// get the previous remote cart object and the new/updated remote cart object
...
_context92.t0=regeneratorRuntime.keys(updatedCartObject);case 3:if((_context92.t1=_context92.t0()).done){_context92.next=60;break;}property=_context92.t1.value;if(previousCartObject[property]){_context92.next=58;break;}// property does not exist in the previousCartObject, so this property belongs to the latest customised product
...
utopiasoftwareCartObject={cartData:{}};// holds the object whose properties make up the cart item
// get the cached user cart
_context92.prev=10;_context92.next=13;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 13:localCart=_context92.sent.cart;// check if this is a save of an "edited" previously customised product
...
}_context92.next=19;break;case 17:_context92.prev=17;_context92.t2=_context92['catch'](10);case 19:// set the other properties of the cart data
...
utopiasoftwareCartObject.uid=Random.uuid4(utopiasoftware[utopiasoftware_app_namespace].randomisationEngine);_context92.prev=28;// add the created 'utopiasoftwareCartObject' to the user cart collection
localCart.push(utopiasoftwareCartObject);// save the updated cached user cart
_context92.next=32;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 32:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=2000;toast.content='Customised product has been added to your cart';toast.dataBind();toast.show();_context92.next=53;break;case 42:_context92.prev=42;_context92.t3=_context92['catch'](28);console.log("CUSTOMISE PRODUCT ERROR",_context92.t3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast6=$('.timed-page-toast').get(0).ej2_instances[0];_toast6.cssClass='error-ej2-toast';_toast6.timeOut=3500;_toast6.content='Error adding customised product to your cart. Try again';_toast6.dataBind();_toast6.show();case 53:_context92.prev=53;// check if this is a save of an "edited" previously customised product
if(utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationCartKey){// since a current customisation cart key exist, this is an update
...
$('#customise-product-page #customise-product-page-iframe-container .modal').css("display","none");return _context92.finish(53);case 57:return _context92.abrupt('break',60);case 58:_context92.next=3;break;case 60:case'end':return _context92.stop();}}},_callee92,this,[[10,17],[28,42,53,57]]);}));function saveCustomisedProductToCart(){return _ref94.apply(this,arguments);}return saveCustomisedProductToCart;}(),/**
         * method is triggered when the user clicks the "Add To Cart" button
         *
         * @returns {Promise<void>}
         */addToCartButtonClicked:function(){var _ref95=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee93(){var toast;return regeneratorRuntime.wrap(function _callee93$(_context93){while(1){switch(_context93.prev=_context93.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context93.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to add customised product to cart';toast.dataBind();toast.show();return _context93.abrupt('return');case 10:// show the spinner on the 'Add To Cart' button to indicate process is ongoing
...
$('#customise-product-page #customise-product-page-iframe').get(0).contentWindow.utopiasoftware_addUsage();case 15:case'end':return _context93.stop();}}},_callee93,this);}));function addToCartButtonClicked(){return _ref95.apply(this,arguments);}return addToCartButtonClicked;}()},/**
     * this is the view-model/controller for the View Cart page
     */viewCartPageViewModel:{/**
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref96=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee94(){var toast;return regeneratorRuntime.wrap(function _callee94$(_context94){while(1){switch(_context94.prev=_context94.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context94.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context94.abrupt('return');case 3:// listen for the back button event
...
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred. Pull down to refresh';toast.dataBind();toast.show();}case 7:case'end':return _context94.stop();}}},_callee94,this);}));return function loadPageOnAppReady(){return _ref96.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
$('#view-cart-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);window.SoftInputMode.set('adjustResize');},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref97=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee95(){return regeneratorRuntime.wrap(function _callee95$(_context95){while(1){switch(_context95.prev=_context95.next){case 0:case'end':return _context95.stop();}}},_callee95,this);}));function pageHide(){return _ref97.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref98=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee96(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var toast;return regeneratorRuntime.wrap(function _callee96$(_context96){while(1){switch(_context96.prev=_context96.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].dataBind();$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].stop();_context96.prev=6;_context96.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart();case 9:_context96.next=18;break;case 11:_context96.prev=11;_context96.t0=_context96['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 18:_context96.prev=18;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context96.finish(18);case 24:case'end':return _context96.stop();}}},_callee96,this,[[6,11,18,24]]);}));function pagePullHookAction(){return _ref98.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to display the user cart on the View Cart page.
         * @param localCart {Array}
         *
         * @returns Promise
         */displayUserCart:function(){var _ref99=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee98(localCart){var displayContent,toast,index;return regeneratorRuntime.wrap(function _callee98$(_context98){while(1){switch(_context98.prev=_context98.next){case 0:displayContent="";// holds the cart content to be displayed
_context98.prev=1;_context98.prev=2;_context98.t0=localCart;if(_context98.t0){_context98.next=8;break;}_context98.next=7;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 7:_context98.t0=_context98.sent.cart;case 8:localCart=_context98.t0;_context98.next=14;break;case 11:_context98.prev=11;_context98.t1=_context98['catch'](2);// if error occurred during local cart retrieval
localCart=[];// set localCart to empty array
case 14:if(!(localCart.length===0)){_context98.next=24;break;}// localCart is empty
// display message to inform user that cart is empty
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Your cart is empty. Go order some products!';toast.dataBind();toast.show();return _context98.abrupt('return');case 24:// destroy all the "Edit" buttons on the View Cart page
$("#view-cart-page .view-cart-edit-button").each(function(index,element){// destroy the "Edit" button
element.ej2_instances[0].destroy();});// destroy all the "Remove" buttons required for the View Cart page
$("#view-cart-page .view-cart-remove-button").each(function(index,element){// destroy the "Remove" button
element.ej2_instances[0].destroy();});// destroy all the "Quantity" input required for the View Cart page
...
$("#view-cart-page .view-cart-quantity-input").each(function(index,element){var _ref101;new ej.inputs.NumericTextBox((_ref101={value:element.value,cssClass:'view-cart-quantity-input-class',currency:null,decimals:0,floatLabelType:'Auto',format:'n',showSpinButton:true,min:1,max:10,placeholder:' ',step:1,strictMode:true,width:'60%'},_defineProperty(_ref101,'value',1),_defineProperty(_ref101,'change',function change(){// track changes in the quantity numeric input for every product
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee97(){var selectedProduct,_toast7,_toast8;return regeneratorRuntime.wrap(function _callee97$(_context97){while(1){switch(_context97.prev=_context97.next){case 0:_context97.prev=0;// find the product to be updated within the app localCart
...
_context97.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 5:_context97.next=7;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart(localCart);case 7:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast7=$('.timed-page-toast').get(0).ej2_instances[0];_toast7.cssClass='success-ej2-toast';_toast7.timeOut=2000;_toast7.content='Product quantity updated';_toast7.dataBind();_toast7.show();_context97.next=28;break;case 17:_context97.prev=17;_context97.t0=_context97['catch'](0);console.log("UPDATE PRODUCT QUANTITY",_context97.t0);// hide all previously displayed ej2 toast
...
_toast8=$('.timed-page-toast').get(0).ej2_instances[0];_toast8.cssClass='error-ej2-toast';_toast8.timeOut=3500;_toast8.content='Product quantity not updated. Try again';_toast8.dataBind();_toast8.show();case 28:_context97.prev=28;// hide page preloader
$('#view-cart-page .page-preloader').css("display","none");return _context97.finish(28);case 31:case'end':return _context97.stop();}}},_callee97,this,[[0,17,28,31]]);})),0);}),_ref101)).appendTo(element);});// update the total price of items displayed
$('#view-cart-page #view-cart-total-price').html('&#x20a6;'+kendo.toString(utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.calculateCartTotalPrice(localCart),"n2"));case 33:_context98.prev=33;return _context98.finish(33);case 35:case'end':return _context98.stop();}}},_callee98,this,[[1,,33,35],[2,11]]);}));function displayUserCart(_x45){return _ref99.apply(this,arguments);}return displayUserCart;}(),/**
         * method is a utility/helper function used to view/load and display the user's cart
         *
         * @returns {Promise<void>}
         */viewCartPage:function(){var _ref102=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee99(){var toast;return regeneratorRuntime.wrap(function _callee99$(_context99){while(1){switch(_context99.prev=_context99.next){case 0:_context99.prev=0;_context99.next=3;return $('#app-main-navigator').get(0).bringPageTop("view-cart-page.html");case 3:_context99.next=5;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart();case 5:// enable the checkout button
$('#view-cart-page #view-cart-checkout').removeAttr("disabled");_context99.next=17;break;case 8:_context99.prev=8;_context99.t0=_context99['catch'](0);console.log("VIEW-CART PAGE",_context99.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred. Pull down to refresh';toast.dataBind();toast.show();case 17:_context99.prev=17;// hide the preloader
$('#view-cart-page .page-preloader').css("display","none");return _context99.finish(17);case 20:case'end':return _context99.stop();}}},_callee99,this,[[0,8,17,20]]);}));function viewCartPage(){return _ref102.apply(this,arguments);}return viewCartPage;}(),/**
...
return accumulator+currentElement.cartData.quantity*kendo.parseFloat(currentElement.product.price);}},0);},/**
         ...
         *
         * @returns {Promise<void>}
         */deleteCartItemButtonClicked:function(){var _ref103=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee102(){var productUId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:"";return regeneratorRuntime.wrap(function _callee102$(_context102){while(1){switch(_context102.prev=_context102.next){case 0:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
...
$('#view-cart-page-delete-cart-item-action-sheet #view-cart-page-delete-cart-item-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee100(){return regeneratorRuntime.wrap(function _callee100$(_context100){while(1){switch(_context100.prev=_context100.next){case 0:_context100.next=2;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').hide();case 2:case'end':return _context100.stop();}}},_callee100,this);}));// function for "Accept/Yes" button
$('#view-cart-page-delete-cart-item-action-sheet #view-cart-page-delete-cart-item-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee101(){var localCart,productIndex,$cartDisplayedItem,toast,_toast9;return regeneratorRuntime.wrap(function _callee101$(_context101){while(1){switch(_context101.prev=_context101.next){case 0:localCart=[];// holds the local cart array
_context101.prev=1;// display page preloader
$('#view-cart-page .page-preloader').css("display","block");// hide the action sheet
_context101.next=5;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').hide();case 5:_context101.prev=5;_context101.next=8;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 8:localCart=_context101.sent.cart;_context101.next=13;break;case 11:_context101.prev=11;_context101.t0=_context101['catch'](5);case 13:// get the product to be deleted from the cart
...
_context101.next=17;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 17:// hide from display, the cart item belonging to the deleted product
$cartDisplayedItem=$('#view-cart-page .col-xs-12[data-utopiasoftware-product-uid="'+productUId+'"]');_context101.next=20;return kendo.fx($cartDisplayedItem).expand("vertical").duration(250).reverse();case 20:// update the total price of items displayed
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=2000;toast.content='Product has been deleted from your cart';toast.dataBind();toast.show();_context101.next=42;break;case 31:_context101.prev=31;_context101.t1=_context101['catch'](1);console.log("DELETE CART ERROR",_context101.t1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast9=$('.timed-page-toast').get(0).ej2_instances[0];_toast9.cssClass='error-ej2-toast';_toast9.timeOut=3500;_toast9.content='Error deleting product from your cart. Try again';_toast9.dataBind();_toast9.show();case 42:_context101.prev=42;// hide page preloader
$('#view-cart-page .page-preloader').css("display","none");return _context101.finish(42);case 45:case'end':return _context101.stop();}}},_callee101,this,[[1,31,42,45],[5,11]]);}));// display the delete confirmation dialog
_context102.next=4;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').show();case 4:case'end':return _context102.stop();}}},_callee102,this);}));function deleteCartItemButtonClicked(){return _ref103.apply(this,arguments);}return deleteCartItemButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */editCartItemButtonClicked:function(){var _ref106=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee103(productUrl,cartItemKey){return regeneratorRuntime.wrap(function _callee103$(_context103){while(1){switch(_context103.prev=_context103.next){case 0:_context103.next=2;return $('#app-main-navigator').get(0).bringPageTop("customise-product-page.html");case 2:_context103.next=4;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(productUrl,cartItemKey);case 4:case'end':return _context103.stop();}}},_callee103,this);}));function editCartItemButtonClicked(_x48,_x49){return _ref106.apply(this,arguments);}return editCartItemButtonClicked;}(),/**
         * method is triggerd when the "Check Out" button is clicked
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref107=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee104(){var userDetails,toast,localCart,_toast10,_toast11,_toast12,orderData,userCart,index,key,_toast13;return regeneratorRuntime.wrap(function _callee104$(_context104){while(1){switch(_context104.prev=_context104.next){case 0:userDetails=null;// holds the user details
// check if a user has signed in
_context104.prev=1;_context104.next=4;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 4:userDetails=_context104.sent.userDetails;_context104.next=19;break;case 7:_context104.prev=7;_context104.t0=_context104['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#app-main-navigator').get(0).pushPage('login-page.html');return _context104.abrupt('return');case 19:_context104.prev=19;_context104.next=22;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 22:localCart=_context104.sent.cart;if(!(localCart.length===0)){_context104.next=25;break;}throw"error";case 25:_context104.next=38;break;case 27:_context104.prev=27;_context104.t1=_context104['catch'](19);// display message to inform user that cart is empty
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast10=$('.timed-page-toast').get(0).ej2_instances[0];_toast10.cssClass='default-ej2-toast';_toast10.timeOut=3000;_toast10.content='Your cart is empty. Go order some products!';_toast10.dataBind();_toast10.show();return _context104.abrupt('return');case 38:if(!(userDetails.billing.address_1=="")){_context104.next=49;break;}// no billing address has been provided
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast11=$('.timed-page-toast').get(0).ej2_instances[0];_toast11.cssClass='error-ej2-toast';_toast11.timeOut=3500;_toast11.content='Please update your billing address to checkout your cart';_toast11.dataBind();_toast11.show();$('#app-main-navigator').get(0).pushPage('billing-info-page.html');return _context104.abrupt('return');case 49:if(!(navigator.connection.type===Connection.NONE)){_context104.next=59;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast12=$('.timed-page-toast').get(0).ej2_instances[0];_toast12.cssClass='error-ej2-toast';_toast12.timeOut=3000;_toast12.content='Connect to the Internet to checkout your cart';_toast12.dataBind();_toast12.show();return _context104.abrupt('return');case 59:// show the app loader modal
$('#loader-modal-message').html("Preparing Checkout...");$('#loader-modal').get(0).show();// show loader
// create the user's order object
orderData={status:"pending",currency:"NGN",customer_id:userDetails.id,billing:userDetails.billing,shipping:userDetails.shipping,line_items:[]};_context104.prev=62;_context104.next=65;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 65:userCart=_context104.sent.cart;// loop through the user cart item to create the order items
...
_context104.next=70;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(orderData)}));case 70:orderData=_context104.sent;_context104.next=73;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:orderData}});case 73:_context104.next=86;break;case 75:_context104.prev=75;_context104.t2=_context104['catch'](62);_context104.t2=JSON.parse(_context104.t2.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast13=$('.timed-page-toast').get(0).ej2_instances[0];_toast13.cssClass='error-ej2-toast';_toast13.timeOut=3000;_toast13.content='Checkout failed. '+(_context104.t2.message||"");_toast13.dataBind();_toast13.show();case 86:_context104.prev=86;// hide the app loader
$('#loader-modal').get(0).hide();// hide loader
return _context104.finish(86);case 89:case'end':return _context104.stop();}}},_callee104,this,[[1,7],[19,27],[62,75,86,89]]);}));function checkoutButtonClicked(){return _ref107.apply(this,arguments);}return checkoutButtonClicked;}()},/**
     ...
     */profilePageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref108=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee105(){return regeneratorRuntime.wrap(function _callee105$(_context105){while(1){switch(_context105.prev=_context105.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context105.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context105.abrupt('return');case 3:// listen for the back button event
...
$('#profile-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener);_context105.prev=9;// create the tooltip objects for the profile form
...
_context105.next=15;return utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.displayProfileContent();case 15:_context105.next=20;break;case 17:_context105.prev=17;_context105.t0=_context105['catch'](9);console.log("PROFILE ERROR",_context105.t0);case 20:_context105.prev=20;return _context105.finish(20);case 22:case'end':return _context105.stop();}}},_callee105,this,[[9,17,20,22]]);}));return function loadPageOnAppReady(){return _ref108.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref109=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee106(){return regeneratorRuntime.wrap(function _callee106$(_context106){while(1){switch(_context106.prev=_context106.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context106.stop();}}},_callee106,this);}));function pageHide(){return _ref109.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref110=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee107(){return regeneratorRuntime.wrap(function _callee107$(_context107){while(1){switch(_context107.prev=_context107.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the profile form
$("#profile-page #profile-form ons-input").each(function(index,element){document.getElementById('profile-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context107.stop();}}},_callee107,this);}));function scrollAndResizeEventListener(){return _ref110.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref111=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee108(){return regeneratorRuntime.wrap(function _callee108$(_context108){while(1){switch(_context108.prev=_context108.next){case 0:// run the validation method for the profile form
utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.profileFormValidator.whenValidate();case 1:case'end':return _context108.stop();}}},_callee108,this);}));function updateButtonClicked(){return _ref111.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the profile form is successfully validated
         *
         * @returns {Promise<void>}
         */profileFormValidated:function(){var _ref112=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee109(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast14,_toast15;return regeneratorRuntime.wrap(function _callee109$(_context109){while(1){switch(_context109.prev=_context109.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context109.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update your profile';toast.dataBind();toast.show();return _context109.abrupt('return');case 10:// disable the "Update" button
...
_context109.prev=17;_context109.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context109.sent.userDetails;console.log("USER DETAILS BEFORE PROFILE UPDATE",userDetails);// temporary hold the user id and password
...
_context109.next=38;return promisesArrayPromise;case 38:resultsArray=_context109.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context109.next=42;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 42:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast14=$('.timed-page-toast').get(0).ej2_instances[0];_toast14.cssClass='success-ej2-toast';_toast14.timeOut=3000;_toast14.content='User profile updated';_toast14.dataBind();_toast14.show();_context109.next=63;break;case 52:_context109.prev=52;_context109.t0=_context109['catch'](17);_context109.t0=JSON.parse(_context109.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast15=$('.timed-page-toast').get(0).ej2_instances[0];_toast15.cssClass='error-ej2-toast';_toast15.timeOut=3000;_toast15.content='User profile update failed. '+(_context109.t0.message||"");_toast15.dataBind();_toast15.show();case 63:_context109.prev=63;// enable the "Update" button
...
$('#profile-page .modal').css("display","none");return _context109.finish(63);case 70:return _context109.abrupt('return',promisesArrayPromise);case 71:case'end':return _context109.stop();}}},_callee109,this,[[17,52,63,70]]);}));function profileFormValidated(){return _ref112.apply(this,arguments);}return profileFormValidated;}(),/**
         * method is used to load the current user profile data into the profile form
         * @returns {Promise<void>}
         */displayProfileContent:function(){var _ref113=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee110(){var userDetails;return regeneratorRuntime.wrap(function _callee110$(_context110){while(1){switch(_context110.prev=_context110.next){case 0:_context110.prev=0;_context110.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context110.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user profile data in the profile form
$('#profile-page #profile-form #profile-email').val(userDetails.email);$('#profile-page #profile-form #profile-first-name').val(userDetails.first_name||"");$('#profile-page #profile-form #profile-last-name').val(userDetails.last_name||"");$('#profile-page #profile-form #profile-phone-number').val(userDetails.billing&&userDetails.billing.phone?userDetails.billing.phone:"");case 9:_context110.prev=9;// hide page preloader
...
$('#profile-page #profile-update').removeAttr("disabled");return _context110.finish(9);case 14:case'end':return _context110.stop();}}},_callee110,this,[[0,,9,14]]);}));function displayProfileContent(){return _ref113.apply(this,arguments);}return displayProfileContent;}()},/**
     ...
     */changePasswordPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref114=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee111(){return regeneratorRuntime.wrap(function _callee111$(_context111){while(1){switch(_context111.prev=_context111.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context111.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context111.abrupt('return');case 3:// listen for the back button event
...
$('#change-password-page #change-password-update').removeAttr("disabled");}case 10:case'end':return _context111.stop();}}},_callee111,this);}));return function loadPageOnAppReady(){return _ref114.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref115=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee112(){return regeneratorRuntime.wrap(function _callee112$(_context112){while(1){switch(_context112.prev=_context112.next){case 0:// hide the tooltips on the changePassword form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context112.stop();}}},_callee112,this);}));function pageHide(){return _ref115.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
var _ej2Button2=buttonElement.ej2_instances[0];_ej2Button2.iconCss='zmdi zmdi-eye';_ej2Button2.dataBind();}},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref116=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee113(){return regeneratorRuntime.wrap(function _callee113$(_context113){while(1){switch(_context113.prev=_context113.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the changePassword form
$("#change-password-page #change-password-form ons-input").each(function(index,element){document.getElementById('change-password-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context113.stop();}}},_callee113,this);}));function scrollAndResizeEventListener(){return _ref116.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref117=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee114(){return regeneratorRuntime.wrap(function _callee114$(_context114){while(1){switch(_context114.prev=_context114.next){case 0:// run the validation method for the profile form
utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.changePasswordFormValidator.whenValidate();case 1:case'end':return _context114.stop();}}},_callee114,this);}));function updateButtonClicked(){return _ref117.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the changePassword form is successfully validated
         *
         * @returns {Promise<void>}
         */changePasswordFormValidated:function(){var _ref118=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee115(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,resultsArray,_toast16,_toast17;return regeneratorRuntime.wrap(function _callee115$(_context115){while(1){switch(_context115.prev=_context115.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context115.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change password';toast.dataBind();toast.show();return _context115.abrupt('return');case 10:// disable the "Update" button
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context115.prev=17;_context115.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context115.sent.userDetails;console.log("USER DETAILS BEFORE PASSWORD CHANGE",userDetails);// check if the current password input matches that in the current user password
_context115.prev=22;_context115.next=25;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json",type:"get",// contentType: "application/json",
...
processData:false}));case 25:_context115.next=30;break;case 27:_context115.prev=27;_context115.t0=_context115['catch'](22);throw{responseText:JSON.stringify({message:"current password is incorrect."})};case 30:// temporary hold the user id
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context115.next=38;return promisesArrayPromise;case 38:resultsArray=_context115.sent;// add the user's new password to the user details retrieved from the server
...
_context115.next=43;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 43:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast16=$('.timed-page-toast').get(0).ej2_instances[0];_toast16.cssClass='success-ej2-toast';_toast16.timeOut=3000;_toast16.content='User password changed';_toast16.dataBind();_toast16.show();_context115.next=64;break;case 53:_context115.prev=53;_context115.t1=_context115['catch'](17);_context115.t1=JSON.parse(_context115.t1.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast17=$('.timed-page-toast').get(0).ej2_instances[0];_toast17.cssClass='error-ej2-toast';_toast17.timeOut=3000;_toast17.content='User password change failed. '+(_context115.t1.message||"");_toast17.dataBind();_toast17.show();case 64:_context115.prev=64;// enable the "Update" button
...
$('#change-password-page .modal').css("display","none");return _context115.finish(64);case 71:return _context115.abrupt('return',promisesArrayPromise);case 72:case'end':return _context115.stop();}}},_callee115,this,[[17,53,64,71],[22,27]]);}));function changePasswordFormValidated(){return _ref118.apply(this,arguments);}return changePasswordFormValidated;}()},/**
     ...
     */billingInfoPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref119=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee117(){var countryDataArray;return regeneratorRuntime.wrap(function _callee117$(_context117){while(1){switch(_context117.prev=_context117.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context117.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context117.abrupt('return');case 3:// listen for the back button event
...
$('#billing-info-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener);_context117.prev=11;// create the "Cancel" button
new ej.buttons.Button({//iconCss: "zmdi zmdi-shopping-cart-add utopiasoftware-icon-zoom-one-point-two",
//iconPosition: "Left"
...
_context117.next=17;return Promise.resolve($.ajax({url:'country-list.json',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 17:countryDataArray=_context117.sent;// create the tooltip objects for the billing info form
...
new ej.dropdowns.DropDownList({cssClass:"billing-info-dropdownlist",dataSource:countryDataArray.find(function(countryElement){return countryElement.code==="NG";}).states,fields:{value:'code',text:'name'},placeholder:"State",floatLabelType:'Auto',itemTemplate:'<span>${name}</span>',valueTemplate:'<span>${name}</span>',select:function(){var _ref120=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee116(){return regeneratorRuntime.wrap(function _callee116$(_context116){while(1){switch(_context116.prev=_context116.next){case 0:// listen for when dropdown list value is changed by selection
...
/*utopiasoftware[utopiasoftware_app_namespace].controller.
                                    billingInfoPageViewModel.updateButtonClicked()*/},0);case 1:case'end':return _context116.stop();}}},_callee116,this);}));function select(){return _ref120.apply(this,arguments);}return select;}()}).appendTo('#billing-info-state');// display the billing info on the billing info form
_context117.next=23;return utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.displayContent();case 23:_context117.next=28;break;case 25:_context117.prev=25;_context117.t0=_context117['catch'](11);console.log("BILLING ADDRESS ERROR",_context117.t0);case 28:_context117.prev=28;return _context117.finish(28);case 30:case'end':return _context117.stop();}}},_callee117,this,[[11,25,28,30]]);}));return function loadPageOnAppReady(){return _ref119.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref121=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee118(){return regeneratorRuntime.wrap(function _callee118$(_context118){while(1){switch(_context118.prev=_context118.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context118.stop();}}},_callee118,this);}));function pageHide(){return _ref121.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// destroy the tooltips on the profile form
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref122=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee119(){return regeneratorRuntime.wrap(function _callee119$(_context119){while(1){switch(_context119.prev=_context119.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the profile form
$('#billing-info-form textarea, #billing-info-form ons-input, #billing-info-form #billing-info-country, #billing-info-form #billing-info-state').each(function(index,element){document.getElementById('billing-info-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context119.stop();}}},_callee119,this);}));function scrollAndResizeEventListener(){return _ref122.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref123=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee120(){return regeneratorRuntime.wrap(function _callee120$(_context120){while(1){switch(_context120.prev=_context120.next){case 0:// run the validation method for the billing-info form
utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.billingInfoFormValidator.whenValidate();case 1:case'end':return _context120.stop();}}},_callee120,this);}));function updateButtonClicked(){return _ref123.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the billing-info form is successfully validated
         *
         * @returns {Promise<void>}
         */billingInfoFormValidated:function(){var _ref124=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee121(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast18,_toast19;return regeneratorRuntime.wrap(function _callee121$(_context121){while(1){switch(_context121.prev=_context121.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context121.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update your billing address';toast.dataBind();toast.show();return _context121.abrupt('return');case 10:// disable the "Update" button
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context121.prev=17;_context121.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context121.sent.userDetails;console.log("USER DETAILS BEFORE BILLING INFO UPDATE",userDetails);// temporary hold the user id and password
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context121.next=39;return promisesArrayPromise;case 39:resultsArray=_context121.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context121.next=43;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 43:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast18=$('.timed-page-toast').get(0).ej2_instances[0];_toast18.cssClass='success-ej2-toast';_toast18.timeOut=3000;_toast18.content='User billing address updated';_toast18.dataBind();_toast18.show();_context121.next=64;break;case 53:_context121.prev=53;_context121.t0=_context121['catch'](17);_context121.t0=JSON.parse(_context121.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast19=$('.timed-page-toast').get(0).ej2_instances[0];_toast19.cssClass='error-ej2-toast';_toast19.timeOut=3000;_toast19.content='User billing address update failed. '+(_context121.t0.message||"");_toast19.dataBind();_toast19.show();case 64:_context121.prev=64;// enable the "Update" button
...
$('#billing-info-page .modal').css("display","none");return _context121.finish(64);case 71:return _context121.abrupt('return',promisesArrayPromise);case 72:case'end':return _context121.stop();}}},_callee121,this,[[17,53,64,71]]);}));function billingInfoFormValidated(){return _ref124.apply(this,arguments);}return billingInfoFormValidated;}(),/**
         * method is used to load the current billing info data into the billing info form
         * @returns {Promise<void>}
         */displayContent:function(){var _ref125=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee125(){var userDetails,countryDropDownList,statesDropDownList;return regeneratorRuntime.wrap(function _callee125$(_context125){while(1){switch(_context125.prev=_context125.next){case 0:_context125.prev=0;_context125.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context125.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user billing info data in the billing info form
...
statesDropDownList.dataBind();}console.log("STATE VALUE",statesDropDownList.value);case 21:_context125.prev=21;// hide page preloader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee124(){return regeneratorRuntime.wrap(function _callee124$(_context124){while(1){switch(_context124.prev=_context124.next){case 0:// reinstate the country dropdownlist "select" listener
countryDropDownList.addEventListener("select",_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee123(){var countryDropDownList;return regeneratorRuntime.wrap(function _callee123$(_context123){while(1){switch(_context123.prev=_context123.next){case 0:// listen for when dropdown list value is changed by selection
countryDropDownList=this;// holds this dropdown list
// execute the task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee122(){var countryStatesArray,stateDropDownList;return regeneratorRuntime.wrap(function _callee122$(_context122){while(1){switch(_context122.prev=_context122.next){case 0:// get the country object and its states that represents the country value selected
...
stateDropDownList.dataBind();case 6:case'end':return _context122.stop();}}},_callee122,this);})),0);case 2:case'end':return _context123.stop();}}},_callee123,this);})));case 1:case'end':return _context124.stop();}}},_callee124,this);})),0);return _context125.finish(21);case 27:case'end':return _context125.stop();}}},_callee125,this,[[0,,21,27]]);}));function displayContent(){return _ref125.apply(this,arguments);}return displayContent;}()},/**
     ...
     */shippingInfoPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref129=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee127(){var countryDataArray;return regeneratorRuntime.wrap(function _callee127$(_context127){while(1){switch(_context127.prev=_context127.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context127.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context127.abrupt('return');case 3:// listen for the back button event
...
$('#shipping-info-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener);_context127.prev=11;// create the "Cancel" button
new ej.buttons.Button({//iconCss: "zmdi zmdi-shopping-cart-add utopiasoftware-icon-zoom-one-point-two",
//iconPosition: "Left"
...
// load the country data from the local list with the app
_context127.next=17;return Promise.resolve($.ajax({url:'country-list.json',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 17:countryDataArray=_context127.sent;// create the tooltip objects for the shipping info form
...
new ej.dropdowns.DropDownList({cssClass:"shipping-info-dropdownlist",dataSource:countryDataArray.find(function(countryElement){return countryElement.code==="NG";}).states,fields:{value:'code',text:'name'},placeholder:"State",floatLabelType:'Auto',itemTemplate:'<span>${name}</span>',valueTemplate:'<span>${name}</span>',select:function(){var _ref130=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee126(){return regeneratorRuntime.wrap(function _callee126$(_context126){while(1){switch(_context126.prev=_context126.next){case 0:// listen for when dropdown list value is changed by selection
// handle method task in a different event block
...
$('#shipping-info-page #shipping-info-form').get(0).ej2_instances[$('#shipping-info-state').get(0)._utopiasoftware_validator_index].close();},0);case 1:case'end':return _context126.stop();}}},_callee126,this);}));function select(){return _ref130.apply(this,arguments);}return select;}()}).appendTo('#shipping-info-state');// display the shipping info on the shipping info form
_context127.next=23;return utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.displayContent();case 23:_context127.next=28;break;case 25:_context127.prev=25;_context127.t0=_context127['catch'](11);console.log("SHIPPING INFO ERROR",_context127.t0);case 28:_context127.prev=28;return _context127.finish(28);case 30:case'end':return _context127.stop();}}},_callee127,this,[[11,25,28,30]]);}));return function loadPageOnAppReady(){return _ref129.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref131=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee128(){return regeneratorRuntime.wrap(function _callee128$(_context128){while(1){switch(_context128.prev=_context128.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context128.stop();}}},_callee128,this);}));function pageHide(){return _ref131.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref132=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee129(){return regeneratorRuntime.wrap(function _callee129$(_context129){while(1){switch(_context129.prev=_context129.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the shipping form
$('#shipping-info-form textarea, #shipping-info-form ons-input, #shipping-info-form #shipping-info-country, #shipping-info-form #shipping-info-state').each(function(index,element){document.getElementById('shipping-info-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context129.stop();}}},_callee129,this);}));function scrollAndResizeEventListener(){return _ref132.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref133=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee130(){return regeneratorRuntime.wrap(function _callee130$(_context130){while(1){switch(_context130.prev=_context130.next){case 0:// run the validation method for the shipping-info form
utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.shippingInfoFormValidator.whenValidate();case 1:case'end':return _context130.stop();}}},_callee130,this);}));function updateButtonClicked(){return _ref133.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the shipping-info form is successfully validated
         *
         * @returns {Promise<void>}
         */shippingInfoFormValidated:function(){var _ref134=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee131(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast20,_toast21;return regeneratorRuntime.wrap(function _callee131$(_context131){while(1){switch(_context131.prev=_context131.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context131.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update shipping information';toast.dataBind();toast.show();return _context131.abrupt('return');case 10:// disable the "Update" button
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context131.prev=17;_context131.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context131.sent.userDetails;console.log("USER DETAILS BEFORE SHIPPING INFO UPDATE",userDetails);// temporary hold the user id and password
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context131.next=40;return promisesArrayPromise;case 40:resultsArray=_context131.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context131.next=44;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 44:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast20=$('.timed-page-toast').get(0).ej2_instances[0];_toast20.cssClass='success-ej2-toast';_toast20.timeOut=3000;_toast20.content='Shipping information updated';_toast20.dataBind();_toast20.show();_context131.next=65;break;case 54:_context131.prev=54;_context131.t0=_context131['catch'](17);_context131.t0=JSON.parse(_context131.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast21=$('.timed-page-toast').get(0).ej2_instances[0];_toast21.cssClass='error-ej2-toast';_toast21.timeOut=3000;_toast21.content='Shipping information update failed. '+(_context131.t0.message||"");_toast21.dataBind();_toast21.show();case 65:_context131.prev=65;// enable the "Update" button
...
$('#shipping-info-page .modal').css("display","none");return _context131.finish(65);case 72:return _context131.abrupt('return',promisesArrayPromise);case 73:case'end':return _context131.stop();}}},_callee131,this,[[17,54,65,72]]);}));function shippingInfoFormValidated(){return _ref134.apply(this,arguments);}return shippingInfoFormValidated;}(),/**
         * method is used to load the current shipping info data into the shipping info form
         * @returns {Promise<void>}
         */displayContent:function(){var _ref135=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee135(){var userDetails,countryDropDownList,statesDropDownList;return regeneratorRuntime.wrap(function _callee135$(_context135){while(1){switch(_context135.prev=_context135.next){case 0:_context135.prev=0;_context135.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context135.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user shipping info data in the shipping info form
...
statesDropDownList.dataBind();}else{// the state dropdown has no value and the country selected is not nigeria
statesDropDownList.enabled=false;// disable the state dropdownlist
statesDropDownList.dataBind();}console.log("STATE VALUE",statesDropDownList.value);case 23:_context135.prev=23;// hide page preloader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee134(){return regeneratorRuntime.wrap(function _callee134$(_context134){while(1){switch(_context134.prev=_context134.next){case 0:// reinstate the country dropdownlist "select" listener
countryDropDownList.addEventListener("select",_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee133(){var countryDropDownList;return regeneratorRuntime.wrap(function _callee133$(_context133){while(1){switch(_context133.prev=_context133.next){case 0:// listen for when dropdown list value is changed by selection
countryDropDownList=this;// holds this dropdown list
// execute the task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee132(){var countryStatesArray,stateDropDownList;return regeneratorRuntime.wrap(function _callee132$(_context132){while(1){switch(_context132.prev=_context132.next){case 0:// get the country object and its states that represents the country value selected
countryStatesArray=countryDropDownList.getDataByValue(countryDropDownList.value).states;// get the state dropdownlist
...
stateDropDownList.dataBind();case 6:case'end':return _context132.stop();}}},_callee132,this);})),0);case 2:case'end':return _context133.stop();}}},_callee133,this);})));case 1:case'end':return _context134.stop();}}},_callee134,this);})),0);return _context135.finish(23);case 29:case'end':return _context135.stop();}}},_callee135,this,[[0,,23,29]]);}));function displayContent(){return _ref135.apply(this,arguments);}return displayContent;}()},/**
     ...
     */checkoutPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref139=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee136(){var promisesArray,toast;return regeneratorRuntime.wrap(function _callee136$(_context136){while(1){switch(_context136.prev=_context136.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context136.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context136.abrupt('return');case 3:// listen for the back button event
...
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder=$('#app-main-navigator').get(0).topPage.data.orderData;_context136.prev=6;// create the accorodion ej2 component used on the "Checkout" page
...
_context136.next=20;return Promise.all(promisesArray);case 20:promisesArray=_context136.sent;// filter only pay method that are enabled
...
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.countryArray=promisesArray[2];_context136.next=41;break;case 28:_context136.prev=28;_context136.t0=_context136['catch'](6);_context136.next=32;return $('#app-main-navigator').get(0).popPage();case 32:console.log("CHECKOUT ERROR",_context136.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Error preparing checkout. Please retry';toast.dataBind();toast.show();case 41:_context136.prev=41;// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");return _context136.finish(41);case 45:case'end':return _context136.stop();}}},_callee136,this,[[6,28,41,45]]);}));return function loadPageOnAppReady(){return _ref139.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function(){var _ref140=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee137(){var paymentMethodDropDown,toast;return regeneratorRuntime.wrap(function _callee137$(_context137){while(1){switch(_context137.prev=_context137.next){case 0:if(!($('#checkout-page #checkout-payment-method-type').length==0)){_context137.next=2;break;}return _context137.abrupt('return');case 2:// get payment method dropdownlist component
...
if(!(paymentMethodDropDown.dataSource.length==0)){_context137.next=7;break;}// datasource for the payment method dropdownlist has not been set
// re-execute this method again after some time
window.setTimeout(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow,500);return _context137.abrupt('return');case 7:window.SoftInputMode.set('adjustResize');// adjust device input mode
...
$('#checkout-page .modal').css("display","table");_context137.prev=11;_context137.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.displayContent();case 14:_context137.next=30;break;case 16:_context137.prev=16;_context137.t0=_context137['catch'](11);console.log("CHECKOUT SHOW ERROR",_context137.t0);// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Checkout error. Please retry or Pull Down to refresh';toast.dataBind();toast.show();return _context137.abrupt('return');case 30:_context137.prev=30;_context137.next=33;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.validateOrderCheckout();case 33:_context137.next=37;break;case 35:_context137.prev=35;_context137.t1=_context137['catch'](30);case 37:_context137.prev=37;// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");return _context137.finish(37);case 41:console.log("END OF CHECKOUT SHOW");case 42:case'end':return _context137.stop();}}},_callee137,this,[[11,16],[30,35,37,41]]);}));function pageShow(){return _ref140.apply(this,arguments);}return pageShow;}(),/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref141=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee138(){return regeneratorRuntime.wrap(function _callee138$(_context138){while(1){switch(_context138.prev=_context138.next){case 0://add listener for when the window is resized by virtue of the device keyboard being shown
...
tooltipArrayElem.close();});console.log("END OF CHECKOUT HIDE");case 3:case'end':return _context138.stop();}}},_callee138,this);}));function pageHide(){return _ref141.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref142=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee139(){return regeneratorRuntime.wrap(function _callee139$(_context139){while(1){switch(_context139.prev=_context139.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the checkout page
$('#checkout-page .utopiasoftware-checkout-failure').each(function(index,element){document.getElementById('checkout-page').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context139.stop();}}},_callee139,this);}));function scrollAndResizeEventListener(){return _ref142.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the "Edit" button for the billing details is clicked
         *
         * @returns {Promise<void>}
         */editBillingDetailsButtonClicked:function(){var _ref143=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee140(){return regeneratorRuntime.wrap(function _callee140$(_context140){while(1){switch(_context140.prev=_context140.next){case 0:// set the update billing details flag to true
...
$('#app-main-navigator').get(0).pushPage('billing-info-page.html');case 2:case'end':return _context140.stop();}}},_callee140,this);}));function editBillingDetailsButtonClicked(){return _ref143.apply(this,arguments);}return editBillingDetailsButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the shipping details is clicked
         *
         * @returns {Promise<void>}
         */editShippingDetailsButtonClicked:function(){var _ref144=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee141(){return regeneratorRuntime.wrap(function _callee141$(_context141){while(1){switch(_context141.prev=_context141.next){case 0:// set the update shipping details flag to true
...
$('#app-main-navigator').get(0).pushPage('shipping-info-page.html');case 2:case'end':return _context141.stop();}}},_callee141,this);}));function editShippingDetailsButtonClicked(){return _ref144.apply(this,arguments);}return editShippingDetailsButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the shipping method is clicked
         *
         * @returns {Promise<void>}
         */editShippingMethodButtonClicked:function(){var _ref145=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee142(){return regeneratorRuntime.wrap(function _callee142$(_context142){while(1){switch(_context142.prev=_context142.next){case 0:// handle the task in a separate event block
window.setTimeout(function(){// enable the shipping method dropdownlist
var shippingMethodDropdownList=$('#checkout-page #checkout-shipping-method-type').get(0).ej2_instances[0];shippingMethodDropdownList.enabled=true;shippingMethodDropdownList.dataBind();},0);case 1:case'end':return _context142.stop();}}},_callee142,this);}));function editShippingMethodButtonClicked(){return _ref145.apply(this,arguments);}return editShippingMethodButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the payment method is clicked
         *
         * @returns {Promise<void>}
         */editPaymentMethodButtonClicked:function(){var _ref146=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee143(){return regeneratorRuntime.wrap(function _callee143$(_context143){while(1){switch(_context143.prev=_context143.next){case 0:// handle the task in a separate event block
window.setTimeout(function(){// enable the payment method dropdownlist
var paymentMethodDropdownList=$('#checkout-page #checkout-payment-method-type').get(0).ej2_instances[0];paymentMethodDropdownList.enabled=true;paymentMethodDropdownList.dataBind();},0);case 1:case'end':return _context143.stop();}}},_callee143,this);}));function editPaymentMethodButtonClicked(){return _ref146.apply(this,arguments);}return editPaymentMethodButtonClicked;}(),/**
         * method is triggerd when  the "Apply" coupon button is clicked
         *
         * @returns {Promise<void>}
         */applyCouponButtonClicked:function(){var _ref147=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee144(){var toast,couponsArray,localOrderObject,_toast22;return regeneratorRuntime.wrap(function _callee144$(_context144){while(1){switch(_context144.prev=_context144.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context144.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to apply coupon';toast.dataBind();toast.show();return _context144.abrupt('return');case 10:_context144.prev=10;// show the page loader modal
$('#checkout-page .modal').css("display","table");// check if user has entered any  coupon code
if(!($('#checkout-page #checkout-payment-voucher-code').val().trim()==="")){_context144.next=14;break;}throw"error - no coupon code provided";case 14:_context144.next=16;return Promise.resolve($.ajax(// load the list of shipping zones
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{code:$('#checkout-page #checkout-payment-voucher-code').val().trim()}}));case 16:couponsArray=_context144.sent;if(!(couponsArray.length==0)){_context144.next=19;break;}throw"error - no coupon found";case 19:// get a local/deep-clone copy of the page's checkout order object
...
_context144.next=24;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 24:localOrderObject=_context144.sent;// update the page checkout order with the updated order from the server
...
_context144.next=29;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 29:_context144.next=42;break;case 31:_context144.prev=31;_context144.t0=_context144['catch'](10);// hide the page loader modal
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast22=$('.timed-page-toast').get(0).ej2_instances[0];_toast22.cssClass='error-ej2-toast';_toast22.timeOut=3000;_toast22.content='Coupon not applied. Invalid coupon code';_toast22.dataBind();_toast22.show();case 42:case'end':return _context144.stop();}}},_callee144,this,[[10,31]]);}));function applyCouponButtonClicked(){return _ref147.apply(this,arguments);}return applyCouponButtonClicked;}(),/**
         * method is triggerd when  the "Add" note button is clicked
         *
         * @returns {Promise<void>}
         */addNoteButtonClicked:function(){var _ref148=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee145(){var toast,localOrderObject,_toast23;return regeneratorRuntime.wrap(function _callee145$(_context145){while(1){switch(_context145.prev=_context145.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context145.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to add shipping notes to the order';toast.dataBind();toast.show();return _context145.abrupt('return');case 10:_context145.prev=10;// show page loader
...
_context145.next=17;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 17:localOrderObject=_context145.sent;// update the page checkout order with the updated order from the server
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder=localOrderObject;// clear the coupon code entered into the coupon/voucher input
...
_context145.next=22;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 22:_context145.next=35;break;case 24:_context145.prev=24;_context145.t0=_context145['catch'](10);// hide the page loader modal
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast23=$('.timed-page-toast').get(0).ej2_instances[0];_toast23.cssClass='error-ej2-toast';_toast23.timeOut=3000;_toast23.content='Shipping note could not added. Please retry';_toast23.dataBind();_toast23.show();case 35:case'end':return _context145.stop();}}},_callee145,this,[[10,24]]);}));function addNoteButtonClicked(){return _ref148.apply(this,arguments);}return addNoteButtonClicked;}(),/**
         * method is triggered when the user clicks the "Make Payment" button
         *
         * @returns {Promise<void>}
         */makePaymentButtonClicked:function(){var _ref149=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee148(){var toast,userDetails,payStackResponse,transactionCompletedUrl,searchParams,completedTransactionReference,localOrderObject,_toast24,_localOrderObject,_toast25;return regeneratorRuntime.wrap(function _callee148$(_context148){while(1){switch(_context148.prev=_context148.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context148.next=14;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();return _context148.abrupt('return');case 14:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="paystack")){_context148.next=76;break;}// user selected the paystack (Pay With Card)
...
_context148.prev=18;_context148.next=21;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 21:userDetails=_context148.sent.userDetails;_context148.next=24;return Promise.resolve($.ajax({url:'https://api.paystack.co/transaction/initialize',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Bearer "+Base64.decode(utopiasoftware[utopiasoftware_app_namespace].paystackAccessor));},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({email:userDetails.email,amount:""+kendo.parseFloat(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.total)*100,callback_url:"https://shopoakexclusive.com/"})}));case 24:payStackResponse=_context148.sent;if(!(payStackResponse.status===true)){_context148.next=54;break;}_context148.next=28;return new Promise(function(resolve,reject){// create/open inapp browser
...
}});});case 28:transactionCompletedUrl=_context148.sent;// get the search parameters object from the transaction completed url
...
if(!(!completedTransactionReference||completedTransactionReference==="")){_context148.next=33;break;}throw"error";case 33:// inform the user that their order is being placed
...
localOrderObject.coupon_lines=localOrderObject.coupon_lines.map(function(couponElem){return{code:couponElem.code};});// update the checkout order data on the remote server
_context148.next=40;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 40:localOrderObject=_context148.sent;_context148.prev=41;_context148.next=44;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 44:_context148.next=48;break;case 46:_context148.prev=46;_context148.t0=_context148['catch'](41);case 48:// update the checkout-order-placement-modal with the checkout order number
...
$('#checkout-order-placement-modal #checkout-order-placement-modal-ok-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee146(){return regeneratorRuntime.wrap(function _callee146$(_context146){while(1){switch(_context146.prev=_context146.next){case 0:_context146.next=2;return $('ons-splitter').get(0).content.load("app-main-template");case 2:_context146.next=4;return $('#checkout-order-placement-modal').get(0).hide();case 4:case'end':return _context146.stop();}}},_callee146,this);}));// show the 'checkout-order-placement-modal'
_context148.next=52;return $('#checkout-order-placement-modal').get(0).show();case 52:_context148.next=55;break;case 54:throw"error";case 55:_context148.next=68;break;case 57:_context148.prev=57;_context148.t1=_context148['catch'](18);console.log("PAYMENT ERROR",_context148.t1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast24=$('.timed-page-toast').get(0).ej2_instances[0];_toast24.cssClass='error-ej2-toast';_toast24.timeOut=3500;_toast24.content='Error making payment for this order. Try again';_toast24.dataBind();_toast24.show();case 68:_context148.prev=68;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
...
$('#loader-modal').get(0).hide();return _context148.finish(68);case 75:return _context148.abrupt('return');case 76:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="cod")){_context148.next=120;break;}// user selected the cod (Cash on Delivery)
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);// inform the user that their order is being placed
$('#loader-modal-message').html("Completing Order Placement...");_context148.next=81;return $('#loader-modal').get(0).show();case 81:_context148.prev=81;// get a local/deep-clone copy of the page's checkout order object
...
_context148.next=87;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+_localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(_localOrderObject)}));case 87:_localOrderObject=_context148.sent;_context148.prev=88;_context148.next=91;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 91:_context148.next=95;break;case 93:_context148.prev=93;_context148.t2=_context148['catch'](88);case 95:// update the checkout-order-placement-modal with the checkout order number
...
$('#checkout-order-placement-modal #checkout-order-placement-modal-ok-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee147(){return regeneratorRuntime.wrap(function _callee147$(_context147){while(1){switch(_context147.prev=_context147.next){case 0:_context147.next=2;return $('ons-splitter').get(0).content.load("app-main-template");case 2:_context147.next=4;return $('#checkout-order-placement-modal').get(0).hide();case 4:case'end':return _context147.stop();}}},_callee147,this);}));// show the 'checkout-order-placement-modal'
_context148.next=99;return $('#checkout-order-placement-modal').get(0).show();case 99:_context148.next=112;break;case 101:_context148.prev=101;_context148.t3=_context148['catch'](81);console.log("PAYMENT ERROR",_context148.t3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast25=$('.timed-page-toast').get(0).ej2_instances[0];_toast25.cssClass='error-ej2-toast';_toast25.timeOut=3500;_toast25.content='Error placing this order. Try again';_toast25.dataBind();_toast25.show();case 112:_context148.prev=112;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
$('#loader-modal').get(0).hide();return _context148.finish(112);case 119:return _context148.abrupt('return');case 120:case'end':return _context148.stop();}}},_callee148,this,[[18,57,68,75],[41,46],[81,101,112,119],[88,93]]);}));function makePaymentButtonClicked(){return _ref149.apply(this,arguments);}return makePaymentButtonClicked;}(),/**
         * method is used to load the current checkout/order data into the page
         * @returns {Promise<void>}
         */displayContent:function(){var _ref152=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee151(){var userDetails,orderData,shippingCountryCode,shippingZoneId,shippingCountry,shippingZone,shippingMethodsArray,shippingMethodDropDown,paymentMethodDropDown,couponsMultiSelectDropDown,couponsArray,orderItemsDisplayContent,index;return regeneratorRuntime.wrap(function _callee151$(_context151){while(1){switch(_context151.prev=_context151.next){case 0:_context151.prev=0;_context151.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context151.sent.userDetails;// check if the checkout order billing data should be updated with the current user's billing
...
_context151.next=23;return Promise.resolve($.ajax(// load the list of shipping zones
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 23:shippingMethodsArray=_context151.sent;// filter the shipping methods for only the methods that are enabled
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee149(){var toast,localOrderObject,remoteCartTotals,_toast26;return regeneratorRuntime.wrap(function _callee149$(_context149){while(1){switch(_context149.prev=_context149.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context149.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change shipping method';toast.dataBind();toast.show();return _context149.abrupt('return');case 10:// display the page loader modal
$('#checkout-page .modal').css("display","table");// get a local/deep-clone copy of the page's checkout order object
...
_context149.prev=15;_context149.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/oakscripts/setshipping.php',type:"post",//contentType: "application/json",
...
processData:false,data:JSON.stringify(localOrderObject)}));case 26:localOrderObject=_context149.sent;// update the page checkout order with the updated order from the server
...
_context149.next=32;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 32:_context149.next=47;break;case 34:_context149.prev=34;_context149.t0=_context149['catch'](15);console.log("CHECKOUT SHIPPING METHOD UPDATE ERROR",_context149.t0);_context149.t0=JSON.parse(_context149.t0.responseText.trim());// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast26=$('.timed-page-toast').get(0).ej2_instances[0];_toast26.cssClass='error-ej2-toast';_toast26.timeOut=3000;_toast26.content='Shipping method not updated, retry. '+(_context149.t0.message||"");_toast26.dataBind();_toast26.show();// hide the page loader modal
$('#checkout-page .modal').css("display","none");case 47:case'end':return _context149.stop();}}},_callee149,this,[[15,34]]);})),0);});// remove the "select" event listener for the shipping method dropdownlist
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee150(){var toast,localOrderObject,_toast27;return regeneratorRuntime.wrap(function _callee150$(_context150){while(1){switch(_context150.prev=_context150.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context150.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change payment method';toast.dataBind();toast.show();return _context150.abrupt('return');case 10:// display the page loader modal
$('#checkout-page .modal').css("display","table");// get a local/deep-clone copy of the page's checkout order object
...
localOrderObject.coupon_lines=localOrderObject.coupon_lines.map(function(couponElem){return{code:couponElem.code};});// update the checkout order data on the remote server
_context150.prev=15;_context150.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 18:localOrderObject=_context150.sent;// update the page checkout order with the updated order from the server
...
_context150.next=24;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 24:_context150.next=39;break;case 26:_context150.prev=26;_context150.t0=_context150['catch'](15);console.log("CHECKOUT PAYMENT METHOD UPDATE ERROR",_context150.t0);_context150.t0=JSON.parse(_context150.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast27=$('.timed-page-toast').get(0).ej2_instances[0];_toast27.cssClass='error-ej2-toast';_toast27.timeOut=3000;_toast27.content='Payment method not updated, retry. '+(_context150.t0.message||"");_toast27.dataBind();_toast27.show();// hide the page loader modal
$('#checkout-page .modal').css("display","none");case 39:case'end':return _context150.stop();}}},_callee150,this,[[15,26]]);})),0);});// set the order coupons
...
$('#checkout-page .checkout-page-discount').css("display","none");}case 50:_context151.prev=50;return _context151.finish(50);case 52:case'end':return _context151.stop();}}},_callee151,this,[[0,,50,52]]);}));function displayContent(){return _ref152.apply(this,arguments);}return displayContent;}(),/**
...
_context152.prev=2;_context152.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 5:userDetails=_context152.sent.userDetails;if(!(!userDetails.first_name||userDetails.first_name=="")){_context152.next=8;break;}throw"validation error";case 8:// user validation was successful
...
tooltipIndex=$('#checkout-page .checkout-personal-details-accordion-item .utopiasoftware-checkout-failure').get(0)._utopiasoftware_validator_index;$('#checkout-page').get(0).ej2_instances[tooltipIndex].close();_context152.next=24;break;case 14:_context152.prev=14;_context152.t0=_context152['catch'](2);// user details could not be loaded, so user validation failed
...
if(!(validationSuccessful===true)){_context152.next=34;break;}// validation was successful
// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");resolve();// resolve validation promise
return _context152.abrupt('return');case 34:// validation failed
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);reject();// reject validation promise
return _context152.abrupt('return');case 37:case'end':return _context152.stop();}}},_callee152,this,[[2,14]]);}));return function(_x50,_x51){return _ref156.apply(this,arguments);};}()));case 2:case'end':return _context153.stop();}}},_callee153,this);}));function validateOrderCheckout(){return _ref155.apply(this,arguments);}return validateOrderCheckout;}(),/**
...
index=0;case 8:if(!(index<orderData.line_items.length)){_context154.next=43;break;}console.log("1");cartItemData={};// use the line item meta data to create part of cartItemData
_iteratorNormalCompletion2=true;_didIteratorError2=false;_iteratorError2=undefined;_context154.prev=14;for(_iterator2=orderData.line_items[index].meta_data[Symbol.iterator]();!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){metaDataElem=_step2.value;console.log("2");if(metaDataElem.key==="_fpd_data"){// check the "key" property of the metaData object
...
_context154.next=22;break;case 18:_context154.prev=18;_context154.t0=_context154['catch'](14);_didIteratorError2=true;_iteratorError2=_context154.t0;case 22:_context154.prev=22;_context154.prev=23;if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}case 25:_context154.prev=25;if(!_didIteratorError2){_context154.next=28;break;}throw _iteratorError2;case 28:return _context154.finish(25);case 29:return _context154.finish(22);case 30:cartItemData.product_id=orderData.line_items[index].product_id;cartItemData.variation_id=orderData.line_items[index].variation_id;cartItemData.quantity=orderData.line_items[index].quantity;console.log("7");// add the created cartItemData to remote user cart
_context154.t1=addToCartPromises;_context154.next=37;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v2/cart/add',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));},crossDomain:true,xhrFields:{withCredentials:true},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(cartItemData)}));case 37:_context154.t2=_context154.sent;_context154.t1.push.call(_context154.t1,_context154.t2);console.log("8");case 40:index++;_context154.next=8;break;case 43:_context154.next=45;return Promise.all(addToCartPromises);case 45:resolve();// resolve the parent promise
case 46:_context154.prev=46;return _context154.finish(46);case 48:case'end':return _context154.stop();}}},_callee154,this,[[0,,46,48],[14,18,22,30],[23,,25,29]]);}));return function(_x53,_x54){return _ref158.apply(this,arguments);};}()));case 1:case'end':return _context155.stop();}}},_callee155,this);}));function createRemoteCartFromOrder(){return _ref157.apply(this,arguments);}return createRemoteCartFromOrder;}()},/**
     ...
     */trackOrderPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref159=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee157(){var searchAutoComplete;return regeneratorRuntime.wrap(function _callee157$(_context157){while(1){switch(_context157.prev=_context157.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context157.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context157.abrupt('return');case 3:// listen for the back button event
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee156(){var searchResultsArray,userDetails,toast,_toast28;return regeneratorRuntime.wrap(function _callee156$(_context156){while(1){switch(_context156.prev=_context156.next){case 0:searchResultsArray=[];_context156.prev=1;// hide the previously displayed orders info
...
_context156.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context156.sent.userDetails;_context156.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"search":searchValue});case 9:searchResultsArray=_context156.sent;_context156.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
...
$('#track-order-page .modal').css("display","none");}_context156.next=28;break;case 15:_context156.prev=15;_context156.t0=_context156['catch'](1);// hide the previously displayed orders info
$('#track-order-page .row').css("display","none");// show the page loader
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast28=$('.timed-page-toast').get(0).ej2_instances[0];_toast28.cssClass='error-ej2-toast';_toast28.timeOut=3000;_toast28.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast28.dataBind();_toast28.show();case 28:case'end':return _context156.stop();}}},_callee156,this,[[1,15]]);})),0);}}).appendTo('#track-order-page-input');}catch(err){}case 5:case'end':return _context157.stop();}}},_callee157,this);}));return function loadPageOnAppReady(){return _ref159.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref161=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee158(){return regeneratorRuntime.wrap(function _callee158$(_context158){while(1){switch(_context158.prev=_context158.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context158.stop();}}},_callee158,this);}));function pageHide(){return _ref161.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// destroy the search input autocomplete component
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param keyEvent
         * @returns {Promise<void>}
         */enterButtonClicked:function(){var _ref162=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee159(keyEvent){var searchAutoComplete;return regeneratorRuntime.wrap(function _callee159$(_context159){while(1){switch(_context159.prev=_context159.next){case 0:// check which key was pressed
if(keyEvent.which===kendo.keys.ENTER)// if the enter key was pressed
{// prevent the default action from occurring
keyEvent.preventDefault();keyEvent.stopImmediatePropagation();keyEvent.stopPropagation();// hide the device keyboard
Keyboard.hide();// get the search autocomplete component
...
searchAutoComplete.dataBind();// bind new value to the component
searchAutoComplete.change();// trigger the change method
}case 1:case'end':return _context159.stop();}}},_callee159,this);}));function enterButtonClicked(_x55){return _ref162.apply(this,arguments);}return enterButtonClicked;}(),/**
...
promisesArray.push(Promise.reject("no internet connection"));}return _context160.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context160.stop();}}},_callee160,this);}));function loadOrders(_x58){return _ref163.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref164=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee161(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee161$(_context161){while(1){switch(_context161.prev=_context161.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
...
$('#track-order-page #track-order-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context161.abrupt('return',displayCompletedPromise);case 2:case'end':return _context161.stop();}}},_callee161,this);}));function displayPageContent(_x59){return _ref164.apply(this,arguments);}return displayPageContent;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref165=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee163(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee163$(_context163){while(1){switch(_context163.prev=_context163.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee162(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee162$(_context162){while(1){switch(_context162.prev=_context162.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context162.prev=3;_context162.next=6;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 6:_context162.next=18;break;case 8:_context162.prev=8;_context162.t0=_context162['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context162.prev=18;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context162.finish(18);case 21:case'end':return _context162.stop();}}},_callee162,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context163.stop();}}},_callee163,this);}));function checkoutButtonClicked(_x60){return _ref165.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */detailsButtonClicked:function(){var _ref167=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee165(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee165$(_context165){while(1){switch(_context165.prev=_context165.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee164(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee164$(_context164){while(1){switch(_context164.prev=_context164.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context164.prev=3;_context164.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context164.next=18;break;case 8:_context164.prev=8;_context164.t0=_context164['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context164.prev=18;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context164.finish(18);case 21:case'end':return _context164.stop();}}},_callee164,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context165.stop();}}},_callee165,this);}));function detailsButtonClicked(_x61){return _ref167.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref169=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee168(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee168$(_context168){while(1){switch(_context168.prev=_context168.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context168.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context168.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee166(){return regeneratorRuntime.wrap(function _callee166$(_context166){while(1){switch(_context166.prev=_context166.next){case 0:_context166.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context166.stop();}}},_callee166,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee167(){var selectedOrder,userDetails,searchResultsArray,_toast29,_toast30;return regeneratorRuntime.wrap(function _callee167$(_context167){while(1){switch(_context167.prev=_context167.next){case 0:// display the page loader
$('#track-order-page .modal').css("display","table");_context167.prev=1;_context167.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
_context167.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+selectedOrder.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context167.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context167.sent.userDetails;_context167.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"search":$('#track-order-page #track-order-page-input').get(0).ej2_instances[0].value||""});case 13:searchResultsArray=_context167.sent;_context167.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast29=$('.timed-page-toast').get(0).ej2_instances[0];_toast29.cssClass='default-ej2-toast';_toast29.timeOut=2000;_toast29.content='Order #'+selectedOrder.id+' has been cancelled';_toast29.dataBind();_toast29.show();_context167.next=36;break;case 26:_context167.prev=26;_context167.t0=_context167['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast30=$('.timed-page-toast').get(0).ej2_instances[0];_toast30.cssClass='error-ej2-toast';_toast30.timeOut=3500;_toast30.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast30.dataBind();_toast30.show();case 36:_context167.prev=36;// display the page loader
$('#track-order-page .modal').css("display","none");return _context167.finish(36);case 39:case'end':return _context167.stop();}}},_callee167,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context168.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context168.stop();}}},_callee168,this);}));function cancelButtonClicked(_x62){return _ref169.apply(this,arguments);}return cancelButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref172=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee170(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee170$(_context170){while(1){switch(_context170.prev=_context170.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context170.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context170.abrupt('return');case 11:// show the page loader
$('#track-order-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee169(){var selectedOrder,newOrder,_toast31;return regeneratorRuntime.wrap(function _callee169$(_context169){while(1){switch(_context169.prev=_context169.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.trackOrderResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context169.prev=3;// create a new order object
...
_context169.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context169.sent;_context169.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context169.next=34;break;case 23:_context169.prev=23;_context169.t0=_context169['catch'](3);console.log(_context169.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast31=$('.timed-page-toast').get(0).ej2_instances[0];_toast31.cssClass='error-ej2-toast';_toast31.timeOut=3000;_toast31.content='Placing new order failed. Please retry';_toast31.dataBind();_toast31.show();case 34:_context169.prev=34;// hide the page loader
$('#track-order-page .modal').css("display","none");return _context169.finish(34);case 37:case'end':return _context169.stop();}}},_callee169,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context170.stop();}}},_callee170,this);}));function reorderButtonClicked(_x63){return _ref172.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */completedOrdersPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref174=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee171(){var userDetails,searchResultsArray,toast,_toast32;return regeneratorRuntime.wrap(function _callee171$(_context171){while(1){switch(_context171.prev=_context171.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context171.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context171.abrupt('return');case 3:// listen for the back button event
...
$('#completed-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context171.prev=6;// hide the previously displayed orders info
...
_context171.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context171.sent.userDetails;_context171.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 14:searchResultsArray=_context171.sent;_context171.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref175=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee172(){return regeneratorRuntime.wrap(function _callee172$(_context172){while(1){switch(_context172.prev=_context172.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context172.stop();}}},_callee172,this);}));function pageHide(){return _ref175.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref176=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee173(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast33;return regeneratorRuntime.wrap(function _callee173$(_context173){while(1){switch(_context173.prev=_context173.next){case 0:// disable pull-to-refresh widget till loading is done
$('#completed-orders-page #completed-orders-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context173.prev=2;// show the page loader
$('#completed-orders-page .modal').css("display","table");// load the user profile details from the app database
_context173.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context173.sent.userDetails;_context173.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 9:searchResultsArray=_context173.sent;_context173.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#completed-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#completed-orders-page .row').css("display","none");// hide the page loader
$('#completed-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
$('#completed-orders-page .page-preloader').css("display","none");// show the orders info
$('#completed-orders-page .row').css("display","block");// hide the page loader
$('#completed-orders-page .modal').css("display","none");}_context173.next=27;break;case 15:_context173.prev=15;_context173.t0=_context173['catch'](2);// hide the page preloader
$('#completed-orders-page .page-preloader').css("display","none");// show the page loader
$('#completed-orders-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast33=$('.timed-page-toast').get(0).ej2_instances[0];_toast33.cssClass='error-ej2-toast';_toast33.timeOut=3000;_toast33.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast33.dataBind();_toast33.show();case 27:_context173.prev=27;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context173.finish(27);case 32:case'end':return _context173.stop();}}},_callee173,this,[[2,15,27,32]]);}));function pagePullHookAction(){return _ref176.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to load orders to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
         ...
         *
         * @returns {Promise<void>}
         */loadOrders:function(){var _ref177=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee174(queryParam){var pageToAccess=arguments.length>1&&arguments[1]!==undefined?arguments[1]:queryParam.page||1;var pageSize=arguments.length>2&&arguments[2]!==undefined?arguments[2]:queryParam.per_page||20;var promisesArray;return regeneratorRuntime.wrap(function _callee174$(_context174){while(1){switch(_context174.prev=_context174.next){case 0:queryParam.page=pageToAccess;queryParam.per_page=pageSize;promisesArray=[];// holds the array for the promises used to load the orders
// check if there is internet connection or not
if(navigator.connection.type!==Connection.NONE){// there is internet connection
// load the requested products list from the server
promisesArray.push(new Promise(function(resolve,reject){Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"get",//contentType: "application/x-www-form-urlencoded",
...
promisesArray.push(Promise.reject("no internet connection"));}return _context174.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context174.stop();}}},_callee174,this);}));function loadOrders(_x67){return _ref177.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref178=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee175(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee175$(_context175){while(1){switch(_context175.prev=_context175.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
// check if the ordersArray is empty or not
if(ordersArray.length<=0){// there are no new content to display
resolve(ordersArray.length);// resolve promise with the length of the orders array
}else{// there are some orders to display
...
$('#completed-orders-page #completed-orders-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context175.abrupt('return',displayCompletedPromise);case 2:case'end':return _context175.stop();}}},_callee175,this);}));function displayPageContent(_x68){return _ref178.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref179=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee177(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee177$(_context177){while(1){switch(_context177.prev=_context177.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee176(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee176$(_context176){while(1){switch(_context176.prev=_context176.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context176.prev=3;_context176.next=6;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 6:_context176.next=18;break;case 8:_context176.prev=8;_context176.t0=_context176['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context176.prev=18;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context176.finish(18);case 21:case'end':return _context176.stop();}}},_callee176,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context177.stop();}}},_callee177,this);}));function checkoutButtonClicked(_x69){return _ref179.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */detailsButtonClicked:function(){var _ref181=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee179(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee179$(_context179){while(1){switch(_context179.prev=_context179.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee178(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee178$(_context178){while(1){switch(_context178.prev=_context178.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context178.prev=3;_context178.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context178.next=18;break;case 8:_context178.prev=8;_context178.t0=_context178['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context178.prev=18;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context178.finish(18);case 21:case'end':return _context178.stop();}}},_callee178,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context179.stop();}}},_callee179,this);}));function detailsButtonClicked(_x70){return _ref181.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref183=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee182(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee182$(_context182){while(1){switch(_context182.prev=_context182.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context182.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context182.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee180(){return regeneratorRuntime.wrap(function _callee180$(_context180){while(1){switch(_context180.prev=_context180.next){case 0:_context180.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context180.stop();}}},_callee180,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee181(){var selectedOrder,userDetails,searchResultsArray,_toast34,_toast35;return regeneratorRuntime.wrap(function _callee181$(_context181){while(1){switch(_context181.prev=_context181.next){case 0:// display the page loader
$('#completed-orders-page .modal').css("display","table");_context181.prev=1;_context181.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
selectedOrder.status="cancelled";// update the selectedOrder status remotely
_context181.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+selectedOrder.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context181.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context181.sent.userDetails;_context181.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 13:searchResultsArray=_context181.sent;_context181.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast34=$('.timed-page-toast').get(0).ej2_instances[0];_toast34.cssClass='default-ej2-toast';_toast34.timeOut=2000;_toast34.content='Order #'+selectedOrder.id+' has been cancelled';_toast34.dataBind();_toast34.show();_context181.next=36;break;case 26:_context181.prev=26;_context181.t0=_context181['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast35=$('.timed-page-toast').get(0).ej2_instances[0];_toast35.cssClass='error-ej2-toast';_toast35.timeOut=3500;_toast35.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast35.dataBind();_toast35.show();case 36:_context181.prev=36;// display the page loader
$('#completed-orders-page .modal').css("display","none");return _context181.finish(36);case 39:case'end':return _context181.stop();}}},_callee181,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context182.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context182.stop();}}},_callee182,this);}));function cancelButtonClicked(_x71){return _ref183.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref186=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee184(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee184$(_context184){while(1){switch(_context184.prev=_context184.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context184.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context184.abrupt('return');case 11:// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee183(){var selectedOrder,newOrder,_toast36;return regeneratorRuntime.wrap(function _callee183$(_context183){while(1){switch(_context183.prev=_context183.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context183.prev=3;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context183.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context183.sent;_context183.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context183.next=34;break;case 23:_context183.prev=23;_context183.t0=_context183['catch'](3);console.log(_context183.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast36=$('.timed-page-toast').get(0).ej2_instances[0];_toast36.cssClass='error-ej2-toast';_toast36.timeOut=3000;_toast36.content='Placing new order failed. Please retry';_toast36.dataBind();_toast36.show();case 34:_context183.prev=34;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context183.finish(34);case 37:case'end':return _context183.stop();}}},_callee183,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context184.stop();}}},_callee184,this);}));function reorderButtonClicked(_x72){return _ref186.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */pendingOrdersPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref188=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee185(){var userDetails,searchResultsArray,toast,_toast37;return regeneratorRuntime.wrap(function _callee185$(_context185){while(1){switch(_context185.prev=_context185.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context185.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context185.abrupt('return');case 3:// listen for the back button event
...
$('#pending-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context185.prev=6;// hide the previously displayed orders info
...
_context185.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context185.sent.userDetails;_context185.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 14:searchResultsArray=_context185.sent;_context185.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref189=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee186(){return regeneratorRuntime.wrap(function _callee186$(_context186){while(1){switch(_context186.prev=_context186.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context186.stop();}}},_callee186,this);}));function pageHide(){return _ref189.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// reset the view-model properties
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref190=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee187(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast38;return regeneratorRuntime.wrap(function _callee187$(_context187){while(1){switch(_context187.prev=_context187.next){case 0:// disable pull-to-refresh widget till loading is done
$('#pending-orders-page #pending-orders-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context187.prev=2;// show the page loader
$('#pending-orders-page .modal').css("display","table");// load the user profile details from the app database
_context187.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context187.sent.userDetails;_context187.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 9:searchResultsArray=_context187.sent;_context187.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#pending-orders-page .row').css("display","none");// hide the page loader
$('#pending-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
$('#pending-orders-page .page-preloader').css("display","none");// show the orders info
$('#pending-orders-page .row').css("display","block");// hide the page loader
$('#pending-orders-page .modal').css("display","none");}_context187.next=27;break;case 15:_context187.prev=15;_context187.t0=_context187['catch'](2);// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// show the page loader
$('#pending-orders-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast38=$('.timed-page-toast').get(0).ej2_instances[0];_toast38.cssClass='error-ej2-toast';_toast38.timeOut=3000;_toast38.content='Sorry, a search error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast38.dataBind();_toast38.show();case 27:_context187.prev=27;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context187.finish(27);case 32:case'end':return _context187.stop();}}},_callee187,this,[[2,15,27,32]]);}));function pagePullHookAction(){return _ref190.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to load orders to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
         ...
         *
         * @returns {Promise<void>}
         */loadOrders:function(){var _ref191=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee188(queryParam){var pageToAccess=arguments.length>1&&arguments[1]!==undefined?arguments[1]:queryParam.page||1;var pageSize=arguments.length>2&&arguments[2]!==undefined?arguments[2]:queryParam.per_page||20;var promisesArray;return regeneratorRuntime.wrap(function _callee188$(_context188){while(1){switch(_context188.prev=_context188.next){case 0:queryParam.page=pageToAccess;queryParam.per_page=pageSize;promisesArray=[];// holds the array for the promises used to load the orders
// check if there is internet connection or not
if(navigator.connection.type!==Connection.NONE){// there is internet connection
// load the requested products list from the server
promisesArray.push(new Promise(function(resolve,reject){Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"get",//contentType: "application/x-www-form-urlencoded",
...
promisesArray.push(Promise.reject("no internet connection"));}return _context188.abrupt('return',Promise.all(promisesArray));case 5:case'end':return _context188.stop();}}},_callee188,this);}));function loadOrders(_x76){return _ref191.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref192=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee189(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee189$(_context189){while(1){switch(_context189.prev=_context189.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
// check if the ordersArray is empty or not
if(ordersArray.length<=0){// there are no new content to display
resolve(ordersArray.length);// resolve promise with the length of the orders array
}else{// there are some orders to display
...
$('#pending-orders-page #pending-orders-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context189.abrupt('return',displayCompletedPromise);case 2:case'end':return _context189.stop();}}},_callee189,this);}));function displayPageContent(_x77){return _ref192.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref193=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee191(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee191$(_context191){while(1){switch(_context191.prev=_context191.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee190(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee190$(_context190){while(1){switch(_context190.prev=_context190.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context190.prev=3;_context190.next=6;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 6:_context190.next=18;break;case 8:_context190.prev=8;_context190.t0=_context190['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context190.prev=18;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context190.finish(18);case 21:case'end':return _context190.stop();}}},_callee190,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context191.stop();}}},_callee191,this);}));function checkoutButtonClicked(_x78){return _ref193.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */detailsButtonClicked:function(){var _ref195=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee193(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee193$(_context193){while(1){switch(_context193.prev=_context193.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee192(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee192$(_context192){while(1){switch(_context192.prev=_context192.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context192.prev=3;_context192.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context192.next=18;break;case 8:_context192.prev=8;_context192.t0=_context192['catch'](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Order checkout failed. Please retry';toast.dataBind();toast.show();case 18:_context192.prev=18;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context192.finish(18);case 21:case'end':return _context192.stop();}}},_callee192,this,[[3,8,18,21]]);})),0);case 3:case'end':return _context193.stop();}}},_callee193,this);}));function detailsButtonClicked(_x79){return _ref195.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref197=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee196(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee196$(_context196){while(1){switch(_context196.prev=_context196.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context196.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to cancel this order';toast.dataBind();toast.show();return _context196.abrupt('return');case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee194(){return regeneratorRuntime.wrap(function _callee194$(_context194){while(1){switch(_context194.prev=_context194.next){case 0:_context194.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case'end':return _context194.stop();}}},_callee194,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee195(){var selectedOrder,userDetails,searchResultsArray,_toast39,_toast40;return regeneratorRuntime.wrap(function _callee195$(_context195){while(1){switch(_context195.prev=_context195.next){case 0:// display the page loader
$('#pending-orders-page .modal').css("display","table");_context195.prev=1;_context195.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context195.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context195.sent.userDetails;_context195.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 13:searchResultsArray=_context195.sent;_context195.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast39=$('.timed-page-toast').get(0).ej2_instances[0];_toast39.cssClass='default-ej2-toast';_toast39.timeOut=2000;_toast39.content='Order #'+selectedOrder.id+' has been cancelled';_toast39.dataBind();_toast39.show();_context195.next=36;break;case 26:_context195.prev=26;_context195.t0=_context195['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast40=$('.timed-page-toast').get(0).ej2_instances[0];_toast40.cssClass='error-ej2-toast';_toast40.timeOut=3500;_toast40.content='Error cancelling order #'+selectedOrder.id+'. Try again';_toast40.dataBind();_toast40.show();case 36:_context195.prev=36;// display the page loader
$('#pending-orders-page .modal').css("display","none");return _context195.finish(36);case 39:case'end':return _context195.stop();}}},_callee195,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context196.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case'end':return _context196.stop();}}},_callee196,this);}));function cancelButtonClicked(_x80){return _ref197.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref200=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee198(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee198$(_context198){while(1){switch(_context198.prev=_context198.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context198.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to make a reorder';toast.dataBind();toast.show();return _context198.abrupt('return');case 11:// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee197(){var selectedOrder,newOrder,_toast41;return regeneratorRuntime.wrap(function _callee197$(_context197){while(1){switch(_context197.prev=_context197.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context197.prev=3;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context197.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context197.sent;_context197.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context197.next=34;break;case 23:_context197.prev=23;_context197.t0=_context197['catch'](3);console.log(_context197.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast41=$('.timed-page-toast').get(0).ej2_instances[0];_toast41.cssClass='error-ej2-toast';_toast41.timeOut=3000;_toast41.content='Placing new order failed. Please retry';_toast41.dataBind();_toast41.show();case 34:_context197.prev=34;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context197.finish(34);case 37:case'end':return _context197.stop();}}},_callee197,this,[[3,23,34,37]]);})),0);case 13:case'end':return _context198.stop();}}},_callee198,this);}));function reorderButtonClicked(_x81){return _ref200.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */orderDetailsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref202=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee199(){var promisesArray,orderId,toast;return regeneratorRuntime.wrap(function _callee199$(_context199){while(1){switch(_context199.prev=_context199.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context199.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context199.abrupt('return');case 3:// listen for the back button event
...
utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails=$('#app-main-navigator').get(0).topPage.data.orderData;_context199.prev=7;// create the "Reorder" button
new ej.splitbuttons.ProgressButton({cssClass:'e-hide-spinner',duration:10*60*60*1000// set spinner/progress duration for 10 hr
...
_context199.next=14;return Promise.all(promisesArray);case 14:promisesArray=_context199.sent;// get the order notes belonging to the specified order object
...
_context199.next=18;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 18:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context199.next=30;break;case 21:_context199.prev=21;_context199.t0=_context199['catch'](7);console.log("ORDER DETAILS ERROR",_context199.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 30:_context199.prev=30;// hide page preloader
$('#order-details-page .page-preloader').css("display","none");// hide page modal loader
$('#order-details-page .modal').css("display","none");return _context199.finish(30);case 34:case'end':return _context199.stop();}}},_callee199,this,[[7,21,30,34]]);}));return function loadPageOnAppReady(){return _ref202.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function(){var _ref203=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee200(){return regeneratorRuntime.wrap(function _callee200$(_context200){while(1){switch(_context200.prev=_context200.next){case 0:window.SoftInputMode.set('adjustPan');// adjust device input mode
// update cart count
$('#order-details-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);case 2:case'end':return _context200.stop();}}},_callee200,this);}));function pageShow(){return _ref203.apply(this,arguments);}return pageShow;}(),/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref204=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee201(){return regeneratorRuntime.wrap(function _callee201$(_context201){while(1){switch(_context201.prev=_context201.next){case 0:case'end':return _context201.stop();}}},_callee201,this);}));function pageHide(){return _ref204.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref205=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee202(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var promisesArray,orderId,toast;return regeneratorRuntime.wrap(function _callee202$(_context202){while(1){switch(_context202.prev=_context202.next){case 0:// disable pull-to-refresh widget till loading is done
$('#order-details-page #order-details-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context202.prev=2;// load the order notes attached to the loaded order details
promisesArray=[];// holds all created promises
orderId=utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails.id;// get the id for the specified order object
promisesArray.push(Promise.resolve($.ajax(// load the order notes for the specified order object
{url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+orderId+'/notes'),type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{"type":"any"}})));// wait for all promises to resolve
_context202.next=8;return Promise.all(promisesArray);case 8:promisesArray=_context202.sent;// get the order notes belonging to the specified order object
utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderNotesArray=promisesArray[0];// display the order details
_context202.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 12:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context202.next=26;break;case 15:_context202.prev=15;_context202.t0=_context202['catch'](2);// hide the page preloader
$('#order-details-page .page-preloader').css("display","none");// show the page loader
$('#order-details-page .modal').css("display","none");console.log("ORDER DETAILS ERROR",_context202.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 26:_context202.prev=26;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context202.finish(26);case 31:case'end':return _context202.stop();}}},_callee202,this,[[2,15,26,31]]);}));function pagePullHookAction(){return _ref205.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is triggered when the user clicks the "Reorder" button
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref206=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee204(){var toast;return regeneratorRuntime.wrap(function _callee204$(_context204){while(1){switch(_context204.prev=_context204.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context204.next=14;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].dataBind();$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].stop();return _context204.abrupt('return');case 14:// show the page loader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee203(){var selectedOrder,newOrder,_toast42;return regeneratorRuntime.wrap(function _callee203$(_context203){while(1){switch(_context203.prev=_context203.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails;_context203.prev=1;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context203.next=16;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 16:newOrder=_context203.sent;// hide the page loader
...
_context203.next=24;return $('#app-main-navigator').get(0).replacePage("checkout-page.html",{data:{orderData:newOrder}});case 24:_context203.next=42;break;case 26:_context203.prev=26;_context203.t0=_context203['catch'](1);console.log(_context203.t0,"REORDER ERROR");// hide the page loader
$('#order-details-page .modal').css("display","none");// disable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled",true);// add the spinner from the 'Reorder'
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast42=$('.timed-page-toast').get(0).ej2_instances[0];_toast42.cssClass='error-ej2-toast';_toast42.timeOut=3000;_toast42.content='Placing new order failed. Please retry';_toast42.dataBind();_toast42.show();case 42:_context203.prev=42;return _context203.finish(42);case 44:case'end':return _context203.stop();}}},_callee203,this,[[1,26,42,44]]);})),0);case 20:case'end':return _context204.stop();}}},_callee204,this);}));function reorderButtonClicked(){return _ref206.apply(this,arguments);}return reorderButtonClicked;}(),/**
         * method is used to load the order details data into the page
         * @returns {Promise<void>}
         */displayContent:function(){var _ref208=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee205(){var orderData,_displayContent,index,orderNote,_index;return regeneratorRuntime.wrap(function _callee205$(_context205){while(1){switch(_context205.prev=_context205.next){case 0:try{// get the order object set on this page
...
_displayContent+='<div class="col-xs-12" style="text-align: left; padding-right: 5px;\n                            padding-top: 10px; padding-bottom: 10px">'+orderData.shipping.postcode+'</div>';}_displayContent+='<div class="col-xs-12" style="text-align: left; padding-right: 5px;\n                            padding-top: 10px; padding-bottom: 10px">'+orderData.shipping.country+'</div>';$('#order-details-page #order-details-list .order-details-shipping-details').html(_displayContent);}finally{}case 1:case'end':return _context205.stop();}}},_callee205,this);}));function displayContent(){return _ref208.apply(this,arguments);}return displayContent;}()}};
