...
case 20:case'end':return _context41.stop();}}},_callee41,this,[[0,9]]);})),0);}));case 1:case'end':return _context42.stop();}}},_callee42,this);}));function profileListItemClicked(){return _ref41.apply(this,arguments);}return profileListItemClicked;}()},/**
     ...
     */loginPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref43=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee43(){return regeneratorRuntime.wrap(function _callee43$(_context43){while(1){switch(_context43.prev=_context43.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context43.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context43.abrupt('return');case 3:// listen for the back button event
...
new ej.buttons.Button({isToggle:true,cssClass:'e-flat e-small e-round',iconCss:"zmdi zmdi-eye",iconPosition:"Left"}).appendTo($('#signup-password-view-button',$thisPage).get(0));}catch(err){}case 20:case'end':return _context43.stop();}}},_callee43,this);}));return function loadPageOnAppReady(){return _ref43.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
window.addEventListener('keyboardDidShow',utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.keyboardShownAdjustView);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref44=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee44(){return regeneratorRuntime.wrap(function _callee44$(_context44){while(1){switch(_context44.prev=_context44.next){case 0:// remove listener for when the device keyboard is shown
...
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.loginFormValidator.destroy();utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.signupFormValidator.destroy();utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.forgotPasswordFormValidator.destroy();},/**
         * method is triggered when the device back button is clicked OR a similar action is triggered
         */backButtonClicked:function(){var _ref45=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee45(){return regeneratorRuntime.wrap(function _callee45$(_context45){while(1){switch(_context45.prev=_context45.next){case 0:return _context45.abrupt('return',$('#app-main-navigator').get(0).popPage());case 1:case'end':return _context45.stop();}}},_callee45,this);}));function backButtonClicked(){return _ref45.apply(this,arguments);}return backButtonClicked;}(),/**
...
$("#login-page ons-carousel-item.third .login-page-form-container").scrollTop(Math.floor($(document.activeElement).closest("ons-input").position().top-30));break;}},/**
         ...
         *
         * @returns {Promise<void>}
         */signinButtonClicked:function(){var _ref46=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee46(){return regeneratorRuntime.wrap(function _callee46$(_context46){while(1){switch(_context46.prev=_context46.next){case 0:// run the validation method for the sign-in form
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.loginFormValidator.whenValidate();case 1:case'end':return _context46.stop();}}},_callee46,this);}));function signinButtonClicked(){return _ref46.apply(this,arguments);}return signinButtonClicked;}(),/**
         * method is triggered when the "Sign Up" button is clicked
         *
         * @returns {Promise<void>}
         */signupButtonClicked:function(){var _ref47=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee47(){return regeneratorRuntime.wrap(function _callee47$(_context47){while(1){switch(_context47.prev=_context47.next){case 0:// run the validation method for the sign-in form
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.signupFormValidator.whenValidate();case 1:case'end':return _context47.stop();}}},_callee47,this);}));function signupButtonClicked(){return _ref47.apply(this,arguments);}return signupButtonClicked;}(),/**
         * method is triggered when the "Forgot Password" button is clicked
         *
         * @returns {Promise<void>}
         */forgotPasswordButtonClicked:function(){var _ref48=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee48(){return regeneratorRuntime.wrap(function _callee48$(_context48){while(1){switch(_context48.prev=_context48.next){case 0:// open inapp browser for user to reset password
cordova.InAppBrowser.open(window.encodeURI('https://shopoakexclusive.com/my-account/lost-password/'),'_blank','location=yes,clearcache=yes,clearsessioncache=yes,closebuttoncolor=#ffffff,hardwareback=no,hidenavigationbuttons=yes,hideurlbar=yes,zoom=no,toolbarcolor=#3f51b5');case 1:case'end':return _context48.stop();}}},_callee48,this);}));function forgotPasswordButtonClicked(){return _ref48.apply(this,arguments);}return forgotPasswordButtonClicked;}(),/**
         * method is triggered when the "Reset Password" button is clicked
         *
         * @returns {Promise<void>}
         */resetPasswordButtonClicked:function(){var _ref49=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee49(){return regeneratorRuntime.wrap(function _callee49$(_context49){while(1){switch(_context49.prev=_context49.next){case 0:// run the validation method for the sign-in form
utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.forgotPasswordFormValidator.whenValidate();case 1:case'end':return _context49.stop();}}},_callee49,this);}));function resetPasswordButtonClicked(){return _ref49.apply(this,arguments);}return resetPasswordButtonClicked;}(),/**
         * method is triggered when the login form is successfully validated
         *
         * @returns {Promise<void>}
         */loginFormValidated:function(){var _ref50=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee52(){var toast,promisesArray,userEmail,userPassword,promisesArrayPromise;return regeneratorRuntime.wrap(function _callee52$(_context52){while(1){switch(_context52.prev=_context52.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context52.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to sign in';toast.dataBind();toast.show();return _context52.abrupt('return');case 10:// display modal to user that signin is being completed
$('#loader-modal-message').html("Completing Signin...");_context52.next=13;return $('#loader-modal').get(0).show();case 13:// show loader
...
promisesArrayPromise.then(function(){var _ref51=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee50(resultsArray){var toast;return regeneratorRuntime.wrap(function _callee50$(_context50){while(1){switch(_context50.prev=_context50.next){case 0:// add the user's password to the user details retrieved from the server
resultsArray[1][0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context50.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[1][0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:_context50.next=5;return $('#loader-modal').get(0).hide();case 5:_context50.next=7;return utopiasoftware[utopiasoftware_app_namespace].controller.loginPageViewModel.backButtonClicked();case 7:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=3000;toast.content='User signin completed';toast.dataBind();toast.show();case 15:case'end':return _context50.stop();}}},_callee50,this);}));return function(_x21){return _ref51.apply(this,arguments);};}()).catch(function(){var _ref52=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee51(err){var toast;return regeneratorRuntime.wrap(function _callee51$(_context51){while(1){switch(_context51.prev=_context51.next){case 0:// an error occurred
console.log("SIGN IN ERROR",err);err=JSON.parse(err.responseText);// hide loader
_context51.next=4;return $('#loader-modal').get(0).hide();case 4:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Invalid user email or password. User signin failed ';toast.dataBind();toast.show();case 12:case'end':return _context51.stop();}}},_callee51,this);}));return function(_x22){return _ref52.apply(this,arguments);};}());return _context52.abrupt('return',promisesArrayPromise);case 21:case'end':return _context52.stop();}}},_callee52,this);}));function loginFormValidated(){return _ref50.apply(this,arguments);}return loginFormValidated;}(),/**
         * method is triggered when the sign up form is successfully validated
         *
         * @returns {Promise<void>}
         */signupFormValidated:function(){var _ref53=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee55(){var toast,promisesArray;return regeneratorRuntime.wrap(function _callee55$(_context55){while(1){switch(_context55.prev=_context55.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context55.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to sign up';toast.dataBind();toast.show();return _context55.abrupt('return');case 10:// display modal to user that signup is being completed
$('#loader-modal-message').html("Completing Signup...");_context55.next=13;return $('#loader-modal').get(0).show();case 13:// show loader
...
case 16:case'end':return _context53.stop();}}},_callee53,this);}));return function(_x23){return _ref54.apply(this,arguments);};}()).catch(function(){var _ref55=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee54(err){var toast;return regeneratorRuntime.wrap(function _callee54$(_context54){while(1){switch(_context54.prev=_context54.next){case 0:// an error occurred
...
case 13:case'end':return _context54.stop();}}},_callee54,this);}));return function(_x24){return _ref55.apply(this,arguments);};}());}));return _context55.abrupt('return',Promise.all(promisesArray));case 16:case'end':return _context55.stop();}}},_callee55,this);}));function signupFormValidated(){return _ref53.apply(this,arguments);}return signupFormValidated;}(),/**
         * method is triggered when the forgot password form is successfully validated
         *
         * @returns {Promise<void>}
         */forgotPasswordFormValidated:function(){var _ref56=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee56(){return regeneratorRuntime.wrap(function _callee56$(_context56){while(1){switch(_context56.prev=_context56.next){case 0:case'end':return _context56.stop();}}},_callee56,this);}));function forgotPasswordFormValidated(){return _ref56.apply(this,arguments);}return forgotPasswordFormValidated;}()},/**
     ...
     */productsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref57=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee57(){return regeneratorRuntime.wrap(function _callee57$(_context57){while(1){switch(_context57.prev=_context57.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context57.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context57.abrupt('return');case 3:// listen for the back button event
...
utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.productItemClicked(window.parseInt($(event.currentTarget).attr('data-product')),window.parseInt($(event.currentTarget).attr('data-page')));});try{}catch(err){}case 12:case'end':return _context57.stop();}}},_callee57,this);}));return function loadPageOnAppReady(){return _ref57.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref58=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee58(event){return regeneratorRuntime.wrap(function _callee58$(_context58){while(1){switch(_context58.prev=_context58.next){case 0:// flag that page infinite scroll should NOT be allowed
...
$('#products-page .page__content .infinite-load-container').remove();case 5:case'end':return _context58.stop();}}},_callee58,this);}));function pageHide(_x25){return _ref58.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){},/**
         * method is triggered when the device back button is clicked OR a similar action is triggered
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref59=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee59(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productArray,toast;return regeneratorRuntime.wrap(function _callee59$(_context59){while(1){switch(_context59.prev=_context59.next){case 0:// disable pull-to-refresh widget till loading is done
$('#products-page #products-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context59.prev=2;_context59.next=5;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.loadProducts(utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentQueryParam,1);case 5:productArray=_context59.sent;_context59.next=8;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.displayPageContent(productArray[0]);case 8:_context59.next=17;break;case 10:_context59.prev=10;_context59.t0=_context59['catch'](2);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 17:_context59.prev=17;// hide the page preloader
...
doneCallBack();return _context59.finish(17);case 22:case'end':return _context59.stop();}}},_callee59,this,[[2,10,17,22]]);}));function pagePullHookAction(){return _ref59.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is triggered when the pull-hook on the page is active
         *
         * @param doneCallBack
         * @returns {Promise<void>}
         */pageInfiniteScroll:function(){var _ref60=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee60(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productArray,toast;return regeneratorRuntime.wrap(function _callee60$(_context60){while(1){switch(_context60.prev=_context60.next){case 0:if(!($('#products-page').get(0)._allowInfinitePageScroll===false)){_context60.next=3;break;}// page infinite scroll is NOT allowed
doneCallBack();return _context60.abrupt('return');case 3:// append an infinite load indicator to the bottom of the page
...
_context60.prev=6;_context60.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.loadProducts(utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentQueryParam,utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.currentPage+1);case 9:productArray=_context60.sent;_context60.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.productsPageViewModel.displayPageContent(productArray[0],true,false);case 12:_context60.next=21;break;case 14:_context60.prev=14;_context60.t0=_context60['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 21:_context60.prev=21;// check if any new products were retrieved
...
doneCallBack();return _context60.finish(21);case 25:case'end':return _context60.stop();}}},_callee60,this,[[6,14,21,25]]);}));function pageInfiniteScroll(){return _ref60.apply(this,arguments);}return pageInfiniteScroll;}(),/**
         * method is used to load products to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
...
reject(err);// reject the parent promise with the error
});}));}return _context61.abrupt('return',Promise.all(productPromisesArray));case 5:case'end':return _context61.stop();}}},_callee61,this);}));function loadProducts(_x30){return _ref61.apply(this,arguments);}return loadProducts;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref62=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee62(productsArray){var appendContent=arguments.length>1&&arguments[1]!==undefined?arguments[1]:true;var overwriteContent=arguments.length>2&&arguments[2]!==undefined?arguments[2]:true;var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee62$(_context62){while(1){switch(_context62.prev=_context62.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var productsContent="";// holds the contents for the products
// check if the productsArray is empty or not
if(productsArray.length<=0){// there are no new content to display
...
$('#products-page').get(0)._allowInfinitePageScroll=true;resolve(productsArray.length);// resolve the promise with length of the productsArray
}});return _context62.abrupt('return',displayCompletedPromise);case 2:case'end':return _context62.stop();}}},_callee62,this);}));function displayPageContent(_x33){return _ref62.apply(this,arguments);}return displayPageContent;}(),/**
         * method scrolls the page to the top
         * @returns {Promise<void>}
         */scrollPageToTop:function(){var _ref63=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee63(){return regeneratorRuntime.wrap(function _callee63$(_context63){while(1){switch(_context63.prev=_context63.next){case 0:window.setTimeout(function(){$('#products-page .page__content').animate({scrollTop:0},400);},0);case 1:case'end':return _context63.stop();}}},_callee63,this);}));function scrollPageToTop(){return _ref63.apply(this,arguments);}return scrollPageToTop;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */productItemClicked:function(){var _ref64=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee65(productIndex,productPage){return regeneratorRuntime.wrap(function _callee65$(_context65){while(1){switch(_context65.prev=_context65.next){case 0:// handle the function task in a different event queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee64(){var productItemsArray;return regeneratorRuntime.wrap(function _callee64$(_context64){while(1){switch(_context64.prev=_context64.next){case 0:_context64.prev=0;_context64.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData((""+productPage).padStart(7,"0")+"products",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 3:productItemsArray=_context64.sent.products;// display the products details page using the selected product
$('#app-main-navigator').get(0).pushPage("product-details-page.html",{animation:"lift",data:{product:productItemsArray[productIndex]}});_context64.next=9;break;case 7:_context64.prev=7;_context64.t0=_context64['catch'](0);case 9:case'end':return _context64.stop();}}},_callee64,this,[[0,7]]);})),0);case 1:case'end':return _context65.stop();}}},_callee65,this);}));function productItemClicked(_x34,_x35){return _ref64.apply(this,arguments);}return productItemClicked;}()},/**
     ...
     */productDetailsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref66=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee67(){var productDetailsArray,toast;return regeneratorRuntime.wrap(function _callee67$(_context67){while(1){switch(_context67.prev=_context67.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context67.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context67.abrupt('return');case 3:// listen for the back button event
...
$('#product-details-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context67.prev=6;// create the "Pick Quantity" button
...
$('#rate-product-modal #rate-product-rater-widget').rateYo({starWidth:"20px",normalFill:"#808080",ratedFill:"#F39C12",numStars:5,precision:0,rating:0,fullStar:true,spacing:"10px",onChange:function(){var _ref67=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee66(ratingValue,ratingWidgetInstance){return regeneratorRuntime.wrap(function _callee66$(_context66){while(1){switch(_context66.prev=_context66.next){case 0:// enable the the comment input and "Rate" button
$('#rate-product-modal #rate-product-comment').removeAttr("disabled");$('#rate-product-modal #rate-product-rate-button').removeAttr("disabled");case 2:case'end':return _context66.stop();}}},_callee66,this);}));function onChange(_x36,_x37){return _ref67.apply(this,arguments);}return onChange;}()});// load product variations asynchronously without waiting for the response
...
_context67.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProduct();case 16:productDetailsArray=_context67.sent;_context67.next=19;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.displayProductDetails(productDetailsArray[0]);case 19:// enable the "Add To Cart" button
$('#product-details-page #product-details-add-to-cart').removeAttr("disabled");_context67.next=30;break;case 22:_context67.prev=22;_context67.t0=_context67['catch'](6);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred.'+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+' Pull down to refresh and try again';toast.dataBind();toast.show();case 30:_context67.prev=30;// hide the preloader
$('#product-details-page .page-preloader').css("display","none");return _context67.finish(30);case 33:case'end':return _context67.stop();}}},_callee67,this,[[6,22,30,33]]);}));return function loadPageOnAppReady(){return _ref66.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
$('#product-details-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);window.SoftInputMode.set('adjustResize');},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref68=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee68(){return regeneratorRuntime.wrap(function _callee68$(_context68){while(1){switch(_context68.prev=_context68.next){case 0:case'end':return _context68.stop();}}},_callee68,this);}));function pageHide(){return _ref68.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();break;}}else{// there is only 1 page in the stack
         ...
         * @returns {Promise<void>}
         */shareButtonClicked:function(){var _ref69=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee69(){var shareOptions;return regeneratorRuntime.wrap(function _callee69$(_context69){while(1){switch(_context69.prev=_context69.next){case 0:shareOptions={};// holds the options for sharing
...
window.plugins.socialsharing.shareWithOptions(shareOptions,function(){},function(){});},0);case 4:case'end':return _context69.stop();}}},_callee69,this);}));function shareButtonClicked(){return _ref69.apply(this,arguments);}return shareButtonClicked;}(),/**
         * method is triggered when the "Rate" button is clicked
         * @returns {Promise<void>}
         */rateButtonClicked:function(){var _ref70=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee72(){var userDetails,toast,_toast,ordersArray,_toast2;return regeneratorRuntime.wrap(function _callee72$(_context72){while(1){switch(_context72.prev=_context72.next){case 0:userDetails=null;// holds the user details
// display page preloader
$('#product-details-page .page-preloader').css("display","block");// check if a user has signed in
_context72.prev=2;_context72.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 5:userDetails=_context72.sent.userDetails;_context72.next=20;break;case 8:_context72.prev=8;_context72.t0=_context72['catch'](2);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#product-details-page .page-preloader').css("display","none");return _context72.abrupt('return');case 20:if(!(navigator.connection.type===Connection.NONE)){_context72.next=31;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#product-details-page .page-preloader').css("display","none");return _context72.abrupt('return');case 31:_context72.prev=31;// display the page loader modal
$('#product-details-page .modal').css("display","table");// check if the current user has ever purchased this product before
_context72.next=35;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{status:"completed",customer:userDetails.id,product:utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.currentProductDetails.id}}));case 35:ordersArray=_context72.sent;if(!(ordersArray.length===0)){_context72.next=38;break;}throw"error";case 38:_context72.next=51;break;case 40:_context72.prev=40;_context72.t1=_context72['catch'](31);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast2=$('.timed-page-toast').get(0).ej2_instances[0];_toast2.cssClass='error-ej2-toast';_toast2.timeOut=3500;_toast2.content='Sorry, you need to have purchased this product before it can be rated';_toast2.dataBind();_toast2.show();return _context72.abrupt('return');case 51:_context72.prev=51;// hide page preloader
$('#product-details-page .page-preloader').css("display","none");// hide page loader
$('#product-details-page .modal').css("display","none");return _context72.finish(51);case 55:// set the handlers for the buttons on the "Rate Product" modal
$('#rate-product-modal #rate-product-cancel-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee70(){return regeneratorRuntime.wrap(function _callee70$(_context70){while(1){switch(_context70.prev=_context70.next){case 0:_context70.next=2;return $('#rate-product-modal').get(0).hide();case 2:case'end':return _context70.stop();}}},_callee70,this);}));$('#rate-product-modal #rate-product-rate-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee71(){var _toast3,_toast4;return regeneratorRuntime.wrap(function _callee71$(_context71){while(1){switch(_context71.prev=_context71.next){case 0:_context71.prev=0;_context71.next=3;return $('#rate-product-modal').get(0).hide();case 3:// inform user that review is being sent
$('#loader-modal-message').html("Sending User Review...");_context71.next=6;return $('#loader-modal').get(0).show();case 6:_context71.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/products/reviews',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
...
_context71.next=13;return $('#loader-modal').get(0).hide();case 13:// hide loader
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show success
_toast3=$('.timed-page-toast').get(0).ej2_instances[0];_toast3.cssClass='success-ej2-toast';_toast3.timeOut=3500;_toast3.content='Thank you. Your product review has been received';_toast3.dataBind();_toast3.show();_context71.next=37;break;case 23:_context71.prev=23;_context71.t0=_context71['catch'](0);_context71.next=27;return $('#loader-modal').get(0).hide();case 27:_context71.next=29;return $('#rate-product-modal').get(0).show();case 29:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show error
_toast4=$('.timed-page-toast').get(0).ej2_instances[0];_toast4.cssClass='error-ej2-toast';_toast4.timeOut=3500;_toast4.content='Error. Your product review could not be sent. Please retry';_toast4.dataBind();_toast4.show();case 37:_context71.prev=37;return _context71.finish(37);case 39:_context71.next=41;return $('#rate-product-modal').get(0).hide();case 41:case'end':return _context71.stop();}}},_callee71,this,[[0,23,37,39]]);}));// display "Rate Product" modal
_context72.next=59;return $('#rate-product-modal').get(0).show();case 59:case'end':return _context72.stop();}}},_callee72,this,[[2,8],[31,40,51,55]]);}));function rateButtonClicked(){return _ref70.apply(this,arguments);}return rateButtonClicked;}(),/**
         * method is triggered when the pull-hook on the page is active
         *
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref73=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee73(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var productDetailsArray,toast;return regeneratorRuntime.wrap(function _callee73$(_context73){while(1){switch(_context73.prev=_context73.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].dataBind();$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].stop();_context73.prev=6;// load product variations asynchronously without waiting for the response
utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProductVariations();// load product details
_context73.next=10;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.loadProduct();case 10:productDetailsArray=_context73.sent;_context73.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.displayProductDetails(productDetailsArray[0]);case 13:_context73.next=22;break;case 15:_context73.prev=15;_context73.t0=_context73['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 22:_context73.prev=22;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context73.finish(22);case 27:case'end':return _context73.stop();}}},_callee73,this,[[6,15,22,27]]);}));function pagePullHookAction(){return _ref73.apply(this,arguments);}return pagePullHookAction;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProduct:function(){var _ref74=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee74(){var productPromisesArray,toast,aProduct;return regeneratorRuntime.wrap(function _callee74$(_context74){while(1){switch(_context74.prev=_context74.next){case 0:productPromisesArray=[];// holds the array for the promises used to load the product
...
reject(err);// reject the parent promise with the error
});}));}return _context74.abrupt('return',Promise.all(productPromisesArray));case 4:case'end':return _context74.stop();}}},_callee74,this);}));function loadProduct(){return _ref74.apply(this,arguments);}return loadProduct;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProductVariations:function(){var _ref75=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee75(){var productPromisesArray,productId;return regeneratorRuntime.wrap(function _callee75$(_context75){while(1){switch(_context75.prev=_context75.next){case 0:productPromisesArray=[];// holds the array for the promises used to load the product
...
reject(err);// reject the parent promise with the error
});}));return _context75.abrupt('return',Promise.all(productPromisesArray));case 5:case'end':return _context75.stop();}}},_callee75,this);}));function loadProductVariations(){return _ref75.apply(this,arguments);}return loadProductVariations;}(),/**
         * method is used to display the product details on the page
         *
         * @param productDetails {Object} the product object to be displayed
         *
         * @returns {Promise<void>}
         */displayProductDetails:function(){var _ref76=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee78(productDetails){var variationContent,index;return regeneratorRuntime.wrap(function _callee78$(_context78){while(1){switch(_context78.prev=_context78.next){case 0:// update the product details image
...
new ej.dropdowns.DropDownList({cssClass:"product-details-variation-class",placeholder:productDetails.attributes[index].name,floatLabelType:'Always',change:function(){var _ref77=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee77(){return regeneratorRuntime.wrap(function _callee77$(_context77){while(1){switch(_context77.prev=_context77.next){case 0:return _context77.abrupt('return',new Promise(function(resolve2,reject2){// handle the change in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee76(){var concatenatedVarationValue,variationIndexPosition,productVariation;return regeneratorRuntime.wrap(function _callee76$(_context76){while(1){switch(_context76.prev=_context76.next){case 0:concatenatedVarationValue="";// holds the concatenated variation values
...
resolve2();case 6:case'end':return _context76.stop();}}},_callee76,this);})),0);}));case 1:case'end':return _context77.stop();}}},_callee77,this);}));function change(){return _ref77.apply(this,arguments);}return change;}()}).appendTo(element);});// collapse the variations content
...
$('#product-details-page .product-details-weight').html(''+(!productDetails.weight||productDetails.weight==""?"(Not Available)":''+productDetails.weight));case 19:case'end':return _context78.stop();}}},_callee78,this);}));function displayProductDetails(_x39){return _ref76.apply(this,arguments);}return displayProductDetails;}(),/**
         * method is triggered when the customise button is clicked
         *
         * @returns {Promise<void>}
         */customiseButtonClicked:function(){var _ref79=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee80(){var toast;return regeneratorRuntime.wrap(function _callee80$(_context80){while(1){switch(_context80.prev=_context80.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context80.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to customise product';toast.dataBind();toast.show();return _context80.abrupt('return');case 10:// perform the method task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee79(){var productUrl,variationIndex,productVariation;return regeneratorRuntime.wrap(function _callee79$(_context79){while(1){switch(_context79.prev=_context79.next){case 0:productUrl="";// holds the url for the product being customised
...
_context79.next=4;return $('#app-main-navigator').get(0).pushPage("customise-product-page.html");case 4:_context79.next=6;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(productUrl);case 6:case'end':return _context79.stop();}}},_callee79,this);})),0);case 11:case'end':return _context80.stop();}}},_callee80,this);}));function customiseButtonClicked(){return _ref79.apply(this,arguments);}return customiseButtonClicked;}(),/**
         * method is triggered when the "Add To Cart" button is clicked
         *
         * @returns {Promise<void>}
         */addToCartButtonClicked:function(){var _ref81=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee82(){return regeneratorRuntime.wrap(function _callee82$(_context82){while(1){switch(_context82.prev=_context82.next){case 0:// disable the "Add To Cart" button
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee81(){var localCart,utopiasoftwareCartObject,variationIndex,productVariation,searchParams,_iteratorNormalCompletion,_didIteratorError,_iteratorError,_iterator,_step,_ref83,_ref84,key,value,toast,_toast5;return regeneratorRuntime.wrap(function _callee81$(_context81){while(1){switch(_context81.prev=_context81.next){case 0:localCart=[];// holds the local cart collection
utopiasoftwareCartObject={cartData:{}};// holds the object whose properties make up the cart item
// get the cached user cart
_context81.prev=2;_context81.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 5:localCart=_context81.sent.cart;_context81.next=10;break;case 8:_context81.prev=8;_context81.t0=_context81['catch'](2);case 10:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.productDetailsPageViewModel.currentProductVariationIndex!==-1)){_context81.next=36;break;}// a product variation was selected
...
utopiasoftwareCartObject.cartData.variation={};_iteratorNormalCompletion=true;_didIteratorError=false;_iteratorError=undefined;_context81.prev=19;for(_iterator=searchParams[Symbol.iterator]();!(_iteratorNormalCompletion=(_step=_iterator.next()).done);_iteratorNormalCompletion=true){_ref83=_step.value;_ref84=_slicedToArray(_ref83,2);key=_ref84[0];value=_ref84[1];utopiasoftwareCartObject.cartData.variation[key]=value;}// store the product variation object as additional data just for the mobile app
_context81.next=27;break;case 23:_context81.prev=23;_context81.t1=_context81['catch'](19);_didIteratorError=true;_iteratorError=_context81.t1;case 27:_context81.prev=27;_context81.prev=28;if(!_iteratorNormalCompletion&&_iterator.return){_iterator.return();}case 30:_context81.prev=30;if(!_didIteratorError){_context81.next=33;break;}throw _iteratorError;case 33:return _context81.finish(30);case 34:return _context81.finish(27);case 35:utopiasoftwareCartObject.productVariation=productVariation;case 36:// set the other properties of the cart data
...
utopiasoftwareCartObject.uid=Random.uuid4(utopiasoftware[utopiasoftware_app_namespace].randomisationEngine);_context81.prev=40;// add the created 'utopiasoftwareCartObject' to the user cart collection
localCart.push(utopiasoftwareCartObject);// save the updated cached user cart
_context81.next=44;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 44:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=2000;toast.content='Product has been added to your cart';toast.dataBind();toast.show();console.log("USER CART OBJECT",utopiasoftwareCartObject);_context81.next=66;break;case 55:_context81.prev=55;_context81.t2=_context81['catch'](40);console.log("PRODUCT DETAILS ERROR",_context81.t2);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast5=$('.timed-page-toast').get(0).ej2_instances[0];_toast5.cssClass='error-ej2-toast';_toast5.timeOut=3500;_toast5.content='Error adding product to your cart. Try again';_toast5.dataBind();_toast5.show();case 66:_context81.prev=66;// enable the "Add To Cart" button
$('#product-details-page #product-details-add-to-cart').removeAttr("disabled");// hide the spinner from the 'Add To Cart'
$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].dataBind();$('#product-details-page #product-details-add-to-cart').get(0).ej2_instances[0].stop();return _context81.finish(66);case 72:case'end':return _context81.stop();}}},_callee81,this,[[2,8],[19,23,27,35],[28,,30,34],[40,55,66,72]]);})),0);case 5:case'end':return _context82.stop();}}},_callee82,this);}));function addToCartButtonClicked(){return _ref81.apply(this,arguments);}return addToCartButtonClicked;}()},/**
     ...
     */customiseProductPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref85=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee83(){return regeneratorRuntime.wrap(function _callee83$(_context83){while(1){switch(_context83.prev=_context83.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context83.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context83.abrupt('return');case 3:// listen for the back button event
...
new ej.splitbuttons.ProgressButton({cssClass:'e-hide-spinner',duration:10*60*60*1000// set spinner/progress duration for 10 hr
}).appendTo('#customise-product-add-to-cart');}catch(err){console.log("CUSTOMISATION ERROR",err);}finally{}case 8:case'end':return _context83.stop();}}},_callee83,this);}));return function loadPageOnAppReady(){return _ref85.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref86=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee84(){return regeneratorRuntime.wrap(function _callee84$(_context84){while(1){switch(_context84.prev=_context84.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.deviceOnlineListener,false);case 2:case'end':return _context84.stop();}}},_callee84,this);}));function pageHide(){return _ref86.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         *
         * @returns {Promise<void>}
         */receiveMessageListener:function(){var _ref87=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee85(receiveEvent){var cartData;return regeneratorRuntime.wrap(function _callee85$(_context85){while(1){switch(_context85.prev=_context85.next){case 0:if(!(receiveEvent.origin!=="https://shopoakexclusive.com")){_context85.next=2;break;}return _context85.abrupt('return');case 2:if(!(receiveEvent.data==="page ready")){_context85.next=8;break;}// parent site is ready to work together
...
$('#customise-product-page .page-preloader').css("display","none");return _context85.abrupt('return');case 8:// the page sent cart data
...
$('.page-toast').get(0).ej2_instances[0].hide('All');_context86.prev=8;_context86.next=11;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationUrl,utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationCartKey);case 11:_context86.next=20;break;case 13:_context86.prev=13;_context86.t0=_context86['catch'](8);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 20:_context86.prev=20;window.setTimeout(function(){// wait for 2 sec before declaring loading done
...
doneCallBack();},2000);return _context86.finish(20);case 23:case'end':return _context86.stop();}}},_callee86,this,[[8,13,20,23]]);}));function pagePullHookAction(){return _ref88.apply(this,arguments);}return pagePullHookAction;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */loadProductCustomisation:function(){var _ref89=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee87(){var customisationUrl=arguments.length>0&&arguments[0]!==undefined?arguments[0]:utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationUrl;var remoteCartItemKey=arguments[1];var toast;return regeneratorRuntime.wrap(function _callee87$(_context87){while(1){switch(_context87.prev=_context87.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context87.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to customise product and Pull Down to refresh';toast.dataBind();toast.show();return _context87.abrupt('return');case 10:// check if the 'remoteCartItemKey' has been provided
...
utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.customisationPageLoadCount=0;utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.cartsQueue=[];return _context87.abrupt('return',true);case 16:case'end':return _context87.stop();}}},_callee87,this);}));function loadProductCustomisation(){return _ref89.apply(this,arguments);}return loadProductCustomisation;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */saveCustomisedProductToCart:function(){var _ref90=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee88(){var previousCartObject,updatedCartObject,property,customisedProduct,localCart,utopiasoftwareCartObject,customisedIndex,toast,_toast6;return regeneratorRuntime.wrap(function _callee88$(_context88){while(1){switch(_context88.prev=_context88.next){case 0:// get the previous remote cart object and the new/updated remote cart object
...
_context88.t0=regeneratorRuntime.keys(updatedCartObject);case 3:if((_context88.t1=_context88.t0()).done){_context88.next=60;break;}property=_context88.t1.value;if(previousCartObject[property]){_context88.next=58;break;}// property does not exist in the previousCartObject, so this property belongs to the latest customised product
...
utopiasoftwareCartObject={cartData:{}};// holds the object whose properties make up the cart item
// get the cached user cart
_context88.prev=10;_context88.next=13;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 13:localCart=_context88.sent.cart;// check if this is a save of an "edited" previously customised product
...
}_context88.next=19;break;case 17:_context88.prev=17;_context88.t2=_context88['catch'](10);case 19:// set the other properties of the cart data
...
utopiasoftwareCartObject.uid=Random.uuid4(utopiasoftware[utopiasoftware_app_namespace].randomisationEngine);_context88.prev=28;// add the created 'utopiasoftwareCartObject' to the user cart collection
localCart.push(utopiasoftwareCartObject);// save the updated cached user cart
_context88.next=32;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 32:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='success-ej2-toast';toast.timeOut=2000;toast.content='Customised product has been added to your cart';toast.dataBind();toast.show();_context88.next=53;break;case 42:_context88.prev=42;_context88.t3=_context88['catch'](28);console.log("CUSTOMISE PRODUCT ERROR",_context88.t3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast6=$('.timed-page-toast').get(0).ej2_instances[0];_toast6.cssClass='error-ej2-toast';_toast6.timeOut=3500;_toast6.content='Error adding customised product to your cart. Try again';_toast6.dataBind();_toast6.show();case 53:_context88.prev=53;// check if this is a save of an "edited" previously customised product
if(utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.currentCustomisationCartKey){// since a current customisation cart key exist, this is an update
...
$('#customise-product-page #customise-product-page-iframe-container .modal').css("display","none");return _context88.finish(53);case 57:return _context88.abrupt('break',60);case 58:_context88.next=3;break;case 60:case'end':return _context88.stop();}}},_callee88,this,[[10,17],[28,42,53,57]]);}));function saveCustomisedProductToCart(){return _ref90.apply(this,arguments);}return saveCustomisedProductToCart;}(),/**
         * method is triggered when the user clicks the "Add To Cart" button
         *
         * @returns {Promise<void>}
         */addToCartButtonClicked:function(){var _ref91=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee89(){var toast;return regeneratorRuntime.wrap(function _callee89$(_context89){while(1){switch(_context89.prev=_context89.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context89.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3500;toast.content='Please connect to the Internet to add customised product to cart';toast.dataBind();toast.show();return _context89.abrupt('return');case 10:// show the spinner on the 'Add To Cart' button to indicate process is ongoing
...
$('#customise-product-page #customise-product-page-iframe').get(0).contentWindow.utopiasoftware_addUsage();case 15:case'end':return _context89.stop();}}},_callee89,this);}));function addToCartButtonClicked(){return _ref91.apply(this,arguments);}return addToCartButtonClicked;}()},/**
     * this is the view-model/controller for the View Cart page
     */viewCartPageViewModel:{/**
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref92=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee90(){var toast;return regeneratorRuntime.wrap(function _callee90$(_context90){while(1){switch(_context90.prev=_context90.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context90.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
...
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred. Pull down to refresh';toast.dataBind();toast.show();}case 7:case'end':return _context90.stop();}}},_callee90,this);}));return function loadPageOnAppReady(){return _ref92.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){// update cart count
$('#view-cart-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);window.SoftInputMode.set('adjustResize');},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref93=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee91(){return regeneratorRuntime.wrap(function _callee91$(_context91){while(1){switch(_context91.prev=_context91.next){case 0:case'end':return _context91.stop();}}},_callee91,this);}));function pageHide(){return _ref93.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref94=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee92(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var toast;return regeneratorRuntime.wrap(function _callee92$(_context92){while(1){switch(_context92.prev=_context92.next){case 0:// disable pull-to-refresh widget till loading is done
...
$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].dataBind();$('#view-cart-page #view-cart-checkout').get(0).ej2_instances[0].stop();_context92.prev=6;_context92.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart();case 9:_context92.next=18;break;case 11:_context92.prev=11;_context92.t0=_context92['catch'](6);// an error occurred
// display toast to show that error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred. Refresh to try again";toast.dataBind();toast.show();case 18:_context92.prev=18;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context92.finish(18);case 24:case'end':return _context92.stop();}}},_callee92,this,[[6,11,18,24]]);}));function pagePullHookAction(){return _ref94.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to display the user cart on the View Cart page.
         * @param localCart {Array}
         *
         * @returns Promise
         */displayUserCart:function(){var _ref95=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee94(localCart){var displayContent,toast,index;return regeneratorRuntime.wrap(function _callee94$(_context94){while(1){switch(_context94.prev=_context94.next){case 0:displayContent="";// holds the cart content to be displayed
_context94.prev=1;_context94.prev=2;_context94.t0=localCart;if(_context94.t0){_context94.next=8;break;}_context94.next=7;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 7:_context94.t0=_context94.sent.cart;case 8:localCart=_context94.t0;_context94.next=14;break;case 11:_context94.prev=11;_context94.t1=_context94['catch'](2);// if error occurred during local cart retrieval
localCart=[];// set localCart to empty array
case 14:if(!(localCart.length===0)){_context94.next=24;break;}// localCart is empty
// display message to inform user that cart is empty
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content='Your cart is empty. Go order some products!';toast.dataBind();toast.show();return _context94.abrupt('return');case 24:// destroy all the "Edit" buttons on the View Cart page
$("#view-cart-page .view-cart-edit-button").each(function(index,element){// destroy the "Edit" button
element.ej2_instances[0].destroy();});// destroy all the "Remove" buttons required for the View Cart page
$("#view-cart-page .view-cart-remove-button").each(function(index,element){// destroy the "Remove" button
element.ej2_instances[0].destroy();});// destroy all the "Quantity" input required for the View Cart page
...
$("#view-cart-page .view-cart-quantity-input").each(function(index,element){var _ref97;new ej.inputs.NumericTextBox((_ref97={value:element.value,cssClass:'view-cart-quantity-input-class',currency:null,decimals:0,floatLabelType:'Auto',format:'n',showSpinButton:true,min:1,max:10,placeholder:' ',step:1,strictMode:true,width:'60%'},_defineProperty(_ref97,'value',1),_defineProperty(_ref97,'change',function change(){// track changes in the quantity numeric input for every product
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee93(){var selectedProduct,_toast7,_toast8;return regeneratorRuntime.wrap(function _callee93$(_context93){while(1){switch(_context93.prev=_context93.next){case 0:_context93.prev=0;// find the product to be updated within the app localCart
...
_context93.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 5:_context93.next=7;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart(localCart);case 7:// inform the user that the product has been added to cart
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast7=$('.timed-page-toast').get(0).ej2_instances[0];_toast7.cssClass='success-ej2-toast';_toast7.timeOut=2000;_toast7.content='Product quantity updated';_toast7.dataBind();_toast7.show();_context93.next=28;break;case 17:_context93.prev=17;_context93.t0=_context93['catch'](0);console.log("UPDATE PRODUCT QUANTITY",_context93.t0);// hide all previously displayed ej2 toast
...
_toast8=$('.timed-page-toast').get(0).ej2_instances[0];_toast8.cssClass='error-ej2-toast';_toast8.timeOut=3500;_toast8.content='Product quantity not updated. Try again';_toast8.dataBind();_toast8.show();case 28:_context93.prev=28;// hide page preloader
$('#view-cart-page .page-preloader').css("display","none");return _context93.finish(28);case 31:case'end':return _context93.stop();}}},_callee93,this,[[0,17,28,31]]);})),0);}),_ref97)).appendTo(element);});// update the total price of items displayed
$('#view-cart-page #view-cart-total-price').html('&#x20a6;'+kendo.toString(utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.calculateCartTotalPrice(localCart),"n2"));case 33:_context94.prev=33;return _context94.finish(33);case 35:case'end':return _context94.stop();}}},_callee94,this,[[1,,33,35],[2,11]]);}));function displayUserCart(_x44){return _ref95.apply(this,arguments);}return displayUserCart;}(),/**
         * method is a utility/helper function used to view/load and display the user's cart
         *
         * @returns {Promise<void>}
         */viewCartPage:function(){var _ref98=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee95(){var toast;return regeneratorRuntime.wrap(function _callee95$(_context95){while(1){switch(_context95.prev=_context95.next){case 0:_context95.prev=0;_context95.next=3;return $('#app-main-navigator').get(0).bringPageTop("view-cart-page.html");case 3:_context95.next=5;return utopiasoftware[utopiasoftware_app_namespace].controller.viewCartPageViewModel.displayUserCart();case 5:// enable the checkout button
$('#view-cart-page #view-cart-checkout').removeAttr("disabled");_context95.next=17;break;case 8:_context95.prev=8;_context95.t0=_context95['catch'](0);console.log("VIEW-CART PAGE",_context95.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content='Sorry, an error occurred. Pull down to refresh';toast.dataBind();toast.show();case 17:_context95.prev=17;// hide the preloader
$('#view-cart-page .page-preloader').css("display","none");return _context95.finish(17);case 20:case'end':return _context95.stop();}}},_callee95,this,[[0,8,17,20]]);}));function viewCartPage(){return _ref98.apply(this,arguments);}return viewCartPage;}(),/**
...
return accumulator+currentElement.cartData.quantity*kendo.parseFloat(currentElement.product.price);}},0);},/**
         ...
         *
         * @returns {Promise<void>}
         */deleteCartItemButtonClicked:function(){var _ref99=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee98(){var productUId=arguments.length>0&&arguments[0]!==undefined?arguments[0]:"";return regeneratorRuntime.wrap(function _callee98$(_context98){while(1){switch(_context98.prev=_context98.next){case 0:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
...
$('#view-cart-page-delete-cart-item-action-sheet #view-cart-page-delete-cart-item-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee96(){return regeneratorRuntime.wrap(function _callee96$(_context96){while(1){switch(_context96.prev=_context96.next){case 0:_context96.next=2;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').hide();case 2:case'end':return _context96.stop();}}},_callee96,this);}));// function for "Accept/Yes" button
$('#view-cart-page-delete-cart-item-action-sheet #view-cart-page-delete-cart-item-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee97(){var localCart,productIndex,$cartDisplayedItem,toast,_toast9;return regeneratorRuntime.wrap(function _callee97$(_context97){while(1){switch(_context97.prev=_context97.next){case 0:localCart=[];// holds the local cart array
_context97.prev=1;// display page preloader
$('#view-cart-page .page-preloader').css("display","block");// hide the action sheet
_context97.next=5;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').hide();case 5:_context97.prev=5;_context97.next=8;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 8:localCart=_context97.sent.cart;_context97.next=13;break;case 11:_context97.prev=11;_context97.t0=_context97['catch'](5);case 13:// get the product to be deleted from the cart
...
_context97.next=17;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-cart",docType:"USER_CART",cart:localCart},utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 17:// hide from display, the cart item belonging to the deleted product
$cartDisplayedItem=$('#view-cart-page .col-xs-12[data-utopiasoftware-product-uid="'+productUId+'"]');_context97.next=20;return kendo.fx($cartDisplayedItem).expand("vertical").duration(250).reverse();case 20:// update the total price of items displayed
...
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=2000;toast.content='Product has been deleted from your cart';toast.dataBind();toast.show();_context97.next=42;break;case 31:_context97.prev=31;_context97.t1=_context97['catch'](1);console.log("DELETE CART ERROR",_context97.t1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast9=$('.timed-page-toast').get(0).ej2_instances[0];_toast9.cssClass='error-ej2-toast';_toast9.timeOut=3500;_toast9.content='Error deleting product from your cart. Try again';_toast9.dataBind();_toast9.show();case 42:_context97.prev=42;// hide page preloader
$('#view-cart-page .page-preloader').css("display","none");return _context97.finish(42);case 45:case'end':return _context97.stop();}}},_callee97,this,[[1,31,42,45],[5,11]]);}));// display the delete confirmation dialog
_context98.next=4;return document.getElementById('view-cart-page-delete-cart-item-action-sheet').show();case 4:case'end':return _context98.stop();}}},_callee98,this);}));function deleteCartItemButtonClicked(){return _ref99.apply(this,arguments);}return deleteCartItemButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */editCartItemButtonClicked:function(){var _ref102=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee99(productUrl,cartItemKey){return regeneratorRuntime.wrap(function _callee99$(_context99){while(1){switch(_context99.prev=_context99.next){case 0:_context99.next=2;return $('#app-main-navigator').get(0).bringPageTop("customise-product-page.html");case 2:_context99.next=4;return utopiasoftware[utopiasoftware_app_namespace].controller.customiseProductPageViewModel.loadProductCustomisation(productUrl,cartItemKey);case 4:case'end':return _context99.stop();}}},_callee99,this);}));function editCartItemButtonClicked(_x47,_x48){return _ref102.apply(this,arguments);}return editCartItemButtonClicked;}(),/**
         * method is triggerd when the "Check Out" button is clicked
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref103=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee100(){var userDetails,toast,localCart,_toast10,_toast11,_toast12,orderData,userCart,index,key,_toast13;return regeneratorRuntime.wrap(function _callee100$(_context100){while(1){switch(_context100.prev=_context100.next){case 0:userDetails=null;// holds the user details
// check if a user has signed in
_context100.prev=1;_context100.next=4;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 4:userDetails=_context100.sent.userDetails;_context100.next=19;break;case 7:_context100.prev=7;_context100.t0=_context100['catch'](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#app-main-navigator').get(0).pushPage('login-page.html');return _context100.abrupt('return');case 19:_context100.prev=19;_context100.next=22;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 22:localCart=_context100.sent.cart;if(!(localCart.length===0)){_context100.next=25;break;}throw"error";case 25:_context100.next=38;break;case 27:_context100.prev=27;_context100.t1=_context100['catch'](19);// display message to inform user that cart is empty
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast10=$('.timed-page-toast').get(0).ej2_instances[0];_toast10.cssClass='default-ej2-toast';_toast10.timeOut=3000;_toast10.content='Your cart is empty. Go order some products!';_toast10.dataBind();_toast10.show();return _context100.abrupt('return');case 38:if(!(userDetails.billing.address_1=="")){_context100.next=49;break;}// no billing address has been provided
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast11=$('.timed-page-toast').get(0).ej2_instances[0];_toast11.cssClass='error-ej2-toast';_toast11.timeOut=3500;_toast11.content='Please update your billing address to checkout your cart';_toast11.dataBind();_toast11.show();$('#app-main-navigator').get(0).pushPage('billing-info-page.html');return _context100.abrupt('return');case 49:if(!(navigator.connection.type===Connection.NONE)){_context100.next=59;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast12=$('.timed-page-toast').get(0).ej2_instances[0];_toast12.cssClass='error-ej2-toast';_toast12.timeOut=3000;_toast12.content='Connect to the Internet to checkout your cart';_toast12.dataBind();_toast12.show();return _context100.abrupt('return');case 59:// show the app loader modal
$('#loader-modal-message').html("Preparing Checkout...");$('#loader-modal').get(0).show();// show loader
// create the user's order object
orderData={status:"pending",currency:"NGN",customer_id:userDetails.id,billing:userDetails.billing,shipping:userDetails.shipping,line_items:[]};_context100.prev=62;_context100.next=65;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 65:userCart=_context100.sent.cart;// loop through the user cart item to create the order items
...
_context100.next=70;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v3/orders',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(orderData)}));case 70:orderData=_context100.sent;_context100.next=73;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:orderData}});case 73:_context100.next=86;break;case 75:_context100.prev=75;_context100.t2=_context100['catch'](62);_context100.t2=JSON.parse(_context100.t2.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast13=$('.timed-page-toast').get(0).ej2_instances[0];_toast13.cssClass='error-ej2-toast';_toast13.timeOut=3000;_toast13.content='Checkout failed. '+(_context100.t2.message||"");_toast13.dataBind();_toast13.show();case 86:_context100.prev=86;// hide the app loader
$('#loader-modal').get(0).hide();// hide loader
return _context100.finish(86);case 89:case'end':return _context100.stop();}}},_callee100,this,[[1,7],[19,27],[62,75,86,89]]);}));function checkoutButtonClicked(){return _ref103.apply(this,arguments);}return checkoutButtonClicked;}()},/**
     ...
     */profilePageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref104=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee101(){return regeneratorRuntime.wrap(function _callee101$(_context101){while(1){switch(_context101.prev=_context101.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context101.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context101.abrupt('return');case 3:// listen for the back button event
...
$('#profile-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener);_context101.prev=9;// create the tooltip objects for the profile form
...
_context101.next=15;return utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.displayProfileContent();case 15:_context101.next=20;break;case 17:_context101.prev=17;_context101.t0=_context101['catch'](9);console.log("PROFILE ERROR",_context101.t0);case 20:_context101.prev=20;return _context101.finish(20);case 22:case'end':return _context101.stop();}}},_callee101,this,[[9,17,20,22]]);}));return function loadPageOnAppReady(){return _ref104.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref105=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee102(){return regeneratorRuntime.wrap(function _callee102$(_context102){while(1){switch(_context102.prev=_context102.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context102.stop();}}},_callee102,this);}));function pageHide(){return _ref105.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref106=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee103(){return regeneratorRuntime.wrap(function _callee103$(_context103){while(1){switch(_context103.prev=_context103.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the profile form
$("#profile-page #profile-form ons-input").each(function(index,element){document.getElementById('profile-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context103.stop();}}},_callee103,this);}));function scrollAndResizeEventListener(){return _ref106.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref107=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee104(){return regeneratorRuntime.wrap(function _callee104$(_context104){while(1){switch(_context104.prev=_context104.next){case 0:// run the validation method for the profile form
utopiasoftware[utopiasoftware_app_namespace].controller.profilePageViewModel.profileFormValidator.whenValidate();case 1:case'end':return _context104.stop();}}},_callee104,this);}));function updateButtonClicked(){return _ref107.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the profile form is successfully validated
         *
         * @returns {Promise<void>}
         */profileFormValidated:function(){var _ref108=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee105(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast14,_toast15;return regeneratorRuntime.wrap(function _callee105$(_context105){while(1){switch(_context105.prev=_context105.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context105.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update your profile';toast.dataBind();toast.show();return _context105.abrupt('return');case 10:// disable the "Update" button
...
_context105.prev=17;_context105.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context105.sent.userDetails;console.log("USER DETAILS BEFORE PROFILE UPDATE",userDetails);// temporary hold the user id and password
...
_context105.next=38;return promisesArrayPromise;case 38:resultsArray=_context105.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context105.next=42;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 42:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast14=$('.timed-page-toast').get(0).ej2_instances[0];_toast14.cssClass='success-ej2-toast';_toast14.timeOut=3000;_toast14.content='User profile updated';_toast14.dataBind();_toast14.show();_context105.next=63;break;case 52:_context105.prev=52;_context105.t0=_context105['catch'](17);_context105.t0=JSON.parse(_context105.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast15=$('.timed-page-toast').get(0).ej2_instances[0];_toast15.cssClass='error-ej2-toast';_toast15.timeOut=3000;_toast15.content='User profile update failed. '+(_context105.t0.message||"");_toast15.dataBind();_toast15.show();case 63:_context105.prev=63;// enable the "Update" button
...
$('#profile-page .modal').css("display","none");return _context105.finish(63);case 70:return _context105.abrupt('return',promisesArrayPromise);case 71:case'end':return _context105.stop();}}},_callee105,this,[[17,52,63,70]]);}));function profileFormValidated(){return _ref108.apply(this,arguments);}return profileFormValidated;}(),/**
         * method is used to load the current user profile data into the profile form
         * @returns {Promise<void>}
         */displayProfileContent:function(){var _ref109=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee106(){var userDetails;return regeneratorRuntime.wrap(function _callee106$(_context106){while(1){switch(_context106.prev=_context106.next){case 0:_context106.prev=0;_context106.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context106.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user profile data in the profile form
$('#profile-page #profile-form #profile-email').val(userDetails.email);$('#profile-page #profile-form #profile-first-name').val(userDetails.first_name||"");$('#profile-page #profile-form #profile-last-name').val(userDetails.last_name||"");$('#profile-page #profile-form #profile-phone-number').val(userDetails.billing&&userDetails.billing.phone?userDetails.billing.phone:"");case 9:_context106.prev=9;// hide page preloader
...
$('#profile-page #profile-update').removeAttr("disabled");return _context106.finish(9);case 14:case'end':return _context106.stop();}}},_callee106,this,[[0,,9,14]]);}));function displayProfileContent(){return _ref109.apply(this,arguments);}return displayProfileContent;}()},/**
     ...
     */changePasswordPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref110=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee107(){return regeneratorRuntime.wrap(function _callee107$(_context107){while(1){switch(_context107.prev=_context107.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context107.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context107.abrupt('return');case 3:// listen for the back button event
...
$('#change-password-page #change-password-update').removeAttr("disabled");}case 10:case'end':return _context107.stop();}}},_callee107,this);}));return function loadPageOnAppReady(){return _ref110.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref111=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee108(){return regeneratorRuntime.wrap(function _callee108$(_context108){while(1){switch(_context108.prev=_context108.next){case 0:// hide the tooltips on the changePassword form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context108.stop();}}},_callee108,this);}));function pageHide(){return _ref111.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
var _ej2Button2=buttonElement.ej2_instances[0];_ej2Button2.iconCss='zmdi zmdi-eye';_ej2Button2.dataBind();}},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref112=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee109(){return regeneratorRuntime.wrap(function _callee109$(_context109){while(1){switch(_context109.prev=_context109.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the changePassword form
$("#change-password-page #change-password-form ons-input").each(function(index,element){document.getElementById('change-password-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context109.stop();}}},_callee109,this);}));function scrollAndResizeEventListener(){return _ref112.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref113=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee110(){return regeneratorRuntime.wrap(function _callee110$(_context110){while(1){switch(_context110.prev=_context110.next){case 0:// run the validation method for the profile form
utopiasoftware[utopiasoftware_app_namespace].controller.changePasswordPageViewModel.changePasswordFormValidator.whenValidate();case 1:case'end':return _context110.stop();}}},_callee110,this);}));function updateButtonClicked(){return _ref113.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the changePassword form is successfully validated
         *
         * @returns {Promise<void>}
         */changePasswordFormValidated:function(){var _ref114=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee111(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,resultsArray,_toast16,_toast17;return regeneratorRuntime.wrap(function _callee111$(_context111){while(1){switch(_context111.prev=_context111.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context111.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change password';toast.dataBind();toast.show();return _context111.abrupt('return');case 10:// disable the "Update" button
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context111.prev=17;_context111.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context111.sent.userDetails;console.log("USER DETAILS BEFORE PASSWORD CHANGE",userDetails);// check if the current password input matches that in the current user password
_context111.prev=22;_context111.next=25;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json",type:"get",// contentType: "application/json",
...
processData:false}));case 25:_context111.next=30;break;case 27:_context111.prev=27;_context111.t0=_context111['catch'](22);throw{responseText:JSON.stringify({message:"current password is incorrect."})};case 30:// temporary hold the user id
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context111.next=38;return promisesArrayPromise;case 38:resultsArray=_context111.sent;// add the user's new password to the user details retrieved from the server
...
_context111.next=43;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 43:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast16=$('.timed-page-toast').get(0).ej2_instances[0];_toast16.cssClass='success-ej2-toast';_toast16.timeOut=3000;_toast16.content='User password changed';_toast16.dataBind();_toast16.show();_context111.next=64;break;case 53:_context111.prev=53;_context111.t1=_context111['catch'](17);_context111.t1=JSON.parse(_context111.t1.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast17=$('.timed-page-toast').get(0).ej2_instances[0];_toast17.cssClass='error-ej2-toast';_toast17.timeOut=3000;_toast17.content='User password change failed. '+(_context111.t1.message||"");_toast17.dataBind();_toast17.show();case 64:_context111.prev=64;// enable the "Update" button
...
$('#change-password-page .modal').css("display","none");return _context111.finish(64);case 71:return _context111.abrupt('return',promisesArrayPromise);case 72:case'end':return _context111.stop();}}},_callee111,this,[[17,53,64,71],[22,27]]);}));function changePasswordFormValidated(){return _ref114.apply(this,arguments);}return changePasswordFormValidated;}()},/**
     ...
     */billingInfoPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref115=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee113(){var countryDataArray;return regeneratorRuntime.wrap(function _callee113$(_context113){while(1){switch(_context113.prev=_context113.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context113.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context113.abrupt('return');case 3:// listen for the back button event
...
$('#billing-info-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener);_context113.prev=11;// create the "Cancel" button
new ej.buttons.Button({//iconCss: "zmdi zmdi-shopping-cart-add utopiasoftware-icon-zoom-one-point-two",
//iconPosition: "Left"
...
_context113.next=17;return Promise.resolve($.ajax({url:'country-list.json',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 17:countryDataArray=_context113.sent;// create the tooltip objects for the billing info form
...
new ej.dropdowns.DropDownList({cssClass:"billing-info-dropdownlist",dataSource:countryDataArray.find(function(countryElement){return countryElement.code==="NG";}).states,fields:{value:'code',text:'name'},placeholder:"State",floatLabelType:'Auto',itemTemplate:'<span>${name}</span>',valueTemplate:'<span>${name}</span>',select:function(){var _ref116=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee112(){return regeneratorRuntime.wrap(function _callee112$(_context112){while(1){switch(_context112.prev=_context112.next){case 0:// listen for when dropdown list value is changed by selection
...
/*utopiasoftware[utopiasoftware_app_namespace].controller.
                                    billingInfoPageViewModel.updateButtonClicked()*/},0);case 1:case'end':return _context112.stop();}}},_callee112,this);}));function select(){return _ref116.apply(this,arguments);}return select;}()}).appendTo('#billing-info-state');// display the billing info on the billing info form
_context113.next=23;return utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.displayContent();case 23:_context113.next=28;break;case 25:_context113.prev=25;_context113.t0=_context113['catch'](11);console.log("BILLING ADDRESS ERROR",_context113.t0);case 28:_context113.prev=28;return _context113.finish(28);case 30:case'end':return _context113.stop();}}},_callee113,this,[[11,25,28,30]]);}));return function loadPageOnAppReady(){return _ref115.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref117=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee114(){return regeneratorRuntime.wrap(function _callee114$(_context114){while(1){switch(_context114.prev=_context114.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context114.stop();}}},_callee114,this);}));function pageHide(){return _ref117.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// destroy the tooltips on the profile form
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref118=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee115(){return regeneratorRuntime.wrap(function _callee115$(_context115){while(1){switch(_context115.prev=_context115.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the profile form
$('#billing-info-form textarea, #billing-info-form ons-input, #billing-info-form #billing-info-country, #billing-info-form #billing-info-state').each(function(index,element){document.getElementById('billing-info-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context115.stop();}}},_callee115,this);}));function scrollAndResizeEventListener(){return _ref118.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref119=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee116(){return regeneratorRuntime.wrap(function _callee116$(_context116){while(1){switch(_context116.prev=_context116.next){case 0:// run the validation method for the billing-info form
utopiasoftware[utopiasoftware_app_namespace].controller.billingInfoPageViewModel.billingInfoFormValidator.whenValidate();case 1:case'end':return _context116.stop();}}},_callee116,this);}));function updateButtonClicked(){return _ref119.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the billing-info form is successfully validated
         *
         * @returns {Promise<void>}
         */billingInfoFormValidated:function(){var _ref120=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee117(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast18,_toast19;return regeneratorRuntime.wrap(function _callee117$(_context117){while(1){switch(_context117.prev=_context117.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context117.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update your billing address';toast.dataBind();toast.show();return _context117.abrupt('return');case 10:// disable the "Update" button
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context117.prev=17;_context117.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context117.sent.userDetails;console.log("USER DETAILS BEFORE BILLING INFO UPDATE",userDetails);// temporary hold the user id and password
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context117.next=39;return promisesArrayPromise;case 39:resultsArray=_context117.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context117.next=43;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 43:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast18=$('.timed-page-toast').get(0).ej2_instances[0];_toast18.cssClass='success-ej2-toast';_toast18.timeOut=3000;_toast18.content='User billing address updated';_toast18.dataBind();_toast18.show();_context117.next=64;break;case 53:_context117.prev=53;_context117.t0=_context117['catch'](17);_context117.t0=JSON.parse(_context117.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast19=$('.timed-page-toast').get(0).ej2_instances[0];_toast19.cssClass='error-ej2-toast';_toast19.timeOut=3000;_toast19.content='User billing address update failed. '+(_context117.t0.message||"");_toast19.dataBind();_toast19.show();case 64:_context117.prev=64;// enable the "Update" button
...
$('#billing-info-page .modal').css("display","none");return _context117.finish(64);case 71:return _context117.abrupt('return',promisesArrayPromise);case 72:case'end':return _context117.stop();}}},_callee117,this,[[17,53,64,71]]);}));function billingInfoFormValidated(){return _ref120.apply(this,arguments);}return billingInfoFormValidated;}(),/**
         * method is used to load the current billing info data into the billing info form
         * @returns {Promise<void>}
         */displayContent:function(){var _ref121=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee121(){var userDetails,countryDropDownList,statesDropDownList;return regeneratorRuntime.wrap(function _callee121$(_context121){while(1){switch(_context121.prev=_context121.next){case 0:_context121.prev=0;_context121.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context121.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user billing info data in the billing info form
...
statesDropDownList.dataBind();}console.log("STATE VALUE",statesDropDownList.value);case 21:_context121.prev=21;// hide page preloader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee120(){return regeneratorRuntime.wrap(function _callee120$(_context120){while(1){switch(_context120.prev=_context120.next){case 0:// reinstate the country dropdownlist "select" listener
countryDropDownList.addEventListener("select",_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee119(){var countryDropDownList;return regeneratorRuntime.wrap(function _callee119$(_context119){while(1){switch(_context119.prev=_context119.next){case 0:// listen for when dropdown list value is changed by selection
countryDropDownList=this;// holds this dropdown list
// execute the task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee118(){var countryStatesArray,stateDropDownList;return regeneratorRuntime.wrap(function _callee118$(_context118){while(1){switch(_context118.prev=_context118.next){case 0:// get the country object and its states that represents the country value selected
...
stateDropDownList.dataBind();case 6:case'end':return _context118.stop();}}},_callee118,this);})),0);case 2:case'end':return _context119.stop();}}},_callee119,this);})));case 1:case'end':return _context120.stop();}}},_callee120,this);})),0);return _context121.finish(21);case 27:case'end':return _context121.stop();}}},_callee121,this,[[0,,21,27]]);}));function displayContent(){return _ref121.apply(this,arguments);}return displayContent;}()},/**
     ...
     */shippingInfoPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref125=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee123(){var countryDataArray;return regeneratorRuntime.wrap(function _callee123$(_context123){while(1){switch(_context123.prev=_context123.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context123.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context123.abrupt('return');case 3:// listen for the back button event
...
$('#shipping-info-page .content').on("scroll",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener);_context123.prev=11;// create the "Cancel" button
new ej.buttons.Button({//iconCss: "zmdi zmdi-shopping-cart-add utopiasoftware-icon-zoom-one-point-two",
//iconPosition: "Left"
...
// load the country data from the local list with the app
_context123.next=17;return Promise.resolve($.ajax({url:'country-list.json',type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 17:countryDataArray=_context123.sent;// create the tooltip objects for the shipping info form
...
new ej.dropdowns.DropDownList({cssClass:"shipping-info-dropdownlist",dataSource:countryDataArray.find(function(countryElement){return countryElement.code==="NG";}).states,fields:{value:'code',text:'name'},placeholder:"State",floatLabelType:'Auto',itemTemplate:'<span>${name}</span>',valueTemplate:'<span>${name}</span>',select:function(){var _ref126=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee122(){return regeneratorRuntime.wrap(function _callee122$(_context122){while(1){switch(_context122.prev=_context122.next){case 0:// listen for when dropdown list value is changed by selection
// handle method task in a different event block
...
$('#shipping-info-page #shipping-info-form').get(0).ej2_instances[$('#shipping-info-state').get(0)._utopiasoftware_validator_index].close();},0);case 1:case'end':return _context122.stop();}}},_callee122,this);}));function select(){return _ref126.apply(this,arguments);}return select;}()}).appendTo('#shipping-info-state');// display the shipping info on the shipping info form
_context123.next=23;return utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.displayContent();case 23:_context123.next=28;break;case 25:_context123.prev=25;_context123.t0=_context123['catch'](11);console.log("SHIPPING INFO ERROR",_context123.t0);case 28:_context123.prev=28;return _context123.finish(28);case 30:case'end':return _context123.stop();}}},_callee123,this,[[11,25,28,30]]);}));return function loadPageOnAppReady(){return _ref125.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function pageShow(){window.SoftInputMode.set('adjustResize');// update cart count
...
window.addEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref127=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee124(){return regeneratorRuntime.wrap(function _callee124$(_context124){while(1){switch(_context124.prev=_context124.next){case 0:// hide the tooltips on the profile form
...
window.removeEventListener("resize",utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.scrollAndResizeEventListener,false);case 3:case'end':return _context124.stop();}}},_callee124,this);}));function pageHide(){return _ref127.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref128=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee125(){return regeneratorRuntime.wrap(function _callee125$(_context125){while(1){switch(_context125.prev=_context125.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the shipping form
$('#shipping-info-form textarea, #shipping-info-form ons-input, #shipping-info-form #shipping-info-country, #shipping-info-form #shipping-info-state').each(function(index,element){document.getElementById('shipping-info-form').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context125.stop();}}},_callee125,this);}));function scrollAndResizeEventListener(){return _ref128.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the user clicks the "Update" button
         *
         * @returns {Promise<void>}
         */updateButtonClicked:function(){var _ref129=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee126(){return regeneratorRuntime.wrap(function _callee126$(_context126){while(1){switch(_context126.prev=_context126.next){case 0:// run the validation method for the shipping-info form
utopiasoftware[utopiasoftware_app_namespace].controller.shippingInfoPageViewModel.shippingInfoFormValidator.whenValidate();case 1:case'end':return _context126.stop();}}},_callee126,this);}));function updateButtonClicked(){return _ref129.apply(this,arguments);}return updateButtonClicked;}(),/**
         * method is triggered when the shipping-info form is successfully validated
         *
         * @returns {Promise<void>}
         */shippingInfoFormValidated:function(){var _ref130=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee127(){var toast,promisesArray,promisesArrayPromise,userDetails,userId,userPassword,resultsArray,_toast20,_toast21;return regeneratorRuntime.wrap(function _callee127$(_context127){while(1){switch(_context127.prev=_context127.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context127.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to update shipping information';toast.dataBind();toast.show();return _context127.abrupt('return');case 10:// disable the "Update" button
...
promisesArrayPromise=null;// holds the promise gotten from the promisesArray
_context127.prev=17;_context127.next=20;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 20:userDetails=_context127.sent.userDetails;console.log("USER DETAILS BEFORE SHIPPING INFO UPDATE",userDetails);// temporary hold the user id and password
...
processData:false,data:JSON.stringify(userDetails)})));// get the promise created from the promisesArray
promisesArrayPromise=Promise.all(promisesArray);// get the result from the promisesArray
_context127.next=40;return promisesArrayPromise;case 40:resultsArray=_context127.sent;// add the user's password to the user details retrieved from the server
resultsArray[0].password=userPassword;// save the created user details data to ENCRYPTED app database as cached data
_context127.next=44;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.saveData({_id:"user-details",docType:"USER_DETAILS",userDetails:resultsArray[0]},utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 44:// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast20=$('.timed-page-toast').get(0).ej2_instances[0];_toast20.cssClass='success-ej2-toast';_toast20.timeOut=3000;_toast20.content='Shipping information updated';_toast20.dataBind();_toast20.show();_context127.next=65;break;case 54:_context127.prev=54;_context127.t0=_context127['catch'](17);_context127.t0=JSON.parse(_context127.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast21=$('.timed-page-toast').get(0).ej2_instances[0];_toast21.cssClass='error-ej2-toast';_toast21.timeOut=3000;_toast21.content='Shipping information update failed. '+(_context127.t0.message||"");_toast21.dataBind();_toast21.show();case 65:_context127.prev=65;// enable the "Update" button
...
$('#shipping-info-page .modal').css("display","none");return _context127.finish(65);case 72:return _context127.abrupt('return',promisesArrayPromise);case 73:case'end':return _context127.stop();}}},_callee127,this,[[17,54,65,72]]);}));function shippingInfoFormValidated(){return _ref130.apply(this,arguments);}return shippingInfoFormValidated;}(),/**
         * method is used to load the current shipping info data into the shipping info form
         * @returns {Promise<void>}
         */displayContent:function(){var _ref131=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee131(){var userDetails,countryDropDownList,statesDropDownList;return regeneratorRuntime.wrap(function _callee131$(_context131){while(1){switch(_context131.prev=_context131.next){case 0:_context131.prev=0;_context131.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context131.sent.userDetails;console.log("USER DETAILS",userDetails);// display the user shipping info data in the shipping info form
...
statesDropDownList.dataBind();}else{// the state dropdown has no value and the country selected is not nigeria
statesDropDownList.enabled=false;// disable the state dropdownlist
statesDropDownList.dataBind();}console.log("STATE VALUE",statesDropDownList.value);case 23:_context131.prev=23;// hide page preloader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee130(){return regeneratorRuntime.wrap(function _callee130$(_context130){while(1){switch(_context130.prev=_context130.next){case 0:// reinstate the country dropdownlist "select" listener
countryDropDownList.addEventListener("select",_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee129(){var countryDropDownList;return regeneratorRuntime.wrap(function _callee129$(_context129){while(1){switch(_context129.prev=_context129.next){case 0:// listen for when dropdown list value is changed by selection
countryDropDownList=this;// holds this dropdown list
// execute the task in a separate event block
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee128(){var countryStatesArray,stateDropDownList;return regeneratorRuntime.wrap(function _callee128$(_context128){while(1){switch(_context128.prev=_context128.next){case 0:// get the country object and its states that represents the country value selected
countryStatesArray=countryDropDownList.getDataByValue(countryDropDownList.value).states;// get the state dropdownlist
...
stateDropDownList.dataBind();case 6:case'end':return _context128.stop();}}},_callee128,this);})),0);case 2:case'end':return _context129.stop();}}},_callee129,this);})));case 1:case'end':return _context130.stop();}}},_callee130,this);})),0);return _context131.finish(23);case 29:case'end':return _context131.stop();}}},_callee131,this,[[0,,23,29]]);}));function displayContent(){return _ref131.apply(this,arguments);}return displayContent;}()},/**
...
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder=$('#app-main-navigator').get(0).topPage.data.orderData;_context132.prev=6;// create the accorodion ej2 component used on the "Checkout" page
...
_context132.next=20;return Promise.all(promisesArray);case 20:promisesArray=_context132.sent;// filter only pay method that are enabled
...
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.countryArray=promisesArray[2];_context132.next=41;break;case 28:_context132.prev=28;_context132.t0=_context132['catch'](6);_context132.next=32;return $('#app-main-navigator').get(0).popPage();case 32:console.log("CHECKOUT ERROR",_context132.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Error preparing checkout. Please retry';toast.dataBind();toast.show();case 41:_context132.prev=41;// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");return _context132.finish(41);case 45:case'end':return _context132.stop();}}},_callee132,this,[[6,28,41,45]]);}));return function loadPageOnAppReady(){return _ref135.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function(){var _ref136=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee133(){var paymentMethodDropDown,toast;return regeneratorRuntime.wrap(function _callee133$(_context133){while(1){switch(_context133.prev=_context133.next){case 0:if(!($('#checkout-page #checkout-payment-method-type').length==0)){_context133.next=2;break;}return _context133.abrupt('return');case 2:// get payment method dropdownlist component
...
if(!(paymentMethodDropDown.dataSource.length==0)){_context133.next=7;break;}// datasource for the payment method dropdownlist has not been set
// re-execute this method again after some time
window.setTimeout(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow,500);return _context133.abrupt('return');case 7:window.SoftInputMode.set('adjustResize');// adjust device input mode
...
$('#checkout-page .modal').css("display","table");_context133.prev=11;_context133.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.displayContent();case 14:_context133.next=30;break;case 16:_context133.prev=16;_context133.t0=_context133['catch'](11);console.log("CHECKOUT SHOW ERROR",_context133.t0);// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Checkout error. Please retry or Pull Down to refresh';toast.dataBind();toast.show();return _context133.abrupt('return');case 30:_context133.prev=30;_context133.next=33;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.validateOrderCheckout();case 33:_context133.next=37;break;case 35:_context133.prev=35;_context133.t1=_context133['catch'](30);case 37:_context133.prev=37;// hide page preloader
$('#checkout-page .page-preloader').css("display","none");// hide page modal loader
$('#checkout-page .modal').css("display","none");return _context133.finish(37);case 41:console.log("END OF CHECKOUT SHOW");case 42:case'end':return _context133.stop();}}},_callee133,this,[[11,16],[30,35,37,41]]);}));function pageShow(){return _ref136.apply(this,arguments);}return pageShow;}(),/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref137=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee134(){return regeneratorRuntime.wrap(function _callee134$(_context134){while(1){switch(_context134.prev=_context134.next){case 0://add listener for when the window is resized by virtue of the device keyboard being shown
...
tooltipArrayElem.close();});console.log("END OF CHECKOUT HIDE");case 3:case'end':return _context134.stop();}}},_callee134,this);}));function pageHide(){return _ref137.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         *
         * @returns {Promise<void>}
         */scrollAndResizeEventListener:function(){var _ref138=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee135(){return regeneratorRuntime.wrap(function _callee135$(_context135){while(1){switch(_context135.prev=_context135.next){case 0:// place function execution in the event queue to be executed ASAP
window.setTimeout(function(){// adjust the tooltips elements on the checkout page
$('#checkout-page .utopiasoftware-checkout-failure').each(function(index,element){document.getElementById('checkout-page').ej2_instances[index].refresh(element);});},0);case 1:case'end':return _context135.stop();}}},_callee135,this);}));function scrollAndResizeEventListener(){return _ref138.apply(this,arguments);}return scrollAndResizeEventListener;}(),/**
         * method is triggered when the "Edit" button for the billing details is clicked
         *
         * @returns {Promise<void>}
         */editBillingDetailsButtonClicked:function(){var _ref139=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee136(){return regeneratorRuntime.wrap(function _callee136$(_context136){while(1){switch(_context136.prev=_context136.next){case 0:// set the update billing details flag to true
...
$('#app-main-navigator').get(0).pushPage('billing-info-page.html');case 2:case'end':return _context136.stop();}}},_callee136,this);}));function editBillingDetailsButtonClicked(){return _ref139.apply(this,arguments);}return editBillingDetailsButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the shipping details is clicked
         *
         * @returns {Promise<void>}
         */editShippingDetailsButtonClicked:function(){var _ref140=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee137(){return regeneratorRuntime.wrap(function _callee137$(_context137){while(1){switch(_context137.prev=_context137.next){case 0:// set the update shipping details flag to true
...
$('#app-main-navigator').get(0).pushPage('shipping-info-page.html');case 2:case'end':return _context137.stop();}}},_callee137,this);}));function editShippingDetailsButtonClicked(){return _ref140.apply(this,arguments);}return editShippingDetailsButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the shipping method is clicked
         *
         * @returns {Promise<void>}
         */editShippingMethodButtonClicked:function(){var _ref141=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee138(){return regeneratorRuntime.wrap(function _callee138$(_context138){while(1){switch(_context138.prev=_context138.next){case 0:// handle the task in a separate event block
window.setTimeout(function(){// enable the shipping method dropdownlist
var shippingMethodDropdownList=$('#checkout-page #checkout-shipping-method-type').get(0).ej2_instances[0];shippingMethodDropdownList.enabled=true;shippingMethodDropdownList.dataBind();},0);case 1:case'end':return _context138.stop();}}},_callee138,this);}));function editShippingMethodButtonClicked(){return _ref141.apply(this,arguments);}return editShippingMethodButtonClicked;}(),/**
         * method is triggered when the "Edit" button for the payment method is clicked
         *
         * @returns {Promise<void>}
         */editPaymentMethodButtonClicked:function(){var _ref142=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee139(){return regeneratorRuntime.wrap(function _callee139$(_context139){while(1){switch(_context139.prev=_context139.next){case 0:// handle the task in a separate event block
window.setTimeout(function(){// enable the payment method dropdownlist
var paymentMethodDropdownList=$('#checkout-page #checkout-payment-method-type').get(0).ej2_instances[0];paymentMethodDropdownList.enabled=true;paymentMethodDropdownList.dataBind();},0);case 1:case'end':return _context139.stop();}}},_callee139,this);}));function editPaymentMethodButtonClicked(){return _ref142.apply(this,arguments);}return editPaymentMethodButtonClicked;}(),/**
         * method is triggerd when  the "Apply" coupon button is clicked
         *
         * @returns {Promise<void>}
         */applyCouponButtonClicked:function(){var _ref143=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee140(){var toast,couponsArray,localOrderObject,_toast22;return regeneratorRuntime.wrap(function _callee140$(_context140){while(1){switch(_context140.prev=_context140.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context140.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to apply coupon';toast.dataBind();toast.show();return _context140.abrupt('return');case 10:_context140.prev=10;// show the page loader modal
$('#checkout-page .modal').css("display","table");// check if the coupon is valid or not
_context140.next=14;return Promise.resolve($.ajax(// load the list of shipping zones
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{code:$('#checkout-page #checkout-payment-voucher-code').val().trim()}}));case 14:couponsArray=_context140.sent;if(!(couponsArray.length==0)){_context140.next=17;break;}throw"error - no coupon found";case 17:// get a local/deep-clone copy of the page's checkout order object
...
_context140.next=22;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 22:localOrderObject=_context140.sent;// update the page checkout order with the updated order from the server
...
_context140.next=27;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 27:_context140.next=40;break;case 29:_context140.prev=29;_context140.t0=_context140['catch'](10);// hide the page loader modal
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast22=$('.timed-page-toast').get(0).ej2_instances[0];_toast22.cssClass='error-ej2-toast';_toast22.timeOut=3000;_toast22.content='Coupon not applied. Invalid coupon code';_toast22.dataBind();_toast22.show();case 40:case'end':return _context140.stop();}}},_callee140,this,[[10,29]]);}));function applyCouponButtonClicked(){return _ref143.apply(this,arguments);}return applyCouponButtonClicked;}(),/**
         * method is triggerd when  the "Add" note button is clicked
         *
         * @returns {Promise<void>}
         */addNoteButtonClicked:function(){var _ref144=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee141(){var toast,localOrderObject,_toast23;return regeneratorRuntime.wrap(function _callee141$(_context141){while(1){switch(_context141.prev=_context141.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context141.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to add shipping notes to the order';toast.dataBind();toast.show();return _context141.abrupt('return');case 10:_context141.prev=10;// show page loader
...
_context141.next=17;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 17:localOrderObject=_context141.sent;// update the page checkout order with the updated order from the server
utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder=localOrderObject;// clear the coupon code entered into the coupon/voucher input
...
_context141.next=22;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 22:_context141.next=35;break;case 24:_context141.prev=24;_context141.t0=_context141['catch'](10);// hide the page loader modal
$('#checkout-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast23=$('.timed-page-toast').get(0).ej2_instances[0];_toast23.cssClass='error-ej2-toast';_toast23.timeOut=3000;_toast23.content='Shipping note could not added. Please retry';_toast23.dataBind();_toast23.show();case 35:case'end':return _context141.stop();}}},_callee141,this,[[10,24]]);}));function addNoteButtonClicked(){return _ref144.apply(this,arguments);}return addNoteButtonClicked;}(),/**
         * method is triggered when the user clicks the "Make Payment" button
         *
         * @returns {Promise<void>}
         */makePaymentButtonClicked:function(){var _ref145=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee144(){var toast,userDetails,payStackResponse,transactionCompletedUrl,searchParams,completedTransactionReference,localOrderObject,_toast24,_localOrderObject,_toast25;return regeneratorRuntime.wrap(function _callee144$(_context144){while(1){switch(_context144.prev=_context144.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context144.next=14;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();return _context144.abrupt('return');case 14:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="paystack")){_context144.next=74;break;}// user selected the paystack (Pay With Card)
...
_context144.prev=18;_context144.next=21;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 21:userDetails=_context144.sent.userDetails;_context144.next=24;return Promise.resolve($.ajax({url:'https://api.paystack.co/transaction/initialize',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Bearer "+Base64.decode(utopiasoftware[utopiasoftware_app_namespace].paystackAccessor));},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify({email:userDetails.email,amount:""+kendo.parseFloat(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.total)*100,callback_url:"https://shopoakexclusive.com/"})}));case 24:payStackResponse=_context144.sent;if(!(payStackResponse.status===true)){_context144.next=52;break;}_context144.next=28;return new Promise(function(resolve,reject){// create/open inapp browser
...
}});});case 28:transactionCompletedUrl=_context144.sent;// get the search parameters object from the transaction completed url
...
localOrderObject.coupon_lines=localOrderObject.coupon_lines.map(function(couponElem){return{code:couponElem.code};});// update the checkout order data on the remote server
_context144.next=38;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 38:localOrderObject=_context144.sent;_context144.prev=39;_context144.next=42;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 42:_context144.next=46;break;case 44:_context144.prev=44;_context144.t0=_context144['catch'](39);case 46:// update the checkout-order-placement-modal with the checkout order number
$('#checkout-order-placement-modal .order-number').html(localOrderObject.number);// show the 'checkout-order-placement-modal'
_context144.next=49;return $('#checkout-order-placement-modal').get(0).show();case 49:// add the click handler for the 'checkout-order-placement-modal-ok-button'
$('#checkout-order-placement-modal #checkout-order-placement-modal-ok-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee142(){return regeneratorRuntime.wrap(function _callee142$(_context142){while(1){switch(_context142.prev=_context142.next){case 0:_context142.next=2;return $('ons-splitter').get(0).content.load("app-main-template");case 2:_context142.next=4;return $('#checkout-order-placement-modal').get(0).hide();case 4:case'end':return _context142.stop();}}},_callee142,this);}));_context144.next=53;break;case 52:throw"error";case 53:_context144.next=66;break;case 55:_context144.prev=55;_context144.t1=_context144['catch'](18);console.log("PAYMENT ERROR",_context144.t1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast24=$('.timed-page-toast').get(0).ej2_instances[0];_toast24.cssClass='error-ej2-toast';_toast24.timeOut=3500;_toast24.content='Error making payment for this order. Try again';_toast24.dataBind();_toast24.show();case 66:_context144.prev=66;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
...
$('#loader-modal').get(0).hide();return _context144.finish(66);case 73:return _context144.abrupt('return');case 74:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="cod")){_context144.next=118;break;}// user selected the cod (Cash on Delivery)
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);// inform the user that their order is being placed
$('#loader-modal-message').html("Completing Order Placement...");_context144.next=79;return $('#loader-modal').get(0).show();case 79:_context144.prev=79;// get a local/deep-clone copy of the page's checkout order object
...
_context144.next=85;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+_localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(_localOrderObject)}));case 85:_localOrderObject=_context144.sent;_context144.prev=86;_context144.next=89;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 89:_context144.next=93;break;case 91:_context144.prev=91;_context144.t2=_context144['catch'](86);case 93:// update the checkout-order-placement-modal with the checkout order number
$('#checkout-order-placement-modal .order-number').html(_localOrderObject.number);// show the 'checkout-order-placement-modal'
_context144.next=96;return $('#checkout-order-placement-modal').get(0).show();case 96:// add the click handler for the 'checkout-order-placement-modal-ok-button'
$('#checkout-order-placement-modal #checkout-order-placement-modal-ok-button').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee143(){return regeneratorRuntime.wrap(function _callee143$(_context143){while(1){switch(_context143.prev=_context143.next){case 0:_context143.next=2;return $('ons-splitter').get(0).content.load("app-main-template");case 2:_context143.next=4;return $('#checkout-order-placement-modal').get(0).hide();case 4:case'end':return _context143.stop();}}},_callee143,this);}));_context144.next=110;break;case 99:_context144.prev=99;_context144.t3=_context144['catch'](79);console.log("PAYMENT ERROR",_context144.t3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast25=$('.timed-page-toast').get(0).ej2_instances[0];_toast25.cssClass='error-ej2-toast';_toast25.timeOut=3500;_toast25.content='Error placing this order. Try again';_toast25.dataBind();_toast25.show();case 110:_context144.prev=110;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
$('#loader-modal').get(0).hide();return _context144.finish(110);case 117:return _context144.abrupt('return');case 118:case'end':return _context144.stop();}}},_callee144,this,[[18,55,66,73],[39,44],[79,99,110,117],[86,91]]);}));function makePaymentButtonClicked(){return _ref145.apply(this,arguments);}return makePaymentButtonClicked;}(),/**
         * method is used to load the current checkout/order data into the page
         * @returns {Promise<void>}
         */displayContent:function(){var _ref148=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee147(){var userDetails,orderData,shippingCountryCode,shippingZoneId,shippingCountry,shippingZone,shippingMethodsArray,shippingMethodDropDown,paymentMethodDropDown,couponsMultiSelectDropDown,couponsArray,orderItemsDisplayContent,index;return regeneratorRuntime.wrap(function _callee147$(_context147){while(1){switch(_context147.prev=_context147.next){case 0:_context147.prev=0;_context147.next=3;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 3:userDetails=_context147.sent.userDetails;// check if the checkout order billing data should be updated with the current user's billing
...
_context147.next=23;return Promise.resolve($.ajax(// load the list of shipping zones
...
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{}}));case 23:shippingMethodsArray=_context147.sent;// filter the shipping methods for only the methods that are enabled
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee145(){var toast,localOrderObject,remoteCartTotals,_toast26;return regeneratorRuntime.wrap(function _callee145$(_context145){while(1){switch(_context145.prev=_context145.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context145.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change shipping method';toast.dataBind();toast.show();return _context145.abrupt('return');case 10:// display the page loader modal
$('#checkout-page .modal').css("display","table");// get a local/deep-clone copy of the page's checkout order object
...
_context145.prev=15;_context145.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/oakscripts/setshipping.php',type:"post",//contentType: "application/json",
...
processData:false,data:JSON.stringify(localOrderObject)}));case 26:localOrderObject=_context145.sent;// update the page checkout order with the updated order from the server
...
_context145.next=32;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 32:_context145.next=47;break;case 34:_context145.prev=34;_context145.t0=_context145['catch'](15);console.log("CHECKOUT SHIPPING METHOD UPDATE ERROR",_context145.t0);_context145.t0=JSON.parse(_context145.t0.responseText.trim());// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast26=$('.timed-page-toast').get(0).ej2_instances[0];_toast26.cssClass='error-ej2-toast';_toast26.timeOut=3000;_toast26.content='Shipping method not updated, retry. '+(_context145.t0.message||"");_toast26.dataBind();_toast26.show();// hide the page loader modal
$('#checkout-page .modal').css("display","none");case 47:case'end':return _context145.stop();}}},_callee145,this,[[15,34]]);})),0);});// remove the "select" event listener for the shipping method dropdownlist
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee146(){var toast,localOrderObject,_toast27;return regeneratorRuntime.wrap(function _callee146$(_context146){while(1){switch(_context146.prev=_context146.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context146.next=10;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content='Connect to the Internet to change payment method';toast.dataBind();toast.show();return _context146.abrupt('return');case 10:// display the page loader modal
$('#checkout-page .modal').css("display","table");// get a local/deep-clone copy of the page's checkout order object
...
localOrderObject.coupon_lines=localOrderObject.coupon_lines.map(function(couponElem){return{code:couponElem.code};});// update the checkout order data on the remote server
_context146.prev=15;_context146.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 18:localOrderObject=_context146.sent;// update the page checkout order with the updated order from the server
...
_context146.next=24;return utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.pageShow();case 24:_context146.next=39;break;case 26:_context146.prev=26;_context146.t0=_context146['catch'](15);console.log("CHECKOUT PAYMENT METHOD UPDATE ERROR",_context146.t0);_context146.t0=JSON.parse(_context146.t0.responseText);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast27=$('.timed-page-toast').get(0).ej2_instances[0];_toast27.cssClass='error-ej2-toast';_toast27.timeOut=3000;_toast27.content='Payment method not updated, retry. '+(_context146.t0.message||"");_toast27.dataBind();_toast27.show();// hide the page loader modal
$('#checkout-page .modal').css("display","none");case 39:case'end':return _context146.stop();}}},_callee146,this,[[15,26]]);})),0);});// set the order coupons
...
$('#checkout-page .checkout-page-discount').css("display","none");}case 50:_context147.prev=50;return _context147.finish(50);case 52:case'end':return _context147.stop();}}},_callee147,this,[[0,,50,52]]);}));function displayContent(){return _ref148.apply(this,arguments);}return displayContent;}(),/**
...
_context148.prev=2;_context148.next=5;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 5:userDetails=_context148.sent.userDetails;if(!(!userDetails.first_name||userDetails.first_name=="")){_context148.next=8;break;}throw"validation error";case 8:// user validation was successful
...
tooltipIndex=$('#checkout-page .checkout-personal-details-accordion-item .utopiasoftware-checkout-failure').get(0)._utopiasoftware_validator_index;$('#checkout-page').get(0).ej2_instances[tooltipIndex].close();_context148.next=24;break;case 14:_context148.prev=14;_context148.t0=_context148['catch'](2);// user details could not be loaded, so user validation failed
...
if(!(validationSuccessful===true)){_context148.next=34;break;}// validation was successful
// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");resolve();// resolve validation promise
return _context148.abrupt('return');case 34:// validation failed
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);reject();// reject validation promise
return _context148.abrupt('return');case 37:case'end':return _context148.stop();}}},_callee148,this,[[2,14]]);}));return function(_x49,_x50){return _ref152.apply(this,arguments);};}()));case 2:case'end':return _context149.stop();}}},_callee149,this);}));function validateOrderCheckout(){return _ref151.apply(this,arguments);}return validateOrderCheckout;}(),/**
...
index=0;case 8:if(!(index<orderData.line_items.length)){_context150.next=43;break;}console.log("1");cartItemData={};// use the line item meta data to create part of cartItemData
_iteratorNormalCompletion2=true;_didIteratorError2=false;_iteratorError2=undefined;_context150.prev=14;for(_iterator2=orderData.line_items[index].meta_data[Symbol.iterator]();!(_iteratorNormalCompletion2=(_step2=_iterator2.next()).done);_iteratorNormalCompletion2=true){metaDataElem=_step2.value;console.log("2");if(metaDataElem.key==="_fpd_data"){// check the "key" property of the metaData object
...
_context150.next=22;break;case 18:_context150.prev=18;_context150.t0=_context150['catch'](14);_didIteratorError2=true;_iteratorError2=_context150.t0;case 22:_context150.prev=22;_context150.prev=23;if(!_iteratorNormalCompletion2&&_iterator2.return){_iterator2.return();}case 25:_context150.prev=25;if(!_didIteratorError2){_context150.next=28;break;}throw _iteratorError2;case 28:return _context150.finish(25);case 29:return _context150.finish(22);case 30:cartItemData.product_id=orderData.line_items[index].product_id;cartItemData.variation_id=orderData.line_items[index].variation_id;cartItemData.quantity=orderData.line_items[index].quantity;console.log("7");// add the created cartItemData to remote user cart
_context150.t1=addToCartPromises;_context150.next=37;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+'/wp-json/wc/v2/cart/add',type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+Base64.encode(userDetails.email+':'+userDetails.password));},crossDomain:true,xhrFields:{withCredentials:true},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(cartItemData)}));case 37:_context150.t2=_context150.sent;_context150.t1.push.call(_context150.t1,_context150.t2);console.log("8");case 40:index++;_context150.next=8;break;case 43:_context150.next=45;return Promise.all(addToCartPromises);case 45:resolve();// resolve the parent promise
case 46:_context150.prev=46;return _context150.finish(46);case 48:case'end':return _context150.stop();}}},_callee150,this,[[0,,46,48],[14,18,22,30],[23,,25,29]]);}));return function(_x52,_x53){return _ref154.apply(this,arguments);};}()));case 1:case'end':return _context151.stop();}}},_callee151,this);}));function createRemoteCartFromOrder(){return _ref153.apply(this,arguments);}return createRemoteCartFromOrder;}()}};
