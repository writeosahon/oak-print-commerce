...
$('#completed-orders-page .modal').css("display","none");return _context174.finish(18);case 21:case"end":return _context174.stop();}}},_callee174,this,[[3,8,18,21]]);})),0);case 3:case"end":return _context175.stop();}}},_callee175,this);}));function checkoutButtonClicked(_x68){return _ref177.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         ...
         *
         * @returns {Promise<void>}
         */detailsButtonClicked:function(){var _ref179=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee177(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee177$(_context177){while(1){switch(_context177.prev=_context177.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context176.prev=3;_context176.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context176.next=18;break;case 8:_context176.prev=8;_context176.t0=_context176["catch"](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
...
$('#completed-orders-page .modal').css("display","none");return _context176.finish(18);case 21:case"end":return _context176.stop();}}},_callee176,this,[[3,8,18,21]]);})),0);case 3:case"end":return _context177.stop();}}},_callee177,this);}));function detailsButtonClicked(_x69){return _ref179.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref181=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee180(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee180$(_context180){while(1){switch(_context180.prev=_context180.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context180.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content="Connect to the Internet to cancel this order";toast.dataBind();toast.show();return _context180.abrupt("return");case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee178(){return regeneratorRuntime.wrap(function _callee178$(_context178){while(1){switch(_context178.prev=_context178.next){case 0:_context178.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case"end":return _context178.stop();}}},_callee178,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee179(){var selectedOrder,userDetails,searchResultsArray,_toast34,_toast35;return regeneratorRuntime.wrap(function _callee179$(_context179){while(1){switch(_context179.prev=_context179.next){case 0:// display the page loader
$('#completed-orders-page .modal').css("display","table");_context179.prev=1;_context179.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
selectedOrder.status="cancelled";// update the selectedOrder status remotely
_context179.next=8;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+("/wp-json/wc/v3/orders/"+selectedOrder.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context179.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context179.sent.userDetails;_context179.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.trackOrderPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"completed"});case 13:searchResultsArray=_context179.sent;_context179.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast34=$('.timed-page-toast').get(0).ej2_instances[0];_toast34.cssClass='default-ej2-toast';_toast34.timeOut=2000;_toast34.content="Order #"+selectedOrder.id+" has been cancelled";_toast34.dataBind();_toast34.show();_context179.next=36;break;case 26:_context179.prev=26;_context179.t0=_context179["catch"](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast35=$('.timed-page-toast').get(0).ej2_instances[0];_toast35.cssClass='error-ej2-toast';_toast35.timeOut=3500;_toast35.content="Error cancelling order #"+selectedOrder.id+". Try again";_toast35.dataBind();_toast35.show();case 36:_context179.prev=36;// display the page loader
$('#completed-orders-page .modal').css("display","none");return _context179.finish(36);case 39:case"end":return _context179.stop();}}},_callee179,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context180.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case"end":return _context180.stop();}}},_callee180,this);}));function cancelButtonClicked(_x70){return _ref181.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref184=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee182(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee182$(_context182){while(1){switch(_context182.prev=_context182.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context182.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content="Connect to the Internet to make a reorder";toast.dataBind();toast.show();return _context182.abrupt("return");case 11:// show the page loader
$('#completed-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee181(){var selectedOrder,newOrder,_toast36;return regeneratorRuntime.wrap(function _callee181$(_context181){while(1){switch(_context181.prev=_context181.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.completedOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context181.prev=3;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context181.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context181.sent;_context181.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context181.next=34;break;case 23:_context181.prev=23;_context181.t0=_context181["catch"](3);console.log(_context181.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast36=$('.timed-page-toast').get(0).ej2_instances[0];_toast36.cssClass='error-ej2-toast';_toast36.timeOut=3000;_toast36.content="Placing new order failed. Please retry";_toast36.dataBind();_toast36.show();case 34:_context181.prev=34;// hide the page loader
$('#completed-orders-page .modal').css("display","none");return _context181.finish(34);case 37:case"end":return _context181.stop();}}},_callee181,this,[[3,23,34,37]]);})),0);case 13:case"end":return _context182.stop();}}},_callee182,this);}));function reorderButtonClicked(_x71){return _ref184.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */pendingOrdersPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref186=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee183(){var userDetails,searchResultsArray,toast,_toast37;return regeneratorRuntime.wrap(function _callee183$(_context183){while(1){switch(_context183.prev=_context183.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context183.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context183.abrupt("return");case 3:// listen for the back button event
...
$('#pending-orders-page-pull-hook-fab',event.originalEvent.pullHook).html('<ons-progress-circular indeterminate modifier="pull-hook"></ons-progress-circular>');break;}});_context183.prev=6;// hide the previously displayed orders info
...
_context183.next=11;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 11:userDetails=_context183.sent.userDetails;_context183.next=14;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 14:searchResultsArray=_context183.sent;_context183.next=17;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 17:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
...
document.addEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);},/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref187=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee184(){return regeneratorRuntime.wrap(function _callee184$(_context184){while(1){switch(_context184.prev=_context184.next){case 0:// remove listener for when the device does not have Internet connection
...
document.removeEventListener("online",utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.deviceOnlineListener,false);case 2:case"end":return _context184.stop();}}},_callee184,this);}));function pageHide(){return _ref187.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
         */pageDestroy:function pageDestroy(){// reset the view-model properties
...
$('.page-toast').get(0).ej2_instances[0].hide('All');},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref188=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee185(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var userDetails,searchResultsArray,toast,_toast38;return regeneratorRuntime.wrap(function _callee185$(_context185){while(1){switch(_context185.prev=_context185.next){case 0:// disable pull-to-refresh widget till loading is done
$('#pending-orders-page #pending-orders-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context185.prev=2;// show the page loader
$('#pending-orders-page .modal').css("display","table");// load the user profile details from the app database
_context185.next=6;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 6:userDetails=_context185.sent.userDetails;_context185.next=9;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 9:searchResultsArray=_context185.sent;_context185.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 12:if(searchResultsArray[0].length==0){// no orders were found
// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// hide the previously displayed orders info
$('#pending-orders-page .row').css("display","none");// hide the page loader
$('#pending-orders-page .modal').css("display","none");// inform the user that no result for the search was found'
...
$('#pending-orders-page .page-preloader').css("display","none");// show the orders info
$('#pending-orders-page .row').css("display","block");// hide the page loader
$('#pending-orders-page .modal').css("display","none");}_context185.next=27;break;case 15:_context185.prev=15;_context185.t0=_context185["catch"](2);// hide the page preloader
$('#pending-orders-page .page-preloader').css("display","none");// show the page loader
$('#pending-orders-page .modal').css("display","none");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast38=$('.timed-page-toast').get(0).ej2_instances[0];_toast38.cssClass='error-ej2-toast';_toast38.timeOut=3000;_toast38.content="Sorry, a search error occurred."+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"");_toast38.dataBind();_toast38.show();case 27:_context185.prev=27;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context185.finish(27);case 32:case"end":return _context185.stop();}}},_callee185,this,[[2,15,27,32]]);}));function pagePullHookAction(){return _ref188.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is used to load orders to the page
         *
         * @param pageToAccess {Integer} the page within the paginated categories to retrieve
         *
         ...
         *
         * @returns {Promise<void>}
         */loadOrders:function(){var _ref189=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee186(queryParam){var pageToAccess=arguments.length>1&&arguments[1]!==undefined?arguments[1]:queryParam.page||1;var pageSize=arguments.length>2&&arguments[2]!==undefined?arguments[2]:queryParam.per_page||20;var promisesArray;return regeneratorRuntime.wrap(function _callee186$(_context186){while(1){switch(_context186.prev=_context186.next){case 0:queryParam.page=pageToAccess;queryParam.per_page=pageSize;promisesArray=[];// holds the array for the promises used to load the orders
// check if there is internet connection or not
if(navigator.connection.type!==Connection.NONE){// there is internet connection
// load the requested products list from the server
promisesArray.push(new Promise(function(resolve,reject){Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"get",//contentType: "application/x-www-form-urlencoded",
...
promisesArray.push(Promise.reject("no internet connection"));}return _context186.abrupt("return",Promise.all(promisesArray));case 5:case"end":return _context186.stop();}}},_callee186,this);}));function loadOrders(_x75){return _ref189.apply(this,arguments);}return loadOrders;}(),/**
         * method is used to display the retrieved products on the search popover
         *
         * @param ordersArray
         *
         * @returns {Promise<void>}
         */displayPageContent:function(){var _ref190=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee187(ordersArray){var displayCompletedPromise;return regeneratorRuntime.wrap(function _callee187$(_context187){while(1){switch(_context187.prev=_context187.next){case 0:displayCompletedPromise=new Promise(function(resolve,reject){var ordersContent="";// holds the contents for the orders
// check if the ordersArray is empty or not
if(ordersArray.length<=0){// there are no new content to display
resolve(ordersArray.length);// resolve promise with the length of the orders array
}else{// there are some orders to display
...
$('#pending-orders-page #pending-orders-page-orders-container').html(ordersContent);resolve(ordersArray.length);// resolve the promise with length of the ordersArray
}});return _context187.abrupt("return",displayCompletedPromise);case 2:case"end":return _context187.stop();}}},_callee187,this);}));function displayPageContent(_x76){return _ref190.apply(this,arguments);}return displayPageContent;}(),/**
         * method is triggered when the "Check Out" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */checkoutButtonClicked:function(){var _ref191=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee189(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee189$(_context189){while(1){switch(_context189.prev=_context189.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee188(){var selectedOrder,toast;return regeneratorRuntime.wrap(function _callee188$(_context188){while(1){switch(_context188.prev=_context188.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context188.prev=3;_context188.next=6;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:selectedOrder}});case 6:_context188.next=18;break;case 8:_context188.prev=8;_context188.t0=_context188["catch"](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.timeOut=3000;toast.content="Order checkout failed. Please retry";toast.dataBind();toast.show();case 18:_context188.prev=18;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context188.finish(18);case 21:case"end":return _context188.stop();}}},_callee188,this,[[3,8,18,21]]);})),0);case 3:case"end":return _context189.stop();}}},_callee189,this);}));function checkoutButtonClicked(_x77){return _ref191.apply(this,arguments);}return checkoutButtonClicked;}(),/**
         * method is triggered when the "Details" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */detailsButtonClicked:function(){var _ref193=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee191(buttonElem){var $buttonElement;return regeneratorRuntime.wrap(function _callee191$(_context191){while(1){switch(_context191.prev=_context191.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
...
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context190.prev=3;_context190.next=6;return $('#app-main-navigator').get(0).pushPage("order-details-page.html",{data:{orderData:selectedOrder}});case 6:_context190.next=18;break;case 8:_context190.prev=8;_context190.t0=_context190["catch"](3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
...
$('#pending-orders-page .modal').css("display","none");return _context190.finish(18);case 21:case"end":return _context190.stop();}}},_callee190,this,[[3,8,18,21]]);})),0);case 3:case"end":return _context191.stop();}}},_callee191,this);}));function detailsButtonClicked(_x78){return _ref193.apply(this,arguments);}return detailsButtonClicked;}(),/**
         * method is triggered when the "Cancel" button on the
         * Orders Collection is clicked
         *
         * @returns {Promise<void>}
         */cancelButtonClicked:function(){var _ref195=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee194(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee194$(_context194){while(1){switch(_context194.prev=_context194.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context194.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content="Connect to the Internet to cancel this order";toast.dataBind();toast.show();return _context194.abrupt("return");case 11:// attach functions to handle the "Reject/No" and "Accept/Yes" buttons click event.
// These buttons are located in the 'Cancel Order Action Sheet'.
// Click event handlers must always be defined for these buttons when using this action sheet
// function for "Reject/No" button
$('#cancel-order-action-sheet #cancel-order-no').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee192(){return regeneratorRuntime.wrap(function _callee192$(_context192){while(1){switch(_context192.prev=_context192.next){case 0:_context192.next=2;return document.getElementById('cancel-order-action-sheet').hide();case 2:case"end":return _context192.stop();}}},_callee192,this);}));// function for "Accept/Yes" button
$('#cancel-order-action-sheet #cancel-order-yes').get(0).onclick=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee193(){var selectedOrder,userDetails,searchResultsArray,_toast39,_toast40;return regeneratorRuntime.wrap(function _callee193$(_context193){while(1){switch(_context193.prev=_context193.next){case 0:// display the page loader
$('#pending-orders-page .modal').css("display","table");_context193.prev=1;_context193.next=4;return document.getElementById('cancel-order-action-sheet').hide();case 4:// get the order that was selected for cancellation
...
processData:false,data:JSON.stringify(selectedOrder)}));case 8:_context193.next=10;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.loadData("user-details",utopiasoftware[utopiasoftware_app_namespace].model.encryptedAppDatabase);case 10:userDetails=_context193.sent.userDetails;_context193.next=13;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.loadOrders({"page":1,"per_page":20,"order":"desc","orderby":"date","customer":userDetails.id,"status":"pending"});case 13:searchResultsArray=_context193.sent;_context193.next=16;return utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.displayPageContent(searchResultsArray[0]);case 16:// inform the user that the order has been cancelled
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast39=$('.timed-page-toast').get(0).ej2_instances[0];_toast39.cssClass='default-ej2-toast';_toast39.timeOut=2000;_toast39.content="Order #"+selectedOrder.id+" has been cancelled";_toast39.dataBind();_toast39.show();_context193.next=36;break;case 26:_context193.prev=26;_context193.t0=_context193["catch"](1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast40=$('.timed-page-toast').get(0).ej2_instances[0];_toast40.cssClass='error-ej2-toast';_toast40.timeOut=3500;_toast40.content="Error cancelling order #"+selectedOrder.id+". Try again";_toast40.dataBind();_toast40.show();case 36:_context193.prev=36;// display the page loader
$('#pending-orders-page .modal').css("display","none");return _context193.finish(36);case 39:case"end":return _context193.stop();}}},_callee193,this,[[1,26,36,39]]);}));// display the cancel order action sheet
_context194.next=15;return document.getElementById('cancel-order-action-sheet').show();case 15:case"end":return _context194.stop();}}},_callee194,this);}));function cancelButtonClicked(_x79){return _ref195.apply(this,arguments);}return cancelButtonClicked;}(),/**
         * method is triggered when the "Reorder" button on the
         * Orders Collection is clicked
         *
         * @buttonElem {HTMLButton}
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref198=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee196(buttonElem){var $buttonElement,toast;return regeneratorRuntime.wrap(function _callee196$(_context196){while(1){switch(_context196.prev=_context196.next){case 0:$buttonElement=$(buttonElem);// get a jQuery reference to the button element that was clicked
// check if there is Internet connection
if(!(navigator.connection.type===Connection.NONE)){_context196.next=11;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.timed-page-toast').get(0).ej2_instances[0];toast.cssClass='default-ej2-toast';toast.timeOut=3000;toast.content="Connect to the Internet to make a reorder";toast.dataBind();toast.show();return _context196.abrupt("return");case 11:// show the page loader
$('#pending-orders-page .modal').css("display","table");// handle the tasks in a separate queue
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee195(){var selectedOrder,newOrder,_toast41;return regeneratorRuntime.wrap(function _callee195$(_context195){while(1){switch(_context195.prev=_context195.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.pendingOrdersPageViewModel.ordersResultsArray[window.parseInt($buttonElement.attr("data-order-index"))];console.log("ORDER INDEX",$buttonElement.attr("data-order-index"));console.log("SELECTED ORDER",selectedOrder);_context195.prev=3;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context195.next=18;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 18:newOrder=_context195.sent;_context195.next=21;return $('#app-main-navigator').get(0).pushPage("checkout-page.html",{data:{orderData:newOrder}});case 21:_context195.next=34;break;case 23:_context195.prev=23;_context195.t0=_context195["catch"](3);console.log(_context195.t0,"REORDER ERROR");// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast41=$('.timed-page-toast').get(0).ej2_instances[0];_toast41.cssClass='error-ej2-toast';_toast41.timeOut=3000;_toast41.content="Placing new order failed. Please retry";_toast41.dataBind();_toast41.show();case 34:_context195.prev=34;// hide the page loader
$('#pending-orders-page .modal').css("display","none");return _context195.finish(34);case 37:case"end":return _context195.stop();}}},_callee195,this,[[3,23,34,37]]);})),0);case 13:case"end":return _context196.stop();}}},_callee196,this);}));function reorderButtonClicked(_x80){return _ref198.apply(this,arguments);}return reorderButtonClicked;}()},/**
     ...
     */orderDetailsPageViewModel:{/**
         ...
         * event is triggered when page is initialised
         */pageInit:function pageInit(event){//function is used to initialise the page if the app is fully ready for execution
var loadPageOnAppReady=function(){var _ref200=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee197(){var promisesArray,orderId,toast;return regeneratorRuntime.wrap(function _callee197$(_context197){while(1){switch(_context197.prev=_context197.next){case 0:if(!(!ons.isReady()||utopiasoftware[utopiasoftware_app_namespace].model.isAppReady===false)){_context197.next=3;break;}setTimeout(loadPageOnAppReady,500);// call this function again after half a second
return _context197.abrupt("return");case 3:// listen for the back button event
...
utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails=$('#app-main-navigator').get(0).topPage.data.orderData;_context197.prev=7;// create the "Reorder" button
new ej.splitbuttons.ProgressButton({cssClass:'e-hide-spinner',duration:10*60*60*1000// set spinner/progress duration for 10 hr
...
_context197.next=14;return Promise.all(promisesArray);case 14:promisesArray=_context197.sent;// get the order notes belonging to the specified order object
...
_context197.next=18;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 18:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context197.next=30;break;case 21:_context197.prev=21;_context197.t0=_context197["catch"](7);console.log("ORDER DETAILS ERROR",_context197.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred."+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+" Pull down to refresh and try again";toast.dataBind();toast.show();case 30:_context197.prev=30;// hide page preloader
$('#order-details-page .page-preloader').css("display","none");// hide page modal loader
$('#order-details-page .modal').css("display","none");return _context197.finish(30);case 34:case"end":return _context197.stop();}}},_callee197,this,[[7,21,30,34]]);}));return function loadPageOnAppReady(){return _ref200.apply(this,arguments);};}();var $thisPage=$(event.target);// get the current page shown
// call the function used to initialise the app page if the app is fully loaded
loadPageOnAppReady();},/**
         * method is triggered when page is shown
         */pageShow:function(){var _ref201=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee198(){return regeneratorRuntime.wrap(function _callee198$(_context198){while(1){switch(_context198.prev=_context198.next){case 0:window.SoftInputMode.set('adjustPan');// adjust device input mode
// update cart count
$('#order-details-page .cart-count').html(utopiasoftware[utopiasoftware_app_namespace].model.cartCount);case 2:case"end":return _context198.stop();}}},_callee198,this);}));function pageShow(){return _ref201.apply(this,arguments);}return pageShow;}(),/**
         * method is triggered when page is hidden
         */pageHide:function(){var _ref202=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee199(){return regeneratorRuntime.wrap(function _callee199$(_context199){while(1){switch(_context199.prev=_context199.next){case 0:case"end":return _context199.stop();}}},_callee199,this);}));function pageHide(){return _ref202.apply(this,arguments);}return pageHide;}(),/**
         * method is triggered when page is destroyed
...
$('#app-main-navigator').get(0).popPage();},/**
         ...
         * @param doneCallBack
         * @returns {Promise<void>}
         */pagePullHookAction:function(){var _ref203=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee200(){var doneCallBack=arguments.length>0&&arguments[0]!==undefined?arguments[0]:function(){};var promisesArray,orderId,toast;return regeneratorRuntime.wrap(function _callee200$(_context200){while(1){switch(_context200.prev=_context200.next){case 0:// disable pull-to-refresh widget till loading is done
$('#order-details-page #order-details-page-pull-hook').attr("disabled",true);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');_context200.prev=2;// load the order notes attached to the loaded order details
promisesArray=[];// holds all created promises
orderId=utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails.id;// get the id for the specified order object
promisesArray.push(Promise.resolve($.ajax(// load the order notes for the specified order object
{url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+("/wp-json/wc/v3/orders/"+orderId+"/notes"),type:"get",//contentType: "application/json",
beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:true,data:{"type":"any"}})));// wait for all promises to resolve
_context200.next=8;return Promise.all(promisesArray);case 8:promisesArray=_context200.sent;// get the order notes belonging to the specified order object
utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderNotesArray=promisesArray[0];// display the order details
_context200.next=12;return utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.displayContent();case 12:// enable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled");_context200.next=26;break;case 15:_context200.prev=15;_context200.t0=_context200["catch"](2);// hide the page preloader
$('#order-details-page .page-preloader').css("display","none");// show the page loader
$('#order-details-page .modal').css("display","none");console.log("ORDER DETAILS ERROR",_context200.t0);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
toast=$('.page-toast').get(0).ej2_instances[0];toast.cssClass='error-ej2-toast';toast.content="Sorry, an error occurred."+(navigator.connection.type===Connection.NONE?" Connect to the Internet.":"")+" Pull down to refresh and try again";toast.dataBind();toast.show();case 26:_context200.prev=26;// enable pull-to-refresh widget till loading is done
...
doneCallBack();return _context200.finish(26);case 31:case"end":return _context200.stop();}}},_callee200,this,[[2,15,26,31]]);}));function pagePullHookAction(){return _ref203.apply(this,arguments);}return pagePullHookAction;}(),/**
         * method is triggered when the user clicks the "Reorder" button
         *
         * @returns {Promise<void>}
         */reorderButtonClicked:function(){var _ref204=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee202(){var toast;return regeneratorRuntime.wrap(function _callee202$(_context202){while(1){switch(_context202.prev=_context202.next){case 0:if(!(navigator.connection.type===Connection.NONE)){_context202.next=14;break;}// there is no Internet connection
// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
...
$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].dataBind();$('#order-details-page #order-details-reorder').get(0).ej2_instances[0].stop();return _context202.abrupt("return");case 14:// show the page loader
...
window.setTimeout(_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee201(){var selectedOrder,newOrder,_toast42;return regeneratorRuntime.wrap(function _callee201$(_context201){while(1){switch(_context201.prev=_context201.next){case 0:// get the selected order to be checked out
selectedOrder=utopiasoftware[utopiasoftware_app_namespace].controller.orderDetailsPageViewModel.orderDetails;_context201.prev=1;// create a new order object
newOrder=JSON.parse(JSON.stringify(selectedOrder));// delete and reset all necessary properties for the new order
delete newOrder.id;newOrder.transaction_id="";newOrder.line_items.forEach(function(lineItem){delete lineItem.id;lineItem.total=lineItem.subtotal;// remove any discounts
for(var index=0;index<lineItem.meta_data.length;index++){delete lineItem.meta_data[index].id;}});newOrder.tax_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.shipping_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});newOrder.fee_lines.forEach(function(item){delete item.id;for(var index=0;index<item.meta_data.length;index++){delete item.meta_data[index].id;}});delete newOrder.coupon_lines;delete newOrder.discount_total;delete newOrder.discount_tax;newOrder.set_paid=false;// update the status of the new order to "pending"
newOrder.status="pending";// update the selectedOrder status remotely
_context201.next=16;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+"/wp-json/wc/v3/orders",type:"post",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(newOrder)}));case 16:newOrder=_context201.sent;// hide the page loader
...
_context201.next=24;return $('#app-main-navigator').get(0).replacePage("checkout-page.html",{data:{orderData:newOrder}});case 24:_context201.next=42;break;case 26:_context201.prev=26;_context201.t0=_context201["catch"](1);console.log(_context201.t0,"REORDER ERROR");// hide the page loader
$('#order-details-page .modal').css("display","none");// disable the "Reorder" button
$('#order-details-page #order-details-reorder').removeAttr("disabled",true);// add the spinner from the 'Reorder'
...
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast message
_toast42=$('.timed-page-toast').get(0).ej2_instances[0];_toast42.cssClass='error-ej2-toast';_toast42.timeOut=3000;_toast42.content="Placing new order failed. Please retry";_toast42.dataBind();_toast42.show();case 42:_context201.prev=42;return _context201.finish(42);case 44:case"end":return _context201.stop();}}},_callee201,this,[[1,26,42,44]]);})),0);case 20:case"end":return _context202.stop();}}},_callee202,this);}));function reorderButtonClicked(){return _ref204.apply(this,arguments);}return reorderButtonClicked;}(),/**
         * method is used to load the order details data into the page
         * @returns {Promise<void>}
         */displayContent:function(){var _ref206=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee203(){var orderData,_displayContent,index,orderNote,_index;return regeneratorRuntime.wrap(function _callee203$(_context203){while(1){switch(_context203.prev=_context203.next){case 0:try{// get the order object set on this page
...
_displayContent+="<div class=\"col-xs-12\" style=\"text-align: left; padding-right: 5px;\n                            padding-top: 10px; padding-bottom: 10px\">"+orderData.shipping.postcode+"</div>";}_displayContent+="<div class=\"col-xs-12\" style=\"text-align: left; padding-right: 5px;\n                            padding-top: 10px; padding-bottom: 10px\">"+orderData.shipping.country+"</div>";$('#order-details-page #order-details-list .order-details-shipping-details').html(_displayContent);}finally{}case 1:case"end":return _context203.stop();}}},_callee203,this);}));function displayContent(){return _ref206.apply(this,arguments);}return displayContent;}()}};
