...
$('#third-party-login-modal #third-party-login-loader').css("display","none");},signInSuccessWithAuthResult:function signInSuccessWithAuthResult(){return false;}}});// disable firebase ui auto-signin
...
processData:false,data:JSON.stringify({email:userDetails.email,amount:""+kendo.parseFloat(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.total)*100,callback_url:"https://shopoakexclusive.com/"})}));case 24:payStackResponse=_context147.sent;if(!(payStackResponse.status===true)){_context147.next=52;break;}_context147.next=28;return new Promise(function(resolve,reject){// create/open inapp browser
...
localOrderObject.coupon_lines=localOrderObject.coupon_lines.map(function(couponElem){return{code:couponElem.code};});// update the checkout order data on the remote server
_context147.next=38;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(localOrderObject)}));case 38:localOrderObject=_context147.sent;_context147.prev=39;_context147.next=42;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 42:_context147.next=46;break;case 44:_context147.prev=44;_context147.t0=_context147['catch'](39);case 46:// update the checkout-order-placement-modal with the checkout order number
...
_context147.next=50;return $('#checkout-order-placement-modal').get(0).show();case 50:_context147.next=53;break;case 52:throw"error";case 53:_context147.next=66;break;case 55:_context147.prev=55;_context147.t1=_context147['catch'](18);console.log("PAYMENT ERROR",_context147.t1);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast24=$('.timed-page-toast').get(0).ej2_instances[0];_toast24.cssClass='error-ej2-toast';_toast24.timeOut=3500;_toast24.content='Error making payment for this order. Try again';_toast24.dataBind();_toast24.show();case 66:_context147.prev=66;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
...
$('#loader-modal').get(0).hide();return _context147.finish(66);case 73:return _context147.abrupt('return');case 74:if(!(utopiasoftware[utopiasoftware_app_namespace].controller.checkoutPageViewModel.chekoutOrder.payment_method==="cod")){_context147.next=118;break;}// user selected the cod (Cash on Delivery)
// disable the "Make Payment" button
$('#checkout-page #checkout-make-payment').attr("disabled",true);// inform the user that their order is being placed
$('#loader-modal-message').html("Completing Order Placement...");_context147.next=79;return $('#loader-modal').get(0).show();case 79:_context147.prev=79;// get a local/deep-clone copy of the page's checkout order object
...
_context147.next=85;return Promise.resolve($.ajax({url:utopiasoftware[utopiasoftware_app_namespace].model.appBaseUrl+('/wp-json/wc/v3/orders/'+_localOrderObject.id),type:"put",contentType:"application/json",beforeSend:function beforeSend(jqxhr){jqxhr.setRequestHeader("Authorization","Basic "+utopiasoftware[utopiasoftware_app_namespace].accessor);},dataType:"json",timeout:240000,// wait for 4 minutes before timeout of request
processData:false,data:JSON.stringify(_localOrderObject)}));case 85:_localOrderObject=_context147.sent;_context147.prev=86;_context147.next=89;return utopiasoftware[utopiasoftware_app_namespace].databaseOperations.removeData("user-cart",utopiasoftware[utopiasoftware_app_namespace].model.appDatabase);case 89:_context147.next=93;break;case 91:_context147.prev=91;_context147.t2=_context147['catch'](86);case 93:// update the checkout-order-placement-modal with the checkout order number
...
_context147.next=97;return $('#checkout-order-placement-modal').get(0).show();case 97:_context147.next=110;break;case 99:_context147.prev=99;_context147.t3=_context147['catch'](79);console.log("PAYMENT ERROR",_context147.t3);// hide all previously displayed ej2 toast
$('.page-toast').get(0).ej2_instances[0].hide('All');$('.timed-page-toast').get(0).ej2_instances[0].hide('All');// display toast to show that an error
_toast25=$('.timed-page-toast').get(0).ej2_instances[0];_toast25.cssClass='error-ej2-toast';_toast25.timeOut=3500;_toast25.content='Error placing this order. Try again';_toast25.dataBind();_toast25.show();case 110:_context147.prev=110;// enable the "Make Payment" button
$('#checkout-page #checkout-make-payment').removeAttr("disabled");// hide the spinner from the 'Make Payment'
$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].cssClass='e-hide-spinner';$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].dataBind();$('#checkout-page #checkout-make-payment').get(0).ej2_instances[0].stop();// hide loader
$('#loader-modal').get(0).hide();return _context147.finish(110);case 117:return _context147.abrupt('return');case 118:case'end':return _context147.stop();}}},_callee147,this,[[18,55,66,73],[39,44],[79,99,110,117],[86,91]]);}));function makePaymentButtonClicked(){return _ref148.apply(this,arguments);}return makePaymentButtonClicked;}(),/**
